    ...
    return function() {
        ...
        var t = {
            ...
            3978: function(e, t, n) {
                ...
                var i = v(n(7042)), a = v(n(9472)), r = v(n(8826)), o = n(4136), l = v(n(6266)), s = n(1507), c = n(4240), u = n(4507), f = n(7539), p = n(7687), d = n(5895);
                function h(e) {
                ...
                function h(e, t, n) {
                        ...
                        function f(r, l, p) {
                            ...
                            if (h === e && void 0 === r.matches) {
                                ...
                                if (r.isAlternator) return function() {
                                    ...
                                    o.hasAlternator = !0;
                                    var a, v = r, y = [], b = m.slice(), x = l.length, P = n.length > 0 ? n.shift() : -1;
                                    if (-1 === P || "string" == typeof P) {
                                        ...
                                        for (var B = 0; B < T.length; B++) {
                                            _ = parseInt(T[B]), m = [], n = "string" == typeof P && S(h, _, x) || E.slice();
                                            var R = v.matches[_];
                                            ...
                                            for (var I = 0; I < a.length; I++) {
                                                ...
                                                for (var V = 0; V < y.length; V++) {
                                                    ...
                                                    if ("string" != typeof P || void 0 !== F.alternation && T.includes(F.locator[F.alternation].toString())) {
                                                        ...
                                                        if (d(F, G, c)) {
                                                            O(F, G) && (N = !0, y.splice(y.indexOf(G), 0, F));
                                                            break;
                                                        }
                                                        if (d(G, F, c)) {
                                                            O(G, F);
                                                        ...
                                                        if (w(F, G)) {
                                                            M(F, G) || void 0 !== u.inputmask.userOptions.keepStatic ? O(F, G) && (N = !0, y.splice(y.indexOf(G), 0, F)) : c.keepStatic = !0;
                                                            break;
                                                        }
                                                        if (w(G, F)) {
                                                            O(G, F);
                                    ...
                                    } else r = f(v.matches[P] || t.matches[P], [ P ].concat(l), p);
                                    if (r) return !0;
                                }();
                                if (r.isQuantifier && p !== t.matches[t.matches.indexOf(r) - 1]) return function() {
                                    for (var a, o = r, u = !1, p = function(n) {
                                    ...
                                    }, d = n.length > 0 ? n.shift() : 0; d < (isNaN(o.quantifier.max) ? d + 1 : o.quantifier.max) && h <= e && 0 !== (a = p(d)); d++) if (a) return a.v;
                                }();
                    ...
                    if (e > -1) {
                        if (void 0 === t) {
                            ...
                            void 0 !== S && w > -1 && (v = P(w, S), y = v.join(""), h = w);
                        }
                        if (s.tests[e] && s.tests[e][0].cd === y) return s.tests[e];
                        for (var O = v.shift(); O < p.length; O++) {
                            if (b(p[O], v, [ O ]) && h === e || h > e) break;
                        }
                    }
            ...
            7687: function(e, t, n) {
                ...
                function l(e, t, n, i, a, s) {
                    ...
                    var h, v, m, g, y, k, b, x, P, S, w, O = u.extend(!0, [], d.validPositions), M = u.extend(!0, {}, d.tests), _ = !1, j = !1, E = void 0 !== a ? a : r.getLastValidPosition.call(c);
                    if (s && (S = s.begin, w = s.end, s.begin > s.end && (S = s.end, w = s.begin)), 
                    -1 === E && void 0 === a) h = 0, v = (g = o.getTest.call(c, h)).alternation; else for (;E >= 0; E--) if ((m = 0 === E ? o.getTest.call(c, 0) : d.validPositions[E]) && void 0 !== m.alternation) {
                        if (E <= (e || 0) && g && g.locator[m.alternation] !== m.locator[m.alternation]) break;
                        h = E, v = m.alternation, g = m;
                    }
                    if (void 0 !== v) {
