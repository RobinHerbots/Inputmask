        ...
        var t = {
            ...
            219: function(e, t, n) {
                ...
                function O(e, t, n, i) {
                    ...
                    for (w(n).lastIndex = 0; a = w(n).exec(e); ) {
                        if (void 0 === t) if (o = P(a)) s += "(" + o[0] + ")"; else switch (a[0]) {
                          case "[":
                            s += "(";
                            break;
            ...
            2391: function(e, t, n) {
                Object.defineProperty(t, "__esModule", {
                    ...
                    var i, o, s, l, c, u, f = /(?:[?*+]|\{[0-9+*]+(?:,[0-9+*]*)?(?:\|[0-9+*]*)?\})|[^.?*+^${[]()|\\]+|./g, p = /\[\^?]?(?:[^\\\]]+|\\[\S\s]?)*]?|\\(?:0(?:[0-3][0-7]{0,2}|[4-7][0-7]?)?|[1-9][0-9]*|x[0-9A-Fa-f]{2}|u[0-9A-Fa-f]{4}|c[A-Za-z]|[\S\s]?)|\((?:\?[:=!]?)?|(?:[?*+]|\{[0-9]+(?:,[0-9]*)?\})\??|[^.?*+^${[()|\\]+|./g, d = !1, h = new a.default, m = [], v = [], g = !1;
                    function y(e, i, a) {
                    ...
                    for (;i = t ? p.exec(e) : f.exec(e); ) {
                        ...
                        if (d) k(); else switch (o.charAt(0)) {
                          ...
                          case n.alternatormarker:
                            ...
                            if (u.isAlternator) m.push(u); else if (u.alternatorGroup ? (c = m.pop(), u.alternatorGroup = !1) : c = new a.default(!1, !1, !1, !0), 
                ...
                var i = l(n(3287)), a = l(n(9695)), r = l(n(2394)), o = l(n(7184));
                function s(e, t) {
                    (null == t || t > e.length) && (t = e.length);
                    for (var n = 0, i = new Array(t); n < t; n++) i[n] = e[n];
                    return i;
            ...
            4713: function(e, t, n) {
                Object.defineProperty(t, "__esModule", {
                    ...
                    var d, h, m, v, g = [], y = 0;
                    do {
                        if (!0 === e && u.validPositions[y]) h = (m = a && u.validPositions[y].match.optionality && void 0 === u.validPositions[y + 1] && (!0 === u.validPositions[y].generatedInput || u.validPositions[y].input == o.skipOptionalPartCharacter && y > 0) ? c.call(r, y, p.call(r, y, d, y - 1)) : u.validPositions[y]).match, 
                        d = m.locator.slice(), g.push(!0 === n ? m.input : !1 === n ? h.nativeDef : s.call(r, y, h)); else {
                            h = (m = l.call(r, y, d, y - 1)).match, d = m.locator.slice();
                            var k = !0 !== i && (!1 !== o.jitMasking ? o.jitMasking : h.jit);
                            (v = (v || u.validPositions[y - 1]) && h.static && h.def !== o.groupSeparator && null === h.fn) || !1 === k || void 0 === k || "number" == typeof k && isFinite(k) && k > y ? g.push(!1 === n ? h.nativeDef : s.call(r, g.length, h)) : v = !1;
                        }
                        y++;
                ...
                function p(e, t, n) {
                    var i, r, o = this, s = this.dependencyLib, l = this.maskset, u = this.opts, p = this.el, d = l.maskToken, h = t ? n : 0, m = t ? t.slice() : [ 0 ], v = [], g = !1, y = t ? t.join("") : "";
                    function k(t, n, r, s) {
                        function c(r, s, d) {
                            function m(e, t) {
                            ...
                            if (h === e && void 0 === r.matches) {
                                ...
                                if (r.isOptional) return function() {
                                    var t = r, a = v.length;
                                    if (r = k(r, n, s, d), v.length > 0) {
                                        if (v.forEach((function(e, t) {
                                            t >= a && (e.match.optionality = e.match.optionality ? e.match.optionality + 1 : 1);
                                        })), i = v[v.length - 1].match, void 0 !== d || !m(i, t)) return r;
                                        g = !0, h = e;
                                    }
                                }();
                                if (r.isAlternator) return function() {
                                    o.hasAlternator = !0;
                                    var i, a, m, y = r, k = [], b = v.slice(), S = s.length, O = !1, M = n.length > 0 ? n.shift() : -1;
                                    if (-1 === M || "string" == typeof M) {
                                            ...
                                            for (var I = 0; I < i.length; I++) {
                                                ...
                                                for (var V = 0; V < k.length; V++) {
                                                    ...
                                                    if ("string" != typeof M || void 0 !== F.alternation && T.includes(F.locator[F.alternation].toString())) {
                                                        ...
                                                        if (m = G, !0 === (a = F).match.static && !0 !== m.match.static && m.match.fn.test(a.match.def, l, e, !1, u, !1)) {
                                        ...
                                        v = b.concat(k), h = e, g = v.length > 0, r = k.length > 0, n = j.slice();
                                    ...
                                    for (var a = r, o = !1, f = n.length > 0 ? n.shift() : 0; f < (isNaN(a.quantifier.max) ? f + 1 : a.quantifier.max) && h <= e; f++) {
                                        ...
                                        if (r = c(p, [ f ].concat(s), p)) {
                                            if (v.forEach((function(t, n) {
                                                (i = b(p, t.match) ? t.match : v[v.length - 1].match).optionalQuantifier = f >= a.quantifier.min, 
                                                i.jit = (f + 1) * (p.matches.indexOf(i) + 1) > a.quantifier.jit, i.optionalQuantifier && m(i, p) && (g = !0, 
                                                h = e, u.greedy && null == l.validPositions[e - 1] && f > a.quantifier.min && -1 != [ "*", "+" ].indexOf(a.quantifier.max) && (v.pop(), 
