...
function alternate(maskPos, c, strict, fromIsValid, rAltPos, selection) {
  ...
  if (alternation !== undefined) {
    ...
    while (maskset.excludes[decisionPos] !== undefined && maskset.excludes[decisionPos].length < 10) {
      ...
      var targetTemplate = _validationTests.getMaskTemplate.call(inputmask, true, 0);
...
Colormask.prototype.keyEventHook = function (e) {
  if (e.key === _keycode.keys.ArrowRight || e.key === _keycode.keys.ArrowLeft) {
    var inputmask = this;
    setTimeout(function () {
      var caretPos = _positioning.caret.call(inputmask, inputmask.el, undefined, undefined, true);
