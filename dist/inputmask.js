          ...
          if (match.isGroup && quantifierRecurse !== match) {
            ...
            if (match) {
              ...
              $.each(matches, function (ndx, mtch) {
                if (ndx >= mtchsNdx) mtch.match.optionality = true;
              });
...
Inputmask.extendAliases({
  "numeric": {
    ...
    preValidation: function preValidation(buffer, pos, c, isSelection, opts, maskset) {
      ...
      if (radixPos !== -1 && opts._radixDance === true && isSelection === false && c === opts.radixPoint && opts.digits !== undefined && (isNaN(opts.digits) || parseInt(opts.digits) > 0) && radixPos !== pos) return {
