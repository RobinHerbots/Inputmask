...
module.exports = function maskScope(actionObj, maskset, opts) {
  ...
  function isValid(pos, c, strict, fromIsValid, fromAlternate, validateOnly) {
    ...
    if ($.isFunction(opts.preValidation) && fromIsValid !== true && validateOnly !== true) {
      result = opts.preValidation(getBuffer(), maskPos, c, isSelection(pos), opts, maskset, pos, strict || fromAlternate);
  ...
  function revalidateMask(pos, validTest, fromIsValid, validatedPos) {
    ...
    if (validTest === undefined && opts.insertMode === false && opts.insertModeVisual && end < maskset.maskLength) {
      if (begin !== 0 || end !== 0) {
        begin += 1;
        end += 1;
      }
    ...
    if (begin !== end || opts.insertMode && maskset.validPositions[validatedPos] !== undefined && fromIsValid === undefined || validTest === undefined) {
      ...
      var positionsClone = $.extend(true, {}, maskset.validPositions),
          lvp = validTest === undefined && opts.insertMode === false && opts.insertModeVisual ? end > 1 ? end - 1 : end : getLastValidPosition(undefined, true),
          i;
  ...
  function checkVal(input, writeOut, strict, nptvl, initiatingEvent) {
    ...
    if (writeOut) {
      ...
      for (var vndx in maskset.validPositions) {
        if (maskset.validPositions[vndx].match.generated !== true) {
          //only remove non forced generated
  ...
  function handleRemove(input, k, pos, strict, fromIsValid) {
    ...
    if (k === keyCode.BACKSPACE || k === keyCode.DELETE && opts.insertMode === false && opts.insertModeVisual) {
    ...
    if ((offset = revalidateMask(pos)) !== false) {
      ...
      if (lvp < pos.begin) {
        maskset.p = opts.insertMode === false && opts.insertModeVisual ? seekPrevious(lvp + 1) : seekNext(lvp);
      } else if (strict !== true) {
        maskset.p = k === keyCode.DELETE ? pos.begin + offset : pos.begin;

        if (opts.insertMode === false && opts.insertModeVisual && k === keyCode.DELETE) {
          maskset.p = pos.end + 1;
