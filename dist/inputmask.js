...
iemobile = /iemobile/i.test(ua),
    iphone = /iphone/i.test(ua) && !iemobile; //masking scope
...
module.exports = function maskScope(actionObj, maskset, opts) {
  ...
  var EventHandlers = {
    keydownEvent: function keydownEvent(e) {
      ...
      if (k === Inputmask.keyCode.BACKSPACE || k === Inputmask.keyCode.DELETE || iphone && k === Inputmask.keyCode.BACKSPACE_SAFARI || e.ctrlKey && k === Inputmask.keyCode.X && !("oncut" in input)) {
        //backspace/delete
        ...
        $input.trigger("click"); // } else if (k === Inputmask.keyCode.INSERT && !(e.shiftKey || e.ctrlKey) && inputmask.userOptions.insertMode === undefined) { //insert
    ...
    onKeyDown: function onKeyDown(e, buffer, caretPos, opts) {
      ...
      if (!e.shiftKey && (e.keyCode === Inputmask.keyCode.DELETE || e.keyCode === Inputmask.keyCode.BACKSPACE || e.keyCode === Inputmask.keyCode.BACKSPACE_SAFARI)) {
        if (buffer[e.keyCode === Inputmask.keyCode.DELETE ? caretPos.begin - 1 : caretPos.end] === opts.negationSymbol.front) {
          ...
          if (!opts.digitsOptional) {
            if (radixPos !== -1 && (caretPos.begin < radixPos || caretPos.end < radixPos || e.keyCode === Inputmask.keyCode.DELETE && caretPos.begin === radixPos)) {
              if (caretPos.begin === caretPos.end && (e.keyCode === Inputmask.keyCode.BACKSPACE || e.keyCode === Inputmask.keyCode.BACKSPACE_SAFARI)) {
