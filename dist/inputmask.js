...
module.exports = function maskScope(actionObj, maskset, opts) {
    ...
    $.each(inputValue, function (ndx, charCode) {
      if (charCode !== undefined) {
        ...
        if (getMaskSet().validPositions[ndx] === undefined && inputValue[ndx] === getPlaceholder(ndx) && isMask(ndx, true) && isValid(ndx, inputValue[ndx], true, undefined, undefined, true) === false) {
          ...
          if (result) {
            if (result.pos && getMaskSet().validPositions[result.pos] && getMaskSet().validPositions[result.pos].match.fn === null) {
  ...
  function unmaskedvalue(input) {
    ...
    for (var pndx in vps) {
      if (vps[pndx] && vps[pndx].match && vps[pndx].match.fn != null) {
...
function genMask(opts) {
  ...
  if (altMask) {
    mask = altMask + autoEscape(opts.suffix, opts) + "[-]"; // [(altMask + autoEscape(opts.suffix, opts) + "[-]"), mask];
  }
