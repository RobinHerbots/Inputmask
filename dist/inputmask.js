        ...
        var e = {
                                ...
                                if (a.isAlternator) return function() {
                                    ...
                                    if (-1 === M || "string" == typeof M) {
                                        ...
                                        for (var B = 0; B < T.length; B++) {
                                            _ = parseInt(T[B]), m = [], n = "string" == typeof M && P(p, _, S) || j.slice();
                                            var R = y.matches[_];
            ...
            7687: function(e, t, n) {
                ...
                function l(e, t, n, i, r, s) {
                    ...
                    var h, v, m, g, y, b, k, x, S, P, w, O = f.extend(!0, [], d.validPositions), M = f.extend(!0, {}, d.tests), _ = !1, E = !1, j = void 0 !== r ? r : a.getLastValidPosition.call(c);
                    ...
                    if (void 0 !== v) {
                        ...
                        for (-1 === A && void 0 !== t && (T.push(t), A = T.length - 1); void 0 !== d.excludes[k] && d.excludes[k].length < 10; ) {
                            ...
                            S = T[y], _ = u.call(c, x, S, !1, i, !0)); y++) y === A && (E = _), 1 == e && _ && (E = {
                                caretPos: y
                            });
                            if (_) break;
                ...
                function u(e, t, n, i, r, f, v) {
                    ...
                    var P = !0, w = g.extend(!0, [], b.validPositions);
                        ...
                        if (P = S(k, t, n), (!n || !0 === i) && !1 === P && !0 !== f) {
                            ...
                            if (!M || !0 !== M.match.static || M.match.def !== t && t !== y.skipOptionalPartCharacter) {
                                if (y.insertMode || void 0 === b.validPositions[a.seekNext.call(m, k)] || e.end > k) {
                                    ...
                                    _ = !0), e.end > k && (b.validPositions[k] = void 0), !_ && !a.isMask.call(m, k, y.keepStatic && 0 === k)) for (var E = k + 1, j = a.seekNext.call(m, k, !1, 0 !== k); E <= j; E++) if (!1 !== (P = S(E, t, n))) {
                        ...
                        y = t ? m : m - 1; y <= k; y++) {
                            if (void 0 !== (S = b[y]) && !0 !== S.generatedInput && (y >= m || y >= v && d(y, b, {
                                ...
                                for (;"" !== o.getTest.call(r, O).match.def; ) {
                                    if (!1 !== (P = f.call(r, O, S, s)) || "+" === S.match.def) {
                                        "+" === S.match.def && a.getBuffer.call(r, !0);
                                        var M = u.call(r, O, S.input, "+" !== S.match.def, !0);
