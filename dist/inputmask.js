    ...
    return function() {
        ...
        var e = {
            ...
            3978: function(e, t, n) {
                ...
                var i = h(n(7042)), a = h(n(9472)), r = h(n(7332)), o = n(4136), l = h(n(6266)), s = n(1507), c = n(4240), u = n(4507), f = n(7539), p = n(7687), d = n(5895);
                function v(e) {
                        ...
                        if (a = i[0], t) {
                            switch (a.charAt(0)) {
                              ...
                              case "|":
                                if (0 === h.length) {
                                    var O = x(v.matches);
                                    O.openGroup = !0, h.push(O), v.matches = [], y = !0;
                                }
                            }
                            switch (a) {
                              case "\\d":
                        ...
                        if (g) k(); else switch (a.charAt(0)) {
                          ...
                          case n.alternatormarker:
                            if (h.length > 0) {
                                ...
                                f = c.openGroup && (void 0 === D.matches || !1 === D.isGroup && !1 === D.isAlternator) ? h.pop() : P(c.matches);
                            } else f = P(v.matches);
                ...
                function m(e, t, n) {
                        ...
                        function f(r, l, d) {
                            ...
                            if (p === e && void 0 === r.matches) {
                                ...
                                if (r.isAlternator) return function() {
                                    ...
                                    o.hasAlternator = !0;
                                    var v, y = r, k = [], x = m.slice(), S = l.length, M = n.length > 0 ? n.shift() : -1;
                    ...
                    if (e > -1) {
                        if (void 0 === t) {
                            ...
                            void 0 !== P && O > -1 && (v = S(O, P), y = v.join(""), p = O);
                        }
                        if (s.tests[e] && s.tests[e][0].cd === y) return s.tests[e];
                        for (var w = v.shift(); w < f.length; w++) {
                            if (k(f[w], v, [ w ]) && p === e || p > e) break;
                        }
                    }
            ...
            7332: function(e, t, n) {
                ...
                var i = p(n(6266)), a = p(n(2088)), r = n(5841), o = p(n(672));
                function l(e) {
                    return l = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function(e) {
                        return typeof e;
                    } : function(e) {
            ...
            7687: function(e, t, n) {
                ...
                function l(e, t, n, i, a, s) {
                    ...
                    var h, m, g, y, b, k, x, S, P, O, w, M = p.extend(!0, [], v.validPositions), _ = p.extend(!0, {}, v.tests), E = !1, j = !1, T = void 0 !== a ? a : r.getLastValidPosition.call(u);
                    ...
                    if (void 0 !== m) {
                        ...
                        D = A.length - 1), (k = v.validPositions[x]) && !0 !== k.generatedInput && (0 !== x || k.input !== d.skipOptionalPartCharacter) && (void 0 === s || b < O || b >= w) && A.push(k.input), 
                ...
                function f(e, t, n, i, a, c, p) {
                            ...
                            if (!M || !0 !== M.match.static || M.match.def !== t && t !== y.skipOptionalPartCharacter) {
                                if (y.insertMode || void 0 === b.validPositions[r.seekNext.call(m, k)] || e.end > k) {
                                    ...
                                    _ = !0), e.end > k && (b.validPositions[k] = void 0), !_ && !r.isMask.call(m, k, y.keepStatic && 0 === k)) for (var E = k + 1, j = r.seekNext.call(m, k, !1, 0 !== k); E <= j; E++) if (!1 !== (P = S(E, t, n))) {
                                        P = v.call(m, k, void 0 !== P.pos ? P.pos : E) || P, k = E;
                                        break;
                                    }
                                }
                            } else P = {
                    ...
                    b.validPositions = g.extend(!0, [], O)) : v.call(m, void 0, k, !0);
                    var A = x(P);
                ...
                function h(e, t, n, i) {
                    ...
                    if (e.begin > e.end && (h = e.end, m = e.begin), i = void 0 !== i ? i : h, void 0 === n && (h !== m || s.insertMode && void 0 !== l.validPositions[i] || void 0 === t || t.match.optionalQuantifier || t.match.optionality)) {
                        ...
                        y = t ? m : m - 1; y <= k; y++) {
                            if (void 0 !== (S = b[y]) && !0 !== S.generatedInput && (y >= m || y >= h && d(y, b, {
                                begin: h,
                                end: m
                            }))) {
                                for (;"" !== o.getTest.call(a, w).match.def; ) {
                                    ...
                                    if (g) {
                                        void 0 === t && S.match.static && y === e.begin && v++;
                                        break;
                                    }
