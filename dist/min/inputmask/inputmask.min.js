...
b.inputmask.__valueSet=i}b.inputmask._valueGet=function(a){return ia&&a!==!0?h.call(this.el).split("").reverse().join(""):h.call(this.el)},b.inputmask._valueSet=function(a,b){//null check is needed for IE8 => otherwise converts to "null"
...
inputEventOnly:!1,//dev option - testing inputfallback behavior
noValuePatching:!1,//dev option - disable value property patching
