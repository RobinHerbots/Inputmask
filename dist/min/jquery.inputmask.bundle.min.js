...
delete m().validPositions[f];m().validPositions[b]=c;var j,k=!0,l=m().validPositions,p=!1;for(f=j=b;f<=i;f++){var q=h[f];if(void 0!==q)for(var r=j,s=-1;r<m().maskLength&&(null==q.match.fn&&l[f]&&(l[f].match.optionalQuantifier===!0||l[f].match.optionality===!0)||null!=q.match.fn);){
...
c[d]!==g.skipOptionalPartCharacter&&C(d,c[d],!0,!0)}function A(a,c,d){switch(c.casing){case"upper":a=a.toUpperCase();break;case"lower":a=a.toLowerCase();break;case"title":var e=m().validPositions[d-1];a=0===d||e&&e.input===String.fromCharCode(b.keyCode.SPACE)?a.toUpperCase():a.toLowerCase()}return a}function B(b,c){for(var d=g.greedy?c:c.slice(0,1),e=!1,f=0;f<b.length;f++)if(a.inArray(b[f],d)!==-1){e=!0;break}return e}function C(c,d,e,f){//strict true ~ no correction or autofill
function h(a){return ja?a.begin-a.end>1||a.begin-a.end===1&&g.insertMode:a.end-a.begin>1||a.end-a.begin===1&&g.insertMode}function i(b,d,e,f){var i=!1;return a.each(w(b),function(j,k){for(var l=k.match,r=d?1:0,s="",t=l.cardinality;t>r;t--)s+=G(b-(t-1));if(d&&(s+=d),
//make sure the buffer is set and correct
y(!0),
//return is false or a json object => { pos: ??, c: ??} or true
i=null!=l.fn?l.fn.test(s,m(),b,e,g,h(c)):(d===l.def||d===g.skipOptionalPartCharacter)&&""!==l.def&&//non mask
{c:l.placeholder||l.def,pos:b},i!==!1){var u=void 0!==i.c?i.c:d;u=u===g.skipOptionalPartCharacter&&null===l.fn?l.placeholder||l.def:u;var v=b,w=y();if(void 0!==i.remove&&(//remove position(s)
a.isArray(i.remove)||(i.remove=[i.remove]),a.each(i.remove.sort(function(a,b){return b-a}),function(a,b){q(b,b+1,!0)})),void 0!==i.insert&&(//insert position(s)
a.isArray(i.insert)||(i.insert=[i.insert]),a.each(i.insert.sort(function(a,b){return a-b}),function(a,b){C(b.pos,b.c,!1,f)})),i.refreshFromBuffer){var x=i.refreshFromBuffer;if(e=!0,z(x===!0?x:x.start,x.end,w),void 0===i.pos&&void 0===i.c)return i.pos=o(),!1;if(v=void 0!==i.pos?i.pos:b,v!==b)//revalidate new position strict
return i=a.extend(i,C(v,u,!0,f)),!1}else if(i!==!0&&void 0!==i.pos&&i.pos!==b&&(//their is a position offset
v=i.pos,z(b,v,y().slice()),v!==b))//revalidate new position strict
return i=a.extend(i,C(v,u,!0)),!1;return(i===!0||void 0!==i.pos||void 0!==i.c)&&(j>0&&n(!0),p(v,a.extend({},k,{input:A(u,l,v)}),f,h(c))||(i=!1),!1)}}),i}function j(b,c,d,e){var f,h,i,j,k,l,p,q=a.extend(!0,{},m().validPositions),r=o();for(
//find last modified alternation
k=m().validPositions[r];r>=0;r--)if(j=m().validPositions[r],j&&void 0!==j.alternation){if(f=r,h=m().validPositions[f].alternation,k.locator[j.alternation]!==j.locator[j.alternation])break;k=j}if(void 0!==h){
//find first decision making position
f=parseInt(f);for(var s in m().validPositions)if(s=parseInt(s),j=m().validPositions[s],s>=f&&void 0!==j.alternation){var t;0===f?(t=[],a.each(m().tests[f],function(a,b){void 0!==b.locator[h]&&(t=t.concat(b.locator[h].toString().split(",")))})):t=m().validPositions[f].locator[h].toString().split(",");var u=void 0!==j.locator[h]?j.locator[h]:t[0];//no match in the alternations (length mismatch)
u.length>0&&(//no decision taken ~ take first one as decider
u=u.split(",")[0]);for(var w=0;w<t.length;w++){var x=[],y=0,z=0;if(u<t[w]){for(var A,B,D=s;D>=0;D--)if(A=m().validPositions[D],void 0!==A){var E=v(D,t[w]);p=m().validPositions[D],p.match.def!==E.match.def&&(p.generatedInput!==!0&&/[0-9a-bA-Z]/.test(p.input)&&x.push(p.input),m().validPositions[D]=E,m().validPositions[D].input=I(D),null===m().validPositions[D].match.fn&&z++,A=E),B=A.locator[h],//store to reset
A.locator[h]=parseInt(t[w]);break}if(u!==A.locator[h]){for(l=s+1;l<o(void 0,!0)+1;l++)p=m().validPositions[l],p&&p.generatedInput!==!0&&/[0-9a-bA-Z]/.test(p.input)?x.push(p.input):l<b&&y++,delete m().validPositions[l];for(n(!0),//clear getbuffer
g.keepStatic=!g.keepStatic,//disable keepStatic on getMaskLength
i=!0;x.length>0;){var F=x.shift();if(F!==g.skipOptionalPartCharacter&&!(i=C(o(void 0,!0)+1,F,!1,e)))break}//reset forceddecision ~ needed for proper delete
if(A.alternation=h,A.locator[h]=B,i){var G=o(b)+1;for(l=s+1;l<o()+1;l++)p=m().validPositions[l],(void 0===p||null==p.match.fn)&&l<b&&z++;b+=z-y,i=C(b>G?G:b,c,d,e)}//enable keepStatic on getMaskLength
if(g.keepStatic=!g.keepStatic,i)return i;n(),m().validPositions=a.extend(!0,{},q)}}}break}}return!1}
//set alternator choice on previous skipped placeholder positions
function k(b,c){for(var d=m().validPositions[c],e=d.locator,f=e.length,g=b;g<c;g++)if(void 0===m().validPositions[g]&&!D(g,!0)){var h=w(g),i=h[0],j=-1;a.each(h,function(a,b){//find best matching
...
var l=c;void 0!==c.begin&&(//position was a position object - used to handle a delete by typing over a selection
 ...
 */
function(a,b){return b.extendAliases({abstractphone:{countrycode:"",phoneCodes:[],mask:function(a){a.definitions={"#":a.definitions[9]};var b=a.phoneCodes.sort(function(a,b){var c=(a.mask||a).replace(/[\+\(\)#-]/g,""),d=(b.mask||b).replace(/[\+\(\)#-]/g,"");return c<d?-1:1});return b},keepStatic:!0,onBeforeMask:function(a,b){var c=a.replace(/^0{1,2}/,"").replace(/[\s]/g,"");return(c.indexOf(b.countrycode)>1||c.indexOf(b.countrycode)===-1)&&(c="+"+b.countrycode+c),c},onUnMask:function(a,b,c){
//implement me
