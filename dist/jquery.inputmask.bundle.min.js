...
d),-1!=a){for(var b=c.data("_inputmask").masksets,c=c.data("_inputmask").activeMasksetIndex,h=1;h<=e.digits&&h<e.getMaskLength(b[c]._buffer,b[c].greedy,b[c].repeat,d,e);h++)void 0==d[a+h]&&(d[a+h]="0");this._valueSet(d.join(""))}}else if(a.keyCode==e.keyCode.DELETE||a.keyCode==e.keyCode.BACKSPACE)e.postFormat(d,0,!0,e),this._valueSet(d.join(""))},definitions:{"~":{validator:function(a,d,e,c,b){if(""==a)return!1;if(1>=e&&"0"===d[0]&&/[\d-]/.test(a))return d[0]="",{pos:0};var h=c?d.slice(0,e):d.slice();
