/*
 ...
 Version: 3.0.29
*/
(function(e){if(void 0===e.fn.inputmask){var a=function(a){var e=document.createElement("input");a="on"+a;var b=a in e;b||(e.setAttribute(a,"return;"),b="function"==typeof e[a]);return b},d=function(a,b,c){return(a=c.aliases[a])?(a.alias&&d(a.alias,void 0,c),e.extend(!0,c,a),e.extend(!0,c,b),!0):!1},c=function(a){function b(e){function z(a,e,b,d){this.matches=[];this.isGroup=a||!1;this.isOptional=e||!1;this.isQuantifier=b||!1;this.isAlternator=d||!1;this.quantifier={min:1,max:1}}function d(e,b,z){var c=
a.definitions[b],l=0==e.matches.length;z=void 0!=z?z:e.matches.length;if(c&&!f){for(var g=c.prevalidator,p=g?g.length:0,m=1;m<c.cardinality;m++){var h=p>=m?g[m-1]:[],x=h.validator,h=h.cardinality;e.matches.splice(z++,0,{fn:x?"string"==typeof x?RegExp(x):new function(){this.test=x}:/./,cardinality:h?h:1,optionality:e.isOptional,newBlockMarker:l,casing:c.casing,def:c.definitionSymbol||b})}e.matches.splice(z++,0,{fn:c.validator?"string"==typeof c.validator?RegExp(c.validator):new function(){this.test=
c.validator}:/./,cardinality:c.cardinality,optionality:e.isOptional,newBlockMarker:l,casing:c.casing,def:c.definitionSymbol||b})}else e.matches.splice(z++,0,{fn:null,cardinality:0,optionality:e.isOptional,newBlockMarker:l,casing:null,def:b}),f=!1}for(var c=/(?:[?*+]|\{[0-9\+\*]+(?:,[0-9\+\*]*)?\})\??|[^.?*+^${[]()|\\]+|./g,f=!1,g=new z,l,p=[],m=[];l=c.exec(e);)switch(l=l[0],l.charAt(0)){case a.optionalmarker.end:case a.groupmarker.end:var h=p.pop();0<p.length?p[p.length-1].matches.push(h):g.matches.push(h);
break;case a.optionalmarker.start:p.push(new z(!1,!0));break;case a.groupmarker.start:p.push(new z(!0));break;case a.quantifiermarker.start:h=new z(!1,!1,!0);l=l.replace(/[{}]/g,"");var n=l.split(",");l=isNaN(n[0])?n[0]:parseInt(n[0]);n=1==n.length?l:isNaN(n[1])?n[1]:parseInt(n[1]);if("*"==n||"+"==n)l="*"==l?0:1,a.greedy=!1;h.quantifier={min:l,max:n};if(0<p.length){n=p[p.length-1].matches;l=n.pop();if(!l.isGroup){var k=new z(!0);k.matches.push(l);l=k}n.push(l);n.push(h)}else l=g.matches.pop(),l.isGroup||
...
a.validPositions[s]){var m=a.validPositions[s];g=m.match;f=m.locator.slice();b.push(null==g.fn?g.def:!0===e?m.input:c.placeholder.charAt(s%c.placeholder.length))}else f=t>s?l(s,f,s-1)[0]:C(s,f,s-1),g=f.match,f=f.locator.slice(),b.push(null==g.fn?g.def:c.placeholder.charAt(s%c.placeholder.length));s++}while((void 0==G||s-1<G)&&null!=g.fn||null==g.fn&&""!=g.def||t>=s);b.pop();return b}function x(c){var t=a;t.buffer=void 0;t.tests={};!0!==c&&(t._buffer=void 0,t.validPositions={},t.p=-1)}function n(u){var t=
a,b=-1,d=t.validPositions;if(e.isFunction(c.getLastValidPosition))b=c.getLastValidPosition.call(r,t,u,c);else{void 0==u&&(u=-1);var t=b,f;for(f in d){var s=parseInt(f);if(-1==u||null!=d[s].match.fn)s<u&&(t=s),s>=u&&(b=s)}b=1<u-t||b<u?t:b}return b}function U(u,b,d){if(c.insertMode&&void 0!=a.validPositions[u]&&void 0==d){d=e.extend(!0,{},a.validPositions);var f=n(),g;for(g=u;g<=f;g++)delete a.validPositions[g];a.validPositions[u]=b;b=!0;for(g=u;g<=f;g++){u=d[g];if(void 0!=u){var s=null==u.match.fn?
g+1:B(g);b=aa(s,u.match.def)?b&&!1!==V(s,u.input,!0,!0):!1}if(!b)break}if(!b)return a.validPositions=e.extend(!0,{},d),!1}else a.validPositions[u]=b;return!0}function C(a,b,e){a=l(a,b,e);var d,g;for(g in a)if(d=a[g],c.greedy||(!1===d.match.optionality||!1===d.match.newBlockMarker)&&!0!==d.match.optionalQuantifier)break;return d}function O(c){return a.validPositions[c]?a.validPositions[c].match:l(c)[0].match}function aa(a,c){var b=!1,e=l(a),d;for(d in e)if(e[d].match.def==c){b=!0;break}return b}function l(c,
b,e){function d(a,b,e,t){function g(e,t,p){if(f==c&&void 0==e.matches)return l.push({match:e,locator:t.reverse()}),!0;if(void 0!=e.matches)if(e.isGroup&&!0!==p){if(e=g(a.matches[E+1],t))return!0}else if(e.isOptional){var h=e;if(e=d(e,b,t,p))e=l[l.length-1].match,(e=0==h.matches.indexOf(e))&&(m=!0),f=c}else{if(!e.isAlternator)if(e.isQuantifier&&!0!==p)for(h=e,p=0<b.length&&!0!==p?b.shift():0;p<(isNaN(h.quantifier.max)?p+1:h.quantifier.max)&&f<=c;p++){var Z=a.matches[a.matches.indexOf(h)-1];if(e=g(Z,
[p].concat(t),!0))if(e=l[l.length-1].match,e.optionalQuantifier=p>h.quantifier.min-1,e=0==Z.matches.indexOf(e))if(p>h.quantifier.min-1){m=!0;f=c;break}else return!0;else return!0}else if(e=d(e,b,t,p))return!0}else f++}for(var E=0<b.length?b.shift():0;E<a.matches.length;E++)if(!0!==a.matches[E].isQuantifier){var p=g(a.matches[E],[E].concat(e),t);if(p&&f==c)return p;if(f>c)break}}var g=a.maskToken,f=b?e:0;e=b||[0];var l=[],m=!1;if(void 0==b){b=c-1;for(var p;void 0==(p=a.validPositions[b])&&-1<b;)b--;
if(void 0!=p&&-1<b)f=b,e=p.locator.slice();else{for(b=c-1;void 0==(p=a.tests[b])&&-1<b;)b--;void 0!=p&&-1<b&&(f=b,e=p[0].locator.slice())}}for(b=e.shift();b<g.length&&!(d(g[b],e,[b])&&f==c||f>c);b++);(0==l.length||m)&&l.push({match:{fn:null,cardinality:0,optionality:!0,casing:null,def:""},locator:[]});return a.tests[c]=l}function A(){void 0==a._buffer&&(a._buffer=d(!1,1));return a._buffer}function m(){void 0==a.buffer&&(a.buffer=d(!0,n(),!0));return a.buffer}function F(a,b){for(var e=m().slice(),
d=a;d<b;d++)e[d]!=P(d)&&e[d]!=c.skipOptionalPartCharacter&&V(d,e[d],!0,!0)}function ga(a,c){switch(c.casing){case "upper":a=a.toUpperCase();break;case "lower":a=a.toLowerCase()}return a}function V(b,d,g,f){function p(b,u,d,t){var g=!1;e.each(l(b),function(f,E){for(var s=E.match,p=u?1:0,h="",ha=m(),Q=s.cardinality;Q>p;Q--)h+=void 0==a.validPositions[b-(Q-1)]?P(b-(Q-1)):a.validPositions[b-(Q-1)].input;u&&(h+=u);g=null!=s.fn?s.fn.test(h,ha,b,d,c):u!=s.def&&u!=c.skipOptionalPartCharacter||""==s.def?!1:
{c:s.def,pos:b};if(!1!==g){p=void 0!=g.c?g.c:u;p=p==c.skipOptionalPartCharacter&&null===s.fn?s.def:p;h=b;if(g.refreshFromBuffer){h=g.refreshFromBuffer;d=!0;!0===h?(a.validPositions={},a.tests={},F(0,m().length)):F(h.start,h.end);if(void 0==g.pos&&void 0==g.c)return g.pos=n(),!1;h=void 0!=g.pos?g.pos:b;E=l(h)[0]}else!0!==g&&g.pos!=b&&(h=g.pos,F(b,h),E=l(h)[0]);0<f&&x(!0);U(h,e.extend({},E,{input:ga(p,s)}),t)||(g=!1);return!1}});return g}g=!0===g;var s=p(b,d,g,f);if(!g&&!1===s){var h=a.validPositions[b];
if(h&&null==h.match.fn&&(h.match.def==d||d==c.skipOptionalPartCharacter))s={caret:B(b)};else if((c.insertMode||void 0==a.validPositions[B(b)])&&!K(b))for(var h=b+1,A=B(b);h<=A;h++)if(s=p(h,d,g,f),!1!==s){b=h;break}}!0===s&&(s={pos:b});return s}function K(a){a=O(a);return null!=a.fn?a.fn:!1}function L(){var b;G=r.prop("maxLength");-1==G&&(G=void 0);if(!1==c.greedy){var e;e=n();b=a.validPositions[e];var d=void 0!=b?b.locator.slice():void 0;for(e+=1;void 0==b||null!=b.match.fn||null==b.match.fn&&""!=
b.match.def;e++)b=C(e,d,e-1),d=b.locator.slice();b=e}else b=m().length;return void 0==G||b<G?b:G}function B(a){var b=L();if(a>=b)return b;for(;++a<b&&!K(a)&&(!0!==c.nojumps||c.nojumpsThreshold>a););return a}function T(a){if(0>=a)return 0;for(;0<--a&&!K(a););return a}function D(a,c,b){a._valueSet(c.join(""));void 0!=b&&w(a,b)}function P(a,b){b=b||O(a);return null==b.fn?b.def:c.placeholder.charAt(a%c.placeholder.length)}function M(c,b,d,g,f){g=void 0!=g?g.slice():fa(c._valueGet()).split("");x();b&&
c._valueSet("");e.each(g,function(b,g){if(!0===f){var t=a.p,t=-1==t?t:T(t),l=-1==t?b:B(t);-1==e.inArray(g,A().slice(t+1,l))&&X.call(c,void 0,!0,g.charCodeAt(0),!1,d,b)}else X.call(c,void 0,!0,g.charCodeAt(0),!1,d,b),d=d||0<b&&b>a.p});b&&D(c,m(),B(n(0)))}function $(a){return e.inputmask.escapeRegex.call(this,a)}function fa(a){return a.replace(RegExp("("+$(A().join(""))+")*$"),"")}function W(c){var b=m().slice(),e,d=n(),g={},f=a.validPositions[d].locator.slice(),l;for(e=d+1;e<b.length;e++)l=C(e,f,e-
1),f=l.locator.slice(),g[e]=l;for(e=b.length-1;e>d;e--)if(l=g[e].match,l.optionality&&b[e]==P(e,l))b.pop();else break;D(c,b)}function ia(b,d){if(!b.data("_inputmask")||!0!==d&&b.hasClass("hasDatepicker"))return b[0]._valueGet();var g=[],f=a.validPositions,l;for(l in f)null!=f[l].match.fn&&g.push(f[l].input);g=(y?g.reverse():g).join("");f=(y?m().reverse():m()).join("");return e.isFunction(c.onUnMask)?c.onUnMask.call(b,f,g,c):g}function J(a){!y||"number"!=typeof a||c.greedy&&""==c.placeholder||(a=m().length-
a);return a}function w(a,b,d){a=a.jquery&&0<a.length?a[0]:a;if("number"==typeof b){b=J(b);d=J(d);d="number"==typeof d?d:b;var g=e(a).data("_inputmask")||{};g.caret={begin:b,end:d};e(a).data("_inputmask",g);e(a).is(":visible")&&(a.scrollLeft=a.scrollWidth,!1==c.insertMode&&b==d&&d++,a.setSelectionRange?(a.selectionStart=b,a.selectionEnd=d):a.createTextRange&&(a=a.createTextRange(),a.collapse(!0),a.moveEnd("character",d),a.moveStart("character",b),a.select()))}else return g=e(a).data("_inputmask"),
!e(a).is(":visible")&&g&&void 0!=g.caret?(b=g.caret.begin,d=g.caret.end):a.setSelectionRange?(b=a.selectionStart,d=a.selectionEnd):document.selection&&document.selection.createRange&&(a=document.selection.createRange(),b=0-a.duplicate().moveStart("character",-1E5),d=b+a.text.length),b=J(b),d=J(d),{begin:b,end:d}}function R(a){if(e.isFunction(c.isComplete))return c.isComplete.call(r,a,c);if("*"!=c.repeat){var b=!1,d=T(L());if(n()==d)for(var b=!0,g=0;g<=d;g++){var f=K(g);if(f&&(void 0==a[g]||a[g]==
P(g))||!f&&a[g]!=P(g)){b=!1;break}}return b}}function ja(a){a=e._data(a).events;e.each(a,function(a,b){e.each(b,function(a,b){if("inputmask"==b.namespace&&"setvalue"!=b.type){var c=b.handler;b.handler=function(a){if(this.readOnly||this.disabled)a.preventDefault;else return c.apply(this,arguments)}}})})}function ka(a){function b(a){if(void 0==e.valHooks[a]||!0!=e.valHooks[a].inputmaskpatch){var c=e.valHooks[a]&&e.valHooks[a].get?e.valHooks[a].get:function(a){return a.value},d=e.valHooks[a]&&e.valHooks[a].set?
...
if(c&&c.get){if(!a._valueGet){var d=c.get,g=c.set;a._valueGet=function(){return y?d.call(this).split("").reverse().join(""):d.call(this)};a._valueSet=function(a){g.call(this,y?a.split("").reverse().join(""):a)};Object.defineProperty(a,"value",{get:function(){var a=e(this),b=e(this).data("_inputmask"),c=b.maskset;return b&&b.opts.autoUnmask?a.inputmask("unmaskedvalue"):d.call(this)!=c._buffer.join("")?d.call(this):""},set:function(a){g.call(this,a);e(this).triggerHandler("setvalue.inputmask")}})}}else document.__lookupGetter__&&
a.__lookupGetter__("value")?a._valueGet||(d=a.__lookupGetter__("value"),g=a.__lookupSetter__("value"),a._valueGet=function(){return y?d.call(this).split("").reverse().join(""):d.call(this)},a._valueSet=function(a){g.call(this,y?a.split("").reverse().join(""):a)},a.__defineGetter__("value",function(){var a=e(this),b=e(this).data("_inputmask"),c=b.maskset;return b&&b.opts.autoUnmask?a.inputmask("unmaskedvalue"):d.call(this)!=c._buffer.join("")?d.call(this):""}),a.__defineSetter__("value",function(a){g.call(this,
a);e(this).triggerHandler("setvalue.inputmask")})):(a._valueGet||(a._valueGet=function(){return y?this.value.split("").reverse().join(""):this.value},a._valueSet=function(a){this.value=y?a.split("").reverse().join(""):a}),b(a.type))}function ba(b,e,d){if(c.numericInput||y){switch(e){case c.keyCode.BACKSPACE:e=c.keyCode.DELETE;break;case c.keyCode.DELETE:e=c.keyCode.BACKSPACE}y&&(b=d.end,d.end=d.begin,d.begin=b)}d.begin==d.end?e==c.keyCode.BACKSPACE?d.begin=T(d.begin):e==c.keyCode.DELETE&&d.end++:
1!=d.end-d.begin||c.insertMode||e==c.keyCode.BACKSPACE&&d.begin--;b=d.begin;var g=d.end;for(e=b;b<g;b++)delete a.validPositions[b];for(b=g;b<=n();){var g=a.validPositions[b],f=a.validPositions[e];void 0!=g&&void 0==f?(aa(e,g.match.def)&&!1!==V(e,g.input,!0)&&(delete a.validPositions[b],b++),e++):b++}for(e=n();0<e&&(void 0==a.validPositions[e]||null==a.validPositions[e].match.fn);)delete a.validPositions[e],e--;x(!0);e=B(-1);n()<e?a.p=e:a.p=d.begin}function ca(b){Y=!1;var d=this,g=e(d),l=b.keyCode,
h=w(d);l==c.keyCode.BACKSPACE||l==c.keyCode.DELETE||f&&127==l||b.ctrlKey&&88==l?(b.preventDefault(),88==l&&(H=m().join("")),ba(d,l,h),D(d,m(),a.p),d._valueGet()==A().join("")&&g.trigger("cleared"),c.showTooltip&&g.prop("title",a.mask)):l==c.keyCode.END||l==c.keyCode.PAGE_DOWN?setTimeout(function(){var a=B(n());c.insertMode||a!=L()||b.shiftKey||a--;w(d,b.shiftKey?h.begin:a,a)},0):l==c.keyCode.HOME&&!b.shiftKey||l==c.keyCode.PAGE_UP?w(d,0,b.shiftKey?h.begin:0):l==c.keyCode.ESCAPE||90==l&&b.ctrlKey?
(M(d,!0,!1,H.split("")),g.click()):l!=c.keyCode.INSERT||b.shiftKey||b.ctrlKey?!1!=c.insertMode||b.shiftKey||(l==c.keyCode.RIGHT?setTimeout(function(){var a=w(d);w(d,a.begin)},0):l==c.keyCode.LEFT&&setTimeout(function(){var a=w(d);w(d,a.begin-1)},0)):(c.insertMode=!c.insertMode,w(d,c.insertMode||h.begin!=L()?h.begin:h.begin-1));var g=w(d),p=c.onKeyDown.call(this,b,m(),c);p&&!0===p.refreshFromBuffer&&(a.validPositions={},a.tests={},F(0,m().length),x(!0),D(d,m()),w(d,g.begin,g.end));da=-1!=e.inArray(l,
c.ignorables)}function X(b,d,g,f,l,h){if(void 0==g&&Y)return!1;Y=!0;var p=e(this);b=b||window.event;g=d?g:b.which||b.charCode||b.keyCode;if(!(!0===d||b.ctrlKey&&b.altKey)&&(b.ctrlKey||b.metaKey||da))return!0;if(g){!0!==d&&46==g&&!1==b.shiftKey&&","==c.radixPoint&&(g=44);var A;g=String.fromCharCode(g);d?(h=l?h:n()+1,h={begin:h,end:h}):h=w(this);var F=y?1<h.begin-h.end||1==h.begin-h.end&&c.insertMode:1<h.end-h.begin||1==h.end-h.begin&&c.insertMode;F&&(a.undoPositions=e.extend(!0,{},a.validPositions),
ba(this,c.keyCode.DELETE,h),c.insertMode||(c.insertMode=!c.insertMode,U(h.begin,l),c.insertMode=!c.insertMode),F=!c.multi);a.writeOutBuffer=!0;var k=h.begin,r=V(k,g,l);!1!==r&&(!0!==r&&(k=void 0!=r.pos?r.pos:k,g=void 0!=r.c?r.c:g),x(!0),void 0!=r.caret?A=r.caret:(l=a.validPositions,A=void 0!=l[k+1]&&C(h+1,l[k].locator.slice(),k).match.def!=l[k+1].match.def?k+1:B(k)),a.p=A);if(!1!==f){var q=this;setTimeout(function(){c.onKeyValidation.call(q,r,c)},0);if(a.writeOutBuffer&&!1!==r){var O=m();D(this,O,
d?void 0:c.numericInput?T(A):A);!0!==d&&setTimeout(function(){!0===R(O)&&p.trigger("complete");S=!0;p.trigger("input")},0)}else F&&(a.buffer=void 0,a.validPositions=a.undoPositions)}else F&&(a.buffer=void 0,a.validPositions=a.undoPositions);c.showTooltip&&p.prop("title",a.mask);b&&!0!=d&&(b.preventDefault?b.preventDefault():b.returnValue=!1)}}function la(b){var d=e(this),g=b.keyCode,f=m();(b=c.onKeyUp.call(this,b,f,c))&&!0===b.refreshFromBuffer&&(a.validPositions={},a.tests={},F(0,m().length),x(!0),
D(this,m()));g==c.keyCode.TAB&&c.showMaskOnFocus&&(d.hasClass("focus.inputmask")&&0==this._valueGet().length?(x(),f=m(),D(this,f),w(this,0),H=m().join("")):(D(this,f),w(this,J(0),J(L()))))}function ea(a){if(!0===S&&"input"==a.type)return S=!1,!0;var b=this,d=e(b);if("propertychange"==a.type&&b._valueGet().length<=L())return!0;setTimeout(function(){var a=e.isFunction(c.onBeforePaste)?c.onBeforePaste.call(b,b._valueGet(),c):b._valueGet();M(b,!0,!1,a.split(""),!0);!0===R(m())&&d.trigger("complete");
d.click()},0)}function ma(a){if(!0===S&&"input"==a.type)return S=!1,!0;var b=w(this),d=this._valueGet(),d=d.replace(RegExp("("+$(A().join(""))+")*"),"");b.begin>d.length&&(w(this,d.length),b=w(this));1!=m().length-d.length||d.charAt(b.begin)==m()[b.begin]||d.charAt(b.begin+1)==m()[b.begin]||K(b.begin)||(a.keyCode=c.keyCode.BACKSPACE,ca.call(this,a));a.preventDefault()}function na(b){r=e(b);if(r.is(":input")){r.data("_inputmask",{maskset:a,opts:c,isRTL:!1});c.showTooltip&&r.prop("title",a.mask);ka(b);
("rtl"==b.dir||c.rightAlign)&&r.css("text-align","right");if("rtl"==b.dir||c.numericInput){b.dir="ltr";r.removeAttr("dir");var d=r.data("_inputmask");d.isRTL=!0;r.data("_inputmask",d);y=!0}r.unbind(".inputmask");r.removeClass("focus.inputmask");r.closest("form").bind("submit",function(){H!=m().join("")&&r.change()}).bind("reset",function(){setTimeout(function(){r.trigger("setvalue")},0)});r.bind("mouseenter.inputmask",function(){!e(this).hasClass("focus.inputmask")&&c.showMaskOnHover&&this._valueGet()!=
m().join("")&&D(this,m())}).bind("blur.inputmask",function(){var a=e(this);if(a.data("_inputmask")){var b=this._valueGet(),d=m();a.removeClass("focus.inputmask");H!=m().join("")&&a.change();c.clearMaskOnLostFocus&&""!=b&&(b==A().join("")?this._valueSet(""):W(this));!1===R(d)&&(a.trigger("incomplete"),c.clearIncomplete&&(x(),c.clearMaskOnLostFocus?this._valueSet(""):(d=A().slice(),D(this,d))))}}).bind("focus.inputmask",function(){var a=e(this),b=this._valueGet();c.showMaskOnFocus&&!a.hasClass("focus.inputmask")&&
(!c.showMaskOnHover||c.showMaskOnHover&&""==b)&&this._valueGet()!=m().join("")&&D(this,m(),B(n()));a.addClass("focus.inputmask");H=m().join("")}).bind("mouseleave.inputmask",function(){var a=e(this);c.clearMaskOnLostFocus&&(a.hasClass("focus.inputmask")||this._valueGet()==a.attr("placeholder")||(this._valueGet()==A().join("")||""==this._valueGet()?this._valueSet(""):W(this)))}).bind("click.inputmask",function(){var a=this;setTimeout(function(){var b=w(a);m();if(b.begin==b.end){var b=y?J(b.begin):
b.begin,c=n(b),c=B(c);b<c?K(b)?w(a,b):w(a,B(b)):w(a,c)}},0)}).bind("dblclick.inputmask",function(){var a=this;setTimeout(function(){w(a,0,B(n()))},0)}).bind(I+".inputmask dragdrop.inputmask drop.inputmask",ea).bind("setvalue.inputmask",function(){M(this,!0);H=m().join("");this._valueGet()==A().join("")&&this._valueSet("")}).bind("complete.inputmask",c.oncomplete).bind("incomplete.inputmask",c.onincomplete).bind("cleared.inputmask",c.oncleared);r.bind("keydown.inputmask",ca).bind("keypress.inputmask",
X).bind("keyup.inputmask",la);if(k||q||v||N)"input"==I&&r.unbind(I+".inputmask"),r.bind("input.inputmask",ma);g&&r.bind("input.inputmask",ea);d=e.isFunction(c.onBeforeMask)?c.onBeforeMask.call(b,b._valueGet(),c):b._valueGet();M(b,!1,!1,d.split(""),!0);D(b,m());H=m().join("");var f;try{f=document.activeElement}catch(l){}f===b?(r.addClass("focus.inputmask"),w(b,B(n()))):c.clearMaskOnLostFocus?m().join("")==A().join("")?b._valueSet(""):W(b):D(b,m());ja(b)}}var y=!1,H=m().join(""),r,Y=!1,S=!1,da=!1,G;
if(void 0!=b)switch(b.action){case "isComplete":return r=e(b.el),R(b.buffer);case "unmaskedvalue":return r=b.$input,y=b.$input.data("_inputmask").isRTL,ia(b.$input,b.skipDatepickerCheck);case "mask":na(b.el);break;case "format":return r=e({}),r.data("_inputmask",{maskset:a,opts:c,isRTL:c.numericInput}),c.numericInput&&(y=!0),b=b.value.split(""),M(r,!1,!1,y?b.reverse():b,!0),y?m().reverse().join(""):m().join("");case "isValid":return r=e({}),r.data("_inputmask",{maskset:a,opts:c,isRTL:c.numericInput}),
c.numericInput&&(y=!0),b=b.value.split(""),M(r,!1,!0,y?b.reverse():b),R(m())}},n=function(a,b,c){function d(b,f,h){b=b.jquery&&0<b.length?b[0]:b;if("number"==typeof f){f=g(f);h=g(h);h="number"==typeof h?h:f;if(b!=a){var n=e(b).data("_inputmask")||{};n.caret={begin:f,end:h};e(b).data("_inputmask",n)}e(b).is(":visible")&&(b.scrollLeft=b.scrollWidth,!1==c.insertMode&&f==h&&h++,b.setSelectionRange?(b.selectionStart=f,b.selectionEnd=h):b.createTextRange&&(b=b.createTextRange(),b.collapse(!0),b.moveEnd("character",
...
g){if("multiMaskScope"!=b){if(e.isFunction(c.determineActiveMasksetIndex))q=c.determineActiveMasksetIndex.call(n,b,g);else{var m=-1,k=-1,z=-1;e.each(g,function(a,b){var c=e(b).data("_inputmask").maskset,g=-1,f=0,l=d(b).begin,p;for(p in c.validPositions)c=parseInt(p),c>g&&(g=c),f++;if(f>m||f==m&&k>l&&z>g||f==m&&k==l&&z<g)m=f,k=l,q=a,z=g})}var x=n.data("_inputmask-multi")||{activeMasksetIndex:0,elmasks:g};x.activeMasksetIndex=q;n.data("_inputmask-multi",x)}-1==["focus"].indexOf(b)&&a.value!=g[q]._valueGet()&&
(x=""==e(g[q]).val()?g[q]._valueGet():e(g[q]).val(),a.value=x);-1==["blur","focus"].indexOf(b)&&e(g[q]).hasClass("focus.inputmask")&&(x=d(g[q]),d(a,x.begin,x.end))}c.multi=!0;var n=e(a),k="rtl"==a.dir||c.numericInput,q=0,v=e.map(b,function(a,b){var d='<input type="text" ';n.attr("value")&&(d+='value="'+n.attr("value")+'" ');n.attr("dir")&&(d+='dir="'+n.attr("dir")+'" ');d=e(d+"/>")[0];C(e.extend(!0,{},a),c,{action:"mask",el:d});return d});n.data("_inputmask-multi",{activeMasksetIndex:0,elmasks:v});
...
a.matches.indexOf(d),f=a.matches[f-1],g=q;if(isNaN(d.quantifier.max)){for(;d.repeaterPart&&d.repeaterPart!=q&&d.repeaterPart.length>q.length&&!(c=v(f,!0)););(c=c||v(f,!0))&&(d.repeaterPart=q);q=g+d.quantifier.max}else{for(var k=0,U=d.quantifier.max-1;k<U&&!(c=v(f,!0));k++);q=g+"{"+d.quantifier.min+","+d.quantifier.max+"}"}}else if(void 0!=d.matches)for(f=0;f<d.length&&!(c=v(d[f],b));f++);else{if("["==d[0]){c=q;c+=d;for(k=0;k<N;k++)c+=")";c=RegExp("^("+c+")$");c=c.test(I)}else for(f=0,g=d.length;f<
