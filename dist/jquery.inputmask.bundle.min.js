...
e(m,d,h,w))m=p[p.length-1].match,(m=0==f.inArray(m,n.matches))&&(A=!0),r=a}else if(m.isAlternator){var n=m,k=[],x,aa=p.slice(),q=h.length,t=0<d.length?d.shift():-1;if(-1==t||"string"==typeof t){var sa=r,la=d.slice(),v;"string"==typeof t&&(v=t.split(","));for(var y=0;y<n.matches.length;y++){p=[];m=K(n.matches[y],[y].concat(h),w)||m;x=p.slice();r=sa;p=[];for(var z=0;z<la.length;z++)d[z]=la[z];for(z=0;z<x.length;z++)for(var W=x[z],u=0;u<k.length;u++){var ka=k[u];if(W.match.mask==ka.match.mask&&("string"!=
typeof t||-1!=f.inArray(W.locator[q].toString(),v))){k.splice(u,1);W.locator[q]=ka.locator[q]+","+W.locator[q];W.alternation=q;break}}k=k.concat(x)}"string"==typeof t&&(k=f.map(k,function(a,c){if(isFinite(c)){var b=a.locator[q].toString().split(","),d;a.locator[q]="";for(var S=0;S<b.length;S++)if(d=-1!=f.inArray(b[S],v))""!=a.locator[q]&&(a.locator[q]+=","),a.locator[q]+=b[S];if(""!=a.locator[q])return a}}));p=aa.concat(k);A=!0}else m=K(n.matches[t],[t].concat(h),w);if(m)return!0}else if(m.isQuantifier&&
...
f.extend(!0,[],p);return c.tests[a]}function H(){void 0==c._buffer&&(c._buffer=d(!1,1));return c._buffer}function t(){void 0==c.buffer&&(c.buffer=d(!0,y(),!0));return c.buffer}function ca(a,b){var d=t().slice();if(!0===a)e(),a=0,b=d.length;else for(var f=a;f<b;f++)delete c.validPositions[f],delete c.tests[f];for(f=a;f<b;f++)d[f]!=g.skipOptionalPartCharacter&&O(f,d[f],!0,!0)}function ra(a,c){switch(c.casing){case "upper":a=a.toUpperCase();break;case "lower":a=a.toLowerCase()}return a}function O(a,
...
ca(!0===r?r:r.start,r.end);if(void 0==m.pos&&void 0==m.c)return m.pos=y(),!1;r=void 0!=m.pos?m.pos:a;if(r!=a)return m=f.extend(m,O(r,A,!0)),!1}else if(!0!==m&&void 0!=m.pos&&m.pos!=a&&(r=m.pos,ca(a,r),r!=a))return m=f.extend(m,O(r,A,!0)),!1;if(!0!=m&&void 0==m.pos&&void 0==m.c)return!1;0<h&&e(!0);l(r,f.extend({},K,{input:ra(A,p)}),S)||(m=!1);return!1}});return m}d=!0===d;for(var r=t(),p=a-1;-1<p&&(!c.validPositions[p]||null!=c.validPositions[p].fn);p--)if((!n(p)||r[p]!=V(p))&&1<J(p).length){w(p,r[p],
!0);break}if(a>=P())return console.log("try alternate match"),!1;r=w(a,b,d,h);if(!d&&!1===r)if((p=c.validPositions[a])&&null==p.match.fn&&(p.match.def==b||b==g.skipOptionalPartCharacter))r={caret:E(a)};else if((g.insertMode||void 0==c.validPositions[E(a)])&&!n(a))for(var p=a+1,A=E(a);p<=A;p++)if(r=w(p,b,d,h),!1!==r){a=p;break}!0===r&&(r={pos:a});return r}function n(a){a=ga(a);return null!=a.fn?a.fn:!1}function P(){var a;L=q.prop("maxLength");-1==L&&(L=void 0);if(!1==g.greedy){var b;b=y();a=c.validPositions[b];
var d=void 0!=a?a.locator.slice():void 0;for(b+=1;void 0==a||null!=a.match.fn||null==a.match.fn&&""!=a.match.def;b++)a=ba(b,d,b-1),d=a.locator.slice();a=b}else a=t().length;return void 0==L||a<L?a:L}function E(a){var c=P();if(a>=c)return c;for(;++a<c&&!n(a)&&(!0!==g.nojumps||g.nojumpsThreshold>a););return a}function U(a){if(0>=a)return 0;for(;0<--a&&!n(a););return a}function F(a,c,b){a._valueSet(c.join(""));void 0!=b&&v(a,b)}function V(a,c){c=c||ga(a);return c.placeholder||(null==c.fn?c.def:g.placeholder.charAt(a%
g.placeholder.length))}function N(a,b,d,h,l){h=void 0!=h?h.slice():qa(a._valueGet()).split("");e();b&&a._valueSet("");f.each(h,function(b,g){if(!0===l){var e=c.p,e=-1==e?e:U(e),m=-1==e?b:E(e);-1==f.inArray(g,H().slice(e+1,m))&&Y.call(a,void 0,!0,g.charCodeAt(0),!1,d,b)}else Y.call(a,void 0,!0,g.charCodeAt(0),!1,d,b),d=d||0<b&&b>c.p});b&&(b=g.onKeyPress.call(this,void 0,t(),0,g),Z(a,b),F(a,t(),f(a).is(":focus")?E(y(0)):void 0))}function ha(a){return f.inputmask.escapeRegex.call(this,a)}function qa(a){return a.replace(RegExp("("+
ha(H().join(""))+")*$"),"")}function ia(a){if(a.data("_inputmask")&&!a.hasClass("hasDatepicker")){var b=[],d=c.validPositions,e;for(e in d)d[e].match&&null!=d[e].match.fn&&b.push(d[e].input);b=(C?b.reverse():b).join("");d=(C?t().reverse():t()).join("");f.isFunction(g.onUnMask)&&(b=g.onUnMask.call(a,d,b,g));return b}return a[0]._valueGet()}function M(a){!C||"number"!=typeof a||g.greedy&&""==g.placeholder||(a=t().length-a);return a}function v(a,c,b){a=a.jquery&&0<a.length?a[0]:a;if("number"==typeof c){c=
...
(c=a.selectionStart,b=a.selectionEnd):document.selection&&document.selection.createRange&&(a=document.selection.createRange(),c=0-a.duplicate().moveStart("character",-1E5),b=c+a.text.length),c=M(c),b=M(b),{begin:c,end:b}}function da(a){var b=t(),d=b.length,e,g=y(),h={},p=c.validPositions[g],l=void 0!=p?p.locator.slice():void 0,n;for(e=g+1;e<b.length;e++)n=ba(e,l,e-1),l=n.locator.slice(),h[e]=f.extend(!0,{},n);l=p&&void 0!=p.alternation?p.locator[p.alternation].split(","):[];for(e=d-1;e>g;e--)if(n=
h[e].match,(n.optionality||n.optionalQuantifier||p&&void 0!=p.alternation&&void 0!=h[e].locator[p.alternation]&&-1!=f.inArray(h[e].locator[p.alternation].toString(),l))&&b[e]==V(e,n))d--;else break;return a?{l:d,def:h[d]?h[d].match:void 0}:d}function ea(a){var c=t().slice(),b=da();c.length=b;F(a,c)}function T(a){if(f.isFunction(g.isComplete))return g.isComplete.call(q,a,g);if("*"!=g.repeat){var c=!1,b=da(!0),d=U(b.l);if(y()==d&&(void 0==b.def||b.def.newBlockMarker||b.def.optionalQuantifier))for(c=
...
c.refreshFromBuffer;ca(!0===d?d:d.start,d.end);e(!0);void 0!=b&&(F(a,t()),v(a,c.caret||b.begin,c.caret||b.end))}}function na(a){$=!1;var b=this,d=f(b),e=a.keyCode,l=v(b);e==g.keyCode.BACKSPACE||e==g.keyCode.DELETE||h&&127==e||a.ctrlKey&&88==e?(a.preventDefault(),88==e&&(I=t().join("")),ma(b,e,l),F(b,t(),c.p),b._valueGet()==H().join("")&&d.trigger("cleared"),g.showTooltip&&d.prop("title",c.mask)):e==g.keyCode.END||e==g.keyCode.PAGE_DOWN?setTimeout(function(){var c=E(y());g.insertMode||c!=P()||a.shiftKey||
...
c=v(this));1!=t().length-b.length||b.charAt(c.begin)==t()[c.begin]||b.charAt(c.begin+1)==t()[c.begin]||n(c.begin)||(a.keyCode=g.keyCode.BACKSPACE,na.call(this,a));a.preventDefault()}function xa(a){var b=this;setTimeout(function(){v(b,v(b).begin-1);var d=f.Event("keypress");d.which=a.originalEvent.data.charCodeAt(0);fa=$=!1;Y.call(b,d,void 0,void 0,!1);d=c.p;F(b,t(),g.numericInput?U(d):d)},0);return!1}function ya(a){q=f(a);if(q.is(":input")&&"number"!=q.attr("type")){q.data("_inputmask",{maskset:c,
opts:g,isRTL:!1});g.showTooltip&&q.prop("title",c.mask);("rtl"==a.dir||g.rightAlign)&&q.css("text-align","right");if("rtl"==a.dir||g.numericInput){a.dir="ltr";q.removeAttr("dir");var d=q.data("_inputmask");d.isRTL=!0;q.data("_inputmask",d);C=!0}q.unbind(".inputmask");q.removeClass("focus-inputmask");q.closest("form").bind("submit",function(){I!=t().join("")&&q.change();g.autoUnmask&&g.removeMaskOnSubmit&&q.inputmask("remove")}).bind("reset",function(){setTimeout(function(){q.trigger("setvalue")},
0)});q.bind("mouseenter.inputmask",function(){!f(this).hasClass("focus-inputmask")&&g.showMaskOnHover&&this._valueGet()!=t().join("")&&F(this,t())}).bind("blur.inputmask",function(){var a=f(this);if(a.data("_inputmask")){var b=this._valueGet(),c=t();a.removeClass("focus-inputmask");I!=t().join("")&&a.change();g.clearMaskOnLostFocus&&""!=b&&(b==H().join("")?this._valueSet(""):ea(this));!1===T(c)&&(a.trigger("incomplete"),g.clearIncomplete&&(e(),g.clearMaskOnLostFocus?this._valueSet(""):(c=H().slice(),
F(this,c))))}}).bind("focus.inputmask",function(){var a=f(this),b=this._valueGet();g.showMaskOnFocus&&!a.hasClass("focus-inputmask")&&(!g.showMaskOnHover||g.showMaskOnHover&&""==b)&&this._valueGet()!=t().join("")&&F(this,t(),E(y()));a.addClass("focus-inputmask");I=t().join("")}).bind("mouseleave.inputmask",function(){var a=f(this);g.clearMaskOnLostFocus&&(a.hasClass("focus-inputmask")||this._valueGet()==a.attr("placeholder")||(this._valueGet()==H().join("")||""==this._valueGet()?this._valueSet(""):
ea(this)))}).bind("click.inputmask",function(){var a=this;f(a).is(":focus")&&setTimeout(function(){var b=v(a);if(b.begin==b.end){var b=C?M(b.begin):b.begin,c=y(b),c=E(c);b<c?n(b)?v(a,b):v(a,E(b)):v(a,c)}},0)}).bind("dblclick.inputmask",function(){var a=this;setTimeout(function(){v(a,0,E(y()))},0)}).bind(R+".inputmask dragdrop.inputmask drop.inputmask",oa).bind("setvalue.inputmask",function(){N(this,!0);I=t().join("")}).bind("complete.inputmask",g.oncomplete).bind("incomplete.inputmask",g.onincomplete).bind("cleared.inputmask",
g.oncleared);q.bind("keydown.inputmask",na).bind("keypress.inputmask",Y).bind("keyup.inputmask",va).bind("compositionupdate.inputmask",xa);if(k||u||D||Q)"input"==R&&q.unbind(R+".inputmask"),q.bind("input.inputmask",wa);b&&q.bind("input.inputmask",oa);ua(a);d=f.isFunction(g.onBeforeMask)?g.onBeforeMask.call(a,a._valueGet(),g):a._valueGet();N(a,!0,!1,d.split(""),!0);I=t().join("");var h;try{h=document.activeElement}catch(l){}!1===T(t())&&g.clearIncomplete&&e();g.clearMaskOnLostFocus?t().join("")==H().join("")?
a._valueSet(""):ea(a):F(a,t());h===a&&(q.addClass("focus-inputmask"),v(a,E(y())));ta(a)}}var C=!1,I,q,$=!1,X=!1,fa=!1,L;if(void 0!=a)switch(a.action){case "isComplete":return q=f(a.el),c=q.data("_inputmask").maskset,g=q.data("_inputmask").opts,T(a.buffer);case "unmaskedvalue":return q=a.$input,c=q.data("_inputmask").maskset,g=q.data("_inputmask").opts,C=a.$input.data("_inputmask").isRTL,ia(a.$input);case "mask":I=t().join("");ya(a.el);break;case "format":q=f({});q.data("_inputmask",{maskset:c,opts:g,
isRTL:g.numericInput});g.numericInput&&(C=!0);var G=a.value.split("");N(q,!1,!1,C?G.reverse():G,!0);g.onKeyPress.call(this,void 0,t(),0,g);return C?t().reverse().join(""):t().join("");case "isValid":q=f({});q.data("_inputmask",{maskset:c,opts:g,isRTL:g.numericInput});g.numericInput&&(C=!0);G=a.value.split("");N(q,!1,!0,C?G.reverse():G);var G=t(),za=da();G.length=za;return T(G)&&a.value==G.join("");case "getemptymask":return q=f(a.el),c=q.data("_inputmask").maskset,g=q.data("_inputmask").opts,H();
case "remove":var B=a.el;q=f(B);c=q.data("_inputmask").maskset;g=q.data("_inputmask").opts;B._valueSet(ia(q));q.unbind(".inputmask");q.removeClass("focus-inputmask");q.removeData("_inputmask");Object.getOwnPropertyDescriptor&&(G=Object.getOwnPropertyDescriptor(B,"value"));G&&G.get?B._valueGet&&Object.defineProperty(B,"value",{get:B._valueGet,set:B._valueSet}):document.__lookupGetter__&&B.__lookupGetter__("value")&&B._valueGet&&(B.__defineGetter__("value",B._valueGet),B.__defineSetter__("value",B._valueSet));
try{delete B._valueGet,delete B._valueSet}catch(Aa){B._valueGet=void 0,B._valueSet=void 0}}};f.inputmask={defaults:{placeholder:"_",optionalmarker:{start:"[",end:"]"},quantifiermarker:{start:"{",end:"}"},groupmarker:{start:"(",end:")"},alternatormarker:"|",escapeChar:"\\",mask:null,oncomplete:f.noop,onincomplete:f.noop,oncleared:f.noop,repeat:0,greedy:!0,autoUnmask:!1,removeMaskOnSubmit:!0,clearMaskOnLostFocus:!0,insertMode:!0,clearIncomplete:!1,aliases:{},alias:null,onKeyUp:f.noop,onKeyPress:f.noop,
onKeyDown:f.noop,onBeforeMask:void 0,onBeforePaste:void 0,onUnMask:void 0,showMaskOnFocus:!0,showMaskOnHover:!0,onKeyValidation:f.noop,skipOptionalPartCharacter:" ",showTooltip:!1,numericInput:!1,rightAlign:!1,radixPoint:"",nojumps:!1,nojumpsThreshold:0,keepStatic:!1,definitions:{9:{validator:"[0-9]",cardinality:1,definitionSymbol:"*"},a:{validator:"[A-Za-z\u0410-\u044f\u0401\u0451\u00c0-\u00ff\u00b5]",cardinality:1,definitionSymbol:"*"},"*":{validator:"[0-9A-Za-z\u0410-\u044f\u0401\u0451\u00c0-\u00ff\u00b5]",
...
isComplete:void 0},masksCache:{},escapeRegex:function(a){return a.replace(RegExp("(\\/|\\.|\\*|\\+|\\?|\\||\\(|\\)|\\[|\\]|\\{|\\}|\\\\)","gim"),"\\$1")},format:function(a,b){var e=f.extend(!0,{},f.inputmask.defaults,b);c(e.alias,b,e);return z({action:"format",value:a},d(e),e)},isValid:function(a,b){var e=f.extend(!0,{},f.inputmask.defaults,b);c(e.alias,b,e);return z({action:"isValid",value:a},d(e),e)}};f.fn.inputmask=function(a,b,e,h,k){function y(a,b){var c=f(a),d;for(d in b){var e=c.data("inputmask-"+
d.toLowerCase());void 0!=e&&(b[d]=e)}return b}e=e||z;h=h||"_inputmask";var l=f.extend(!0,{},f.inputmask.defaults,b),u;if("string"===typeof a)switch(a){case "mask":return c(l.alias,b,l),u=d(l,e!==z),0==u.length?this:this.each(function(){e({action:"mask",el:this},f.extend(!0,{},u),y(this,l))});case "unmaskedvalue":return a=f(this),a.data(h)?e({action:"unmaskedvalue",$input:a}):a.val();case "remove":return this.each(function(){f(this).data(h)&&e({action:"remove",el:this})});case "getemptymask":return this.data(h)?
e({action:"getemptymask",el:this}):"";case "hasMaskedValue":return this.data(h)?!this.data(h).opts.autoUnmask:!1;case "isComplete":return this.data(h)?e({action:"isComplete",buffer:this[0]._valueGet().split(""),el:this}):!0;case "getmetadata":if(this.data(h))return u=this.data(h).maskset,u.metadata;break;case "_detectScope":return c(l.alias,b,l),void 0==k||c(k,b,l)||-1!=f.inArray(k,"mask unmaskedvalue remove getemptymask hasMaskedValue isComplete getmetadata _detectScope".split(" "))||(l.mask=k),
f.isFunction(l.mask)&&(l.mask=l.mask.call(this,l)),f.isArray(l.mask);default:return c(l.alias,b,l),c(a,b,l)||(l.mask=a),u=d(l,e!==z),void 0==u?this:this.each(function(){e({action:"mask",el:this},f.extend(!0,{},u),y(this,l))})}else{if("object"==typeof a)return l=f.extend(!0,{},f.inputmask.defaults,a),c(l.alias,a,l),u=d(l,e!==z),void 0==u?this:this.each(function(){e({action:"mask",el:this},f.extend(!0,{},u),y(this,l))});if(void 0==a)return this.each(function(){var a=f(this).attr("data-inputmask");if(a&&
""!=a)try{var a=a.replace(RegExp("'","g"),'"'),d=f.parseJSON("{"+a+"}");f.extend(!0,d,b);l=f.extend(!0,{},f.inputmask.defaults,d);c(l.alias,d,l);l.alias=void 0;f(this).inputmask("mask",l,e)}catch(h){}})}}}});
