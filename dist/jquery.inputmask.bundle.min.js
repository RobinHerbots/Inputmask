...
y(a),e=h();if(c.begin==c.end){var c=g.isRTL?J(c.begin):c.begin,f=b().lastValidPosition,e=g.isNumeric?!1===g.skipRadixDance&&""!=g.radixPoint&&-1!=d.inArray(g.radixPoint,e)?g.numericInput?p(d.inArray(g.radixPoint,e)):d.inArray(g.radixPoint,e):p(f):p(f);c<e?v(c)?y(a,c):y(a,p(c)):y(a,e)}},0)}).bind("dblclick.inputmask",function(){var a=this;setTimeout(function(){y(a,0,p(b().lastValidPosition))},0)}).bind("keydown.inputmask",X).bind("keypress.inputmask",fa).bind("keyup.inputmask",Z).bind(G+".inputmask dragdrop.inputmask drop.inputmask",
function(a){var b=this,c=d(b);if("propertychange"==a.type&&b._valueGet().length<=t())return!0;setTimeout(function(){O(b,!0,!1);R(h())&&c.trigger("complete");c.click()},0)}).bind("setvalue.inputmask",function(){O(this,!0);K=h().join("");this._valueGet()==e().join("")&&this._valueSet("")}).bind("_keypress.inputmask",fa).bind("complete.inputmask",g.oncomplete).bind("incomplete.inputmask",g.onincomplete).bind("cleared.inputmask",g.oncleared);O(s,!0,!1);K=h().join("");var da;try{da=document.activeElement}catch(ha){}da===
s?(w.addClass("focus.inputmask"),y(s,p(b().lastValidPosition))):g.clearMaskOnLostFocus?h().join("")==e().join("")?s._valueSet(""):Y(s):L(s,h());M(s)}};return this}var g=d.extend(!0,{},d.inputmask.defaults,f),N=null!==navigator.userAgent.match(/iphone/i),s=null!==navigator.userAgent.match(/android.*safari.*/i),G=b("paste")?"paste":b("input")?"input":"propertychange",m,l,p=0;if(s){var r=navigator.userAgent.match(/safari.*/i);m=537>=parseInt(RegExp(/[0-9]+/).exec(r))}if("string"===typeof a)switch(a){case "mask":return e(g.alias,
f),l=k(),this.each(function(){q(d.extend(!0,{},l),0).mask(this)});case "unmaskedvalue":return r=d(this),r.data("_inputmask")?(l=r.data("_inputmask").masksets,p=r.data("_inputmask").activeMasksetIndex,g=r.data("_inputmask").opts,q(l,p).unmaskedvalue(r)):r.val();case "remove":return this.each(function(){var a=d(this);if(a.data("_inputmask")){l=a.data("_inputmask").masksets;p=a.data("_inputmask").activeMasksetIndex;g=a.data("_inputmask").opts;this._valueSet(q(l,p).unmaskedvalue(a,!0));a.removeData("_inputmask");
a.unbind(".inputmask");a.removeClass("focus.inputmask");var b;Object.getOwnPropertyDescriptor&&(b=Object.getOwnPropertyDescriptor(this,"value"));b&&b.get?this._valueGet&&Object.defineProperty(this,"value",{get:this._valueGet,set:this._valueSet}):document.__lookupGetter__&&this.__lookupGetter__("value")&&this._valueGet&&(this.__defineGetter__("value",this._valueGet),this.__defineSetter__("value",this._valueSet));try{delete this._valueGet,delete this._valueSet}catch(c){this._valueSet=this._valueGet=
void 0}}});case "getemptymask":return this.data("_inputmask")?(l=this.data("_inputmask").masksets,p=this.data("_inputmask").activeMasksetIndex,l[p]._buffer.join("")):"";case "hasMaskedValue":return this.data("_inputmask")?!this.data("_inputmask").opts.autoUnmask:!1;case "isComplete":return l=this.data("_inputmask").masksets,p=this.data("_inputmask").activeMasksetIndex,g=this.data("_inputmask").opts,q(l,p).isComplete(this[0]._valueGet().split(""));case "getmetadata":if(this.data("_inputmask"))return l=
this.data("_inputmask").masksets,p=this.data("_inputmask").activeMasksetIndex,l[p].metadata;return;default:return e(a,f)||(g.mask=a),l=k(),this.each(function(){q(d.extend(!0,{},l),p).mask(this)})}else{if("object"==typeof a)return g=d.extend(!0,{},d.inputmask.defaults,a),e(g.alias,a),l=k(),this.each(function(){q(d.extend(!0,{},l),p).mask(this)});if(void 0==a)return this.each(function(){var a=d(this).attr("data-inputmask");if(a&&""!=a)try{var a=a.replace(RegExp("'","g"),'"'),b=d.parseJSON("{"+a+"}");
d.extend(!0,b,f);g=d.extend(!0,{},d.inputmask.defaults,b);e(g.alias,b);g.alias=void 0;d(this).inputmask(g)}catch(c){}})}return this})})(jQuery);
