...
d.call(this).split("").reverse().join(""):valueGetvalueGet.call(this)},a._valueSet=function(a){f.call(this,z?a.split("").reverse().join(""):a)},a.__defineGetter__("value",function(){var a=c(this),b=c(this).data("_inputmask"),d=b.masksets,f=b.activeMasksetIndex;return b&&b.opts.autoUnmask?a.inputmask("unmaskedvalue"):this._valueGet()!=d[f]._buffer.join("")?this._valueGet():""}),a.__defineSetter__("value",function(a){this._valueSet(a);c(this).triggerHandler("setvalue.inputmask")}));else if(a._valueGet||
(a._valueGet=function(){return z?this.value.split("").reverse().join(""):this.value},a._valueSet=function(a){this.value=z?a.split("").reverse().join(""):a}),!0!=c.fn.val.inputmaskpatch)c.fn.val=function(){if(arguments.length==0){var a=c(this);if(a.data("_inputmask")){if(a.data("_inputmask").opts.autoUnmask)return a.inputmask("unmaskedvalue");var a=c.inputmask.val.apply(a),b=c(this).data("_inputmask");return a!=b.masksets[b.activeMasksetIndex]._buffer.join("")?a:""}return c.inputmask.val.apply(a)}var d=
arguments;return this.each(function(){var a=c(this),b=c.inputmask.val.apply(a,d);a.data("_inputmask")&&a.triggerHandler("setvalue.inputmask");return b})},c.extend(c.fn.val,{inputmaskpatch:!0})}function J(a,d,c){for(var h=f();!n(a)&&0<=a-1;)a--;for(var l=a;l<d&&l<r();l++)if(n(l)){L(h,l);var m=p(l),w=B(h,m);if(w!=k(m))if(m<r()&&!1!==j(l,w,!0)&&e()[q(l)].def==e()[q(m)].def)K(h,l,B(h,m),!0),m<d&&L(h,m);else if(n(l))break}else L(h,l);void 0!=c&&K(h,x(d),c);if(!1==b().greedy){d=R(h.join("")).split("");
h.length=d.length;l=0;for(c=h.length;l<c;l++)h[l]=d[l];0==h.length&&(b().buffer=g().slice())}return a}function y(a,d,c,h){for(var l=f();a<=d&&a<r();a++)if(n(a)){var m=B(l,a,!0);K(l,a,c,!0);if(m!=k(a))if(c=p(a),c<r())if(!1!==j(c,m,!0)&&e()[q(a)].def==e()[q(c)].def)c=m;else if(n(c))break;else c=m;else break;else if(c=m,!0!==h)break}else L(l,a);h=l.length;if(!1==b().greedy){c=R(l.join("")).split("");l.length=c.length;a=0;for(m=l.length;a<m;a++)l[a]=c[a];0==l.length&&(b().buffer=g().slice())}return d-
(h-l.length)}function S(e){P=!1;var j=this,m=e.keyCode,u=v(j);if(m==h.keyCode.BACKSPACE||m==h.keyCode.DELETE||I&&127==m||e.ctrlKey&&88==m){e.preventDefault();if(h.numericInput||z)switch(m){case h.keyCode.BACKSPACE:m=h.keyCode.DELETE;break;case h.keyCode.DELETE:m=h.keyCode.BACKSPACE}if(Z(u.begin,u.end)){if(z){var H=u.end;u.end=u.begin;u.begin=H}Q(f(),u.begin,u.end);if(0==u.begin&&u.end==r())c.each(a,function(a,b){"object"==typeof b&&(b.buffer=b._buffer.slice(),b.lastValidPosition=void 0,b.p=0)});else{H=
r();if(!1==h.greedy)J(u.begin,H);else for(var q=u.begin;q<u.end;q++)n(q)&&J(u.begin,H);M(j,!1,!0,f())}}else c.each(a,function(a,c){if("object"==typeof c){d=a;var e=l?u.end:u.begin,j=f(),n=p(-1),V=r();if(m==h.keyCode.DELETE)e<n&&(e=n),e<V&&(h.isNumeric&&(""!=h.radixPoint&&j[e]==h.radixPoint)&&(e=j.length-1==e?e:p(e)),e=J(e,V),void 0!=b().lastValidPosition&&(-1!=b().lastValidPosition&&f()[b().lastValidPosition]==g()[b().lastValidPosition]&&(b().lastValidPosition=0==b().lastValidPosition?-1:x(b().lastValidPosition)),
b().lastValidPosition<n?(b().lastValidPosition=void 0,b().p=n):(b().writeOutBuffer=!0,b().p=e)));else if(m==h.keyCode.BACKSPACE)if(e>n){if(e-=1,h.isNumeric&&""!=h.radixPoint&&j[e]==h.radixPoint?(e=y(0,j.length-1==e?e:e-1,k(e),!0),e++):e=J(e,V),void 0!=b().lastValidPosition)-1!=b().lastValidPosition&&f()[b().lastValidPosition]==g()[b().lastValidPosition]&&(b().lastValidPosition=0==b().lastValidPosition?-1:x(b().lastValidPosition)),b().lastValidPosition<n?(b().lastValidPosition=void 0,b().p=n):(b().writeOutBuffer=
!0,b().p=e)}else 0<d&&(b().lastValidPosition=void 0,b().writeOutBuffer=!0,b().p=n,d=0,b().buffer=g().slice(),b().p=p(-1),b().lastValidPosition=void 0)}});w();E(j,f(),b().p);j._valueGet()==g().join("")&&c(j).trigger("cleared");h.showTooltip&&o.prop("title",b().mask)}else m==h.keyCode.END||m==h.keyCode.PAGE_DOWN?setTimeout(function(){var a=p(b().lastValidPosition);!h.insertMode&&(a==r()&&!e.shiftKey)&&a--;v(j,e.shiftKey?u.begin:a,a)},0):m==h.keyCode.HOME&&!e.shiftKey||m==h.keyCode.PAGE_UP?v(j,0,e.shiftKey?
u.begin:0):m==h.keyCode.ESCAPE?(j._valueSet(b().undoBuffer),M(j,!0,!0)):m==h.keyCode.INSERT&&!e.shiftKey&&!e.ctrlKey?(h.insertMode=!h.insertMode,v(j,!h.insertMode&&u.begin==r()?u.begin-1:u.begin)):!1==h.insertMode&&!e.shiftKey&&(m==h.keyCode.RIGHT?setTimeout(function(){var a=v(j);v(j,a.begin)},0):m==h.keyCode.LEFT&&setTimeout(function(){var a=v(j);v(j,a.begin-1)},0));H=v(j);h.onKeyDown.call(this,e,f(),h);v(j,H.begin,H.end);W=-1!=c.inArray(m,h.ignorables)}function U(e,g,l,m,q,o){if(void 0==l&&P)return!1;
P=!0;var G=c(this),e=e||window.event,l=l||e.which||e.charCode||e.keyCode,t=String.fromCharCode(l);if((!e.ctrlKey||!e.altKey)&&(e.ctrlKey||e.metaKey||W)&&!0!==g)return!0;if(l){var s,A;g?(l=q?o:b().p,s={begin:l,end:l}):s=v(this);var l=Z(s.begin,s.end),F=!1;l&&(z&&(o=s.end,s.end=s.begin,s.begin=o),o=d,c.each(a,function(a,e){if(typeof e=="object"){d=a;b().undoBuffer=f().join("");var c=s.end<r()?s.end:r();b().lastValidPosition>s.begin&&b().lastValidPosition<c?b().lastValidPosition=x(s.begin):F=true;Q(f(),
