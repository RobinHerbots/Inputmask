...
e.repeat){var b=!1,c=O(N());if(p()==c)for(var b=!0,h=0;h<=c;h++){var k=E(h);if(k&&(void 0==a[h]||a[h]==R(h))||!k&&a[h]!=R(h)){b=!1;break}}return b}}function ia(a){a=d._data(a).events;d.each(a,function(a,b){d.each(b,function(a,b){if("inputmask"==b.namespace&&"setvalue"!=b.type){var c=b.handler;b.handler=function(a){if(this.readOnly||this.disabled)a.preventDefault;else return c.apply(this,arguments)}}})})}function ja(a){function b(a){if(void 0==d.valHooks[a]||!0!=d.valHooks[a].inputmaskpatch){var c=
...
$input:n})):n.val();case "remove":return this.each(function(){var a=d(this);if(a.data("_inputmask")){t=a.data("_inputmask").maskset;g=a.data("_inputmask").opts;this._valueSet(u(t,g,{action:"unmaskedvalue",$input:a,skipDatepickerCheck:!0}));a.unbind(".inputmask");a.removeClass("focus.inputmask");a.removeData("_inputmask");var b;Object.getOwnPropertyDescriptor&&(b=Object.getOwnPropertyDescriptor(this,"value"));b&&b.get?this._valueGet&&Object.defineProperty(this,"value",{get:this._valueGet,set:this._valueSet}):
...
(function(d){d.extend(d.inputmask.defaults.aliases,{numeric:{mask:function(a){0!==a.repeat&&isNaN(a.integerDigits)&&(a.integerDigits=a.repeat);a.repeat=0;var c=a.prefix,c=c+"[+]"+("~{1,"+a.integerDigits+"}");void 0!=a.digits&&(isNaN(a.digits)||0<parseInt(a.digits))&&(c=a.digitsOptional?c+("["+a.radixPoint+"={"+a.digits+"}]"):c+(a.radixPoint+"={"+a.digits+"}"));return c+=a.suffix},placeholder:"",greedy:!1,numericInput:!1,isNumeric:!0,digits:"*",digitsOptional:!0,groupSeparator:"",radixPoint:".",groupSize:3,
autoGroup:!1,allowPlus:!0,allowMinus:!0,integerDigits:"*",defaultValue:"",prefix:"",suffix:"",postFormat:function(a,c,k,f){if(""==f.groupSeparator)return c;var b=a.slice();k||b.splice(c,0,"?");b=b.join("");if(f.autoGroup||k&&-1!=b.indexOf(f.groupSeparator)){for(var g=d.inputmask.escapeRegex.call(this,f.groupSeparator),b=b.replace(RegExp(g,"g"),""),g=b.split(f.radixPoint),b=g[0],n=RegExp("([-+]?[\\d?]+)([\\d?]{"+f.groupSize+"})");n.test(b);)b=b.replace(n,"$1"+f.groupSeparator+"$2"),b=b.replace(f.groupSeparator+
f.groupSeparator,f.groupSeparator);1<g.length&&(b+=f.radixPoint+g[1])}a.length=b.length;f=0;for(g=b.length;f<g;f++)a[f]=b.charAt(f);b=d.inArray("?",a);k||a.splice(b,1);return k?c:b},onKeyDown:function(a,c,k){d(this);if(k.autoGroup&&a.keyCode==k.keyCode.DELETE||a.keyCode==k.keyCode.BACKSPACE)return k.postFormat(c,0,!0,k),{refreshFromBuffer:!0}},regex:{integerPart:function(a){return/[-+]?\d+/}},definitions:{"~":{validator:function(a,c,k,f,b){if(!f&&"-"===a){var g=c.join("").match(b.regex.integerPart(b));
if(0<g.length)return"+"==c[g.index]?(c.splice(g.index,1),{pos:g.index,c:"-",refreshFromBuffer:!0,caret:k}):"-"==c[g.index]?(c.splice(g.index,1),{refreshFromBuffer:!0,caret:k-1}):{pos:g.index,c:"-",caret:k+1}}g=f?RegExp("[0-9"+d.inputmask.escapeRegex.call(this,b.groupSeparator)+"]").test(a):/[0-9]/.test(a);return!1==g||f||a==b.radixPoint||!0!==b.autoGroup?g:{pos:b.postFormat(c,k,"-"==a||"+"==a?!0:!1,b),refreshFromBuffer:!0}},cardinality:1,prevalidator:null},"=":{validator:function(a,c,d,f,b){return!f&&
"-"===a&&(f=c.join("").match(b.regex.integerPart(b)),0<f.length)?"+"==c[f.index]?(c.splice(f.index,1),{pos:f.index,c:"-",refreshFromBuffer:!0,caret:d}):"-"==c[f.index]?(c.splice(f.index,1),{refreshFromBuffer:!0,caret:d-1}):{pos:f.index,c:"-",caret:d+1}:/[0-9]/.test(a)},cardinality:1,prevalidator:null},"+":{validator:function(a,c,d,f,b){c="[";!0===b.allowMinus&&(c+="-");!0===b.allowPlus&&(c+="+");return RegExp(c+"]").test(a)},cardinality:1,prevalidator:null}},insertMode:!0,autoUnmask:!1},decimal:{alias:"numeric"},
integer:{alias:"numeric",digits:"0"}})})(jQuery);
...
a.matches.indexOf(f),g=a.matches[g-1],k=r;if(isNaN(f.quantifier.max)){for(;f.repeaterPart&&f.repeaterPart!=r&&f.repeaterPart.length>r.length&&!(c=B(g,!0)););(c=c||B(g,!0))&&(f.repeaterPart=r);r=k+f.quantifier.max}else{for(var n=0,J=f.quantifier.max-1;n<J&&!(c=B(g,!0));n++);r=k+"{"+f.quantifier.min+","+f.quantifier.max+"}"}}else if(void 0!=f.matches)for(g=0;g<f.length&&!(c=B(f[g],b));g++);else{if("["==f[0]){c=r;c+=f;for(n=0;n<L;n++)c+=")";c=RegExp("^("+c+")$");c=c.test(M)}else for(g=0,k=f.length;g<
k;g++)if("\\"!=f[g]){c=r;c+=f.substr(0,g+1);c=c.replace(/\|$/,"");for(n=0;n<L;n++)c+=")";c=RegExp("^("+c+")$");if(c=c.test(M))break}r+=f}if(c)break}b&&(r+=")",L--);return c}null==b.regexTokens&&n();f=c.slice();var r="";c=!1;var L=0;f.splice(d,0,a);var M=f.join("");for(a=0;a<b.regexTokens.length&&!(g=b.regexTokens[a],c=B(g,g.isGroup));a++);return c},cardinality:1}}}})})(jQuery);
