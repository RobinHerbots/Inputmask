...
!0;else{if(d!=a.optionalmarker.start||b){if(d!=a.optionalmarker.end||b){var y=a.definitions[d];if(y&&!b){for(var h=y.prevalidator,U=h?h.length:0,m=1;m<y.cardinality;m++){var A=U>=m?h[m-1]:[],k=A.validator,A=A.cardinality;g.push({fn:k?"string"==typeof k?RegExp(k):new function(){this.test=k}:/./,cardinality:A?A:1,optionality:c,newBlockMarker:!0==c?f:!1,offset:0,casing:y.casing,def:y.definitionSymbol||d});!0==c&&(f=!1)}g.push({fn:y.validator?"string"==typeof y.validator?RegExp(y.validator):new function(){this.test=
y.validator}:/./,cardinality:y.cardinality,optionality:c,newBlockMarker:f,offset:0,casing:y.casing,def:y.definitionSymbol||d})}else g.push({fn:null,cardinality:0,optionality:c,newBlockMarker:f,offset:0,casing:null,def:d}),b=!1;f=!1;return g}c=!1}else c=!0;f=!0}})}function f(d){for(var c=d.length,e=0;e<c&&d.charAt(e)!=a.optionalmarker.start;e++);var b=[d.substring(0,e)];e<c&&b.push(d.substring(e+1,c));return b}function b(m,k,l){for(var r=0,u=0,n=k.length,p=0;p<n&&!(k.charAt(p)==a.optionalmarker.start&&
r++,k.charAt(p)==a.optionalmarker.end&&u++,0<r&&r==u);p++);r=[k.substring(0,p)];p<n&&r.push(k.substring(p+1,n));p=f(r[0]);1<p.length?(k=m+p[0]+(a.optionalmarker.start+p[1]+a.optionalmarker.end)+(1<r.length?r[1]:""),-1==e.inArray(k,h)&&""!=k&&(h.push(k),n=c(k),g.push({mask:k,_buffer:n.mask,buffer:n.mask.slice(),tests:d(k),lastValidPosition:-1,greedy:n.greedy,repeat:n.repeat,metadata:l})),k=m+p[0]+(1<r.length?r[1]:""),-1==e.inArray(k,h)&&""!=k&&(h.push(k),n=c(k),g.push({mask:k,_buffer:n.mask,buffer:n.mask.slice(),
tests:d(k),lastValidPosition:-1,greedy:n.greedy,repeat:n.repeat,metadata:l})),1<f(p[1]).length&&b(m+p[0],p[1]+r[1],l),1<r.length&&1<f(r[1]).length&&(b(m+p[0]+(a.optionalmarker.start+p[1]+a.optionalmarker.end),r[1],l),b(m+p[0],r[1],l))):(k=m+r,-1==e.inArray(k,h)&&""!=k&&(h.push(k),n=c(k),g.push({mask:k,_buffer:n.mask,buffer:n.mask.slice(),tests:d(k),lastValidPosition:-1,greedy:n.greedy,repeat:n.repeat,metadata:l})))}var g=[],h=[];e.isFunction(a.mask)&&(a.mask=a.mask.call(this,a));e.isArray(a.mask)?
e.each(a.mask,function(a,d){void 0!=d.mask?b("",d.mask.toString(),d):b("",d.toString())}):b("",a.mask.toString());return a.greedy?g:g.sort(function(a,d){return a.mask.length-d.mask.length})},g="function"===typeof ScriptEngineMajorVersion?ScriptEngineMajorVersion():10<=(new Function("/*@cc_on return @_jscript_version; @*/"))(),c=navigator.userAgent,h=null!==c.match(/iphone/i),k=null!==c.match(/android.*safari.*/i),l=null!==c.match(/android.*chrome.*/i),u=null!==c.match(/android.*firefox.*/i),M=/Kindle/i.test(c)||
/Silk/i.test(c)||/KFTT/i.test(c)||/KFOT/i.test(c)||/KFJWA/i.test(c)||/KFJWI/i.test(c)||/KFSOWI/i.test(c)||/KFTHWA/i.test(c)||/KFTHWI/i.test(c)||/KFAPWA/i.test(c)||/KFAPWI/i.test(c),Q=a("paste")?"paste":a("input")?"input":"propertychange",q=function(a,c,d,b){function f(){return a[c]}function q(){return f().tests}function t(){return f()._buffer}function m(){return f().buffer}function S(N,b,v){function z(a,c,f,N){for(var b=D(a),e=f?1:0,v="",ea=c.buffer,z=c.tests[b].cardinality;z>e;z--)v+=H(ea,b-(z-1));
f&&(v+=f);return null!=c.tests[b].fn?c.tests[b].fn.test(v,ea,a,N,d):f==H(c._buffer.slice(),a,!0)||f==d.skipOptionalPartCharacter?{refresh:!0,c:H(c._buffer.slice(),a,!0),pos:a}:!1}if(v=!0===v){var g=z(N,f(),b,v);!0===g&&(g={pos:N});return g}var h=[],g=!1,k=c,A=m().slice(),t=f().lastValidPosition;F(N);var l=[];e.each(a,function(a,d){if("object"==typeof d){c=a;var e=N,B=f().lastValidPosition,q;if(B==t){if(1<e-t)for(B=-1==B?0:B;B<e&&(q=z(B,f(),A[B],!0),!1!==q);B++)G(m(),B,A[B],!0),!0===q&&(q={pos:B}),
q=q.pos||B,f().lastValidPosition<q&&(f().lastValidPosition=q);if(!r(e)&&!z(e,f(),b,v)){B=p(e)-e;for(q=0;q<B&&!1===z(++e,f(),b,v);q++);l.push(c)}}(f().lastValidPosition>=t||c==k)&&0<=e&&e<n()&&(g=z(e,f(),b,v),!1!==g&&(!0===g&&(g={pos:e}),q=g.pos||e,f().lastValidPosition<q&&(f().lastValidPosition=q)),h.push({activeMasksetIndex:a,result:g}))}});c=k;return function(c,d){var f=!1;e.each(d,function(a,d){if(f=-1==e.inArray(d.activeMasksetIndex,c)&&!1!==d.result)return!1});if(f)d=e.map(d,function(d,f){if(-1==
...
function(a){b.call(this,a);e(this).triggerHandler("setvalue.inputmask")})):(a._valueGet||(a._valueGet=function(){return x?this.value.split("").reverse().join(""):this.value},a._valueSet=function(a){this.value=x?a.split("").reverse().join(""):a}),d(a.type))}function ga(a,d,c,b){var e=m();if(!1!==b)for(;!r(a)&&0<=a-1;)a--;for(b=a;b<d&&b<n();b++)if(r(b)){V(e,b);var g=p(b),h=H(e,g);if(h!=P(g))if(g<n()&&!1!==S(b,h,!0)&&q()[D(b)].def==q()[D(g)].def)G(e,b,h,!0);else if(r(b))break}else V(e,b);void 0!=c&&
G(e,F(d),c);if(!1==f().greedy){d=Y(e.join("")).split("");e.length=d.length;b=0;for(c=e.length;b<c;b++)e[b]=d[b];0==e.length&&(f().buffer=t().slice())}return a}function ha(a,d,c){var b=m();if(H(b,a,!0)!=P(a))for(var e=F(d);e>a&&0<=e;e--)if(r(e)){var g=F(e),h=H(b,g);h!=P(g)&&!1!==S(e,h,!0)&&q()[D(e)].def==q()[D(g)].def&&(G(b,e,h,!0),V(b,g))}else V(b,e);void 0!=c&&H(b,a)==P(a)&&G(b,a,c);a=b.length;if(!1==f().greedy){c=Y(b.join("")).split("");b.length=c.length;e=0;for(g=b.length;e<g;e++)b[e]=c[e];0==
b.length&&(f().buffer=t().slice())}return d-(a-b.length)}function ia(a,c,b){if(d.numericInput||x){switch(c){case d.keyCode.BACKSPACE:c=d.keyCode.DELETE;break;case d.keyCode.DELETE:c=d.keyCode.BACKSPACE}if(x){var e=b.end;b.end=b.begin;b.begin=e}}e=!0;b.begin==b.end?(e=c==d.keyCode.BACKSPACE?b.begin-1:b.begin,d.isNumeric&&""!=d.radixPoint&&m()[e]==d.radixPoint&&(b.begin=m().length-1==e?b.begin:c==d.keyCode.BACKSPACE?e:p(e),b.end=b.begin),e=!1,c==d.keyCode.BACKSPACE?b.begin--:c==d.keyCode.DELETE&&b.end++):
1!=b.end-b.begin||d.insertMode||(e=!1,c==d.keyCode.BACKSPACE&&b.begin--);X(m(),b.begin,b.end);var g=n();if(!1==d.greedy&&(isNaN(d.repeat)||0<d.repeat))ga(b.begin,g,void 0,!x&&c==d.keyCode.BACKSPACE&&!e);else{for(var h=b.begin,k=b.begin;k<b.end;k++)if(r(k)||!e)h=ga(b.begin,g,void 0,!x&&c==d.keyCode.BACKSPACE&&!e);e||(b.begin=h)}c=p(-1);X(m(),b.begin,b.end,!0);J(a,!1,!1,m());f().lastValidPosition<c?(f().lastValidPosition=-1,f().p=c):f().p=b.begin}function $(a){aa=!1;var c=this,b=e(c),g=a.keyCode,k=
w(c);g==d.keyCode.BACKSPACE||g==d.keyCode.DELETE||h&&127==g||a.ctrlKey&&88==g?(a.preventDefault(),88==g&&(L=m().join("")),ia(c,g,k),ca(),I(c,m(),f().p),c._valueGet()==t().join("")&&b.trigger("cleared"),d.showTooltip&&b.prop("title",f().mask)):g==d.keyCode.END||g==d.keyCode.PAGE_DOWN?setTimeout(function(){var b=p(f().lastValidPosition);d.insertMode||b!=n()||a.shiftKey||b--;w(c,a.shiftKey?k.begin:b,b)},0):g==d.keyCode.HOME&&!a.shiftKey||g==d.keyCode.PAGE_UP?w(c,0,a.shiftKey?k.begin:0):g==d.keyCode.ESCAPE||
90==g&&a.ctrlKey?(J(c,!0,!1,L.split("")),b.click()):g!=d.keyCode.INSERT||a.shiftKey||a.ctrlKey?!1!=d.insertMode||a.shiftKey||(g==d.keyCode.RIGHT?setTimeout(function(){var a=w(c);w(c,a.begin)},0):g==d.keyCode.LEFT&&setTimeout(function(){var a=w(c);w(c,a.begin-1)},0)):(d.insertMode=!d.insertMode,w(c,d.insertMode||k.begin!=n()?k.begin:k.begin-1));b=w(c);!0===d.onKeyDown.call(this,a,m(),d)&&w(c,b.begin,b.end);ja=-1!=e.inArray(g,d.ignorables)}function W(b,g,h,k,A,t){if(void 0==h&&aa)return!1;aa=!0;var q=
e(this);b=b||window.event;h=g?h:b.which||b.charCode||b.keyCode;if(!(!0===g||b.ctrlKey&&b.altKey)&&(b.ctrlKey||b.metaKey||ja))return!0;if(h){!0!==g&&46==h&&!1==b.shiftKey&&","==d.radixPoint&&(h=44);var l,s,r=String.fromCharCode(h);g?(h=A?t:f().lastValidPosition+1,l={begin:h,end:h}):l=w(this);t=x?1<l.begin-l.end||1==l.begin-l.end&&d.insertMode:1<l.end-l.begin||1==l.end-l.begin&&d.insertMode;var u=c;t&&(e.each(a,function(a,d){"object"==typeof d&&(c=a,f().undoBuffer=m().join(""))}),c=u,ia(this,d.keyCode.DELETE,
l),d.insertMode||e.each(a,function(a,d){"object"==typeof d&&(c=a,ha(l.begin,n()),f().lastValidPosition=p(f().lastValidPosition))}),c=u);var T=m().join("").indexOf(d.radixPoint);d.isNumeric&&!0!==g&&-1!=T&&(d.greedy&&l.begin<=T?(l.begin=F(l.begin),l.end=l.begin):r==d.radixPoint&&(l.begin=T,l.end=l.begin));var C=l.begin;h=S(C,r,A);!0===A&&(h=[{activeMasksetIndex:c,result:h}]);var E=-1;e.each(h,function(a,b){c=b.activeMasksetIndex;f().writeOutBuffer=!0;var e=b.result;if(!1!==e){var g=!1,h=m();!0!==e&&
(g=e.refresh,C=void 0!=e.pos?e.pos:C,r=void 0!=e.c?e.c:r);if(!0!==g){if(!0==d.insertMode){e=n();for(h=h.slice();H(h,e,!0)!=P(e)&&e>=C;)e=0==e?-1:F(e);e>=C?(ha(C,n(),r),h=f().lastValidPosition,e=p(h),e!=n()&&h>=C&&H(m().slice(),e,!0)!=P(e)&&(f().lastValidPosition=e)):f().writeOutBuffer=!1}else G(h,C,r,!0);if(-1==E||E>p(C))E=p(C)}else!A&&(h=C<n()?C+1:C,-1==E||E>h)&&(E=h);E>f().p&&(f().p=E)}});!0!==A&&(c=u,ca());if(!1!==k)if(e.each(h,function(a,d){if(d.activeMasksetIndex==c)return s=d,!1}),void 0!=s){var D=
this;setTimeout(function(){d.onKeyValidation.call(D,s.result,d)},0);if(f().writeOutBuffer&&!1!==s.result){var J=m();k=g?void 0:d.numericInput?C>T?F(E):r==d.radixPoint?E-1:F(E-1):E;I(this,J,k);!0!==g&&setTimeout(function(){!0===R(J)&&q.trigger("complete");ba=!0;q.trigger("input")},0)}else t&&(f().buffer=f().undoBuffer.split(""))}else t&&(f().buffer=f().undoBuffer.split(""));d.showTooltip&&q.prop("title",f().mask);b&&(b.preventDefault?b.preventDefault():b.returnValue=!1)}}function ka(a){var c=e(this),
b=a.keyCode,f=m();d.onKeyUp.call(this,a,f,d);b==d.keyCode.TAB&&d.showMaskOnFocus&&(c.hasClass("focus.inputmask")&&0==this._valueGet().length?(f=t().slice(),I(this,f),w(this,0),L=m().join("")):(I(this,f),f.join("")==t().join("")&&-1!=e.inArray(d.radixPoint,f)?(w(this,K(0)),c.click()):w(this,K(0),K(n()))))}function la(a){if(!0===ba&&"input"==a.type)return ba=!1,!0;var c=this,b=e(c);if("propertychange"==a.type&&c._valueGet().length<=n())return!0;setTimeout(function(){var a=e.isFunction(d.onBeforePaste)?
d.onBeforePaste.call(c,c._valueGet(),d):c._valueGet();J(c,!1,!1,a.split(""),!0);I(c,m());!0===R(m())&&b.trigger("complete");b.click()},0)}function pa(a){var c=e(this),b=w(this),f=this._valueGet(),f=f.replace(RegExp("("+fa(t().join(""))+")*"),"");b.begin>f.length&&(w(this,f.length),b=w(this));1!=m().length-f.length||f.charAt(b.begin)==m()[b.begin]||f.charAt(b.begin+1)==m()[b.begin]||r(b.begin)?(J(this,!1,!1,f.split("")),I(this,m()),!0===R(m())&&c.trigger("complete"),c.click()):(a.keyCode=d.keyCode.BACKSPACE,
...
(d.isNumeric=d.numericInput);("rtl"==b.dir||d.numericInput&&d.rightAlignNumerics||d.isNumeric&&d.rightAlignNumerics)&&s.css("text-align","right");if("rtl"==b.dir||d.numericInput){b.dir="ltr";s.removeAttr("dir");var A=s.data("_inputmask");A.isRTL=!0;s.data("_inputmask",A);x=!0}s.unbind(".inputmask");s.removeClass("focus.inputmask");s.closest("form").bind("submit",function(){L!=m().join("")&&s.change()}).bind("reset",function(){setTimeout(function(){s.trigger("setvalue")},0)});s.bind("mouseenter.inputmask",
function(){!e(this).hasClass("focus.inputmask")&&d.showMaskOnHover&&this._valueGet()!=m().join("")&&I(this,m())}).bind("blur.inputmask",function(){var b=e(this),f=this._valueGet(),g=m();b.removeClass("focus.inputmask");L!=m().join("")&&b.change();d.clearMaskOnLostFocus&&""!=f&&(f==t().join("")?this._valueSet(""):Z(this));!1===R(g)&&(b.trigger("incomplete"),d.clearIncomplete&&(e.each(a,function(a,d){"object"==typeof d&&(d.buffer=d._buffer.slice(),d.lastValidPosition=-1)}),c=0,d.clearMaskOnLostFocus?
this._valueSet(""):(g=t().slice(),I(this,g))))}).bind("focus.inputmask",function(){var a=e(this),b=this._valueGet();d.showMaskOnFocus&&!a.hasClass("focus.inputmask")&&(!d.showMaskOnHover||d.showMaskOnHover&&""==b)&&this._valueGet()!=m().join("")&&I(this,m(),p(f().lastValidPosition));a.addClass("focus.inputmask");L=m().join("")}).bind("mouseleave.inputmask",function(){var a=e(this);d.clearMaskOnLostFocus&&(a.hasClass("focus.inputmask")||this._valueGet()==a.attr("placeholder")||(this._valueGet()==t().join("")||
""==this._valueGet()?this._valueSet(""):Z(this)))}).bind("click.inputmask",function(){var a=this;setTimeout(function(){var b=w(a),c=m();if(b.begin==b.end){var b=x?K(b.begin):b.begin,g=f().lastValidPosition,c=d.isNumeric?!1===d.skipRadixDance&&""!=d.radixPoint&&-1!=e.inArray(d.radixPoint,c)?d.numericInput?p(e.inArray(d.radixPoint,c)):e.inArray(d.radixPoint,c):p(g):p(g);b<c?r(b)?w(a,b):w(a,p(b)):w(a,c)}},0)}).bind("dblclick.inputmask",function(){var a=this;setTimeout(function(){w(a,0,p(f().lastValidPosition))},
0)}).bind(Q+".inputmask dragdrop.inputmask drop.inputmask",la).bind("setvalue.inputmask",function(){J(this,!0);L=m().join("");this._valueGet()==t().join("")&&this._valueSet("")}).bind("complete.inputmask",d.oncomplete).bind("incomplete.inputmask",d.onincomplete).bind("cleared.inputmask",d.oncleared);s.bind("keydown.inputmask",$).bind("keypress.inputmask",W).bind("keyup.inputmask",ka);if(k||u||l||M)if(s.attr("autocomplete","off").attr("autocorrect","off").attr("autocapitalize","off").attr("spellcheck",
!1),u||M)s.unbind("keydown.inputmask",$).unbind("keypress.inputmask",W).unbind("keyup.inputmask",ka),"input"==Q&&s.unbind(Q+".inputmask"),s.bind("input.inputmask",pa);g&&s.bind("input.inputmask",la);A=e.isFunction(d.onBeforeMask)?d.onBeforeMask.call(b,b._valueGet(),d):b._valueGet();J(b,!0,!1,A.split(""));L=m().join("");var q;try{q=document.activeElement}catch(T){}q===b?(s.addClass("focus.inputmask"),w(b,p(f().lastValidPosition))):d.clearMaskOnLostFocus?m().join("")==t().join("")?b._valueSet(""):Z(b):
I(b,m());na(b)}}var x=!1,L=m().join(""),s,aa=!1,ba=!1,ja=!1;if(void 0!=b)switch(b.action){case "isComplete":return R(b.buffer);case "unmaskedvalue":return x=b.$input.data("_inputmask").isRTL,ma(b.$input,b.skipDatepickerCheck);case "mask":qa(b.el);break;case "format":return s=e({}),s.data("_inputmask",{masksets:a,activeMasksetIndex:c,opts:d,isRTL:d.numericInput}),d.numericInput&&(d.isNumeric=d.numericInput,x=!0),b=b.value.split(""),J(s,!1,!1,x?b.reverse():b,!0),x?m().reverse().join(""):m().join("");
case "isValid":return s=e({}),s.data("_inputmask",{masksets:a,activeMasksetIndex:c,opts:d,isRTL:d.numericInput}),d.numericInput&&(d.isNumeric=d.numericInput,x=!0),b=b.value.split(""),J(s,!1,!0,x?b.reverse():b),R(m())}};e.inputmask={defaults:{placeholder:"_",optionalmarker:{start:"[",end:"]"},quantifiermarker:{start:"{",end:"}"},groupmarker:{start:"(",end:")"},escapeChar:"\\",mask:null,oncomplete:e.noop,onincomplete:e.noop,oncleared:e.noop,repeat:0,greedy:!0,autoUnmask:!1,clearMaskOnLostFocus:!0,insertMode:!0,
...
urlpre8:/(ftp:\/\/|ftps:\/\/|http:\/\/|https:\/\/)/},definitions:{i:{validator:function(a,f,b,e,c){return!0},cardinality:8,prevalidator:function(){for(var a=[],f=0;8>f;f++)a[f]=function(){var a=f;return{validator:function(f,c,e,k,l){if(l.regex["urlpre"+(a+1)]){var u=f;0<a+1-f.length&&(u=c.join("").substring(0,a+1-f.length)+""+u);f=l.regex["urlpre"+(a+1)].test(u);if(!k&&!f){e-=a;for(k=0;k<l.defaultPrefix.length;k++)c[e]=l.defaultPrefix[k],e++;for(k=0;k<u.length-1;k++)c[e]=u[k],e++;return{pos:e}}return f}return!1},
...
f,b,g,c){var h=e.extend({},c,{digits:g?"*":c.digits});if(""==a)return!1;if(!g&&1>=b&&"0"===f[0]&&/[\d-]/.test(a)&&1==f.join("").length)return f[0]="",{pos:0};var k=g?f.slice(0,b):f.slice();k.splice(b,0,a);var k=k.join(""),l=e.inputmask.escapeRegex.call(this,c.groupSeparator),k=k.replace(RegExp(l,"g"),"");g&&k.lastIndexOf(c.radixPoint)==k.length-1&&(l=e.inputmask.escapeRegex.call(this,c.radixPoint),k=k.replace(RegExp(l,"g"),""));if(!g&&""==k)return!1;l=c.regex.number(h).test(k);if(!l&&(k+="0",l=c.regex.number(h).test(k),
!l)){l=k.lastIndexOf(c.groupSeparator);for(l=k.length-l;3>=l;l++)k+="0";l=c.regex.number(h).test(k);if(!l&&!g&&a==c.radixPoint&&(l=c.regex.number(h).test("0"+k+"0")))return f[b]="0",b++,{pos:b}}return!1==l||g||a==c.radixPoint?l:{pos:c.postFormat(f,b,"-"==a||"+"==a?!0:!1,c)}},cardinality:1,prevalidator:null}},insertMode:!0,autoUnmask:!1},integer:{regex:{number:function(a){var f=e.inputmask.escapeRegex.call(this,a.groupSeparator);return RegExp("^"+(a.allowPlus||a.allowMinus?"["+(a.allowPlus?"+":"")+
...
{min:b,max:d};if(0<e.length){var g=e[e.length-1].matches;b=g.pop();b.isGroup||(d=new h(!0),d.matches.push(b),b=d);g.push(b);g.push(f)}else b=a.matches.pop(),b.isGroup||(d=new h(!0),d.matches.push(b),b=d),a.matches.push(b),a.matches.push(f);break;default:0<e.length?e[e.length-1].matches.push(b):a.matches.push(b)}0<a.matches.length&&c.regexTokens.push(a)}function l(a,b){var c=!1;b&&(u+="(",M++);for(var d=0;d<a.matches.length;d++){var e=a.matches[d];if(!0==e.isGroup)c=l(e,!0);else if(!0==e.isQuantifier){var f=
a.matches.indexOf(e),f=a.matches[f-1],h=u;if(isNaN(e.quantifier.max)){for(;e.repeaterPart&&e.repeaterPart!=u&&e.repeaterPart.length>u.length&&!(c=l(f,!0)););(c=c||l(f,!0))&&(e.repeaterPart=u);u=h+e.quantifier.max}else{for(var g=0,k=e.quantifier.max-1;g<k&&!(c=l(f,!0));g++);u=h+"{"+e.quantifier.min+","+e.quantifier.max+"}"}}else if(void 0!=e.matches)for(f=0;f<e.length&&!(c=l(e[f],b));f++);else{if("["==e[0]){c=u;c+=e;for(g=0;g<M;g++)c+=")";c=RegExp("^("+c+")$");c=c.test(Q)}else for(f=0,h=e.length;f<
h;f++)if("\\"!=e[f]){c=u;c+=e.substr(0,f+1);c=c.replace(/\|$/,"");for(g=0;g<M;g++)c+=")";c=RegExp("^("+c+")$");if(c=c.test(Q))break}u+=e}if(c)break}b&&(u+=")",M--);return c}null==c.regexTokens&&k();g=e.slice();var u="";e=!1;var M=0;g.splice(b,0,a);var Q=g.join("");for(a=0;a<c.regexTokens.length&&!(h=c.regexTokens[a],e=l(h,h.isGroup));a++);return e},cardinality:1}}}})})(jQuery);
