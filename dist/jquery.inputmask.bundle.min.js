...
a.definitions[e],p=0==b.matches.length;f=void 0!=f?f:b.matches.length;if(d&&!g){for(var m=d.prevalidator,h=m?m.length:0,t=1;t<d.cardinality;t++){var l=h>=t?m[t-1]:[],I=l.validator,l=l.cardinality;b.matches.splice(f++,0,{fn:I?"string"==typeof I?RegExp(I):new function(){this.test=I}:/./,cardinality:l?l:1,optionality:b.isOptional,newBlockMarker:p,casing:d.casing,def:d.definitionSymbol||e,placeholder:d.placeholder})}b.matches.splice(f++,0,{fn:d.validator?"string"==typeof d.validator?RegExp(d.validator):
...
a.mask.mask?f(a.mask.mask.toString(),a.mask):f(a.mask.toString()));return c},g="function"===typeof ScriptEngineMajorVersion?ScriptEngineMajorVersion():10<=(new Function("/*@cc_on return @_jscript_version; @*/"))(),d=navigator.userAgent,h=null!==d.match(/iphone/i),n=null!==d.match(/android.*safari.*/i),y=null!==d.match(/android.*chrome.*/i),u=null!==d.match(/android.*firefox.*/i),J=/Kindle/i.test(d)||/Silk/i.test(d)||/KFTT/i.test(d)||/KFOT/i.test(d)||/KFJWA/i.test(d)||/KFJWI/i.test(d)||/KFSOWI/i.test(d)||
/KFTHWA/i.test(d)||/KFTHWI/i.test(d)||/KFAPWA/i.test(d)||/KFAPWI/i.test(d),K=a("paste")?"paste":a("input")?"input":"propertychange",r=function(a,b,f){function c(a,e,d){e=e||0;var g=[],m,v=0,h;do{if(!0===a&&b.validPositions[v]){var t=b.validPositions[v];h=t.match;m=t.locator.slice();g.push(null==h.fn?h.def:!0===d?t.input:h.placeholder||f.placeholder.charAt(v%f.placeholder.length))}else m=e>v?N(v,m,v-1)[0]:F(v,m,v-1),h=m.match,m=m.locator.slice(),g.push(null==h.fn?h.def:h.placeholder||f.placeholder.charAt(v%
f.placeholder.length));v++}while((void 0==L||v-1<L)&&null!=h.fn||null==h.fn&&""!=h.def||e>=v);g.pop();return g}function d(a){var e=b;e.buffer=void 0;e.tests={};!0!==a&&(e._buffer=void 0,e.validPositions={},e.p=-1)}function r(a){var e=-1,f=b.validPositions;void 0==a&&(a=-1);var d=e,c;for(c in f){var g=parseInt(c);if(-1==a||null!=f[g].match.fn)g<a&&(d=g),g>=a&&(e=g)}return 1<a-d||e<a?d:e}function m(a,d,c){if(f.insertMode&&void 0!=b.validPositions[a]&&void 0==c){c=e.extend(!0,{},b.validPositions);var g=
r(),h;for(h=a;h<=g;h++)delete b.validPositions[h];b.validPositions[a]=d;d=!0;for(h=a;h<=g;h++){a=c[h];if(void 0!=a){var v=null==a.match.fn?h+1:B(h);d=ea(v,a.match.def)?d&&!1!==P(v,a.input,!0,!0):!1}if(!d)break}if(!d)return b.validPositions=e.extend(!0,{},c),!1}else b.validPositions[a]=d;return!0}function t(a,e){var f,c=a;for(f=a;f<e;f++)delete b.validPositions[f];for(f=e;f<=r();){var g=b.validPositions[f],h=b.validPositions[c];void 0!=g&&void 0==h?(ea(c,g.match.def)&&!1!==P(c,g.input,!0)&&(delete b.validPositions[f],
f++),c++):f++}for(f=r();0<f&&(void 0==b.validPositions[f]||null==b.validPositions[f].match.fn);)delete b.validPositions[f],f--;d(!0)}function F(a,b,e){a=N(a,b,e);var d;for(b=0;b<a.length&&(d=a[b],!f.greedy&&(!d.match||!1!==d.match.optionality&&!1!==d.match.newBlockMarker||!0===d.match.optionalQuantifier));b++);return d}function w(a){return b.validPositions[a]?b.validPositions[a].match:N(a)[0].match}function ea(a,b){for(var e=!1,f=N(a),d=0;d<f.length;d++)if(f[d].match&&f[d].match.def==b){e=!0;break}return e}
function N(a,d,c){function g(b,d,c,G){function S(c,G,p){if(m==a&&void 0==c.matches)return t.push({match:c,locator:G.reverse()}),!0;if(void 0!=c.matches)if(c.isGroup&&!0!==p){if(c=S(b.matches[h+1],G))return!0}else if(c.isOptional){var l=c;if(c=g(c,d,G,p))c=t[t.length-1].match,(c=0==e.inArray(c,l.matches))&&(k=!0),m=a}else{if(!c.isAlternator)if(c.isQuantifier&&!0!==p)for(l=c,f.greedy=f.greedy&&isFinite(l.quantifier.max),p=0<d.length&&!0!==p?d.shift():0;p<(isNaN(l.quantifier.max)?p+1:l.quantifier.max)&&
m<=a;p++){var r=b.matches[e.inArray(l,b.matches)-1];if(c=S(r,[p].concat(G),!0))if(c=t[t.length-1].match,c.optionalQuantifier=p>l.quantifier.min-1,c=0==e.inArray(c,r.matches))if(p>l.quantifier.min-1){k=!0;m=a;break}else return!0;else return!0}else if(c=g(c,d,G,p))return!0}else m++}for(var h=0<d.length?d.shift():0;h<b.matches.length;h++)if(!0!==b.matches[h].isQuantifier){var p=S(b.matches[h],[h].concat(c),G);if(p&&m==a)return p;if(m>a)break}}var h=b.maskToken,m=d?c:0;c=d||[0];var t=[],k=!1;if(void 0==
...
!0));return b.buffer}function Z(a,e){var c=q().slice();if(!0===a)d(),a=0,e=c.length;else for(var g=a;g<e;g++)delete b.validPositions[g],delete b.tests[g];for(g=a;g<e;g++)c[g]!=f.skipOptionalPartCharacter&&P(g,c[g],!0,!0)}function la(a,b){switch(b.casing){case "upper":a=a.toUpperCase();break;case "lower":a=a.toLowerCase()}return a}function P(a,c,g,h){function l(a,c,g,ma){var h=!1;e.each(N(a),function(G,S){var k=S.match,v=c?1:0,l="";q();for(var V=k.cardinality;V>v;V--)l+=void 0==b.validPositions[a-
(V-1)]?U(a-(V-1)):b.validPositions[a-(V-1)].input;c&&(l+=c);h=null!=k.fn?k.fn.test(l,b,a,g,f):c!=k.def&&c!=f.skipOptionalPartCharacter||""==k.def?!1:{c:k.def,pos:a};if(!1!==h){v=void 0!=h.c?h.c:c;v=v==f.skipOptionalPartCharacter&&null===k.fn?k.def:v;l=a;void 0!=h.remove&&t(h.remove,h.remove+1);if(h.refreshFromBuffer){l=h.refreshFromBuffer;g=!0;Z(!0===l?l:l.start,l.end);if(void 0==h.pos&&void 0==h.c)return h.pos=r(),!1;l=void 0!=h.pos?h.pos:a;if(l!=a)return h=e.extend(h,P(l,v,!0)),!1}else if(!0!==
h&&void 0!=h.pos&&h.pos!=a&&(l=h.pos,Z(a,l),l!=a))return h=e.extend(h,P(l,v,!0)),!1;if(!0!=h&&void 0==h.pos&&void 0==h.c)return!1;0<G&&d(!0);m(l,e.extend({},S,{input:la(v,k)}),ma)||(h=!1);return!1}});return h}g=!0===g;for(var v=q(),k=a-1;-1<k&&(!b.validPositions[k]||null!=b.validPositions[k].fn);k--)if((!M(k)||v[k]!=U(k))&&1<N(k).length){l(k,v[k],!0);break}if(a>=Q())return!1;v=l(a,c,g,h);if(!g&&!1===v)if((k=b.validPositions[a])&&null==k.match.fn&&(k.match.def==c||c==f.skipOptionalPartCharacter))v=
{caret:B(a)};else if((f.insertMode||void 0==b.validPositions[B(a)])&&!M(a))for(var k=a+1,w=B(a);k<=w;k++)if(v=l(k,c,g,h),!1!==v){a=k;break}!0===v&&(v={pos:a});return v}function M(a){a=w(a);return null!=a.fn?a.fn:!1}function Q(){var a;L=s.prop("maxLength");-1==L&&(L=void 0);if(!1==f.greedy){var c;c=r();a=b.validPositions[c];var e=void 0!=a?a.locator.slice():void 0;for(c+=1;void 0==a||null!=a.match.fn||null==a.match.fn&&""!=a.match.def;c++)a=F(c,e,c-1),e=a.locator.slice();a=c}else a=q().length;return void 0==
L||a<L?a:L}function B(a){var b=Q();if(a>=b)return b;for(;++a<b&&!M(a)&&(!0!==f.nojumps||f.nojumpsThreshold>a););return a}function X(a){if(0>=a)return 0;for(;0<--a&&!M(a););return a}function E(a,b,c){a._valueSet(b.join(""));void 0!=c&&x(a,c)}function U(a,b){b=b||w(a);return b.placeholder||(null==b.fn?b.def:f.placeholder.charAt(a%f.placeholder.length))}function R(a,c,g,h,m){h=void 0!=h?h.slice():ka(a._valueGet()).split("");d();c&&a._valueSet("");e.each(h,function(c,d){if(!0===m){var f=b.p,f=-1==f?f:
X(f),h=-1==f?c:B(f);-1==e.inArray(d,C().slice(f+1,h))&&$.call(a,void 0,!0,d.charCodeAt(0),!1,g,c)}else $.call(a,void 0,!0,d.charCodeAt(0),!1,g,c),g=g||0<c&&c>b.p});c&&(c=f.onKeyPress.call(this,void 0,q(),0,f),Y(a,c),E(a,q(),e(a).is(":focus")?B(r(0)):void 0))}function da(a){return e.inputmask.escapeRegex.call(this,a)}function ka(a){return a.replace(RegExp("("+da(C().join(""))+")*$"),"")}function fa(a){if(a.data("_inputmask")&&!a.hasClass("hasDatepicker")){var c=[],d=b.validPositions,g;for(g in d)d[g].match&&
null!=d[g].match.fn&&c.push(d[g].input);c=(z?c.reverse():c).join("");d=(z?q().reverse():q()).join("");e.isFunction(f.onUnMask)&&(c=f.onUnMask.call(a,d,c,f));return c}return a[0]._valueGet()}function O(a){!z||"number"!=typeof a||f.greedy&&""==f.placeholder||(a=q().length-a);return a}function x(a,b,c){a=a.jquery&&0<a.length?a[0]:a;if("number"==typeof b){b=O(b);c=O(c);c="number"==typeof c?c:b;var d=e(a).data("_inputmask")||{};d.caret={begin:b,end:c};e(a).data("_inputmask",d);e(a).is(":visible")&&(a.scrollLeft=
...
e(this),b=e(this).data("_inputmask");return b?b.opts.autoUnmask?a.inputmask("unmaskedvalue"):d.call(this)!=C().join("")?d.call(this):"":d.call(this)},set:function(a){var b=e(this).data("_inputmask");b?(f.call(this,e.isFunction(b.opts.onBeforeMask)?b.opts.onBeforeMask.call(A,a,b.opts):a),e(this).triggerHandler("setvalue.inputmask")):f.call(this,a)}})}}else document.__lookupGetter__&&a.__lookupGetter__("value")?a._valueGet||(d=a.__lookupGetter__("value"),f=a.__lookupSetter__("value"),a._valueGet=function(){return z?
d.call(this).split("").reverse().join(""):d.call(this)},a._valueSet=function(a){f.call(this,z?a.split("").reverse().join(""):a)},a.__defineGetter__("value",function(){var a=e(this),b=e(this).data("_inputmask");return b?b.opts.autoUnmask?a.inputmask("unmaskedvalue"):d.call(this)!=C().join("")?d.call(this):"":d.call(this)}),a.__defineSetter__("value",function(a){var b=e(this).data("_inputmask");b?(f.call(this,e.isFunction(b.opts.onBeforeMask)?b.opts.onBeforeMask.call(A,a,b.opts):a),e(this).triggerHandler("setvalue.inputmask")):
f.call(this,a)})):(a._valueGet||(a._valueGet=function(){return z?this.value.split("").reverse().join(""):this.value},a._valueSet=function(a){this.value=z?a.split("").reverse().join(""):a}),b(a.type))}function ga(a,c,d){if(f.numericInput||z)c==f.keyCode.BACKSPACE?c=f.keyCode.DELETE:c==f.keyCode.DELETE&&(c=f.keyCode.BACKSPACE),z&&(a=d.end,d.end=d.begin,d.begin=a);c==f.keyCode.BACKSPACE&&1>=d.end-d.begin?d.begin=X(d.begin):c==f.keyCode.DELETE&&d.begin==d.end&&d.end++;t(d.begin,d.end);c=r(d.begin);b.p=
c<d.begin?B(c):d.begin}function Y(a,b,c){if(b&&b.refreshFromBuffer){var f=b.refreshFromBuffer;Z(!0===f?f:f.start,f.end);d(!0);void 0!=c&&(E(a,q()),x(a,b.caret||c.begin,b.caret||c.end))}}function ha(a){ca=!1;var c=this,d=e(c),g=a.keyCode,m=x(c);g==f.keyCode.BACKSPACE||g==f.keyCode.DELETE||h&&127==g||a.ctrlKey&&88==g?(a.preventDefault(),88==g&&(H=q().join("")),ga(c,g,m),E(c,q(),b.p),c._valueGet()==C().join("")&&d.trigger("cleared"),f.showTooltip&&d.prop("title",b.mask)):g==f.keyCode.END||g==f.keyCode.PAGE_DOWN?
setTimeout(function(){var b=B(r());f.insertMode||b!=Q()||a.shiftKey||b--;x(c,a.shiftKey?m.begin:b,b)},0):g==f.keyCode.HOME&&!a.shiftKey||g==f.keyCode.PAGE_UP?x(c,0,a.shiftKey?m.begin:0):g==f.keyCode.ESCAPE||90==g&&a.ctrlKey?(R(c,!0,!1,H.split("")),d.click()):g!=f.keyCode.INSERT||a.shiftKey||a.ctrlKey?!1!=f.insertMode||a.shiftKey||(g==f.keyCode.RIGHT?setTimeout(function(){var a=x(c);x(c,a.begin)},0):g==f.keyCode.LEFT&&setTimeout(function(){var a=x(c);x(c,z?a.begin+1:a.begin-1)},0)):(f.insertMode=!f.insertMode,
x(c,f.insertMode||m.begin!=Q()?m.begin:m.begin-1));var d=x(c),k=f.onKeyDown.call(this,a,q(),d.begin,f);Y(c,k,d);ia=-1!=e.inArray(g,f.ignorables)}function $(a,c,g,h,k,l){if(void 0==g&&ca)return!1;ca=!0;var t=e(this);a=a||window.event;g=c?g:a.which||a.charCode||a.keyCode;if(!(!0===c||a.ctrlKey&&a.altKey)&&(a.ctrlKey||a.metaKey||ia))return!0;if(g){!0!==c&&46==g&&!1==a.shiftKey&&","==f.radixPoint&&(g=44);var w,F;g=String.fromCharCode(g);c?(l=k?l:r()+1,w={begin:l,end:l}):w=x(this);if(l=z?1<w.begin-w.end||
1==w.begin-w.end&&f.insertMode:1<w.end-w.begin||1==w.end-w.begin&&f.insertMode)b.undoPositions=e.extend(!0,{},b.validPositions),ga(this,f.keyCode.DELETE,w),f.insertMode||(f.insertMode=!f.insertMode,m(w.begin,k),f.insertMode=!f.insertMode),l=!f.multi;b.writeOutBuffer=!0;w=z&&!l?w.end:w.begin;var n=P(w,g,k);!1!==n&&(!0!==n&&(w=void 0!=n.pos?n.pos:w,g=void 0!=n.c?n.c:g),d(!0),void 0!=n.caret?F=n.caret:(k=b.validPositions,F=void 0!=k[w+1]&&1<N(w+1,k[w].locator.slice(),w).length?w+1:B(w)),b.p=F);if(!1!==
...
c.begin,f),Y(this,a,c));for(var C in b.validPositions);}}function pa(a){var b=e(this),c=a.keyCode,g=q(),h=x(this);a=f.onKeyUp.call(this,a,g,h.begin,f);Y(this,a,h);c==f.keyCode.TAB&&f.showMaskOnFocus&&(b.hasClass("focus-inputmask")&&0==this._valueGet().length?(d(),g=q(),E(this,g),x(this,0),H=q().join("")):(E(this,g),x(this,O(0),O(Q()))))}function ja(a){if(!0===W&&"input"==a.type)return W=!1,!0;var b=e(this),c=this._valueGet();if("propertychange"==a.type&&this._valueGet().length<=Q())return!0;"paste"==
a.type&&(window.clipboardData&&window.clipboardData.getData?c=window.clipboardData.getData("Text"):a.originalEvent&&a.originalEvent.clipboardData&&a.originalEvent.clipboardData.getData&&(c=a.originalEvent.clipboardData.getData("text/plain")));a=e.isFunction(f.onBeforePaste)?f.onBeforePaste.call(this,c,f):c;R(this,!0,!1,a.split(""),!0);b.click();!0===T(q())&&b.trigger("complete");return!1}function qa(a){if(!0===W&&"input"==a.type)return W=!1,!0;var b=x(this),c=this._valueGet(),c=c.replace(RegExp("("+
da(C().join(""))+")*"),"");b.begin>c.length&&(x(this,c.length),b=x(this));1!=q().length-c.length||c.charAt(b.begin)==q()[b.begin]||c.charAt(b.begin+1)==q()[b.begin]||M(b.begin)||(a.keyCode=f.keyCode.BACKSPACE,ha.call(this,a));a.preventDefault()}function ra(a){s=e(a);if(s.is(":input")&&"number"!=s.attr("type")){s.data("_inputmask",{maskset:b,opts:f,isRTL:!1});f.showTooltip&&s.prop("title",b.mask);oa(a);("rtl"==a.dir||f.rightAlign)&&s.css("text-align","right");if("rtl"==a.dir||f.numericInput){a.dir=
"ltr";s.removeAttr("dir");var c=s.data("_inputmask");c.isRTL=!0;s.data("_inputmask",c);z=!0}s.unbind(".inputmask");s.removeClass("focus-inputmask");s.closest("form").bind("submit",function(){H!=q().join("")&&s.change();f.autoUnmask&&f.removeMaskOnSubmit&&s.inputmask("remove")}).bind("reset",function(){setTimeout(function(){s.trigger("setvalue")},0)});s.bind("mouseenter.inputmask",function(){!e(this).hasClass("focus-inputmask")&&f.showMaskOnHover&&this._valueGet()!=q().join("")&&E(this,q())}).bind("blur.inputmask",
function(){var a=e(this);if(a.data("_inputmask")){var b=this._valueGet(),c=q();a.removeClass("focus-inputmask");H!=q().join("")&&a.change();f.clearMaskOnLostFocus&&""!=b&&(b==C().join("")?this._valueSet(""):ba(this));!1===T(c)&&(a.trigger("incomplete"),f.clearIncomplete&&(d(),f.clearMaskOnLostFocus?this._valueSet(""):(c=C().slice(),E(this,c))))}}).bind("focus.inputmask",function(){var a=e(this),b=this._valueGet();f.showMaskOnFocus&&!a.hasClass("focus-inputmask")&&(!f.showMaskOnHover||f.showMaskOnHover&&
""==b)&&this._valueGet()!=q().join("")&&E(this,q(),B(r()));a.addClass("focus-inputmask");H=q().join("")}).bind("mouseleave.inputmask",function(){var a=e(this);f.clearMaskOnLostFocus&&(a.hasClass("focus-inputmask")||this._valueGet()==a.attr("placeholder")||(this._valueGet()==C().join("")||""==this._valueGet()?this._valueSet(""):ba(this)))}).bind("click.inputmask",function(){var a=this;e(a).is(":focus")&&setTimeout(function(){var b=x(a);if(b.begin==b.end){var b=z?O(b.begin):b.begin,c=r(b),c=B(c);b<
c?M(b)?x(a,b):x(a,B(b)):x(a,c)}},0)}).bind("dblclick.inputmask",function(){var a=this;setTimeout(function(){x(a,0,B(r()))},0)}).bind(K+".inputmask dragdrop.inputmask drop.inputmask",ja).bind("setvalue.inputmask",function(){R(this,!0);H=q().join("");this._valueGet()==C().join("")&&this._valueSet("")}).bind("complete.inputmask",f.oncomplete).bind("incomplete.inputmask",f.onincomplete).bind("cleared.inputmask",f.oncleared);s.bind("keydown.inputmask",ha).bind("keypress.inputmask",$).bind("keyup.inputmask",
pa);if(n||u||y||J)"input"==K&&s.unbind(K+".inputmask"),s.bind("input.inputmask",qa);g&&s.bind("input.inputmask",ja);c=e.isFunction(f.onBeforeMask)?f.onBeforeMask.call(a,a._valueGet(),f):a._valueGet();R(a,!0,!1,c.split(""),!0);H=q().join("");var h;try{h=document.activeElement}catch(m){}h===a?(s.addClass("focus-inputmask"),x(a,B(r()))):(!1===T(q())&&f.clearIncomplete&&d(),f.clearMaskOnLostFocus?q().join("")==C().join("")?a._valueSet(""):ba(a):E(a,q()));na(a)}}var z=!1,H,s,ca=!1,W=!1,ia=!1,L;if(void 0!=
a)switch(a.action){case "isComplete":return s=e(a.el),b=s.data("_inputmask").maskset,f=s.data("_inputmask").opts,T(a.buffer);case "unmaskedvalue":return s=a.$input,b=s.data("_inputmask").maskset,f=s.data("_inputmask").opts,z=a.$input.data("_inputmask").isRTL,fa(a.$input);case "mask":H=q().join("");ra(a.el);break;case "format":s=e({});s.data("_inputmask",{maskset:b,opts:f,isRTL:f.numericInput});f.numericInput&&(z=!0);var D=a.value.split("");R(s,!1,!1,z?D.reverse():D,!0);return z?q().reverse().join(""):
q().join("");case "isValid":s=e({});s.data("_inputmask",{maskset:b,opts:f,isRTL:f.numericInput});f.numericInput&&(z=!0);D=a.value.split("");R(s,!1,!0,z?D.reverse():D);var D=q(),sa=aa();D.length=sa;return T(D)&&a.value==D.join("");case "getemptymask":return s=e(a.el),b=s.data("_inputmask").maskset,f=s.data("_inputmask").opts,C();case "remove":var A=a.el;s=e(A);b=s.data("_inputmask").maskset;f=s.data("_inputmask").opts;A._valueSet(fa(s));s.unbind(".inputmask");s.removeClass("focus-inputmask");s.removeData("_inputmask");
Object.getOwnPropertyDescriptor&&(D=Object.getOwnPropertyDescriptor(A,"value"));D&&D.get?A._valueGet&&Object.defineProperty(A,"value",{get:A._valueGet,set:A._valueSet}):document.__lookupGetter__&&A.__lookupGetter__("value")&&A._valueGet&&(A.__defineGetter__("value",A._valueGet),A.__defineSetter__("value",A._valueSet));try{delete A._valueGet,delete A._valueSet}catch(ua){A._valueGet=void 0,A._valueSet=void 0}}};e.inputmask={defaults:{placeholder:"_",optionalmarker:{start:"[",end:"]"},quantifiermarker:{start:"{",
...
return r({action:"format",value:a},c(f),f)},isValid:function(a,d){var f=e.extend(!0,{},e.inputmask.defaults,d);b(f.alias,d,f);return r({action:"isValid",value:a},c(f),f)}};e.fn.inputmask=function(a,d,f,g,h){function n(a,b){var c=e(a),d;for(d in b){var f=c.data("inputmask-"+d.toLowerCase());void 0!=f&&(b[d]=f)}return b}f=f||r;g=g||"_inputmask";var m=e.extend(!0,{},e.inputmask.defaults,d),t;if("string"===typeof a)switch(a){case "mask":return b(m.alias,d,m),t=c(m),0==t.length?this:this.each(function(){f({action:"mask",
el:this},e.extend(!0,{},e.isArray(t)&&f===r?t[0]:t),n(this,m))});case "unmaskedvalue":return a=e(this),a.data(g)?f({action:"unmaskedvalue",$input:a}):a.val();case "remove":return this.each(function(){e(this).data(g)&&f({action:"remove",el:this})});case "getemptymask":return this.data(g)?f({action:"getemptymask",el:this}):"";case "hasMaskedValue":return this.data(g)?!this.data(g).opts.autoUnmask:!1;case "isComplete":return this.data(g)?f({action:"isComplete",buffer:this[0]._valueGet().split(""),el:this}):
!0;case "getmetadata":if(this.data(g))return t=this.data(g).maskset,t.metadata;break;case "_detectScope":return b(m.alias,d,m),void 0==h||b(h,d,m)||-1!=e.inArray(h,"mask unmaskedvalue remove getemptymask hasMaskedValue isComplete getmetadata _detectScope".split(" "))||(m.mask=h),e.isFunction(m.mask)&&(m.mask=m.mask.call(this,m)),e.isArray(m.mask);default:return b(m.alias,d,m),b(a,d,m)||(m.mask=a),t=c(m),void 0==t?this:this.each(function(){f({action:"mask",el:this},e.extend(!0,{},e.isArray(t)&&f===
r?t[0]:t),n(this,m))})}else{if("object"==typeof a)return m=e.extend(!0,{},e.inputmask.defaults,a),b(m.alias,a,m),t=c(m),void 0==t?this:this.each(function(){f({action:"mask",el:this},e.extend(!0,{},e.isArray(t)&&f===r?t[0]:t),n(this,m))});if(void 0==a)return this.each(function(){var a=e(this).attr("data-inputmask");if(a&&""!=a)try{var a=a.replace(RegExp("'","g"),'"'),c=e.parseJSON("{"+a+"}");e.extend(!0,c,d);m=e.extend(!0,{},e.inputmask.defaults,c);b(m.alias,c,m);m.alias=void 0;e(this).inputmask("mask",
m,f)}catch(g){}})}}}})(jQuery);
...
e.inArray(a.type,["keydown"])&&b.begin!=b.end&&n(h,b.begin,b.end);e(h).triggerHandler(a)});d&&setTimeout(function(){u(a.type,f)},0)});p.bind(K+" dragdrop drop setvalue",function(a){n(k);setTimeout(function(){e.each(f,function(b,c){c._valueSet(k.value);e(c).triggerHandler(a)});setTimeout(function(){u(a.type,f)},0)},0)});h(k.type)}var K=d("paste")?"paste":d("input")?"input":"propertychange",r,k,p,f,l;g.multi=!0;if(void 0!=a)switch(a.action){case "isComplete":return p=e(a.el),a=p.data("_inputmask-multi"),
a=a.elmasks[a.activeMasksetIndex],e(a).inputmask("isComplete");case "unmaskedvalue":return p=a.$input,a=p.data("_inputmask-multi"),a=a.elmasks[a.activeMasksetIndex],e(a).inputmask("unmaskedvalue");case "mask":J(a.el);break;case "format":return p=e({}),p.data("_inputmask",{maskset:maskset,opts:g,isRTL:g.numericInput}),g.numericInput&&(r=!0),a=a.value.split(""),checkVal(p,!1,!1,r?a.reverse():a,!0),r?getBuffer().reverse().join(""):getBuffer().join("");case "isValid":return p=e({}),p.data("_inputmask",
{maskset:maskset,opts:g,isRTL:g.numericInput}),g.numericInput&&(r=!0),a=a.value.split(""),checkVal(p,!1,!0,r?a.reverse():a),isComplete(getBuffer());case "getemptymask":return p=e(a.el),maskset=p.data("_inputmask").maskset,g=p.data("_inputmask").opts,getBufferTemplate();case "remove":k=a.el;p=e(k);maskset=p.data("_inputmask").maskset;g=p.data("_inputmask").opts;k._valueSet(unmaskedvalue(p));p.unbind(".inputmask");p.removeClass("focus-inputmask");p.removeData("_inputmask");var I;Object.getOwnPropertyDescriptor&&
(I=Object.getOwnPropertyDescriptor(k,"value"));I&&I.get?k._valueGet&&Object.defineProperty(k,"value",{get:k._valueGet,set:k._valueSet}):document.__lookupGetter__&&k.__lookupGetter__("value")&&k._valueGet&&(k.__defineGetter__("value",k._valueGet),k.__defineSetter__("value",k._valueSet));try{delete k._valueGet,delete k._valueSet}catch(ta){k._valueGet=void 0,k._valueSet=void 0}}};e.extend(e.inputmask.defaults,{multi:!1,determineActiveMasksetIndex:void 0});e.inputmask._fn=e.fn.inputmask;e.fn.inputmask=
...
{min:b,max:e};if(0<c.length){var n=c[c.length-1].matches;b=n.pop();b.isGroup||(e=new h(!0),e.matches.push(b),b=e);n.push(b);n.push(g)}else b=a.matches.pop(),b.isGroup||(e=new h(!0),e.matches.push(b),b=e),a.matches.push(b),a.matches.push(g);break;default:0<c.length?c[c.length-1].matches.push(b):a.matches.push(b)}0<a.matches.length&&d.regexTokens.push(a)}function y(a,b){var c=!1;b&&(u+="(",J++);for(var d=0;d<a.matches.length;d++){var g=a.matches[d];if(!0==g.isGroup)c=y(g,!0);else if(!0==g.isQuantifier){var h=
e.inArray(g,a.matches),h=a.matches[h-1],n=u;if(isNaN(g.quantifier.max)){for(;g.repeaterPart&&g.repeaterPart!=u&&g.repeaterPart.length>u.length&&!(c=y(h,!0)););(c=c||y(h,!0))&&(g.repeaterPart=u);u=n+g.quantifier.max}else{for(var m=0,t=g.quantifier.max-1;m<t&&!(c=y(h,!0));m++);u=n+"{"+g.quantifier.min+","+g.quantifier.max+"}"}}else if(void 0!=g.matches)for(h=0;h<g.length&&!(c=y(g[h],b));h++);else{if("["==g[0]){c=u;c+=g;for(m=0;m<J;m++)c+=")";c=RegExp("^("+c+")$");c=c.test(K)}else for(h=0,n=g.length;h<
n;h++)if("\\"!=g[h]){c=u;c+=g.substr(0,h+1);c=c.replace(/\|$/,"");for(m=0;m<J;m++)c+=")";c=RegExp("^("+c+")$");if(c=c.test(K))break}u+=g}if(c)break}b&&(u+=")",J--);return c}null==d.regexTokens&&n();g=b.buffer.slice();var u="";b=!1;var J=0;g.splice(c,0,a);var K=g.join("");for(a=0;a<d.regexTokens.length&&!(h=d.regexTokens[a],b=y(h,h.isGroup));a++);return b},cardinality:1}}}})})(jQuery);
