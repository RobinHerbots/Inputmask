...
this._valueGet=void 0}}});case "getemptymask":return this.data("_inputmask")?(t=this.data("_inputmask").maskset,t._buffer.join("")):"";case "hasMaskedValue":return this.data("_inputmask")?!this.data("_inputmask").opts.autoUnmask:!1;case "isComplete":return this.data("_inputmask")?(t=this.data("_inputmask").maskset,g=this.data("_inputmask").opts,u(t,g,{action:"isComplete",buffer:this[0]._valueGet().split(""),el:this})):!0;case "getmetadata":if(this.data("_inputmask"))return t=this.data("_inputmask").maskset,
t.metadata;break;default:return c(a,b,g)||(g.mask=a),t=k(g),void 0==t?this:this.each(function(){d.isArray(t)?n(this,t,f(this,g)):u(d.extend(!0,{},t),f(this,g),{action:"mask",el:this})})}else{if("object"==typeof a)return g=d.extend(!0,{},d.inputmask.defaults,a),c(g.alias,a,g),t=k(g),void 0==t?this:this.each(function(){d.isArray(t)?n(this,t,f(this,g)):u(d.extend(!0,{},t),f(this,g),{action:"mask",el:this})});if(void 0==a)return this.each(function(){var a=d(this).attr("data-inputmask");if(a&&""!=a)try{var a=
a.replace(RegExp("'","g"),'"'),f=d.parseJSON("{"+a+"}");d.extend(!0,f,b);g=d.extend(!0,{},d.inputmask.defaults,f);c(g.alias,f,g);g.alias=void 0;d(this).inputmask(g)}catch(k){}})}}}})(jQuery);
...
g;f++)if("\\"!=d[f]){c=r;c+=d.substr(0,f+1);c=c.replace(/\|$/,"");for(k=0;k<L;k++)c+=")";c=RegExp("^("+c+")$");if(c=c.test(M))break}r+=d}if(c)break}b&&(r+=")",L--);return c}null==b.regexTokens&&p();f=c.slice();var r="";c=!1;var L=0;f.splice(d,0,a);var M=f.join("");for(a=0;a<b.regexTokens.length&&!(g=b.regexTokens[a],c=C(g,g.isGroup));a++);return c},cardinality:1}}}})})(jQuery);
