...
c.tests[g].fn?c.tests[g].fn.test(I,A,a,h,f):b==E(e(),a,!0)||b==f.skipOptionalPartCharacter?{refresh:!0,c:E(e(),a,!0),pos:a}:!1}if(C=!0===C){var l=k(h,b(),A,C);!0===l&&(l={pos:h});return l}var w=[],l=!1,m=c,K=g().slice(),s=b().lastValidPosition,x=o(h),z=[];d.each(a,function(e,d){if("object"==typeof d){c=e;var f=h;if(m!=c){var j=b().lastValidPosition,B;if(j==s&&1<f-(void 0==s?-1:s))for(j=void 0==j?0:j;j<f&&!(B=k(j,b(),K[j],!0),!1===B);j++)if(u(g(),j,K[j],!0),!0===B&&(B={pos:j}),B=B.pos||j,void 0==b().lastValidPosition||
b().lastValidPosition<B)b().lastValidPosition=B;!r(f)&&b().lastValidPosition==x&&(!k(f,b(),A,C)&&a[m].lastValidPosition<f)&&(f=p(h),z.push(c))}if((void 0==b().lastValidPosition&&f==p(-1)||b().lastValidPosition>=(void 0==s?a[m].lastValidPosition-1:s))&&0<=f&&f<q()){l=k(f,b(),A,C);if(!1!==l&&(!0===l&&(l={pos:f}),B=l.pos||f,void 0==b().lastValidPosition||b().lastValidPosition<B))b().lastValidPosition=B;w.push({activeMasksetIndex:e,result:l})}}});c=m;return function(c,b){var e=!1;d.each(b,function(a,
b){if(e=-1==d.inArray(b.activeMasksetIndex,c)&&!1!==b.result)return!1});e&&(b=d.map(b,function(b){if(-1==d.inArray(b.activeMasksetIndex,c))return b;a[b.activeMasksetIndex].lastValidPosition=s}));return b}(z,w)}function k(){var e=c,f={activeMasksetIndex:0,lastValidPosition:-1};d.each(a,function(a,b){"object"==typeof b&&(void 0!=this.lastValidPosition&&this.lastValidPosition>f.lastValidPosition)&&(f.activeMasksetIndex=a,f.lastValidPosition=this.lastValidPosition)});c=-1!=f.lastValidPosition&&a[e].lastValidPosition==
...
break;case "lower":f=c.toLowerCase()}a[b]=f}function E(a,b,c){c&&(b=N(a,b));return a[b]}function N(a,b){for(var c;void 0==a[b]&&a.length<q();)for(c=0;void 0!==e()[c];)a.push(e()[c++]);return b}function J(a,b,c){a._valueSet(b.join(""));void 0!=c&&w(a,c)}function V(a,b,c){for(var f=q();b<c&&b<f;b++)u(a,b,E(e().slice(),b,!0))}function Q(a,b){var c=n(b);u(a,b,E(e(),c))}function L(f,g,h,j){j=void 0!=j?j.slice():W(f._valueGet()).split("");d.each(a,function(a,b){"object"==typeof b&&(b.buffer=b._buffer.slice(),
b.lastValidPosition=void 0,b.p=0)});!0!==h&&(c=0);g&&f._valueSet("");q();d.each(j,function(a,c){var j=b().lastValidPosition,k=b().p,k=void 0==j?a:k,j=void 0==j?-1:j;(h&&r(a)||(c!=E(e().slice(),a,!0)||r(a))&&-1==d.inArray(c,e().slice(j+1,k)))&&d(f).trigger("keypress",[!0,c.charCodeAt(0),g,h,a])});!0===h&&(b().lastValidPosition=o(b().p))}function X(a){return d.inputmask.escapeRegex.call(this,a)}function W(a){return a.replace(RegExp("("+X(e().join(""))+")*$"),"")}function Y(a){var b=g(),c=b.slice(),
e,f;for(f=c.length-1;0<=f;f--)if(e=n(f),h()[e].optionality)if(!r(f)||!j(f,b[f],!0))c.pop();else break;else break;J(a,c)}function Z(a,b){return h()&&(!0===b||!a.hasClass("hasDatepicker"))?d.map(g(),function(a,b){return r(b)&&j(b,a,!0)?a:null}).join(""):a[0]._valueGet()}function O(a){z&&"number"==typeof a&&(a=g().length-a);return a}function w(a,b,c){var e=a.jquery&&0<a.length?a[0]:a;if("number"==typeof b)b=O(b),c=O(c),d(a).is(":visible")&&(c="number"==typeof c?c:b,!1==f.insertMode&&b==c&&c++,e.setSelectionRange?
(e.selectionStart=b,e.selectionEnd=m?b:c):e.createTextRange&&(a=e.createTextRange(),a.collapse(!0),a.moveEnd("character",c),a.moveStart("character",b),a.select()));else{if(!d(a).is(":visible"))return{begin:0,end:0};e.setSelectionRange?(b=e.selectionStart,c=e.selectionEnd):document.selection&&document.selection.createRange&&(a=document.selection.createRange(),b=0-a.duplicate().moveStart("character",-1E5),c=b+a.text.length);b=O(b);c=O(c);return{begin:b,end:c}}}function R(b){var f=!1,h=0,g=c;d.each(a,
function(a,g){if("object"==typeof g){c=a;var d=o(q());if(void 0!=g.lastValidPosition&&g.lastValidPosition>=h&&g.lastValidPosition==d){for(var j=!0,k=0;k<=d;k++){var l=r(k),p=n(k);if(l&&(void 0==b[k]||b[k]==x(k))||!l&&b[k]!=e()[p]){j=!1;break}}if(f=f||j)return!1}h=g.lastValidPosition}});c=g;return f}function ea(a,b){return z?1<a-b||1==a-b&&f.insertMode:1<b-a||1==b-a&&f.insertMode}var z=!1,G=g().join(""),aa=!1;this.unmaskedvalue=function(a,b){z=a.data("_inputmask").isRTL;return Z(a,b)};this.isComplete=
function(a){return R(a)};this.mask=function(m){function A(a){a=d._data(a).events;d.each(a,function(a,b){d.each(b,function(a,b){if("inputmask"==b.namespace){var c=b.handler;b.handler=function(a){if(this.readOnly||this.disabled)a.preventDefault;else return c.apply(this,arguments)}}})})}function C(a){var b;Object.getOwnPropertyDescriptor&&(b=Object.getOwnPropertyDescriptor(a,"value"));if(b&&b.get){if(!a._valueGet){var c=b.get,e=b.set;a._valueGet=function(){return z?c.call(this).split("").reverse().join(""):
c.call(this)};a._valueSet=function(a){e.call(this,z?a.split("").reverse().join(""):a)};Object.defineProperty(a,"value",{get:function(){var a=d(this),b=d(this).data("_inputmask"),e=b.masksets,f=b.activeMasksetIndex;return b&&b.opts.autoUnmask?a.inputmask("unmaskedvalue"):c.call(this)!=e[f]._buffer.join("")?c.call(this):""},set:function(a){e.call(this,a);d(this).triggerHandler("setvalue.inputmask")}})}}else if(document.__lookupGetter__&&a.__lookupGetter__("value"))a._valueGet||(c=a.__lookupGetter__("value"),
e=a.__lookupSetter__("value"),a._valueGet=function(){return z?c.call(this).split("").reverse().join(""):c.call(this)},a._valueSet=function(a){e.call(this,z?a.split("").reverse().join(""):a)},a.__defineGetter__("value",function(){var a=d(this),b=d(this).data("_inputmask"),e=b.masksets,f=b.activeMasksetIndex;return b&&b.opts.autoUnmask?a.inputmask("unmaskedvalue"):c.call(this)!=e[f]._buffer.join("")?c.call(this):""}),a.__defineSetter__("value",function(a){e.call(this,a);d(this).triggerHandler("setvalue.inputmask")}));
else if(a._valueGet||(a._valueGet=function(){return z?this.value.split("").reverse().join(""):this.value},a._valueSet=function(a){this.value=z?a.split("").reverse().join(""):a}),void 0==d.valHooks.text||!0!=d.valHooks.text.inputmaskpatch)c=d.valHooks.text&&d.valHooks.text.get?d.valHooks.text.get:function(){return this.value},e=d.valHooks.text&&d.valHooks.text.set?d.valHooks.text.set:function(a){return this.value=a},jQuery.extend(d.valHooks,{text:{get:function(a){var b=d(a);if(b.data("_inputmask")){if(b.data("_inputmask").opts.autoUnmask)return b.inputmask("unmaskedvalue");
a=c.call(a);b=b.data("_inputmask");return a!=b.masksets[b.activeMasksetIndex]._buffer.join("")?a:""}return c.call(a)},set:function(a,b){var c=d(a),f=e.call(a,b);c.data("_inputmask")&&c.triggerHandler("setvalue.inputmask");return f},inputmaskpatch:!0}})}function M(a,c,f){for(var d=g();!r(a)&&0<=a-1;)a--;for(var k=a;k<c&&k<q();k++)if(r(k)){Q(d,k);var l=p(k),m=E(d,l);if(m!=x(l))if(l<q()&&!1!==j(k,m,!0)&&h()[n(k)].def==h()[n(l)].def)u(d,k,E(d,l),!0),l<c&&Q(d,l);else if(r(k))break}else Q(d,k);void 0!=
f&&u(d,o(c),f);if(!1==b().greedy){c=W(d.join("")).split("");d.length=c.length;k=0;for(f=d.length;k<f;k++)d[k]=c[k];0==d.length&&(b().buffer=e().slice())}return a}function N(a,c,f,d){for(var k=g();a<=c&&a<q();a++)if(r(a)){var l=E(k,a,!0);u(k,a,f,!0);if(l!=x(a))if(f=p(a),f<q())if(!1!==j(f,l,!0)&&h()[n(a)].def==h()[n(f)].def)f=l;else if(r(f))break;else f=l;else break;else if(f=l,!0!==d)break}else Q(k,a);d=k.length;if(!1==b().greedy){f=W(k.join("")).split("");k.length=f.length;a=0;for(l=k.length;a<l;a++)k[a]=
f[a];0==k.length&&(b().buffer=e().slice())}return c-(d-k.length)}function X(h){U=!1;var j=this,y=h.keyCode,m=w(j);if(y==f.keyCode.BACKSPACE||y==f.keyCode.DELETE||P&&127==y||h.ctrlKey&&88==y){h.preventDefault();if(f.numericInput||z)switch(y){case f.keyCode.BACKSPACE:y=f.keyCode.DELETE;break;case f.keyCode.DELETE:y=f.keyCode.BACKSPACE}if(ea(m.begin,m.end)){if(z){var u=m.end;m.end=m.begin;m.begin=u}V(g(),m.begin,m.end);if(0==m.begin&&m.end==q())d.each(a,function(a,b){"object"==typeof b&&(b.buffer=b._buffer.slice(),
b.lastValidPosition=void 0,b.p=0)});else{u=q();if(!1==f.greedy)M(m.begin,u);else for(var n=m.begin;n<m.end;n++)r(n)&&M(m.begin,u);L(j,!1,!0,g())}}else d.each(a,function(a,h){if("object"==typeof h){c=a;var d=l?m.end:m.begin,j=g(),k=p(-1),B=q();y==f.keyCode.BACKSPACE&&d--;d<k&&(d=k);d<B&&(f.isNumeric&&(""!=f.radixPoint&&j[d]==f.radixPoint)&&(d=j.length-1==d?d:p(d)),d=M(d,B),void 0!=b().lastValidPosition&&(-1!=b().lastValidPosition&&g()[b().lastValidPosition]==e()[b().lastValidPosition]&&(b().lastValidPosition=
0==b().lastValidPosition?-1:o(b().lastValidPosition)),b().lastValidPosition<k?(b().lastValidPosition=void 0,b().p=k):(b().writeOutBuffer=!0,b().p=d)))}});k();J(j,g(),b().p);j._valueGet()==e().join("")&&d(j).trigger("cleared");f.showTooltip&&s.prop("title",b().mask)}else y==f.keyCode.END||y==f.keyCode.PAGE_DOWN?setTimeout(function(){var a=p(b().lastValidPosition);!f.insertMode&&(a==q()&&!h.shiftKey)&&a--;w(j,h.shiftKey?m.begin:a,a)},0):y==f.keyCode.HOME&&!h.shiftKey||y==f.keyCode.PAGE_UP?w(j,0,h.shiftKey?
m.begin:0):y==f.keyCode.ESCAPE?L(j,!0,!0,G):y==f.keyCode.INSERT&&!h.shiftKey&&!h.ctrlKey?(f.insertMode=!f.insertMode,w(j,!f.insertMode&&m.begin==q()?m.begin-1:m.begin)):!1==f.insertMode&&!h.shiftKey&&(y==f.keyCode.RIGHT?setTimeout(function(){var a=w(j);w(j,a.begin)},0):y==f.keyCode.LEFT&&setTimeout(function(){var a=w(j);w(j,a.begin-1)},0));u=w(j);f.onKeyDown.call(this,h,g(),f);w(j,u.begin,u.end);ba=-1!=d.inArray(y,f.ignorables)}function Z(e,h,l,m,n,s){if(void 0==l&&U)return!1;U=!0;var K=d(this),e=
e||window.event,l=l||e.which||e.charCode||e.keyCode,A=String.fromCharCode(l);if((!e.ctrlKey||!e.altKey)&&(e.ctrlKey||e.metaKey||ba)&&!0!==h)return!0;if(l){var t,D,C;h?(l=n?s:b().p,t={begin:l,end:l}):t=w(this);var l=ea(t.begin,t.end),F=!1,s=c;l&&(z&&(D=t.end,t.end=t.begin,t.begin=D),d.each(a,function(a,e){if(typeof e=="object"){c=a;b().undoBuffer=g().join("");var d=t.end<q()?t.end:q();b().lastValidPosition>t.begin&&b().lastValidPosition<d?b().lastValidPosition=o(t.begin):F=true;V(g(),t.begin,d);var h=
q();if(f.greedy==false)M(t.begin,h);else for(var j=t.begin;j<d;j++)r(j)&&M(t.begin,h)}}),!0===F&&(c=s,L(this,!1,!0,g()),f.insertMode||d.each(a,function(a,e){if(typeof e=="object"){c=a;N(t.begin,q(),x(t.begin),true);b().lastValidPosition=p(b().lastValidPosition)}})),c=s);f.isNumeric&&(A==f.radixPoint&&!0!==h)&&(D=g().join("").indexOf(f.radixPoint),-1!=D&&(t.begin=t.begin==D?p(D):D,t.end=t.begin,w(this,t.begin)));var H=p(t.begin-1);D=j(H,A,n);!0===n&&(D=[{activeMasksetIndex:c,result:D}]);d.each(D,function(a,
e){c=e.activeMasksetIndex;b().writeOutBuffer=true;var d=e.result;if(d!==false){var h=false,j=g();if(d!==true){h=d.refresh;H=d.pos!=void 0?d.pos:H;A=d.c!=void 0?d.c:A}if(h!==true)if(f.insertMode==true){d=q();for(h=j.slice();E(h,d,true)!=x(d)&&d>=H;)d=d==0?-1:o(d);if(d>=H){N(H,j.length,A);j=b().lastValidPosition;d=p(j);d!=q()&&(j>=H&&E(g(),d)!=x(d))&&(b().lastValidPosition=d)}else b().writeOutBuffer=false}else u(j,H,A,true);b().p=p(H)}});!0!==n&&(c=s,k());if(!1!==m&&(d.each(D,function(a,b){if(b.activeMasksetIndex==
c){C=b;return false}}),void 0!=C)){var G=this;setTimeout(function(){f.onKeyValidation.call(G,C.result,f)},0);if(b().writeOutBuffer&&!1!==C.result){var I=g();J(this,I,h?void 0:f.numericInput?o(b().p):b().p);!0!==h&&setTimeout(function(){R(I)&&K.trigger("complete")},0)}else l&&(b().buffer=b().undoBuffer.split(""))}f.showTooltip&&K.prop("title",b().mask);e.preventDefault()}}function ga(a){var b=d(this),c=a.keyCode,h=g(),j=w(this);f.onKeyUp.call(this,a,h,f);w(this,j.begin,j.end);c==f.keyCode.TAB&&(b.hasClass("focus.inputmask")&&
0==this._valueGet().length&&f.showMaskOnFocus)&&(h=e().slice(),J(this,h),w(this,0),G=g().join(""))}var s=d(m);if(s.is(":input")){s.data("_inputmask",{masksets:a,activeMasksetIndex:c,opts:f,isRTL:!1});f.showTooltip&&s.prop("title",b().mask);b().greedy=b().greedy?b().greedy:0==b().repeat;if(null!=s.attr("maxLength")){var F=s.prop("maxLength");-1<F&&d.each(a,function(a,b){"object"==typeof b&&"*"==b.repeat&&(b.repeat=F)});q()>F&&-1<F&&(F<e().length&&(e().length=F),!1==b().greedy&&(b().repeat=Math.round(F/
e().length)),s.prop("maxLength",2*q()))}C(m);var U=!1,ba=!1;f.numericInput&&(f.isNumeric=f.numericInput);("rtl"==m.dir||f.numericInput&&f.rightAlignNumerics||f.isNumeric&&f.rightAlignNumerics)&&s.css("text-align","right");if("rtl"==m.dir||f.numericInput){m.dir="ltr";s.removeAttr("dir");var ca=s.data("_inputmask");ca.isRTL=!0;s.data("_inputmask",ca);z=!0}s.unbind(".inputmask");s.removeClass("focus.inputmask");s.closest("form").bind("submit",function(){G!=g().join("")&&s.change()}).bind("reset",function(){d.each(a,
function(a,b){if(typeof b=="object"){b.buffer=b._buffer.slice();b.lastValidPosition=void 0;b.p=-1}})});s.bind("mouseenter.inputmask",function(){!d(this).hasClass("focus.inputmask")&&f.showMaskOnHover&&this._valueGet()!=g().join("")&&J(this,g())}).bind("blur.inputmask",function(){var b=d(this),h=this._valueGet(),j=g();b.removeClass("focus.inputmask");G!=g().join("")&&b.change();f.clearMaskOnLostFocus&&h!=""&&(h==e().join("")?this._valueSet(""):Y(this));if(!R(j)){b.trigger("incomplete");if(f.clearIncomplete){d.each(a,
...
f.clearMaskOnLostFocus&&(a.hasClass("focus.inputmask")||(this._valueGet()==e().join("")||this._valueGet()==""?this._valueSet(""):Y(this)))}).bind("click.inputmask",function(){var a=this;setTimeout(function(){var c=w(a),e=g();if(c.begin==c.end){var c=f.isRTL?O(c.begin):c.begin,h=b().lastValidPosition,h=f.isNumeric?f.skipRadixDance===false&&f.radixPoint!=""&&d.inArray(f.radixPoint,e)!=-1?f.numericInput?p(d.inArray(f.radixPoint,e)):d.inArray(f.radixPoint,e):p(h==void 0?-1:h):p(h==void 0?-1:h);w(a,!aa&&
c<h&&(j(c,e[c],true)!==false||!r(c))?c:h);aa=false}},0)}).bind("dblclick.inputmask",function(){var a=this;b().lastValidPosition!=void 0&&setTimeout(function(){w(a,0,p(b().lastValidPosition))},0)}).bind("keydown.inputmask",X).bind("keypress.inputmask",Z).bind("keyup.inputmask",ga).bind(K+".inputmask dragdrop.inputmask drop.inputmask",function(a){var b=this,c=d(b);if(a.type=="propertychange"&&b._valueGet().length<=q())return true;setTimeout(function(){L(b,true,false);R(g())&&c.trigger("complete");c.click()},
0)}).bind("setvalue.inputmask",function(){L(this,true);G=g().join("");this._valueGet()==e().join("")&&this._valueSet("")}).bind("complete.inputmask",f.oncomplete).bind("incomplete.inputmask",f.onincomplete).bind("cleared.inputmask",f.oncleared);L(m,!0,!1);G=g().join("");var da;try{da=document.activeElement}catch(ha){}da===m?(s.addClass("focus.inputmask"),w(m,b().p)):f.clearMaskOnLostFocus?g().join("")==e().join("")?m._valueSet(""):Y(m):J(m,g());A(m)}};return this}var f=d.extend(!0,{},d.inputmask.defaults,
h),P=null!==navigator.userAgent.match(/iphone/i),m=null!==navigator.userAgent.match(/android.*safari.*/i),K=b("paste")?"paste":b("input")?"input":"propertychange",l,k,p=0;if(m){var u=navigator.userAgent.match(/safari.*/i);l=537>=parseInt(RegExp(/[0-9]+/).exec(u))}if("string"===typeof a)switch(a){case "mask":return e(f.alias,h),k=j(),this.each(function(){o(d.extend(!0,{},k),0).mask(this)});case "unmaskedvalue":return u=d(this),u.data("_inputmask")?(k=u.data("_inputmask").masksets,p=u.data("_inputmask").activeMasksetIndex,
f=u.data("_inputmask").opts,o(k,p).unmaskedvalue(u)):u.val();case "remove":return this.each(function(){var a=d(this);if(a.data("_inputmask")){k=a.data("_inputmask").masksets;p=a.data("_inputmask").activeMasksetIndex;f=a.data("_inputmask").opts;this._valueSet(o(k,p).unmaskedvalue(a,!0));a.removeData("_inputmask");a.unbind(".inputmask");a.removeClass("focus.inputmask");var b;Object.getOwnPropertyDescriptor&&(b=Object.getOwnPropertyDescriptor(this,"value"));b&&b.get?this._valueGet&&Object.defineProperty(this,
"value",{get:this._valueGet,set:this._valueSet}):document.__lookupGetter__&&this.__lookupGetter__("value")&&this._valueGet&&(this.__defineGetter__("value",this._valueGet),this.__defineSetter__("value",this._valueSet));try{delete this._valueGet,delete this._valueSet}catch(c){this._valueSet=this._valueGet=void 0}}});case "getemptymask":return this.data("_inputmask")?(k=this.data("_inputmask").masksets,p=this.data("_inputmask").activeMasksetIndex,k[p]._buffer.join("")):"";case "hasMaskedValue":return this.data("_inputmask")?
!this.data("_inputmask").opts.autoUnmask:!1;case "isComplete":return k=this.data("_inputmask").masksets,p=this.data("_inputmask").activeMasksetIndex,f=this.data("_inputmask").opts,o(k,p).isComplete(this[0]._valueGet().split(""));case "getmetadata":if(this.data("_inputmask"))return k=this.data("_inputmask").masksets,p=this.data("_inputmask").activeMasksetIndex,k[p].metadata;return;default:return e(a,h)||(f.mask=a),k=j(),this.each(function(){o(d.extend(true,{},k),p).mask(this)})}else{if("object"==typeof a)return f=
d.extend(!0,{},d.inputmask.defaults,a),e(f.alias,a),k=j(),this.each(function(){o(d.extend(!0,{},k),p).mask(this)});if(void 0==a)return this.each(function(){var a=d(this).attr("data-inputmask");if(a&&""!=a)try{var a=a.replace(RegExp("'","g"),'"'),b=d.parseJSON("{"+a+"}");d.extend(!0,b,h);f=d.extend(!0,{},d.inputmask.defaults,b);e(f.alias,b);f.alias=void 0;d(this).inputmask(f)}catch(c){}})}return this})})(jQuery);
