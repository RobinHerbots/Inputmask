...
a,e.lastValidPosition=b().lastValidPosition,e.next=p(b().lastValidPosition)))});c=-1!=e.lastValidPosition&&a[g].lastValidPosition==e.lastValidPosition?g:e.activeMasksetIndex;g!=c&&(V(h(),p(e.lastValidPosition),t()),b().writeOutBuffer=!0);w.data("_inputmask").activeMasksetIndex=c}function v(a){a=n(a);a=f()[a];return void 0!=a?a.fn:!1}function n(a){return a%f().length}function t(){return g.getMaskLength(e(),b().greedy,b().repeat,h(),g)}function p(a){var b=t();if(a>=b)return b;for(;++a<b&&!v(a););return a}
function q(a){if(0>=a)return 0;for(;0<--a&&!v(a););return a}function r(a,b,c,e){e&&(b=M(a,b));e=f()[n(b)];var h=c;if(void 0!=h)switch(e.casing){case "upper":h=c.toUpperCase();break;case "lower":h=c.toLowerCase()}a[b]=h}function H(a,b,c){c&&(b=M(a,b));return a[b]}function M(a,b){for(var c;void 0==a[b]&&a.length<t();)for(c=0;void 0!==e()[c];)a.push(e()[c++]);return b}function L(a,b,c){a._valueSet(b.join(""));void 0!=c&&y(a,c)}function V(a,b,c){for(var h=t();b<c&&b<h;b++)r(a,b,H(e().slice(),b,!0))}function Q(a,
b){var c=n(b);r(a,b,H(e(),c))}function O(h,g,f,k){k=void 0!=k?k.slice():W(h._valueGet()).split("");d.each(a,function(a,b){"object"==typeof b&&(b.buffer=b._buffer.slice(),b.lastValidPosition=-1,b.p=-1)});!0!==f&&(c=0);g&&h._valueSet("");t();d.each(k,function(a,c){var k=b().lastValidPosition,l=-1==k?a:p(k);(f&&v(a)||(c!=H(e().slice(),a,!0)||v(a))&&-1==d.inArray(c,e().slice(k+1,l)))&&d(h).trigger("_keypress",[!0,c.charCodeAt(0),g,f,a])});!0===f&&-1!=b().p&&(b().lastValidPosition=q(b().p))}function X(a){return d.inputmask.escapeRegex.call(this,
...
b=0-a.duplicate().moveStart("character",-1E5),c=b+a.text.length);b=J(b);c=J(c);return{begin:b,end:c}}}function R(b){var h=!1,g=0,f=c;d.each(a,function(a,f){if("object"==typeof f){c=a;var d=q(t());if(f.lastValidPosition>=g&&f.lastValidPosition==d){for(var k=!0,l=0;l<=d;l++){var m=v(l),p=n(l);if(m&&(void 0==b[l]||b[l]==D(l))||!m&&b[l]!=e()[p]){k=!1;break}}if(h=h||k)return!1}g=f.lastValidPosition}});c=f;return h}function ga(a,b){return E?1<a-b||1==a-b&&g.insertMode:1<b-a||1==b-a&&g.insertMode}var E=
...
{text:{get:function(a){var b=d(a);if(b.data("_inputmask")){if(b.data("_inputmask").opts.autoUnmask)return b.inputmask("unmaskedvalue");a=c.call(a);b=b.data("_inputmask");return a!=b.masksets[b.activeMasksetIndex]._buffer.join("")?a:""}return c.call(a)},set:function(a,b){var c=d(a),h=e.call(a,b);c.data("_inputmask")&&c.triggerHandler("setvalue.inputmask");return h},inputmaskpatch:!0}})}function P(a,c,g){for(var d=h();!v(a)&&0<=a-1;)a--;for(var l=a;l<c&&l<t();l++)if(v(l)){Q(d,l);var m=p(l),s=H(d,m);
if(s!=D(m))if(m<t()&&!1!==k(l,s,!0)&&f()[n(l)].def==f()[n(m)].def)r(d,l,H(d,m),!0),m<c&&Q(d,m);else if(v(l))break}else Q(d,l);void 0!=g&&r(d,q(c),g);if(!1==b().greedy){c=W(d.join("")).split("");d.length=c.length;l=0;for(g=d.length;l<g;l++)d[l]=c[l];0==d.length&&(b().buffer=e().slice())}return a}function ea(a,c,g,d){for(var l=h();a<=c&&a<t();a++)if(v(a)){var m=H(l,a,!0);r(l,a,g,!0);if(m!=D(a))if(g=p(a),g<t())if(!1!==k(g,m,!0)&&f()[n(a)].def==f()[n(g)].def)g=m;else if(v(g))break;else g=m;else break;
else if(g=m,!0!==d)break}else Q(l,a);d=l.length;if(!1==b().greedy){g=W(l.join("")).split("");l.length=g.length;a=0;for(m=l.length;a<m;a++)l[a]=g[a];0==l.length&&(b().buffer=e().slice())}return c-(d-l.length)}function X(f){U=!1;var k=this,s=d(k),r=f.keyCode,u=y(k);if(r==g.keyCode.BACKSPACE||r==g.keyCode.DELETE||N&&127==r||f.ctrlKey&&88==r){f.preventDefault();if(g.numericInput||E)switch(r){case g.keyCode.BACKSPACE:r=g.keyCode.DELETE;break;case g.keyCode.DELETE:r=g.keyCode.BACKSPACE}if(ga(u.begin,u.end)){if(E){var n=
u.end;u.end=u.begin;u.begin=n}V(h(),u.begin,u.end);if(0==u.begin&&u.end==t())d.each(a,function(a,b){"object"==typeof b&&(b.buffer=b._buffer.slice(),b.lastValidPosition=-1)});else{n=t();if(!1==g.greedy)P(u.begin,n);else for(var w=u.begin;w<u.end;w++)v(w)&&P(u.begin,n);n=p(-1);O(k,!1,!0,h());b().lastValidPosition<n?(b().lastValidPosition=-1,b().p=n):(b().writeOutBuffer=!0,b().p=u.begin)}}else d.each(a,function(a,f){if("object"==typeof f){c=a;var d=m?u.end:u.begin,k=h(),l=p(-1),A=t();r==g.keyCode.BACKSPACE&&
d--;d<l&&(d=l);d<A&&(g.isNumeric&&""!=g.radixPoint&&k[d]==g.radixPoint&&(d=k.length-1==d?d:p(d)),d=P(d,A),-1!=b().lastValidPosition&&h()[b().lastValidPosition]==e()[b().lastValidPosition]&&(b().lastValidPosition=0==b().lastValidPosition?-1:q(b().lastValidPosition)),b().lastValidPosition<l?(b().lastValidPosition=-1,b().p=l):(b().writeOutBuffer=!0,b().p=d))}});l();L(k,h(),b().p);k._valueGet()==e().join("")&&s.trigger("cleared");g.showTooltip&&s.prop("title",b().mask)}else r==g.keyCode.END||r==g.keyCode.PAGE_DOWN?
setTimeout(function(){var a=p(b().lastValidPosition);g.insertMode||a!=t()||f.shiftKey||a--;y(k,f.shiftKey?u.begin:a,a)},0):r==g.keyCode.HOME&&!f.shiftKey||r==g.keyCode.PAGE_UP?y(k,0,f.shiftKey?u.begin:0):r==g.keyCode.ESCAPE?(O(k,!0,!0,K),s.click()):r!=g.keyCode.INSERT||f.shiftKey||f.ctrlKey?!1!=g.insertMode||f.shiftKey||(r==g.keyCode.RIGHT?setTimeout(function(){var a=y(k);y(k,a.begin)},0):r==g.keyCode.LEFT&&setTimeout(function(){var a=y(k);y(k,a.begin-1)},0)):(g.insertMode=!g.insertMode,y(k,g.insertMode||
u.begin!=t()?u.begin:u.begin-1));s=y(k);g.onKeyDown.call(this,f,h(),g);y(k,s.begin,s.end);ba=-1!=d.inArray(r,g.ignorables)}function fa(e,f,m,s,u,n){if(void 0==m&&U)return!1;U=!0;var w=d(this);e=e||window.event;m=m||e.which||e.charCode||e.keyCode;if((!e.ctrlKey||!e.altKey)&&(e.ctrlKey||e.metaKey||ba)&&!0!==f)return!0;if(m){!0!==f&&46==m&&!1==e.shiftKey&&","==g.radixPoint&&(m=44);var x,G,B,C=String.fromCharCode(m);f?(m=u?n:b().lastValidPosition+1,x={begin:m,end:m}):x=y(this);m=ga(x.begin,x.end);var K=
!1;n=c;m&&(E&&(G=x.end,x.end=x.begin,x.begin=G),d.each(a,function(a,e){if("object"==typeof e){c=a;b().undoBuffer=h().join("");var f=x.end<t()?x.end:t();b().lastValidPosition>x.begin&&b().lastValidPosition<f?b().lastValidPosition=q(x.begin):K=!0;V(h(),x.begin,f);var d=t();if(!1==g.greedy)P(x.begin,d);else for(var k=x.begin;k<f;k++)v(k)&&P(x.begin,d)}}),!0===K&&(c=n,O(this,!1,!0,h()),g.insertMode||d.each(a,function(a,e){"object"==typeof e&&(c=a,ea(x.begin,t(),D(x.begin),!0),b().lastValidPosition=p(b().lastValidPosition))})),
c=n);var J=h().join("").indexOf(g.radixPoint);g.isNumeric&&!0!==f&&-1!=J&&(g.greedy&&x.begin<=J?(x.begin=q(x.begin),x.end=x.begin):C==g.radixPoint&&(x.begin=J,x.end=x.begin));var F=x.begin;G=k(F,C,u);!0===u&&(G=[{activeMasksetIndex:c,result:G}]);var I=-1;d.each(G,function(a,e){c=e.activeMasksetIndex;b().writeOutBuffer=!0;var f=e.result;if(!1!==f){var d=!1,k=h();!0!==f&&(d=f.refresh,F=void 0!=f.pos?f.pos:F,C=void 0!=f.c?f.c:C);if(!0!==d){if(!0==g.insertMode){f=t();for(d=k.slice();H(d,f,!0)!=D(f)&&
f>=F;)f=0==f?-1:q(f);f>=F?(ea(F,k.length,C),k=b().lastValidPosition,f=p(k),f!=t()&&k>=F&&H(h(),f,!0)!=D(f)&&(b().lastValidPosition=f)):b().writeOutBuffer=!1}else r(k,F,C,!0);if(-1==I||I>p(F))I=p(F)}else if(k=F<t()?F+1:F,-1==I||I>k)I=k;b().p=I}});!0!==u&&(c=n,l());if(!1!==s&&(d.each(G,function(a,b){if(b.activeMasksetIndex==c)return B=b,!1}),void 0!=B)){var N=this;setTimeout(function(){g.onKeyValidation.call(N,B.result,g)},0);if(b().writeOutBuffer&&!1!==B.result){var M=h();s=f?void 0:g.numericInput?
F>J?q(I):C==g.radixPoint?I-1:q(I-1):I;L(this,M,s);!0!==f&&setTimeout(function(){R(M)&&w.trigger("complete")},0)}else m&&(b().buffer=b().undoBuffer.split(""))}g.showTooltip&&w.prop("title",b().mask);e.preventDefault()}}function Z(a){var b=d(this),c=a.keyCode,f=h(),k=y(this);g.onKeyUp.call(this,a,f,g);y(this,k.begin,k.end);c==g.keyCode.TAB&&b.hasClass("focus.inputmask")&&0==this._valueGet().length&&g.showMaskOnFocus&&(f=e().slice(),L(this,f),y(this,0),K=h().join(""))}w=d(s);if(w.is(":input")){w.data("_inputmask",
{masksets:a,activeMasksetIndex:c,opts:g,isRTL:!1});g.showTooltip&&w.prop("title",b().mask);b().greedy=b().greedy?b().greedy:0==b().repeat;if(null!=w.attr("maxLength")){var B=w.prop("maxLength");-1<B&&d.each(a,function(a,b){"object"==typeof b&&"*"==b.repeat&&(b.repeat=B)});t()>B&&-1<B&&(B<e().length&&(e().length=B),!1==b().greedy&&(b().repeat=Math.round(B/e().length)),w.prop("maxLength",2*t()))}C(s);var U=!1,ba=!1;g.numericInput&&(g.isNumeric=g.numericInput);("rtl"==s.dir||g.numericInput&&g.rightAlignNumerics||
g.isNumeric&&g.rightAlignNumerics)&&w.css("text-align","right");if("rtl"==s.dir||g.numericInput){s.dir="ltr";w.removeAttr("dir");var ca=w.data("_inputmask");ca.isRTL=!0;w.data("_inputmask",ca);E=!0}w.unbind(".inputmask");w.removeClass("focus.inputmask");w.closest("form").bind("submit",function(){K!=h().join("")&&w.change()}).bind("reset",function(){d.each(a,function(a,b){"object"==typeof b&&(b.buffer=b._buffer.slice(),b.lastValidPosition=-1)})});w.bind("mouseenter.inputmask",function(){!d(this).hasClass("focus.inputmask")&&
g.showMaskOnHover&&this._valueGet()!=h().join("")&&L(this,h())}).bind("blur.inputmask",function(){var b=d(this),f=this._valueGet(),k=h();b.removeClass("focus.inputmask");K!=h().join("")&&b.change();g.clearMaskOnLostFocus&&""!=f&&(f==e().join("")?this._valueSet(""):Y(this));R(k)||(b.trigger("incomplete"),g.clearIncomplete&&(d.each(a,function(a,b){"object"==typeof b&&(b.buffer=b._buffer.slice(),b.lastValidPosition=-1)}),c=0,g.clearMaskOnLostFocus?this._valueSet(""):(k=e().slice(),L(this,k))))}).bind("focus.inputmask",
function(){var a=d(this),c=this._valueGet();g.showMaskOnFocus&&!a.hasClass("focus.inputmask")&&(!g.showMaskOnHover||g.showMaskOnHover&&""==c)&&this._valueGet()!=h().join("")&&L(this,h(),p(b().lastValidPosition));a.addClass("focus.inputmask");K=h().join("")}).bind("mouseleave.inputmask",function(){var a=d(this);g.clearMaskOnLostFocus&&(a.hasClass("focus.inputmask")||this._valueGet()==a.attr("placeholder")||(this._valueGet()==e().join("")||""==this._valueGet()?this._valueSet(""):Y(this)))}).bind("click.inputmask",
function(){var a=this;setTimeout(function(){var c=y(a),e=h();if(c.begin==c.end){var c=g.isRTL?J(c.begin):c.begin,f=b().lastValidPosition,e=g.isNumeric?!1===g.skipRadixDance&&""!=g.radixPoint&&-1!=d.inArray(g.radixPoint,e)?g.numericInput?p(d.inArray(g.radixPoint,e)):d.inArray(g.radixPoint,e):p(f):p(f);c<e?v(c)?y(a,c):y(a,p(c)):y(a,e)}},0)}).bind("dblclick.inputmask",function(){var a=this;setTimeout(function(){y(a,0,p(b().lastValidPosition))},0)}).bind("keydown.inputmask",X).bind("keypress.inputmask",
fa).bind("keyup.inputmask",Z).bind(G+".inputmask dragdrop.inputmask drop.inputmask",function(a){var b=this,c=d(b);if("propertychange"==a.type&&b._valueGet().length<=t())return!0;setTimeout(function(){O(b,!0,!1);R(h())&&c.trigger("complete");c.click()},0)}).bind("setvalue.inputmask",function(){O(this,!0);K=h().join("");this._valueGet()==e().join("")&&this._valueSet("")}).bind("_keypress.inputmask",fa).bind("complete.inputmask",g.oncomplete).bind("incomplete.inputmask",g.onincomplete).bind("cleared.inputmask",
g.oncleared);O(s,!0,!1);K=h().join("");var da;try{da=document.activeElement}catch(ha){}da===s?(w.addClass("focus.inputmask"),y(s,p(b().lastValidPosition))):g.clearMaskOnLostFocus?h().join("")==e().join("")?s._valueSet(""):Y(s):L(s,h());M(s)}};return this}var g=d.extend(!0,{},d.inputmask.defaults,f),N=null!==navigator.userAgent.match(/iphone/i),s=null!==navigator.userAgent.match(/android.*safari.*/i),G=b("paste")?"paste":b("input")?"input":"propertychange",m,l,p=0;if(s){var r=navigator.userAgent.match(/safari.*/i);
m=537>=parseInt(RegExp(/[0-9]+/).exec(r))}if("string"===typeof a)switch(a){case "mask":return e(g.alias,f),l=k(),this.each(function(){q(d.extend(!0,{},l),0).mask(this)});case "unmaskedvalue":return r=d(this),r.data("_inputmask")?(l=r.data("_inputmask").masksets,p=r.data("_inputmask").activeMasksetIndex,g=r.data("_inputmask").opts,q(l,p).unmaskedvalue(r)):r.val();case "remove":return this.each(function(){var a=d(this);if(a.data("_inputmask")){l=a.data("_inputmask").masksets;p=a.data("_inputmask").activeMasksetIndex;
g=a.data("_inputmask").opts;this._valueSet(q(l,p).unmaskedvalue(a,!0));a.removeData("_inputmask");a.unbind(".inputmask");a.removeClass("focus.inputmask");var b;Object.getOwnPropertyDescriptor&&(b=Object.getOwnPropertyDescriptor(this,"value"));b&&b.get?this._valueGet&&Object.defineProperty(this,"value",{get:this._valueGet,set:this._valueSet}):document.__lookupGetter__&&this.__lookupGetter__("value")&&this._valueGet&&(this.__defineGetter__("value",this._valueGet),this.__defineSetter__("value",this._valueSet));
try{delete this._valueGet,delete this._valueSet}catch(c){this._valueSet=this._valueGet=void 0}}});case "getemptymask":return this.data("_inputmask")?(l=this.data("_inputmask").masksets,p=this.data("_inputmask").activeMasksetIndex,l[p]._buffer.join("")):"";case "hasMaskedValue":return this.data("_inputmask")?!this.data("_inputmask").opts.autoUnmask:!1;case "isComplete":return l=this.data("_inputmask").masksets,p=this.data("_inputmask").activeMasksetIndex,g=this.data("_inputmask").opts,q(l,p).isComplete(this[0]._valueGet().split(""));
case "getmetadata":if(this.data("_inputmask"))return l=this.data("_inputmask").masksets,p=this.data("_inputmask").activeMasksetIndex,l[p].metadata;return;default:return e(a,f)||(g.mask=a),l=k(),this.each(function(){q(d.extend(!0,{},l),p).mask(this)})}else{if("object"==typeof a)return g=d.extend(!0,{},d.inputmask.defaults,a),e(g.alias,a),l=k(),this.each(function(){q(d.extend(!0,{},l),p).mask(this)});if(void 0==a)return this.each(function(){var a=d(this).attr("data-inputmask");if(a&&""!=a)try{var a=
a.replace(RegExp("'","g"),'"'),b=d.parseJSON("{"+a+"}");d.extend(!0,b,f);g=d.extend(!0,{},d.inputmask.defaults,b);e(g.alias,b);g.alias=void 0;d(this).inputmask(g)}catch(c){}})}return this})})(jQuery);
...
(function(d){d.extend(d.inputmask.defaults.aliases,{decimal:{mask:"~",placeholder:"",repeat:"*",greedy:!1,numericInput:!1,isNumeric:!0,digits:"*",groupSeparator:"",radixPoint:".",groupSize:3,autoGroup:!1,allowPlus:!0,allowMinus:!0,getMaskLength:function(a,f,b,e,c){var h=a.length;f||("*"==b?h=e.length+1:1<b&&(h+=a.length*(b-1)));a=d.inputmask.escapeRegex.call(this,c.groupSeparator);c=d.inputmask.escapeRegex.call(this,c.radixPoint);e=e.join("");c=e.replace(RegExp(a,"g"),"").replace(RegExp(c),"");return h+
(e.length-c.length)},postFormat:function(a,f,b,e){if(""==e.groupSeparator)return f;var c=a.slice();d.inArray(e.radixPoint,a);b||c.splice(f,0,"?");c=c.join("");if(e.autoGroup||b&&-1!=c.indexOf(e.groupSeparator)){for(var h=d.inputmask.escapeRegex.call(this,e.groupSeparator),c=c.replace(RegExp(h,"g"),""),h=c.split(e.radixPoint),c=h[0],k=RegExp("([-+]?[\\d?]+)([\\d?]{"+e.groupSize+"})");k.test(c);)c=c.replace(k,"$1"+e.groupSeparator+"$2"),c=c.replace(e.groupSeparator+e.groupSeparator,e.groupSeparator);
1<h.length&&(c+=e.radixPoint+h[1])}a.length=c.length;e=0;for(h=c.length;e<h;e++)a[e]=c.charAt(e);c=d.inArray("?",a);b||a.splice(c,1);return b?f:c},regex:{number:function(a){var f=d.inputmask.escapeRegex.call(this,a.groupSeparator),b=d.inputmask.escapeRegex.call(this,a.radixPoint),e=isNaN(a.digits)?a.digits:"{0,"+a.digits+"}";return RegExp("^"+("["+(a.allowPlus?"+":"")+(a.allowMinus?"-":"")+"]?")+"(\\d+|\\d{1,"+a.groupSize+"}(("+f+"\\d{"+a.groupSize+"})?)+)("+b+"\\d"+e+")?$")}},onKeyDown:function(a,
f,b){var e=d(this);if(a.keyCode==b.keyCode.TAB){if(a=d.inArray(b.radixPoint,f),-1!=a){for(var c=e.data("_inputmask").masksets,e=e.data("_inputmask").activeMasksetIndex,h=1;h<=b.digits&&h<b.getMaskLength(c[e]._buffer,c[e].greedy,c[e].repeat,f,b);h++)if(void 0==f[a+h]||""==f[a+h])f[a+h]="0";this._valueSet(f.join(""))}}else if(a.keyCode==b.keyCode.DELETE||a.keyCode==b.keyCode.BACKSPACE)b.postFormat(f,0,!0,b),this._valueSet(f.join(""))},definitions:{"~":{validator:function(a,f,b,e,c){if(""==a)return!1;
if(!e&&1>=b&&"0"===f[0]&&/[\d-]/.test(a)&&1==f.length)return f[0]="",{pos:0};var h=e?f.slice(0,b):f.slice();h.splice(b,0,a);var h=h.join(""),k=d.inputmask.escapeRegex.call(this,c.groupSeparator),h=h.replace(RegExp(k,"g"),""),k=c.regex.number(c).test(h);if(!k&&(h+="0",k=c.regex.number(c).test(h),!k)){k=h.lastIndexOf(c.groupSeparator);for(i=h.length-k;3>=i;i++)h+="0";k=c.regex.number(c).test(h);if(!k&&!e&&a==c.radixPoint&&(k=c.regex.number(c).test("0"+h+"0")))return f[b]="0",b++,{pos:b}}return!1==k||
e||a==c.radixPoint?k:{pos:c.postFormat(f,b,!1,c)}},cardinality:1,prevalidator:null}},insertMode:!0,autoUnmask:!1},integer:{regex:{number:function(a){var f=d.inputmask.escapeRegex.call(this,a.groupSeparator);return RegExp("^"+(a.allowPlus||a.allowMinus?"["+(a.allowPlus?"+":"")+(a.allowMinus?"-":"")+"]?":"")+"(\\d+|\\d{1,"+a.groupSize+"}(("+f+"\\d{"+a.groupSize+"})?)+)$")}},alias:"decimal"}})})(jQuery);
