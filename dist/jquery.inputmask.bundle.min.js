...
e||!1;this.isAlternator=u||!1;this.quantifier={min:1,max:1}}function e(b,f,u){var c=a.definitions[f],d=0==b.matches.length;u=void 0!=u?u:b.matches.length;if(c&&!g){for(var h=c.prevalidator,k=h?h.length:0,s=1;s<c.cardinality;s++){var m=k>=s?h[s-1]:[],D=m.validator,m=m.cardinality;b.matches.splice(u++,0,{fn:D?"string"==typeof D?RegExp(D):new function(){this.test=D}:/./,cardinality:m?m:1,optionality:b.isOptional,newBlockMarker:d,casing:c.casing,def:c.definitionSymbol||f,placeholder:c.placeholder,mask:f})}b.matches.splice(u++,
...
k,m;u=c.exec(b);)switch(u=u[0],u.charAt(0)){case a.optionalmarker.end:case a.groupmarker.end:u=h.pop();if(0<h.length){if(k=h[h.length-1],k.matches.push(u),k.isAlternator){u=h.pop();for(k=0;k<u.matches.length;k++)u.matches[k].isGroup=!1;0<h.length?(k=h[h.length-1],k.matches.push(u)):d.matches.push(u)}}else d.matches.push(u);break;case a.optionalmarker.start:h.push(new f(!1,!0));break;case a.groupmarker.start:h.push(new f(!0));break;case a.quantifiermarker.start:k=new f(!1,!1,!0);u=u.replace(/[{}]/g,
"");m=u.split(",");u=isNaN(m[0])?m[0]:parseInt(m[0]);m=1==m.length?u:isNaN(m[1])?m[1]:parseInt(m[1]);if("*"==m||"+"==m)u="*"==m?0:1;k.quantifier={min:u,max:m};if(0<h.length){m=h[h.length-1].matches;u=m.pop();if(!u.isGroup){var D=new f(!0);D.matches.push(u);u=D}m.push(u);m.push(k)}else u=d.matches.pop(),u.isGroup||(D=new f(!0),D.matches.push(u),u=D),d.matches.push(u),d.matches.push(k);break;case a.escapeChar:g=!0;break;case a.alternatormarker:0<h.length?(k=h[h.length-1],m=k.matches.pop()):m=d.matches.pop();
m.isAlternator?h.push(m):(u=new f(!1,!1,!1,!0),u.matches.push(m),h.push(u));break;default:if(0<h.length){if(k=h[h.length-1],0<k.matches.length&&(m=k.matches[k.matches.length-1],m.isGroup&&(m.isGroup=!1,e(m,a.groupmarker.start,0),e(m,a.groupmarker.end))),e(k,u),k.isAlternator){u=h.pop();for(k=0;k<u.matches.length;k++)u.matches[k].isGroup=!1;0<h.length?(k=h[h.length-1],k.matches.push(u)):d.matches.push(u)}}else 0<d.matches.length&&(m=d.matches[d.matches.length-1],m.isGroup&&(m.isGroup=!1,e(m,a.groupmarker.start,
0),e(m,a.groupmarker.end))),e(d,u)}0<d.matches.length&&(m=d.matches[d.matches.length-1],m.isGroup&&(m.isGroup=!1,e(m,a.groupmarker.start,0),e(m,a.groupmarker.end)),l.push(d));return l}function c(b,u){if(a.numericInput&&!0!==a.multi){b=b.split("").reverse();for(var d=0;d<b.length;d++)b[d]==a.optionalmarker.start?b[d]=a.optionalmarker.end:b[d]==a.optionalmarker.end?b[d]=a.optionalmarker.start:b[d]==a.groupmarker.start?b[d]=a.groupmarker.end:b[d]==a.groupmarker.end&&(b[d]=a.groupmarker.start);b=b.join("")}if(void 0!=
...
b){for(var f=!1,c=M(a),e=0;e<c.length;e++)if(c[e].match&&c[e].match.def==b){f=!0;break}return f}function M(a,c,d){function g(c,d,q,B){function h(q,B,t){if(1E4<k)return alert("jquery.inputmask: There is probably an error in your mask definition or in the code. Create an issue on github with an example of the mask you are using. "+b.mask),!0;if(k==a&&void 0==q.matches)return r.push({match:q,locator:B.reverse()}),!0;if(void 0!=q.matches)if(q.isGroup&&!0!==t){if(q=h(c.matches[s+1],B))return!0}else if(q.isOptional){var m=
q;if(q=g(q,d,B,t))q=r[r.length-1].match,(q=0==e.inArray(q,m.matches))&&(n=!0),k=a}else if(q.isAlternator){var m=q,p=[],R,D=r.slice(),l=B.length,x=0<d.length?d.shift():-1;if(-1==x||"string"==typeof x){var sa=k,w=d.slice(),fa;"string"==typeof x&&(fa=x.split(","));for(var F=0;F<m.matches.length;F++){r=[];q=h(m.matches[F],[F].concat(B),t)||q;R=r.slice();k=sa;r=[];for(var K=0;K<w.length;K++)d[K]=w[K];for(K=0;K<R.length;K++)for(var v=R[K],A=0;A<p.length;A++){var z=p[A];if(v.match.mask==z.match.mask&&("string"!=
typeof x||-1!=e.inArray(v.locator[l].toString(),fa))){R.splice(K,1);z.locator[l]=z.locator[l]+","+v.locator[l];z.alternation=l;break}}p=p.concat(R)}"string"==typeof x&&(p=e.map(p,function(a,b){if(isFinite(b)){var c=a.locator[l].toString().split(","),f;a.locator[l]=void 0;a.alternation=void 0;for(var d=0;d<c.length;d++)if(f=-1!=e.inArray(c[d],fa))void 0!=a.locator[l]?(a.locator[l]+=",",a.alternation=l,a.locator[l]+=c[d]):a.locator[l]=parseInt(c[d]);if(void 0!=a.locator[l])return a}}));r=D.concat(p);
n=!0}else q=h(m.matches[x],[x].concat(B),t);if(q)return!0}else if(q.isQuantifier&&!0!==t)for(m=q,f.greedy=f.greedy&&isFinite(m.quantifier.max),t=0<d.length&&!0!==t?d.shift():0;t<(isNaN(m.quantifier.max)?t+1:m.quantifier.max)&&k<=a;t++){if(p=c.matches[e.inArray(m,c.matches)-1],q=h(p,[t].concat(B),!0))if(q=r[r.length-1].match,q.optionalQuantifier=t>m.quantifier.min-1,q=0==e.inArray(q,p.matches))if(t>m.quantifier.min-1){n=!0;k=a;break}else return!0;else return!0}else{if(q=g(q,d,B,t))return!0}else k++}
for(var s=0<d.length?d.shift():0;s<c.matches.length;s++)if(!0!==c.matches[s].isQuantifier){var t=h(c.matches[s],[s].concat(q),B);if(t&&k==a)return t;if(k>a)break}}var h=b.maskToken,k=c?d:0;d=c||[0];var r=[],n=!1;if(void 0==c){c=a-1;for(var s;void 0==(s=b.validPositions[c])&&-1<c;)c--;if(void 0!=s&&-1<c)k=c,d=s.locator.slice();else{for(c=a-1;void 0==(s=b.tests[c])&&-1<c;)c--;void 0!=s&&-1<c&&(k=c,d=s[0].locator.slice())}}for(c=d.shift();c<h.length&&!(g(h[c],d,[c])&&k==a||k>a);c++);(0==r.length||n)&&
...
a.toUpperCase();break;case "lower":a=a.toLowerCase()}return a}function N(a,c,d,h){function t(a,c,d,q){var y=!1;e.each(M(a),function(h,B){var n=B.match,r=c?1:0,t="";s();for(var O=n.cardinality;O>r;O--)t+=void 0==b.validPositions[a-(O-1)]?Z(a-(O-1)):b.validPositions[a-(O-1)].input;c&&(t+=c);y=null!=n.fn?n.fn.test(t,b,a,d,f):c!=n.def&&c!=f.skipOptionalPartCharacter||""==n.def?!1:{c:n.def,pos:a};if(!1!==y){r=void 0!=y.c?y.c:c;r=r==f.skipOptionalPartCharacter&&null===n.fn?n.def:r;t=a;void 0!=y.remove&&
F(y.remove,y.remove+1);if(y.refreshFromBuffer){t=y.refreshFromBuffer;d=!0;ea(!0===t?t:t.start,t.end);if(void 0==y.pos&&void 0==y.c)return y.pos=x(),!1;t=void 0!=y.pos?y.pos:a;if(t!=a)return y=e.extend(y,N(t,r,!0)),!1}else if(!0!==y&&void 0!=y.pos&&y.pos!=a&&(t=y.pos,ea(a,t),t!=a))return y=e.extend(y,N(t,r,!0)),!1;if(!0!=y&&void 0==y.pos&&void 0==y.c)return!1;0<h&&g(!0);k(t,e.extend({},B,{input:ra(r,n)}),q)||(y=!1);return!1}});return y}function p(a,c,d,y){if(f.keepStatic){var q=e.extend(!0,{},b.validPositions),
h,B;for(h=x();0<=h;h--)if(b.validPositions[h]&&void 0!=b.validPositions[h].alternation){B=b.validPositions[h].alternation;break}if(void 0!=B)for(var n in b.validPositions)if(parseInt(n)>parseInt(h)&&void 0===b.validPositions[n].alternation){var r=b.validPositions[n].locator[B];h=b.validPositions[h].locator[B].split(",");for(var t=0;t<h.length;t++)if(r<h[t]){for(var k,O,m=n-1;0<=m;m--)if(k=b.validPositions[m],void 0!=k){O=k.locator[B];k.locator[B]=h[t];break}if(r!=k.locator[B]){for(var m=s().slice(),
l=n;l<x()+1;l++)delete b.validPositions[l],delete b.tests[l];g(!0);f.keepStatic=!f.keepStatic;for(l=n;l<m.length;l++)m[l]!=f.skipOptionalPartCharacter&&N(x()+1,m[l],!1,!0);k.locator[B]=O;m=x()+1==a&&N(a,c,d,y);f.keepStatic=!f.keepStatic;if(m)return m;g();b.validPositions=e.extend(!0,{},q)}}break}}return!1}d=!0===d;for(var r=s(),n=a-1;-1<n&&(!b.validPositions[n]||null!=b.validPositions[n].match.fn);n--)void 0==b.validPositions[n]&&(!m(n)||r[n]!=Z(n))&&1<M(n).length&&t(n,r[n],!0);r=a;if(r>=V())return p(a,
c,d,h);a=t(r,c,d,h);if(!d&&!1===a)if((n=b.validPositions[r])&&null==n.match.fn&&(n.match.def==c||c==f.skipOptionalPartCharacter))a={caret:E(r)};else if((f.insertMode||void 0==b.validPositions[E(r)])&&!m(r))for(var n=r+1,l=E(r);n<=l;n++)if(a=t(n,c,d,h),!1!==a){r=n;break}!0===a&&(a={pos:r});return a}function m(a){a=ia(a);return null!=a.fn?a.fn:!1}function V(){var a;P=p.prop("maxLength");-1==P&&(P=void 0);if(!1==f.greedy){var c;c=x();a=b.validPositions[c];var d=void 0!=a?a.locator.slice():void 0;for(c+=
1;void 0==a||null!=a.match.fn||null==a.match.fn&&""!=a.match.def;c++)a=da(c,d,c-1),d=a.locator.slice();a=c}else a=s().length;return void 0==P||a<P?a:P}function E(a){var b=V();if(a>=b)return b;for(;++a<b&&!m(a)&&(!0!==f.nojumps||f.nojumpsThreshold>a););return a}function Y(a){if(0>=a)return 0;for(;0<--a&&!m(a););return a}function G(a,b,c){a._valueSet(b.join(""));void 0!=c&&w(a,c)}function Z(a,b){b=b||ia(a);return b.placeholder||(null==b.fn?b.def:f.placeholder.charAt(a%f.placeholder.length))}function U(a,
...
c=a.selectionEnd):document.selection&&document.selection.createRange&&(a=document.selection.createRange(),b=0-a.duplicate().moveStart("character",-1E5),c=b+a.text.length),b=S(b),c=S(c),{begin:b,end:c}}function ga(a){var c=s(),d=c.length,f,g=x(),h={},r=b.validPositions[g],n=void 0!=r?r.locator.slice():void 0,k;for(f=g+1;f<c.length;f++)k=da(f,n,f-1),n=k.locator.slice(),h[f]=e.extend(!0,{},k);n=r&&void 0!=r.alternation?r.locator[r.alternation].split(","):[];for(f=d-1;f>g;f--)if(k=h[f].match,(k.optionality||
k.optionalQuantifier||r&&void 0!=r.alternation&&void 0!=h[f].locator[r.alternation]&&-1!=e.inArray(h[f].locator[r.alternation].toString(),n))&&c[f]==Z(f,k))d--;else break;return a?{l:d,def:h[d]?h[d].match:void 0}:d}function ha(a){var b=s().slice(),c=ga();b.length=c;G(a,b)}function X(a){if(e.isFunction(f.isComplete))return f.isComplete.call(p,a,f);if("*"!=f.repeat){var b=!1,c=ga(!0),d=Y(c.l);if(x()==d&&(void 0==c.def||c.def.newBlockMarker||c.def.optionalQuantifier))for(b=!0,c=0;c<=d;c++){var g=m(c);
...
w(c),m=f.onKeyDown.call(this,a,s(),d.begin,f);ba(c,m,d);ca=-1!=e.inArray(g,f.ignorables)}function $(a,c,d,h,t,m){if(void 0==d&&aa)return!1;aa=!0;var r=e(this);a=a||window.event;d=c?d:a.which||a.charCode||a.keyCode;if(!(!0===c||a.ctrlKey&&a.altKey)&&(a.ctrlKey||a.metaKey||ca))return!0;if(d){!0!==c&&46==d&&!1==a.shiftKey&&","==f.radixPoint&&(d=44);var n,l;d=String.fromCharCode(d);c?(m=t?m:x()+1,n={begin:m,end:m}):n=w(this);if(m=z?1<n.begin-n.end||1==n.begin-n.end&&f.insertMode:1<n.end-n.begin||1==n.end-
n.begin&&f.insertMode)b.undoPositions=e.extend(!0,{},b.validPositions),ma(this,f.keyCode.DELETE,n),f.insertMode||(f.insertMode=!f.insertMode,k(n.begin,t),f.insertMode=!f.insertMode),m=!f.multi;b.writeOutBuffer=!0;n=z&&!m?n.end:n.begin;var p=N(n,d,t);!1!==p&&(!0!==p&&(n=void 0!=p.pos?p.pos:n,d=void 0!=p.c?p.c:d),g(!0),void 0!=p.caret?l=p.caret:(t=b.validPositions,l=!f.keepStatic&&(void 0!=t[n+1]&&1<M(n+1,t[n].locator.slice(),n).length||void 0!=t[n].alternation)?n+1:E(n)),b.p=l);if(!1!==h){var R=this;
setTimeout(function(){f.onKeyValidation.call(R,p,f)},0);if(b.writeOutBuffer&&!1!==p){var D=s();G(this,D,c?void 0:f.numericInput?Y(l):l);!0!==c&&setTimeout(function(){!0===X(D)&&r.trigger("complete");Q=!0;r.trigger("input")},0)}else m&&(b.buffer=void 0,b.validPositions=b.undoPositions)}else m&&(b.buffer=void 0,b.validPositions=b.undoPositions);f.showTooltip&&r.prop("title",b.mask);a&&!0!=c&&(a.preventDefault?a.preventDefault():a.returnValue=!1,c=w(this),a=f.onKeyPress.call(this,a,s(),c.begin,f),ba(this,
...
b=w(this));1!=s().length-c.length||c.charAt(b.begin)==s()[b.begin]||c.charAt(b.begin+1)==s()[b.begin]||m(b.begin)||(a.keyCode=f.keyCode.BACKSPACE,na.call(this,a));a.preventDefault()}function xa(a){if(!0===Q&&"input"==a.type)return Q=!1,!0;var c=w(this),d=this._valueGet();w(this,c.begin-1);var g=e.Event("keypress");g.which=d.charCodeAt(c.begin-1);ca=aa=!1;$.call(this,g,void 0,void 0,!1);c=b.p;G(this,s(),f.numericInput?Y(c):c);a.preventDefault()}function ya(a){Q=!0;var c=this;setTimeout(function(){w(c,
w(c).begin-1);var d=e.Event("keypress");d.which=a.originalEvent.data.charCodeAt(0);ca=aa=!1;$.call(c,d,void 0,void 0,!1);d=b.p;G(c,s(),f.numericInput?Y(d):d)},0);return!1}function za(a){p=e(a);if(p.is(":input")&&"number"!=p.attr("type")){p.data("_inputmask",{maskset:b,opts:f,isRTL:!1});f.showTooltip&&p.prop("title",b.mask);("rtl"==a.dir||f.rightAlign)&&p.css("text-align","right");if("rtl"==a.dir||f.numericInput){a.dir="ltr";p.removeAttr("dir");var c=p.data("_inputmask");c.isRTL=!0;p.data("_inputmask",
c);z=!0}p.unbind(".inputmask");p.removeClass("focus-inputmask");p.closest("form").bind("submit",function(){L!=s().join("")?p.change():p[0]._valueSet("");f.autoUnmask&&f.removeMaskOnSubmit&&p.inputmask("remove")}).bind("reset",function(){setTimeout(function(){p.trigger("setvalue")},0)});p.bind("mouseenter.inputmask",function(){!e(this).hasClass("focus-inputmask")&&f.showMaskOnHover&&this._valueGet()!=s().join("")&&G(this,s())}).bind("blur.inputmask",function(){var a=e(this);if(a.data("_inputmask")){var b=
...
E(x()));a.addClass("focus-inputmask");L=s().join("")}).bind("mouseleave.inputmask",function(){var a=e(this);f.clearMaskOnLostFocus&&(a.hasClass("focus-inputmask")||this._valueGet()==a.attr("placeholder")||(this._valueGet()==I().join("")||""==this._valueGet()?this._valueSet(""):ha(this)))}).bind("click.inputmask",function(){var a=this;e(a).is(":focus")&&setTimeout(function(){var b=w(a);if(b.begin==b.end){var b=z?S(b.begin):b.begin,c=x(b),c=E(c);b<c?m(b)?w(a,b):w(a,E(b)):w(a,c)}},0)}).bind("dblclick.inputmask",
function(){var a=this;setTimeout(function(){w(a,0,E(x()))},0)}).bind(T+".inputmask dragdrop.inputmask drop.inputmask",oa).bind("setvalue.inputmask",function(){U(this,!0,!1,void 0,!0);L=s().join("")}).bind("complete.inputmask",f.oncomplete).bind("incomplete.inputmask",f.onincomplete).bind("cleared.inputmask",f.oncleared);p.bind("keydown.inputmask",na).bind("keypress.inputmask",$).bind("keyup.inputmask",va).bind("compositionupdate.inputmask",ya);"paste"===T&&p.bind("input.inputmask",xa);if(l||v||C||
W)"input"==T&&p.unbind(T+".inputmask"),p.bind("input.inputmask",wa);d&&p.bind("input.inputmask",oa);ua(a);c=e.isFunction(f.onBeforeMask)?f.onBeforeMask.call(a,a._valueGet(),f):a._valueGet();U(a,!0,!1,c.split(""),!0);L=s().join("");var h;try{h=document.activeElement}catch(k){}!1===X(s())&&f.clearIncomplete&&g();f.clearMaskOnLostFocus?s().join("")==I().join("")?a._valueSet(""):ha(a):G(a,s());h===a&&(p.addClass("focus-inputmask"),w(a,E(x())));ta(a)}}var z=!1,L,p,aa=!1,Q=!1,ca=!1,P;if(void 0!=a)switch(a.action){case "isComplete":return p=
e(a.el),b=p.data("_inputmask").maskset,f=p.data("_inputmask").opts,X(a.buffer);case "unmaskedvalue":return p=a.$input,b=p.data("_inputmask").maskset,f=p.data("_inputmask").opts,z=a.$input.data("_inputmask").isRTL,ka(a.$input);case "mask":L=s().join("");za(a.el);break;case "format":p=e({});p.data("_inputmask",{maskset:b,opts:f,isRTL:f.numericInput});f.numericInput&&(z=!0);var H=(e.isFunction(f.onBeforeMask)?f.onBeforeMask.call(p,a.value,f):a.value).split("");U(p,!1,!1,z?H.reverse():H,!0);f.onKeyPress.call(this,
void 0,s(),0,f);return z?s().slice().reverse().join(""):s().join("");case "isValid":p=e({});p.data("_inputmask",{maskset:b,opts:f,isRTL:f.numericInput});f.numericInput&&(z=!0);H=a.value.split("");U(p,!1,!0,z?H.reverse():H);var H=s(),J=ga();H.length=J;return X(H)&&a.value==H.join("");case "getemptymask":return p=e(a.el),b=p.data("_inputmask").maskset,f=p.data("_inputmask").opts,I();case "remove":var A=a.el;p=e(A);b=p.data("_inputmask").maskset;f=p.data("_inputmask").opts;A._valueSet(ka(p));p.unbind(".inputmask");
p.removeClass("focus-inputmask");p.removeData("_inputmask");Object.getOwnPropertyDescriptor&&(J=Object.getOwnPropertyDescriptor(A,"value"));J&&J.get?A._valueGet&&Object.defineProperty(A,"value",{get:A._valueGet,set:A._valueSet}):document.__lookupGetter__&&A.__lookupGetter__("value")&&A._valueGet&&(A.__defineGetter__("value",A._valueGet),A.__defineSetter__("value",A._valueSet));try{delete A._valueGet,delete A._valueSet}catch(Aa){A._valueGet=void 0,A._valueSet=void 0}break;case "getmetadata":p=e(a.el);
b=p.data("_inputmask").maskset;f=p.data("_inputmask").opts;if(e.isArray(b.metadata)){for(J=a=x();0<=J;J--)if(b.validPositions[J]&&void 0!=b.validPositions[J].alternation){H=b.validPositions[J].alternation;break}return void 0!=H?b.metadata[b.validPositions[a].locator[H]]:b.metadata[0]}return b.metadata}};e.inputmask={defaults:{placeholder:"_",optionalmarker:{start:"[",end:"]"},quantifiermarker:{start:"{",end:"}"},groupmarker:{start:"(",end:")"},alternatormarker:"|",escapeChar:"\\",mask:null,oncomplete:e.noop,
onincomplete:e.noop,oncleared:e.noop,repeat:0,greedy:!0,autoUnmask:!1,removeMaskOnSubmit:!0,clearMaskOnLostFocus:!0,insertMode:!0,clearIncomplete:!1,aliases:{},alias:null,onKeyUp:e.noop,onKeyPress:e.noop,onKeyDown:e.noop,onBeforeMask:void 0,onBeforePaste:void 0,onUnMask:void 0,showMaskOnFocus:!0,showMaskOnHover:!0,onKeyValidation:e.noop,skipOptionalPartCharacter:" ",showTooltip:!1,numericInput:!1,rightAlign:!1,radixPoint:"",nojumps:!1,nojumpsThreshold:0,keepStatic:void 0,definitions:{9:{validator:"[0-9]",
...
NUMPAD_SUBTRACT:109,PAGE_DOWN:34,PAGE_UP:33,PERIOD:190,RIGHT:39,SHIFT:16,SPACE:32,TAB:9,UP:38,WINDOWS:91},ignorables:[8,9,13,19,27,33,34,35,36,37,38,39,40,45,46,93,112,113,114,115,116,117,118,119,120,121,122,123],isComplete:void 0},masksCache:{},escapeRegex:function(a){return a.replace(RegExp("(\\/|\\.|\\*|\\+|\\?|\\||\\(|\\)|\\[|\\]|\\{|\\}|\\\\)","gim"),"\\$1")},format:function(a,d){var f=e.extend(!0,{},e.inputmask.defaults,d);b(f.alias,d,f);return F({action:"format",value:a},c(f),f)},isValid:function(a,
