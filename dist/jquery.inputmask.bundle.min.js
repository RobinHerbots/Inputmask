...
function n(a,c){function b(){return a[c]}function h(){return b().tests}function e(){return b()._buffer}function f(){return b().buffer}function k(e,h,D){function l(a,c,b,f){for(var h=n(a),e=b?1:0,d="",H=c.buffer,S=c.tests[h].cardinality;S>e;S--)d+=F(H,h-(S-1));b&&(d+=b);return null!=c.tests[h].fn?c.tests[h].fn.test(d,H,a,f,g):b==F(c._buffer,a,!0)||b==g.skipOptionalPartCharacter?{refresh:!0,c:F(c._buffer,a,!0),pos:a}:!1}if(D=!0===D){var m=l(e,b(),h,D);!0===m&&(m={pos:e});return m}var s=[],m=!1,u=c,
v=f().slice(),t=b().lastValidPosition;w(e);var y=[];d.each(a,function(a,g){if("object"==typeof g){c=a;var d=e,k=b().lastValidPosition,n;if(k==t){if(1<d-t)for(k=-1==k?0:k;k<d&&(n=l(k,b(),v[k],!0),!1!==n);k++)G(f(),k,v[k],!0),!0===n&&(n={pos:k}),n=n.pos||k,b().lastValidPosition<n&&(b().lastValidPosition=n);if(!r(d)&&!l(d,b(),h,D)){k=q(d)-d;for(n=0;n<k&&!1===l(++d,b(),h,D);n++);y.push(c)}}(b().lastValidPosition>=t||c==u)&&0<=d&&d<p()&&(m=l(d,b(),h,D),!1!==m&&(!0===m&&(m={pos:d}),n=m.pos||d,b().lastValidPosition<
n&&(b().lastValidPosition=n)),s.push({activeMasksetIndex:a,result:m}))}});c=u;return function(c,b){var f=!1;d.each(b,function(a,b){if(f=-1==d.inArray(b.activeMasksetIndex,c)&&!1!==b.result)return!1});if(f)b=d.map(b,function(b,f){if(-1==d.inArray(b.activeMasksetIndex,c))return b;a[b.activeMasksetIndex].lastValidPosition=t});else{var g=-1,k=-1;d.each(b,function(a,b){-1!=d.inArray(b.activeMasksetIndex,c)&&!1!==b.result&(-1==g||g>b.result.pos)&&(g=b.result.pos,k=b.activeMasksetIndex)});b=d.map(b,function(b,
f){if(-1!=d.inArray(b.activeMasksetIndex,c)){if(b.result.pos==g)return b;if(!1!==b.result){for(var H=e;H<g;H++)if(rsltValid=l(H,a[b.activeMasksetIndex],a[k].buffer[H],!0),!1===rsltValid){a[b.activeMasksetIndex].lastValidPosition=g-1;break}else G(a[b.activeMasksetIndex].buffer,H,a[k].buffer[H],!0),a[b.activeMasksetIndex].lastValidPosition=H;rsltValid=l(g,a[b.activeMasksetIndex],h,!0);!1!==rsltValid&&(G(a[b.activeMasksetIndex].buffer,g,h,!0),a[b.activeMasksetIndex].lastValidPosition=g);return b}}})}return b}(y,
...
e.lastValidPosition?h:e.activeMasksetIndex;h!=c&&(U(f(),q(e.lastValidPosition),p()),b().writeOutBuffer=!0);u.data("_inputmask").activeMasksetIndex=c}function r(a){a=n(a);a=h()[a];return void 0!=a?a.fn:!1}function n(a){return a%h().length}function p(){return g.getMaskLength(e(),b().greedy,b().repeat,f(),g)}function q(a){var b=p();if(a>=b)return b;for(;++a<b&&!r(a););return a}function w(a){if(0>=a)return 0;for(;0<--a&&!r(a););return a}function G(a,b,c,e){e&&(b=P(a,b));e=h()[n(b)];var f=c;if(void 0!=
f&&void 0!=e)switch(e.casing){case "upper":f=c.toUpperCase();break;case "lower":f=c.toLowerCase()}a[b]=f}function F(a,b,c){c&&(b=P(a,b));return a[b]}function P(a,b){for(var c;void 0==a[b]&&a.length<p();)for(c=0;void 0!==e()[c];)a.push(e()[c++]);return b}function J(a,b,c){a._valueSet(b.join(""));void 0!=c&&v(a,c)}function U(a,b,c,f){for(var h=p();b<c&&b<h;b++)!0===f?r(b)||G(a,b,""):G(a,b,F(e().slice(),b,!0))}function Q(a,b){var c=n(b);G(a,b,F(e(),c))}function M(f,h,g,k,l){k=void 0!=k?k.slice():V(f._valueGet()).split("");
d.each(a,function(a,b){"object"==typeof b&&(b.buffer=b._buffer.slice(),b.lastValidPosition=-1,b.p=-1)});!0!==g&&(c=0);h&&f._valueSet("");p();d.each(k,function(a,c){if(!0===l){var k=b().p,k=-1==k?k:w(k),n=-1==k?a:q(k);-1==d.inArray(c,e().slice(k+1,n))&&d(f).trigger("_keypress",[!0,c.charCodeAt(0),h,g,a])}else d(f).trigger("_keypress",[!0,c.charCodeAt(0),h,g,a])});!0===g&&-1!=b().p&&(b().lastValidPosition=w(b().p))}function W(a){return d.inputmask.escapeRegex.call(this,a)}function V(a){return a.replace(RegExp("("+
W(e().join(""))+")*$"),"")}function X(a){var b=f(),c=b.slice(),e,g;for(g=c.length-1;0<=g;g--)if(e=n(g),h()[e].optionality)if(r(g)&&k(g,b[g],!0))break;else c.pop();else break;J(a,c)}function fa(a,b){if(!h()||!0!==b&&a.hasClass("hasDatepicker"))return a[0]._valueGet();var c=d.map(f(),function(a,b){return r(b)&&k(b,a,!0)?a:null}),c=(A?c.reverse():c).join("");return void 0!=g.onUnMask?g.onUnMask.call(this,f().join(""),c):c}function C(a){!A||"number"!=typeof a||g.greedy&&""==g.placeholder||(a=f().length-
...
document.selection.createRange&&(a=document.selection.createRange(),b=0-a.duplicate().moveStart("character",-1E5),c=b+a.text.length);b=C(b);c=C(c);return{begin:b,end:c}}}function O(b){if("*"!=g.repeat){var f=!1,h=0,k=c;d.each(a,function(a,g){if("object"==typeof g){c=a;var d=w(p());if(g.lastValidPosition>=h&&g.lastValidPosition==d){for(var k=!0,l=0;l<=d;l++){var q=r(l),m=n(l);if(q&&(void 0==b[l]||b[l]==y(l))||!q&&b[l]!=e()[m]){k=!1;break}}if(f=f||k)return!1}h=g.lastValidPosition}});c=k;return f}}var A=
!1,K=f().join(""),u,ga;this.unmaskedvalue=function(a,b){A=a.data("_inputmask").isRTL;return fa(a,b)};this.isComplete=function(a){return O(a)};this.mask=function(z){function P(a){a=d._data(a).events;d.each(a,function(a,b){d.each(b,function(a,b){if("inputmask"==b.namespace&&"setvalue"!=b.type&&"_keypress"!=b.type){var c=b.handler;b.handler=function(a){if(this.readOnly||this.disabled)a.preventDefault;else return c.apply(this,arguments)}}})})}function D(a){var b;Object.getOwnPropertyDescriptor&&(b=Object.getOwnPropertyDescriptor(a,
...
{text:{get:function(a){var b=d(a);if(b.data("_inputmask")){if(b.data("_inputmask").opts.autoUnmask)return b.inputmask("unmaskedvalue");a=c(a);b=b.data("_inputmask");return a!=b.masksets[b.activeMasksetIndex]._buffer.join("")?a:""}return c(a)},set:function(a,b){var c=d(a),e=f(a,b);c.data("_inputmask")&&c.triggerHandler("setvalue.inputmask");return e},inputmaskpatch:!0}})}function Y(a,c,g,d){var l=f();if(!1!==d)for(;!r(a)&&0<=a-1;)a--;for(d=a;d<c&&d<p();d++)if(r(d)){Q(l,d);var m=q(d),L=F(l,m);if(L!=
y(m))if(m<p()&&!1!==k(d,L,!0)&&h()[n(d)].def==h()[n(m)].def)G(l,d,L,!0);else if(r(d))break}else Q(l,d);void 0!=g&&G(l,w(c),g);if(!1==b().greedy){c=V(l.join("")).split("");l.length=c.length;d=0;for(g=l.length;d<g;d++)l[d]=c[d];0==l.length&&(b().buffer=e().slice())}return a}function ba(a,c,g){var d=f();if(F(d,a,!0)!=y(a))for(var l=w(c);l>a&&0<=l;l--)if(r(l)){var m=w(l),q=F(d,m);if(q!=y(m))if(!1!==k(m,q,!0)&&h()[n(l)].def==h()[n(m)].def)G(d,l,q,!0),Q(d,m);else break}else Q(d,l);void 0!=g&&F(d,a)==y(a)&&
G(d,a,g);a=d.length;if(!1==b().greedy){g=V(d.join("")).split("");d.length=g.length;l=0;for(m=d.length;l<m;l++)d[l]=g[l];0==d.length&&(b().buffer=e().slice())}return c-(a-d.length)}function ca(c,d,e){if(g.numericInput||A){switch(d){case g.keyCode.BACKSPACE:d=g.keyCode.DELETE;break;case g.keyCode.DELETE:d=g.keyCode.BACKSPACE}if(A){var h=e.end;e.end=e.begin;e.begin=h}}h=!0;e.begin==e.end?(h=d==g.keyCode.BACKSPACE?e.begin-1:e.begin,g.isNumeric&&""!=g.radixPoint&&f()[h]==g.radixPoint&&(e.begin=f().length-
1==h?e.begin:d==g.keyCode.BACKSPACE?h:q(h),e.end=e.begin),h=!1,d==g.keyCode.BACKSPACE?e.begin--:d==g.keyCode.DELETE&&e.end++):1!=e.end-e.begin||g.insertMode||(h=!1,d==g.keyCode.BACKSPACE&&e.begin--);U(f(),e.begin,e.end);var k=p();if(!1==g.greedy)Y(e.begin,k,void 0,!A&&d==g.keyCode.BACKSPACE&&!h);else{for(var l=e.begin,m=e.begin;m<e.end;m++)if(r(m)||!h)l=Y(e.begin,k,void 0,!A&&d==g.keyCode.BACKSPACE&&!h);h||(e.begin=l)}d=q(-1);U(f(),e.begin,e.end,!0);M(c,!1,void 0==a[1]||d>=e.end,f());b().lastValidPosition<
d?(b().lastValidPosition=-1,b().p=d):b().p=e.begin}function da(a){T=!1;var c=this,h=d(c),k=a.keyCode,m=v(c);k==g.keyCode.BACKSPACE||k==g.keyCode.DELETE||t&&127==k||a.ctrlKey&&88==k?(a.preventDefault(),88==k&&(K=f().join("")),ca(c,k,m),l(),J(c,f(),b().p),c._valueGet()==e().join("")&&h.trigger("cleared"),g.showTooltip&&h.prop("title",b().mask)):k==g.keyCode.END||k==g.keyCode.PAGE_DOWN?setTimeout(function(){var e=q(b().lastValidPosition);g.insertMode||e!=p()||a.shiftKey||e--;v(c,a.shiftKey?m.begin:e,
e)},0):k==g.keyCode.HOME&&!a.shiftKey||k==g.keyCode.PAGE_UP?v(c,0,a.shiftKey?m.begin:0):k==g.keyCode.ESCAPE||90==k&&a.ctrlKey?(M(c,!0,!1,K.split("")),h.click()):k!=g.keyCode.INSERT||a.shiftKey||a.ctrlKey?!1!=g.insertMode||a.shiftKey||(k==g.keyCode.RIGHT?setTimeout(function(){var a=v(c);v(c,a.begin)},0):k==g.keyCode.LEFT&&setTimeout(function(){var a=v(c);v(c,a.begin-1)},0)):(g.insertMode=!g.insertMode,v(c,g.insertMode||m.begin!=p()?m.begin:m.begin-1));h=v(c);!0===g.onKeyDown.call(this,a,f(),g)&&v(c,
h.begin,h.end);Z=-1!=d.inArray(k,g.ignorables)}function ea(e,h,m,n,r,z){if(void 0==m&&T)return!1;T=!0;var u=d(this);e=e||window.event;m=m||e.which||e.charCode||e.keyCode;if((!e.ctrlKey||!e.altKey)&&(e.ctrlKey||e.metaKey||Z)&&!0!==h)return!0;if(m){!0!==h&&46==m&&!1==e.shiftKey&&","==g.radixPoint&&(m=44);var t,N,x=String.fromCharCode(m);h?(m=r?z:b().lastValidPosition+1,t={begin:m,end:m}):t=v(this);z=A?1<t.begin-t.end||1==t.begin-t.end&&g.insertMode:1<t.end-t.begin||1==t.end-t.begin&&g.insertMode;var D=
c;z&&(c=D,d.each(a,function(a,e){"object"==typeof e&&(c=a,b().undoBuffer=f().join(""))}),ca(this,g.keyCode.DELETE,t),g.insertMode||d.each(a,function(a,e){"object"==typeof e&&(c=a,ba(t.begin,p()),b().lastValidPosition=q(b().lastValidPosition))}),c=D);var C=f().join("").indexOf(g.radixPoint);g.isNumeric&&!0!==h&&-1!=C&&(g.greedy&&t.begin<=C?(t.begin=w(t.begin),t.end=t.begin):x==g.radixPoint&&(t.begin=C,t.end=t.begin));var B=t.begin;m=k(B,x,r);!0===r&&(m=[{activeMasksetIndex:c,result:m}]);var E=-1;d.each(m,
function(a,e){c=e.activeMasksetIndex;b().writeOutBuffer=!0;var d=e.result;if(!1!==d){var h=!1,k=f();!0!==d&&(h=d.refresh,B=void 0!=d.pos?d.pos:B,x=void 0!=d.c?d.c:x);if(!0!==h){if(!0==g.insertMode){d=p();for(k=k.slice();F(k,d,!0)!=y(d)&&d>=B;)d=0==d?-1:w(d);d>=B?(ba(B,p(),x),k=b().lastValidPosition,d=q(k),d!=p()&&k>=B&&F(f(),d,!0)!=y(d)&&(b().lastValidPosition=d)):b().writeOutBuffer=!1}else G(k,B,x,!0);if(-1==E||E>q(B))E=q(B)}else!r&&(k=B<p()?B+1:B,-1==E||E>k)&&(E=k);E>b().p&&(b().p=E)}});!0!==r&&
(c=D,l());if(!1!==n&&(d.each(m,function(a,b){if(b.activeMasksetIndex==c)return N=b,!1}),void 0!=N)){var K=this;setTimeout(function(){g.onKeyValidation.call(K,N.result,g)},0);if(b().writeOutBuffer&&!1!==N.result){var I=f();n=h?void 0:g.numericInput?B>C?w(E):x==g.radixPoint?E-1:w(E-1):E;J(this,I,n);!0!==h&&setTimeout(function(){!0===O(I)&&u.trigger("complete")},0)}else z&&(b().buffer=b().undoBuffer.split(""))}g.showTooltip&&u.prop("title",b().mask);e.preventDefault()}}function W(a){var b=d(this),c=
a.keyCode,h=f();m&&c==g.keyCode.BACKSPACE&&ga==this._valueGet()&&da.call(this,a);g.onKeyUp.call(this,a,h,g);c==g.keyCode.TAB&&g.showMaskOnFocus&&(b.hasClass("focus.inputmask")&&0==this._valueGet().length?(h=e().slice(),J(this,h),v(this,0),K=f().join("")):(J(this,h),h.join("")==e().join("")&&-1!=d.inArray(g.radixPoint,h)?(v(this,C(0)),b.click()):v(this,C(0),C(p()))))}u=d(z);if(u.is(":input")){u.data("_inputmask",{masksets:a,activeMasksetIndex:c,opts:g,isRTL:!1});g.showTooltip&&u.prop("title",b().mask);
b().greedy=b().greedy?b().greedy:0==b().repeat;if(null!=u.attr("maxLength")){var I=u.prop("maxLength");-1<I&&d.each(a,function(a,b){"object"==typeof b&&"*"==b.repeat&&(b.repeat=I)});p()>=I&&-1<I&&(I<e().length&&(e().length=I),!1==b().greedy&&(b().repeat=Math.round(I/e().length)),u.prop("maxLength",2*p()))}D(z);var T=!1,Z=!1;g.numericInput&&(g.isNumeric=g.numericInput);("rtl"==z.dir||g.numericInput&&g.rightAlignNumerics||g.isNumeric&&g.rightAlignNumerics)&&u.css("text-align","right");if("rtl"==z.dir||
g.numericInput){z.dir="ltr";u.removeAttr("dir");var $=u.data("_inputmask");$.isRTL=!0;u.data("_inputmask",$);A=!0}u.unbind(".inputmask");u.removeClass("focus.inputmask");u.closest("form").bind("submit",function(){K!=f().join("")&&u.change()}).bind("reset",function(){setTimeout(function(){u.trigger("setvalue")},0)});u.bind("mouseenter.inputmask",function(){!d(this).hasClass("focus.inputmask")&&g.showMaskOnHover&&this._valueGet()!=f().join("")&&J(this,f())}).bind("blur.inputmask",function(){var b=d(this),
h=this._valueGet(),k=f();b.removeClass("focus.inputmask");K!=f().join("")&&b.change();g.clearMaskOnLostFocus&&""!=h&&(h==e().join("")?this._valueSet(""):X(this));!1===O(k)&&(b.trigger("incomplete"),g.clearIncomplete&&(d.each(a,function(a,b){"object"==typeof b&&(b.buffer=b._buffer.slice(),b.lastValidPosition=-1)}),c=0,g.clearMaskOnLostFocus?this._valueSet(""):(k=e().slice(),J(this,k))))}).bind("focus.inputmask",function(){var a=d(this),c=this._valueGet();g.showMaskOnFocus&&!a.hasClass("focus.inputmask")&&
(!g.showMaskOnHover||g.showMaskOnHover&&""==c)&&this._valueGet()!=f().join("")&&J(this,f(),q(b().lastValidPosition));a.addClass("focus.inputmask");K=f().join("")}).bind("mouseleave.inputmask",function(){var a=d(this);g.clearMaskOnLostFocus&&(a.hasClass("focus.inputmask")||this._valueGet()==a.attr("placeholder")||(this._valueGet()==e().join("")||""==this._valueGet()?this._valueSet(""):X(this)))}).bind("click.inputmask",function(){var a=this;setTimeout(function(){var c=v(a),e=f();if(c.begin==c.end){var c=
g.isRTL?C(c.begin):c.begin,h=b().lastValidPosition,e=g.isNumeric?!1===g.skipRadixDance&&""!=g.radixPoint&&-1!=d.inArray(g.radixPoint,e)?g.numericInput?q(d.inArray(g.radixPoint,e)):d.inArray(g.radixPoint,e):q(h):q(h);c<e?r(c)?v(a,c):v(a,q(c)):v(a,e)}},0)}).bind("dblclick.inputmask",function(){var a=this;setTimeout(function(){v(a,0,q(b().lastValidPosition))},0)}).bind(N+".inputmask dragdrop.inputmask drop.inputmask",function(a){var b=this,c=d(b);if("propertychange"==a.type&&b._valueGet().length<=p())return!0;
setTimeout(function(){M(b,!0,!1,void 0,!0);!0===O(f())&&c.trigger("complete");c.click()},0)}).bind("setvalue.inputmask",function(){M(this,!0);K=f().join("");this._valueGet()==e().join("")&&this._valueSet("")}).bind("_keypress.inputmask",ea).bind("complete.inputmask",g.oncomplete).bind("incomplete.inputmask",g.onincomplete).bind("cleared.inputmask",g.oncleared).bind("keyup.inputmask",W);m?u.bind("input.inputmask",function(a){a=d(this);ga=f().join("");M(this,!1,!1);J(this,f());!0===O(f())&&a.trigger("complete");
a.click()}):u.bind("keydown.inputmask",da).bind("keypress.inputmask",ea);M(z,!0,!1);K=f().join("");var aa;try{aa=document.activeElement}catch(fa){}aa===z?(u.addClass("focus.inputmask"),v(z,q(b().lastValidPosition))):g.clearMaskOnLostFocus?f().join("")==e().join("")?z._valueSet(""):X(z):J(z,f());P(z)}};return this}var g=d.extend(!0,{},d.inputmask.defaults,b),w=null!==navigator.userAgent.match(/msie 10/i),t=null!==navigator.userAgent.match(/iphone/i),z=null!==navigator.userAgent.match(/android.*safari.*/i),
m=null!==navigator.userAgent.match(/android.*chrome.*/i),N=h("paste")&&!w?"paste":h("input")?"input":"propertychange",l,q=0;if("string"===typeof a)switch(a){case "mask":return e(g.alias,b),l=k(),0==l.length?this:this.each(function(){n(d.extend(!0,{},l),0).mask(this)});case "unmaskedvalue":return w=d(this),w.data("_inputmask")?(l=w.data("_inputmask").masksets,q=w.data("_inputmask").activeMasksetIndex,g=w.data("_inputmask").opts,n(l,q).unmaskedvalue(w)):w.val();case "remove":return this.each(function(){var a=
d(this);if(a.data("_inputmask")){l=a.data("_inputmask").masksets;q=a.data("_inputmask").activeMasksetIndex;g=a.data("_inputmask").opts;this._valueSet(n(l,q).unmaskedvalue(a,!0));a.removeData("_inputmask");a.unbind(".inputmask");a.removeClass("focus.inputmask");var b;Object.getOwnPropertyDescriptor&&(b=Object.getOwnPropertyDescriptor(this,"value"));b&&b.get?this._valueGet&&Object.defineProperty(this,"value",{get:this._valueGet,set:this._valueSet}):document.__lookupGetter__&&this.__lookupGetter__("value")&&
...
q=this.data("_inputmask").activeMasksetIndex,g=this.data("_inputmask").opts,n(l,q).isComplete(this[0]._valueGet().split(""));case "getmetadata":if(this.data("_inputmask"))return l=this.data("_inputmask").masksets,q=this.data("_inputmask").activeMasksetIndex,l[q].metadata;return;default:return e(a,b)||(g.mask=a),l=k(),0==l.length?this:this.each(function(){n(d.extend(!0,{},l),q).mask(this)})}else{if("object"==typeof a)return g=d.extend(!0,{},d.inputmask.defaults,a),e(g.alias,a),l=k(),0==l.length?this:
this.each(function(){n(d.extend(!0,{},l),q).mask(this)});if(void 0==a)return this.each(function(){var a=d(this).attr("data-inputmask");if(a&&""!=a)try{var a=a.replace(RegExp("'","g"),'"'),c=d.parseJSON("{"+a+"}");d.extend(!0,c,b);g=d.extend(!0,{},d.inputmask.defaults,c);e(g.alias,c);g.alias=void 0;d(this).inputmask(g)}catch(h){}})}return this})})(jQuery);
