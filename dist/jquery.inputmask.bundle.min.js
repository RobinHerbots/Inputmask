...
break;case a.quantifiermarker.start:k=new e(!1,!1,!0);l=l.replace(/[{}]/g,"");var u=l.split(",");l=isNaN(u[0])?u[0]:parseInt(u[0]);u=1==u.length?l:isNaN(u[1])?u[1]:parseInt(u[1]);k.quantifier={min:l,max:u};if("*"==u||"+"==u)a.greedy=!1;if(0<f.length){u=f[f.length-1].matches;l=u.pop();if(!l.isGroup){var v=new e(!0);v.matches.push(l);l=v}u.push(l);u.push(k)}else l=g.matches.pop(),l.isGroup||(v=new e(!0),v.matches.push(l),l=v),g.matches.push(l),g.matches.push(k);break;case a.escapeChar:n=!0;break;case a.alternatormarker:console.log("alternator");
break;default:0<f.length?h(f[f.length-1],l):(0<g.matches.length&&(k=g.matches[g.matches.length-1],k.isGroup&&(k.isGroup=!1,h(k,a.groupmarker.start,0),h(k,a.groupmarker.end))),h(g,l))}0<g.matches.length&&y.push(g);return y}function h(c,g){a.numericInput&&(c=c.split("").reverse().join(""));if(void 0!=c&&""!=c){if(0<a.repeat||"*"==a.repeat||"+"==a.repeat)c=a.groupmarker.start+c+a.groupmarker.end+a.quantifiermarker.start+("*"==a.repeat?0:"+"==a.repeat?1:a.repeat)+","+a.repeat+a.quantifiermarker.end;void 0==
...
c(a.matches[E],[E].concat(e),d);if(A&&h==p)return A;if(h>p)break}}var c=a.maskToken,h=e?d:0;d=e||[0];var g=[],f=!1;if(!0!==b&&a.tests[p]&&!a.validPositions[p])return a.tests[p];if(void 0==e){for(b=p-1;void 0==(e=a.validPositions[b])&&-1<b;)b--;if(void 0!=e&&-1<b)h=b,d=e.locator.slice();else{for(b=p-1;void 0==(e=a.tests[b])&&-1<b;)b--;void 0!=e&&-1<b&&(h=b,d=e[0].locator.slice())}}for(b=d.shift();b<c.length&&!(l(c[b],d,[b])&&h==p||h>p);b++);(0==g.length||f&&2>g.length)&&g.push({match:{fn:null,cardinality:0,
...
a=e(a);b=(b=b.data("_inputmask").maskset._buffer)?b.join(""):"";return a!=b?a:""}return e(a)},set:function(a,b){var e=d(a),h=c(a,b);e.data("_inputmask")&&e.triggerHandler("setvalue.inputmask");return h},inputmaskpatch:!0}}}var e;Object.getOwnPropertyDescriptor&&(e=Object.getOwnPropertyDescriptor(a,"value"));if(e&&e.get){if(!a._valueGet){var c=e.get,h=e.set;a._valueGet=function(){return x?c.call(this).split("").reverse().join(""):c.call(this)};a._valueSet=function(a){h.call(this,x?a.split("").reverse().join(""):
a)};Object.defineProperty(a,"value",{get:function(){var a=d(this),b=d(this).data("_inputmask"),e=b.maskset;return b&&b.opts.autoUnmask?a.inputmask("unmaskedvalue"):c.call(this)!=e._buffer.join("")?c.call(this):""},set:function(a){h.call(this,a);d(this).triggerHandler("setvalue.inputmask")}})}}else document.__lookupGetter__&&a.__lookupGetter__("value")?a._valueGet||(c=a.__lookupGetter__("value"),h=a.__lookupSetter__("value"),a._valueGet=function(){return x?c.call(this).split("").reverse().join(""):
c.call(this)},a._valueSet=function(a){h.call(this,x?a.split("").reverse().join(""):a)},a.__defineGetter__("value",function(){var a=d(this),b=d(this).data("_inputmask"),e=b.maskset;return b&&b.opts.autoUnmask?a.inputmask("unmaskedvalue"):c.call(this)!=e._buffer.join("")?c.call(this):""}),a.__defineSetter__("value",function(a){h.call(this,a);d(this).triggerHandler("setvalue.inputmask")})):(a._valueGet||(a._valueGet=function(){return x?this.value.split("").reverse().join(""):this.value},a._valueSet=
function(a){this.value=x?a.split("").reverse().join(""):a}),b(a.type))}function $(b,c,d){if(e.numericInput||x){switch(c){case e.keyCode.BACKSPACE:c=e.keyCode.DELETE;break;case e.keyCode.DELETE:c=e.keyCode.BACKSPACE}x&&(b=d.end,d.end=d.begin,d.begin=b)}d.begin==d.end?(b=c==e.keyCode.BACKSPACE?d.begin-1:d.begin,e.isNumeric&&""!=e.radixPoint&&l()[b]==e.radixPoint&&(d.begin=l().length-1==b?d.begin:c==e.keyCode.BACKSPACE?b:B(b),d.end=d.begin),c==e.keyCode.BACKSPACE?d.begin=I(d.begin):c==e.keyCode.DELETE&&
d.end++):1!=d.end-d.begin||e.insertMode||c==e.keyCode.BACKSPACE&&d.begin--;b=d.begin;var f=d.end;for(c=B(b-1);b<f;b++)delete a.validPositions[b];b=f;for(f=J();b<f;b++){var g=a.validPositions[b],n=a.validPositions[c];void 0!=g&&void 0==n&&(t(c).def==g.match.def&&!1!==T(c,g.input,!0)&&delete a.validPositions[b],c=B(c))}h(!0);c=B(-1);z()<c?a.p=c:a.p=d.begin}function W(b){X=!1;var c=this,h=d(c),g=b.keyCode,n=w(c);g==e.keyCode.BACKSPACE||g==e.keyCode.DELETE||f&&127==g||b.ctrlKey&&88==g?(b.preventDefault(),
...
(a=c.data("_inputmask-multi"),b(a.elmasks[a.activeMasksetIndex])):b(a)},set:function(a,b){var e=d(a),h=c(a,b);e.data("_inputmask-multi")&&e.triggerHandler("setvalue.inputmaskmulti");return h},inputmaskmultipatch:!0}}})(a.type);""!=k.attr("value")&&setTimeout(function(){f("init",s)},0)};d.inputmask={defaults:{placeholder:"_",optionalmarker:{start:"[",end:"]"},quantifiermarker:{start:"{",end:"}"},groupmarker:{start:"(",end:")"},alternatormarker:"|",escapeChar:"\\",mask:null,oncomplete:d.noop,onincomplete:d.noop,
oncleared:d.noop,repeat:0,greedy:!0,autoUnmask:!1,clearMaskOnLostFocus:!0,insertMode:!0,clearIncomplete:!1,aliases:{},onKeyUp:d.noop,onKeyDown:d.noop,onBeforeMask:void 0,onBeforePaste:void 0,onUnMask:void 0,showMaskOnFocus:!0,showMaskOnHover:!0,onKeyValidation:d.noop,skipOptionalPartCharacter:" ",showTooltip:!1,numericInput:!1,isNumeric:!1,radixPoint:"",skipRadixDance:!1,rightAlignNumerics:!0,definitions:{9:{validator:"[0-9]",cardinality:1,definitionSymbol:"*"},a:{validator:"[A-Za-z\u0410-\u044f\u0401\u0451]",
