...
function(a,h){function b(a){var d=document.createElement("input"),a="on"+a,f=a in d;f||(d.setAttribute(a,"return;"),f="function"==typeof d[a]);return f}function e(a,d){var B=f.aliases[a];return B?(B.alias&&e(B.alias),c.extend(!0,f,B),c.extend(!0,f,d),!0):!1}function d(a){f.numericInput&&(a=a.split("").reverse().join(""));var d=!1,B=0,b=f.greedy,h=f.repeat;"*"==h&&(b=!1);!0==b&&""==f.placeholder&&(f.placeholder=" ");1==a.length&&!1==b&&(f.placeholder="");for(var a=c.map(a.split(""),function(a){var c=
[];if(a==f.escapeChar)d=true;else if(a!=f.optionalmarker.start&&a!=f.optionalmarker.end||d){var b=f.definitions[a];if(b&&!d)for(a=0;a<b.cardinality;a++)c.push(w(B+a));else{c.push(a);d=false}B=B+c.length;return c}}),e=a.slice(),g=1;g<h&&b;g++)e=e.concat(a.slice());return{mask:e,repeat:h,greedy:b}}function g(a){f.numericInput&&(a=a.split("").reverse().join(""));var d=!1,b=!1,h=!1;return c.map(a.split(""),function(a){var c=[];if(a==f.escapeChar)b=!0;else if(a==f.optionalmarker.start&&!b)h=d=!0;else if(a==
f.optionalmarker.end&&!b)d=!1,h=!0;else{var e=f.definitions[a];if(e&&!b){for(var g=e.prevalidator,aa=g?g.length:0,j=1;j<e.cardinality;j++){var q=aa>=j?g[j-1]:[],m=q.validator,q=q.cardinality;c.push({fn:m?"string"==typeof m?RegExp(m):new function(){this.test=m}:/./,cardinality:q?q:1,optionality:d,newBlockMarker:!0==d?h:!1,offset:0,casing:e.casing,def:e.definitionSymbol|a});!0==d&&(h=!1)}c.push({fn:e.validator?"string"==typeof e.validator?RegExp(e.validator):new function(){this.test=e.validator}:/./,
cardinality:e.cardinality,optionality:d,newBlockMarker:h,offset:0,casing:e.casing,def:e.definitionSymbol|a})}else c.push({fn:null,cardinality:0,optionality:d,newBlockMarker:h,offset:0,casing:null,def:a}),b=!1;h=!1;return c}})}function j(){function a(d){var c=d.length;for(i=0;i<c&&d.charAt(i)!=f.optionalmarker.start;i++);var b=[d.substring(0,i)];i<c&&b.push(d.substring(i+1,c));return b}function b(j,K){var m=0,k=0,p=K.length;for(i=0;i<p&&!(K.charAt(i)==f.optionalmarker.start&&m++,K.charAt(i)==f.optionalmarker.end&&
k++,0<m&&m==k);i++);m=[K.substring(0,i)];i<p&&m.push(K.substring(i+1,p));var l=a(m[0]);if(1<l.length){if(p=j+l[0]+(f.optionalmarker.start+l[1]+f.optionalmarker.end)+(1<m.length?m[1]:""),-1==c.inArray(p,h)&&(h.push(p),k=d(p),e.push({mask:p,_buffer:k.mask,buffer:k.mask.slice(),tests:g(p),lastValidPosition:void 0,greedy:k.greedy,repeat:k.repeat})),p=j+l[0]+(1<m.length?m[1]:""),-1==c.inArray(p,h)&&(h.push(p),k=d(p),e.push({mask:p,_buffer:k.mask,buffer:k.mask.slice(),tests:g(p),lastValidPosition:void 0,
greedy:k.greedy,repeat:k.repeat})),1<a(l[1]).length&&b(j+l[0],l[1]+m[1]),1<m.length&&1<a(m[1]).length)b(j+l[0]+(f.optionalmarker.start+l[1]+f.optionalmarker.end),m[1]),b(j+l[0],m[1])}else p=j+m,-1==c.inArray(p,h)&&(h.push(p),k=d(p),e.push({mask:p,_buffer:k.mask,buffer:k.mask.slice(),tests:g(p),lastValidPosition:void 0,greedy:k.greedy,repeat:k.repeat}))}var e=[],h=[];c.isArray(f.mask)?c.each(f.mask,function(a,d){b("",d.toString())}):b("",f.mask.toString());return f.greedy?e:e.sort(function(a,d){return a.mask.length-
d.mask.length})}function w(a){return f.placeholder.charAt(a%f.placeholder.length)}function l(a,d){function b(){return a[d]}function e(){return b().tests}function h(){return b()._buffer}function g(){return b().buffer}function j(e,g,n){function m(a,b){for(var d=l(a),h=g?1:0,e="",c=b.buffer,O=b.tests[d].cardinality;O>h;O--)e+=z(c,d-(O-1));g&&(e+=g);return null!=b.tests[d].fn?b.tests[d].fn.test(e,c,a,n,f):!1}if(n=!0===n){var k=m(e,b());!0===k&&(k={pos:e});return k}var C=[],k=!1,t=d;c.each(a,function(c,
j){if("object"==typeof j){d=c;var n=e;if(t!=d&&!p(n)&&b().lastValidPosition==v(n)){if(g==h()[n]||g==f.skipOptionalPartCharacter)return C.push({activeMasksetIndex:c,result:{refresh:!0,c:h()[n]}}),b().lastValidPosition=n,!1;a[t].lastValidPosition>=n?b().lastValidPosition=-1:n=r(e)}if((void 0==b().lastValidPosition&&n==r(-1)||b().lastValidPosition>=v(n))&&0<=n&&n<q()){k=m(n,b());if(!1!==k&&(!0===k&&(k={pos:n}),n=k.pos||n,void 0==b().lastValidPosition||b().lastValidPosition<n))b().lastValidPosition=n;
C.push({activeMasksetIndex:c,result:k})}}});d=t;return C}function k(){var h=d,e={activeMasksetIndex:0,lastValidPosition:-1};c.each(a,function(a,b){"object"==typeof b&&(void 0!=this.lastValidPosition&&this.lastValidPosition>e.lastValidPosition)&&(e.activeMasksetIndex=a,e.lastValidPosition=this.lastValidPosition)});d=e.activeMasksetIndex;h!=d&&(R(g(),r(e.lastValidPosition),q()),b().writeOutBuffer=!0)}function p(a){a=l(a);a=e()[a];return void 0!=a?a.fn:!1}function l(a){return a%e().length}function q(){return f.getMaskLength(h(),
b().greedy,b().repeat,g(),f)}function r(a){var b=q();if(a>=b)return b;for(;++a<b&&!p(a););return a}function v(a){if(0>=a)return 0;for(;0<--a&&!p(a););return a}function I(a,b,d,h){h&&(b=F(a,b));var h=e()[l(b)],c=d;if(void 0!=c)switch(h.casing){case "upper":c=d.toUpperCase();break;case "lower":c=d.toLowerCase()}a[b]=c}function z(a,b,d){d&&(b=F(a,b));return a[b]}function F(a,b){for(var d;void 0==a[b]&&a.length<q();)for(d=0;void 0!==h()[d];)a.push(h()[d++]);return b}function D(a,b,d){a._valueSet(b.join(""));
void 0!=d&&t(a,d)}function R(a,b,d){for(var e=q();b<d&&b<e;b++)I(a,b,z(h().slice(),b,!0))}function L(a,b){var d=l(b);I(a,b,z(h(),d))}function J(e,g,f,j){j=void 0!=j?j.slice():S(e._valueGet()).split("");c.each(a,function(a,b){"object"==typeof b&&(b.buffer=b._buffer.slice(),b.lastValidPosition=void 0,b.p=0)});!0!==f&&(d=0);g&&e._valueSet("");q();c.each(j,function(a,d){var j=b().lastValidPosition,k=b().p,k=void 0==j?a:k,j=void 0==j?-1:j;(f&&p(a)||(d!=z(h().slice(),a,!0)||p(a))&&-1==c.inArray(d,h().slice(j+
1,k)))&&c(e).trigger("keypress",[!0,d.charCodeAt(0),g,f,a])});!0===f&&(b().lastValidPosition=v(b().p))}function T(a){return c.inputmask.escapeRegex.call(this,a)}function S(a){return a.replace(RegExp("("+T(h().join(""))+")*$"),"")}function U(a){var b=g(),d=b.slice(),h,c;for(c=d.length-1;0<=c;c--)if(h=l(c),e()[h].optionality)if(!p(c)||!j(c,b[c],!0))d.pop();else break;else break;D(a,d)}function V(a,b){return e()&&(!0===b||!a.hasClass("hasDatepicker"))?c.map(g(),function(a,b){return p(b)&&j(b,a,!0)?a:
null}).join(""):a[0]._valueGet()}function t(a,b,d){function h(a){x&&"number"==typeof a&&(a=g().length-a);return a}var e=a.jquery&&0<a.length?a[0]:a;if("number"==typeof b)b=h(b),d=h(d),c(a).is(":visible")&&(d="number"==typeof d?d:b,!1==f.insertMode&&b==d&&d++,e.setSelectionRange?(e.selectionStart=b,e.selectionEnd=o?b:d):e.createTextRange&&(a=e.createTextRange(),a.collapse(!0),a.moveEnd("character",d),a.moveStart("character",b),a.select()));else{if(!c(a).is(":visible"))return{begin:0,end:0};e.setSelectionRange?
...
0){var a=c(this);if(a.data("_inputmask")){if(a.data("_inputmask").opts.autoUnmask)return a.inputmask("unmaskedvalue");var a=c.inputmask.val.apply(a),b=c(this).data("_inputmask");return a!=b.masksets[b.activeMasksetIndex]._buffer.join("")?a:""}return c.inputmask.val.apply(a)}var d=arguments;return this.each(function(){var a=c(this),b=c.inputmask.val.apply(a,d);a.data("_inputmask")&&a.triggerHandler("setvalue.inputmask");return b})},c.extend(c.fn.val,{inputmaskpatch:!0})}function H(a,d,c){for(var f=
g();!p(a)&&0<=a-1;)a--;for(var k=a;k<d&&k<q();k++)if(p(k)){L(f,k);var m=r(k),o=z(f,m);if(o!=w(m))if(m<q()&&!1!==j(k,o,!0)&&e()[l(k)].def==e()[l(m)].def)I(f,k,z(f,m),!0),m<d&&L(f,m);else if(p(k))break}else L(f,k);void 0!=c&&I(f,v(d),c);if(!1==b().greedy){d=S(f.join("")).split("");f.length=d.length;k=0;for(c=f.length;k<c;k++)f[k]=d[k];0==f.length&&(b().buffer=h().slice())}return a}function Q(a,d,c,f){for(var k=g();a<=d&&a<q();a++)if(p(a)){var m=z(k,a,!0);I(k,a,c,!0);if(m!=w(a))if(c=r(a),c<q())if(!1!==
j(c,m,!0)&&e()[l(a)].def==e()[l(c)].def)c=m;else if(p(c))break;else c=m;else break;else if(c=m,!0!==f)break}else L(k,a);f=k.length;if(!1==b().greedy){c=S(k.join("")).split("");k.length=c.length;a=0;for(m=k.length;a<m;a++)k[a]=c[a];0==k.length&&(b().buffer=h().slice())}return d-(f-k.length)}function C(e){P=!1;var j=this,l=e.keyCode,o=t(j);if(l==f.keyCode.BACKSPACE||l==f.keyCode.DELETE||G&&127==l||e.ctrlKey&&88==l){e.preventDefault();if(f.numericInput||x)switch(l){case f.keyCode.BACKSPACE:l=f.keyCode.DELETE;
break;case f.keyCode.DELETE:l=f.keyCode.BACKSPACE}if($(o.begin,o.end)){if(x){var n=o.end;o.end=o.begin;o.begin=n}R(g(),o.begin,o.end);if(0==o.begin&&o.end==q())c.each(a,function(a,b){"object"==typeof b&&(b.buffer=b._buffer.slice(),b.lastValidPosition=void 0,b.p=0)});else{n=q();if(!1==f.greedy)H(o.begin,n);else for(var W=o.begin;W<o.end;W++)p(W)&&H(o.begin,n);J(j,!1,!0,g())}}else c.each(a,function(a,e){if("object"==typeof e){d=a;var c=m?o.end:o.begin,k=g(),j=r(-1),p=q();if(l==f.keyCode.DELETE)c<j&&
(c=j),c<p&&(f.isNumeric&&(""!=f.radixPoint&&k[c]==f.radixPoint)&&(c=k.length-1==c?c:r(c)),c=H(c,p),void 0!=b().lastValidPosition&&(-1!=b().lastValidPosition&&g()[b().lastValidPosition]==h()[b().lastValidPosition]&&(b().lastValidPosition=0==b().lastValidPosition?-1:v(b().lastValidPosition)),b().lastValidPosition<j?(b().lastValidPosition=void 0,b().p=j):(b().writeOutBuffer=!0,b().p=c)));else if(l==f.keyCode.BACKSPACE)if(c>j){if(c-=1,f.isNumeric&&""!=f.radixPoint&&k[c]==f.radixPoint?(c=Q(0,k.length-
1==c?c:c-1,w(c),!0),c++):c=H(c,p),void 0!=b().lastValidPosition)-1!=b().lastValidPosition&&g()[b().lastValidPosition]==h()[b().lastValidPosition]&&(b().lastValidPosition=0==b().lastValidPosition?-1:v(b().lastValidPosition)),b().lastValidPosition<j?(b().lastValidPosition=void 0,b().p=j):(b().writeOutBuffer=!0,b().p=c)}else 0<d&&(b().lastValidPosition=void 0,b().writeOutBuffer=!0,b().p=j,d=0,b().buffer=h().slice(),b().p=r(-1),b().lastValidPosition=void 0)}});k();D(j,g(),b().p);j._valueGet()==h().join("")&&
c(j).trigger("cleared");f.showTooltip&&u.prop("title",b().mask)}else l==f.keyCode.END||l==f.keyCode.PAGE_DOWN?setTimeout(function(){var a=r(b().lastValidPosition);!f.insertMode&&(a==q()&&!e.shiftKey)&&a--;t(j,e.shiftKey?o.begin:a,a)},0):l==f.keyCode.HOME&&!e.shiftKey||l==f.keyCode.PAGE_UP?t(j,0,e.shiftKey?o.begin:0):l==f.keyCode.ESCAPE?(j._valueSet(b().undoBuffer),J(j,!0,!0)):l==f.keyCode.INSERT&&!e.shiftKey&&!e.ctrlKey?(f.insertMode=!f.insertMode,t(j,!f.insertMode&&o.begin==q()?o.begin-1:o.begin)):
!1==f.insertMode&&!e.shiftKey&&(l==f.keyCode.RIGHT?setTimeout(function(){var a=t(j);t(j,a.begin)},0):l==f.keyCode.LEFT&&setTimeout(function(){var a=t(j);t(j,a.begin-1)},0));n=t(j);f.onKeyDown.call(this,e,g(),f);t(j,n.begin,n.end);X=-1!=c.inArray(l,f.ignorables)}function T(e,h,m,l,o,n){if(void 0==m&&P)return!1;P=!0;var u=c(this),e=e||window.event,m=m||e.which||e.charCode||e.keyCode,E=String.fromCharCode(m);if((!e.ctrlKey||!e.altKey)&&(e.ctrlKey||e.metaKey||X)&&!0!==h)return!0;if(m){var s,y;h?(m=o?
n:b().p,s={begin:m,end:m}):s=t(this);var m=$(s.begin,s.end),C=!1;m&&(x&&(n=s.end,s.end=s.begin,s.begin=n),n=d,c.each(a,function(a,e){if(typeof e=="object"){d=a;b().undoBuffer=g().join("");var c=s.end<q()?s.end:q();b().lastValidPosition>s.begin&&b().lastValidPosition<c?b().lastValidPosition=v(s.begin):C=true;R(g(),s.begin,c);var h=q();if(f.greedy==false)H(s.begin,h);else for(var j=s.begin;j<c;j++)p(j)&&H(s.begin,h)}}),!0===C&&(d=n,J(this,!1,!0,g()),f.insertMode||c.each(a,function(a,e){if(typeof e==
"object"){d=a;Q(s.begin,q(),w(s.begin),true);b().lastValidPosition=r(b().lastValidPosition)}})),d=n);f.isNumeric&&(E==f.radixPoint&&!0!==h)&&(n=g().join("").indexOf(f.radixPoint),-1!=n&&(s.begin=s.begin==n?r(n):n,s.end=s.begin,t(this,s.begin)));var A=f.numericInput&&!0!=o&&!m?v(s.begin):r(s.begin-1),n=j(A,E,o);!0===o&&(n=[{activeMasksetIndex:d,result:n}]);c.each(n,function(a,e){d=e.activeMasksetIndex;b().writeOutBuffer=true;var c=e.result;if(c!==false){var h=false,j=g();if(c!==true){h=c.refresh;A=
c.pos!=void 0?c.pos:A;E=c.c!=void 0?c.c:E}if(h!==true)if(f.insertMode==true){c=q();for(h=j.slice();z(h,c,true)!=w(c)&&c>=A;)c=c==0?-1:v(c);if(c>=A){Q(A,j.length,E);j=b().lastValidPosition;c=r(j);c!=q()&&(j>=A&&z(g(),c)!=w(c))&&(b().lastValidPosition=c)}else b().writeOutBuffer=false}else I(j,A,E,true);b().p=r(A)}});!0!==o&&k();if(!1!==l&&(c.each(n,function(a,b){if(b.activeMasksetIndex==d){y=b;return false}}),void 0!=y)){var G=this;setTimeout(function(){f.onKeyValidation.call(G,y.result,f)},0);if(b().writeOutBuffer&&
!1!==y.result){var F=g();D(this,F,h?void 0:f.numericInput?v(b().p):b().p);!0!==h&&setTimeout(function(){M(F)&&u.trigger("complete")},0)}else m&&(b().buffer=b().undoBuffer.split(""))}f.showTooltip&&u.prop("title",b().mask);e.preventDefault()}}function V(a){var d=c(this),e=a.keyCode,j=g(),k=t(this);f.onKeyUp.call(this,a,j,f);t(this,k.begin,k.end);e==f.keyCode.TAB&&(d.hasClass("focus.inputmask")&&0==this._valueGet().length&&f.showMaskOnFocus)&&(j=h().slice(),D(this,j),t(this,0),b().undoBuffer=this._valueGet())}
var u=c(o);if(u.is(":input")){u.data("_inputmask",{masksets:a,activeMasksetIndex:d,opts:f,isRTL:!1});f.showTooltip&&u.prop("title",b().mask);b().greedy=b().greedy?b().greedy:0==b().repeat;if(null!=u.attr("maxLength")){var y=u.prop("maxLength");-1<y&&c.each(a,function(a,b){"object"==typeof b&&"*"==b.repeat&&(b.repeat=y)});q()>y&&-1<y&&(y<h().length&&(h().length=y),!1==b().greedy&&(b().repeat=Math.round(y/h().length)),u.prop("maxLength",2*q()))}n(o);b().undoBuffer=o._valueGet();var P=!1,X=!1;("rtl"==
o.dir||f.numericInput&&f.rightAlignNumerics||f.isNumeric&&f.rightAlignNumerics)&&u.css("text-align","right");if("rtl"==o.dir||f.numericInput){o.dir="ltr";u.removeAttr("dir");var Y=u.data("_inputmask");Y.isRTL=!0;u.data("_inputmask",Y);x=!0}u.unbind(".inputmask");u.removeClass("focus.inputmask");u.closest("form").bind("submit",function(){u[0]._valueGet&&u[0]._valueGet()!=b().undoBuffer&&u.change()}).bind("reset",function(){c.each(a,function(a,b){"object"==typeof b&&(b.buffer=b._buffer.slice(),b.lastValidPosition=
void 0,b.p=-1)})});u.bind("mouseenter.inputmask",function(){!c(this).hasClass("focus.inputmask")&&f.showMaskOnHover&&this._valueGet()!=g().join("")&&D(this,g())}).bind("blur.inputmask",function(){var e=c(this),j=this._valueGet(),k=g();e.removeClass("focus.inputmask");j!=b().undoBuffer&&e.change();f.clearMaskOnLostFocus&&""!=j&&(j==h().join("")?this._valueSet(""):U(this));M(k)||(e.trigger("incomplete"),f.clearIncomplete&&(c.each(a,function(a,b){"object"==typeof b&&(b.buffer=b._buffer.slice(),b.lastValidPosition=
void 0,b.p=0)}),d=0,f.clearMaskOnLostFocus?this._valueSet(""):(k=h().slice(),D(this,k))))}).bind("focus.inputmask",function(){var a=c(this),d=this._valueGet();f.showMaskOnFocus&&!a.hasClass("focus.inputmask")&&(!f.showMaskOnHover||f.showMaskOnHover&&""==d)&&this._valueGet()!=g().join("")&&D(this,g(),b().p);a.addClass("focus.inputmask");b().undoBuffer=this._valueGet();a.click()}).bind("mouseleave.inputmask",function(){var a=c(this);f.clearMaskOnLostFocus&&(a.hasClass("focus.inputmask")||(this._valueGet()==
h().join("")||""==this._valueGet()?this._valueSet(""):U(this)))}).bind("click.inputmask",function(){var a=this;setTimeout(function(){var d=t(a),e=g();if(d.begin==d.end){var d=d.begin,h=b().lastValidPosition,h=f.isNumeric?!1===f.skipRadixDance&&""!=f.radixPoint&&-1!=c.inArray(f.radixPoint,e)?c.inArray(f.radixPoint,e):q():r(void 0==h?-1:h);t(a,d<h&&(!1!==j(d,e[d],!0)||!p(d))?d:h)}},0)}).bind("dblclick.inputmask",function(){var a=this;void 0!=b().lastValidPosition&&setTimeout(function(){t(a,0,r(b().lastValidPosition))},
0)}).bind("keydown.inputmask",C).bind("keypress.inputmask",T).bind("keyup.inputmask",V).bind(E+".inputmask dragdrop.inputmask drop.inputmask",function(a){var b=this,d=c(b);if("propertychange"==a.type&&b._valueGet().length<=q())return!0;setTimeout(function(){J(b,!0,!1);M(g())&&d.trigger("complete");d.click()},0)}).bind("setvalue.inputmask",function(){b().undoBuffer=this._valueGet();J(this,!0);this._valueGet()==h().join("")&&this._valueSet("")}).bind("complete.inputmask",f.oncomplete).bind("incomplete.inputmask",
f.onincomplete).bind("cleared.inputmask",f.oncleared);J(o,!0,!1);var Z;try{Z=document.activeElement}catch(ba){}Z===o?(u.addClass("focus.inputmask"),t(o,b().p)):f.clearMaskOnLostFocus?g().join("")==h().join("")?o._valueSet(""):U(o):D(o,g());F(o)}};return this}var f=c.extend(!0,{},c.inputmask.defaults,h),G=null!==navigator.userAgent.match(/iphone/i),o=null!==navigator.userAgent.match(/android.*safari.*/i),E=b("paste")?"paste":b("input")?"input":"propertychange",m,k,r=0;if(o){var v=navigator.userAgent.match(/safari.*/i);
m=537>=parseInt(RegExp(/[0-9]+/).exec(v))}if("string"===typeof a)switch(a){case "mask":return e(f.alias,h),k=j(),this.each(function(){l(c.extend(!0,{},k),0).mask(this)});case "unmaskedvalue":return v=c(this),v.data("_inputmask")?(k=v.data("_inputmask").masksets,r=v.data("_inputmask").activeMasksetIndex,f=v.data("_inputmask").opts,l(k,r).unmaskedvalue(v)):v.val();case "remove":return this.each(function(){var a=c(this);if(a.data("_inputmask")){k=a.data("_inputmask").masksets;r=a.data("_inputmask").activeMasksetIndex;
f=a.data("_inputmask").opts;this._valueSet(l(k,r).unmaskedvalue(a,!0));a.removeData("_inputmask");a.unbind(".inputmask");a.removeClass("focus.inputmask");var b;Object.getOwnPropertyDescriptor&&(b=Object.getOwnPropertyDescriptor(this,"value"));b&&b.get?this._valueGet&&Object.defineProperty(this,"value",{get:this._valueGet,set:this._valueSet}):document.__lookupGetter__&&this.__lookupGetter__("value")&&this._valueGet&&(this.__defineGetter__("value",this._valueGet),this.__defineSetter__("value",this._valueSet));
try{delete this._valueGet,delete this._valueSet}catch(d){this._valueSet=this._valueGet=void 0}}});case "getemptymask":return this.data("_inputmask")?(k=this.data("_inputmask").masksets,r=this.data("_inputmask").activeMasksetIndex,k[r]._buffer.join("")):"";case "hasMaskedValue":return this.data("_inputmask")?!this.data("_inputmask").opts.autoUnmask:!1;case "isComplete":return k=this.data("_inputmask").masksets,r=this.data("_inputmask").activeMasksetIndex,f=this.data("_inputmask").opts,l(k,r).isComplete(this[0]._valueGet().split(""));
default:return e(a,h)||(f.mask=a),k=j(),this.each(function(){l(c.extend(true,{},k),r).mask(this)})}else{if("object"==typeof a)return f=c.extend(!0,{},c.inputmask.defaults,a),e(f.alias,a),k=j(),this.each(function(){l(c.extend(!0,{},k),r).mask(this)});if(void 0==a)return this.each(function(){var a=c(this).attr("data-inputmask");if(a&&""!=a)try{var a=a.replace(RegExp("'","g"),'"'),b=c.parseJSON("{"+a+"}");c.extend(!0,b,h);f=c.extend(!0,{},c.inputmask.defaults,b);e(f.alias,b);f.alias=void 0;c(this).inputmask(f)}catch(d){}})}return this})})(jQuery);
