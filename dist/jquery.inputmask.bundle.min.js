...
0,s=0,o=h.length;for(i=0;i<o&&!(h.charAt(i)==g.optionalmarker.start&&l++,h.charAt(i)==g.optionalmarker.end&&s++,0<l&&l==s);i++);l=[h.substring(0,i)];i<o&&l.push(h.substring(i+1,o));var n=a(l[0]);if(1<n.length){if(o=f+n[0]+(g.optionalmarker.start+n[1]+g.optionalmarker.end)+(1<l.length?l[1]:""),-1==e.inArray(o,d)&&(d.push(o),s=j(o),c.push({mask:o,_buffer:s.mask,buffer:s.mask.slice(),tests:k(o),lastValidPosition:void 0,greedy:s.greedy,repeat:s.repeat})),o=f+n[0]+(1<l.length?l[1]:""),-1==e.inArray(o,
d)&&(d.push(o),s=j(o),c.push({mask:o,_buffer:s.mask,buffer:s.mask.slice(),tests:k(o),lastValidPosition:void 0,greedy:s.greedy,repeat:s.repeat})),1<a(n[1]).length&&b(f+n[0],n[1]+l[1]),1<l.length&&1<a(l[1]).length)b(f+n[0]+(g.optionalmarker.start+n[1]+g.optionalmarker.end),l[1]),b(f+n[0],l[1])}else o=f+l,-1==e.inArray(o,d)&&(d.push(o),s=j(o),c.push({mask:o,_buffer:s.mask,buffer:s.mask.slice(),tests:k(o),lastValidPosition:void 0,greedy:s.greedy,repeat:s.repeat}))}var c=[],d=[];e.isArray(g.mask)?e.each(g.mask,
function(a,c){b("",c.toString())}):b("",g.mask.toString());return c}function h(){return z[q]}function C(){return h().tests}function p(){return h()._buffer}function r(){return h().buffer}function F(a,b,c,d){function f(a,d){for(var e=x(a),v=b?1:0,j="",h=d.buffer,l=d.tests[e].cardinality;l>v;l--)j+=G(h,e-(l-1));b&&(j+=b);return null!=d.tests[e].fn?d.tests[e].fn.test(j,h,a,c,g):!1}if(c){var j=f(a,h());!0===j&&(j={pos:a});return j}var k=[],j=!1,s=q;e.each(z,function(c){q=c;if(s!=q&&!A(a)){if(b==this._buffer[a]||
...
""):a.replace(RegExp("("+L(p().join(""))+")*$"),"")}function W(a){var b=r(),c=b.slice(),d,f;if(e(a).data("inputmask").isRTL)for(f=0;f<=c.length-1;f++)if(d=x(f),C()[d].optionality)if(!A(f)||!F(f,b[f],!0))c.splice(0,1);else break;else break;else for(f=c.length-1;0<=f;f--)if(d=x(f),C()[d].optionality)if(!A(f)||!F(f,b[f],!0))c.pop();else break;else break;J(a,c)}function M(a,b){var c=a[0];return C()&&(!0===b||!a.hasClass("hasDatepicker"))?(K(c,!1,!0),e.map(r(),function(a,b){return A(b)&&F(b,a,!0)?a:null}).join("")):
...
function k(a,b,c){for(var d=r();!A(a)&&0<=a-1;)a--;for(var e=a;e<b&&e<l();e++)if(A(e)){P(d,e);var f=u(e),j=G(d,f);if(j!=E(f))if(f<l()&&!1!==F(e,j,!0,m)&&C()[x(e)].def==C()[x(f)].def)I(d,e,G(d,f),!0,m),f<b&&P(d,f);else if(A(e))break}else P(d,e);void 0!=c&&I(d,m?b:B(b),c);if(!1==h().greedy){b=V(d.join(""),m).split("");d.length=b.length;e=0;for(c=d.length;e<c;e++)d[e]=b[e];0==d.length&&(h().buffer=p().slice())}return a}function y(a,b,c,d){for(var e=r();a<=b&&a<l();a++)if(A(a)){var f=G(e,a);I(e,a,c,!0,
m);if(f!=E(a))if(c=u(a),c<l())if(!1!==F(c,f,!0,m)&&C()[x(a)].def==C()[x(c)].def)c=f;else if(A(c))break;else c=f;else break;else if(c=f,!0!==d)break}else P(e,a);d=e.length;if(!1==h().greedy){c=V(e.join(""),m).split("");e.length=c.length;a=0;for(f=e.length;a<f;a++)e[a]=c[a];0==e.length&&(h().buffer=p().slice())}return b-(d-e.length)}function O(a){R=!1;var b=this,c=a.keyCode,d=w(b);j(b,d);if(c==g.keyCode.BACKSPACE||c==g.keyCode.DELETE||Z&&127==c||a.ctrlKey&&88==c){a.preventDefault();var f=d.begin;if(0==
...
c==g.keyCode.PAGE_UP?w(b,0,a.shiftKey?d.begin:0):c==g.keyCode.ESCAPE?(b._valueSet(h().undoBuffer),K(b,!0,!0)):c==g.keyCode.INSERT?(g.insertMode=!g.insertMode,w(b,!g.insertMode&&d.begin==l()?d.begin-1:d.begin)):!1==g.insertMode&&!a.shiftKey&&(c==g.keyCode.RIGHT?setTimeout(function(){var a=w(b);w(b,a.begin)},0):c==g.keyCode.LEFT&&setTimeout(function(){var a=w(b);w(b,a.begin-1)},0));g.onKeyDown.call(this,a,r(),g);L=-1!=e.inArray(c,g.ignorables)}function s(a,b,d,j,v,p){if(void 0==d&&R)return!1;R=!0;var o=
e(this),a=a||window.event,d=d||a.which||a.charCode||a.keyCode,n=String.fromCharCode(d);if(g.numericInput&&n==g.radixPoint){var s=this._valueGet().indexOf(g.radixPoint);w(this,u(-1!=s?s:l()))}if((a.ctrlKey||a.metaKey||L)&&!0!==b)return!0;if(d){var D,x;b?(b=v?p:h().p,D={begin:b,end:b}):D=w(this);b=q;e.each(z,function(a){q=a;h().undoBuffer=r().join("");if(D.end-D.begin>1||D.end-D.begin==1&&g.insertMode){a=D.end<l()?D.end:l();U(r(),D.begin,a);var b=l();if(g.greedy==false)m?y(0,a-1,E(a),true):k(D.begin,
b);else for(var c=D.begin;c<a;c++)A(c)&&(m?y(0,a-1,E(a),true):k(D.begin,b))}});q=b;if(m){var t=B(D.end),b=F(t==l()||G(r(),t)==g.radixPoint?B(t):t,n,v,m);!0===v&&(b=[{activeMasksetIndex:q,result:b}]);e.each(b,function(a,b){q=b.activeMasksetIndex;h().writeOutBuffer=true;var c=b.result;if(c!==false){var d=false,f=r();if(c!==true){d=c.refresh;t=c.pos!=void 0?c.pos:t;n=c.c!=void 0?c.c:n}if(d!==true){var d=l(),e=u(-1),c=e;if(g.insertMode==true){if(h().greedy==true)for(var j=f.slice();G(j,c,true)!=E(c)&&
c<=t;)c=c==d?d+1:u(c);if(c<=t&&(h().greedy||f.length<d)){if(f[e]!=E(e)&&f.length<d){f=T(f,-1,m);D.end!=0&&(t=t+f)}k(c,t,n)}else h().writeOutBuffer=false}else I(f,t,n,true,m)}h().p=t}});!0!==v&&S(m);if(!1!==j&&(e.each(b,function(a,b){if(b.activeMasksetIndex==q){x=b;return false}}),void 0!=x))if(setTimeout(function(){g.onKeyValidation.call(this,x.result,g)},0),h().writeOutBuffer&&!1!==x.result){var C=r();J(this,C,g.numericInput?u(h().p):h().p);setTimeout(function(){N(C)&&o.trigger("complete")},0)}else h().buffer=
h().undoBuffer.split("")}else t=u(D.begin-1),b=F(t,n,v,m),!0===v&&(b=[{activeMasksetIndex:q,result:b}]),e.each(b,function(a,b){q=b.activeMasksetIndex;h().writeOutBuffer=true;var c=b.result;if(c!==false){var d=false,f=r();if(c!==true){d=c.refresh;t=c.pos!=void 0?c.pos:t;n=c.c!=void 0?c.c:n}if(d!==true)if(g.insertMode==true){c=l();for(d=f.slice();G(d,c,true)!=E(c)&&c>=t;)c=c==0?-1:B(c);c>=t?y(t,f.length,n):h().writeOutBuffer=false}else I(f,t,n,true,m);h().p=u(t)}}),!0!==v&&S(m),!1!==j&&(e.each(b,function(a,
b){if(b.activeMasksetIndex==q){x=b;return false}}),void 0!=x&&(setTimeout(function(){g.onKeyValidation.call(this,x.result,g)},0),h().writeOutBuffer&&!1!==x.result?(t=h().p,C=r(),J(this,C,t),setTimeout(function(){N(C)&&o.trigger("complete")},0)):h().buffer=h().undoBuffer.split("")));Q&&w(this,c,f);g.showTooltip&&o.prop("title",h().mask);a.preventDefault()}}function o(a){var b=e(this),c=a.keyCode,d=r();g.onKeyUp.call(this,a,d,g);c==g.keyCode.TAB&&(b.hasClass("focus.inputmask")&&0==this._valueGet().length&&
g.showMaskOnFocus)&&(d=p().slice(),J(this,d),m||w(this,0),h().undoBuffer=this._valueGet())}var n=e(a);if(n.is(":input")){g.showTooltip&&n.prop("title",h().mask);h().greedy=h().greedy?h().greedy:0==h().repeat;var H=n.prop("maxLength");l()>H&&-1<H&&(H<p().length&&(p().length=H),!1==h().greedy&&(h().repeat=Math.round(H/p().length)),n.prop("maxLength",2*l()));n.data("inputmask",{masksets:z,activeMasksetIndex:q,opts:g,isRTL:!1});d(a);h().undoBuffer=a._valueGet();var R=!1,L=!1,m=!1;if("rtl"==a.dir||g.numericInput)("rtl"==
a.dir||g.numericInput&&g.rightAlignNumerics)&&n.css("text-align","right"),a.dir="ltr",n.removeAttr("dir"),H=n.data("inputmask"),H.isRTL=!0,n.data("inputmask",H),m=!0;n.unbind(".inputmask");n.removeClass("focus.inputmask");n.bind("mouseenter.inputmask",function(){var a=e(this),b=r();if(!a.hasClass("focus.inputmask")&&g.showMaskOnHover){a=this._valueGet().length;if(a<b.length){a==0&&(b=p().slice());J(this,b)}}}).bind("blur.inputmask",function(){var a=e(this),b=this._valueGet(),c=r();a.removeClass("focus.inputmask");
b!=h().undoBuffer&&a.change();g.clearMaskOnLostFocus&&b!=""&&(b==p().join("")?this._valueSet(""):W(this));if(!N(c)){a.trigger("incomplete");if(g.clearIncomplete)if(g.clearMaskOnLostFocus)this._valueSet("");else{c=p().slice();J(this,c)}}}).bind("focus.inputmask",function(){var a=e(this),b=this._valueGet();if(g.showMaskOnFocus&&!a.hasClass("focus.inputmask")&&(!g.showMaskOnHover||g.showMaskOnHover&&b=="")){b=b.length;if(b<r().length){if(b==0){h().buffer=p().slice();h().p=m?B(l()):u(-1)}w(this,h().p)}}a.addClass("focus.inputmask");
h().undoBuffer=this._valueGet()}).bind("mouseleave.inputmask",function(){var a=e(this);g.clearMaskOnLostFocus&&(a.hasClass("focus.inputmask")||(this._valueGet()==p().join("")||this._valueGet()==""?this._valueSet(""):W(this)))}).bind("click.inputmask",function(){var a=this;setTimeout(function(){var b=w(a),c=r();if(b.begin==b.end){var d=b.begin,f=h().lastValidPosition;j(a,b);if(m){b=g.numericInput?g.skipRadixDance===false&&g.radixPoint!=""&&e.inArray(g.radixPoint,c)!=-1?e.inArray(g.radixPoint,c):l():
B((f==void 0?l():f)+1);w(a,d>b&&(F(d,c[d],true,m)!==false||!A(d))?d:b)}else{b=u(f==void 0?-1:f);w(a,d<b&&(F(d,c[d],true,m)!==false||!A(d))?d:b)}}},0)}).bind("dblclick.inputmask",function(){var a=this;h().lastValidPosition!=void 0&&setTimeout(function(){m?w(a,B(h().lastValidPosition),l()):w(a,0,u(h().lastValidPosition))},0)}).bind("keydown.inputmask",O).bind("keypress.inputmask",s).bind("keyup.inputmask",o).bind($+".inputmask dragdrop.inputmask drop.inputmask",function(){var a=this,b=r();setTimeout(function(){w(a,
K(a,true,false));N(b)&&n.trigger("complete")},0)}).bind("setvalue.inputmask",function(){h().undoBuffer=this._valueGet();K(this,true,true);this._valueGet()==p().join("")&&this._valueSet("")}).bind("complete.inputmask",g.oncomplete).bind("incomplete.inputmask",g.onincomplete).bind("cleared.inputmask",g.oncleared);K(a,!0);var M;try{M=document.activeElement}catch(Y){}M===a?(n.addClass("focus.inputmask"),w(a,h().lastValidPosition)):g.clearMaskOnLostFocus&&(r().join("")==p().join("")?a._valueSet(""):W(a));
b(a)}}var g=e.extend(!0,{},e.inputmask.defaults,d),$=function(a){var b=document.createElement("input"),a="on"+a,c=a in b;c||(b.setAttribute(a,"return;"),c="function"==typeof b[a]);return c}("paste")?"paste":"input",Z=null!=navigator.userAgent.match(/iphone/i),Q=null!=navigator.userAgent.match(/android.*safari.*/i),X;if(Q){var Y=navigator.userAgent.match(/safari.*/i);X=533>=parseInt(RegExp(/[0-9]+/).exec(Y))}var z,q=0;if("string"==typeof a)switch(a){case "mask":return b(g.alias,d),z=y(),this.each(function(){O(this)});
case "unmaskedvalue":return z=this.data("inputmask").masksets,q=this.data("inputmask").activeMasksetIndex,g=this.data("inputmask").opts,M(this);case "remove":return this.each(function(){var a=e(this),b=this;setTimeout(function(){if(a.data("inputmask")){z=a.data("inputmask").masksets;q=a.data("inputmask").activeMasksetIndex;g=a.data("inputmask").opts;b._valueSet(M(a,!0));a.removeData("inputmask");a.unbind(".inputmask");a.removeClass("focus.inputmask");var c;Object.getOwnPropertyDescriptor&&(c=Object.getOwnPropertyDescriptor(b,
"value"));c&&c.get?b._valueGet&&Object.defineProperty(b,"value",{get:b._valueGet,set:b._valueSet}):document.__lookupGetter__&&b.__lookupGetter__("value")&&b._valueGet&&(b.__defineGetter__("value",b._valueGet),b.__defineSetter__("value",b._valueSet));delete b._valueGet;delete b._valueSet}},0)});case "getemptymask":return this.data("inputmask")?(z=this.data("inputmask").masksets,q=this.data("inputmask").activeMasksetIndex,z[q]._buffer.join("")):"";case "hasMaskedValue":return this.data("inputmask")?
!this.data("inputmask").opts.autoUnmask:!1;case "isComplete":return z=this.data("inputmask").masksets,q=this.data("inputmask").activeMasksetIndex,g=this.data("inputmask").opts,N(this[0]._valueGet().split(""));default:return b(a,d)||(g.mask=a),z=y(),this.each(function(){O(this)})}else{if("object"==typeof a)return g=e.extend(!0,{},e.inputmask.defaults,a),b(g.alias,a),z=y(),this.each(function(){O(this)});if(void 0==a)return this.each(function(){var a=e(this).attr("data-inputmask");if(a&&""!=a)try{var a=
a.replace(RegExp("'","g"),'"'),c=e.parseJSON("{"+a+"}");g=e.extend(!0,{},e.inputmask.defaults,c);b(g.alias,c);g.alias=void 0;e(this).inputmask(g)}catch(d){}})}return this})})(jQuery);
