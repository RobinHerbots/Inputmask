...
void 0!=d.pos?d.pos:A,s=void 0!=d.c?d.c:s);if(!0!==e){if(!0==f.insertMode){d=q();for(g=g.slice();D(g,d,!0)!=I(d)&&d>=A;)d=0==d?-1:B(d);d>=A?(ca(A,q(),s),g=l().lastValidPosition,d=r(g),d!=q()&&g>=A&&D(n().slice(),d,!0)!=I(d)&&(l().lastValidPosition=d)):l().writeOutBuffer=!1}else C(g,A,s,!0);if(-1==v||v>r(A))v=r(A)}else!k&&(g=A<q()?A+1:A,-1==v||v>g)&&(v=g);v>l().p&&(l().p=v)}});!0!==k&&(c=T,K());if(!1!==h&&(e.each(g,function(a,b){if(b.activeMasksetIndex==c)return p=b,!1}),void 0!=p)){var E=this;setTimeout(function(){f.onKeyValidation.call(E,
p.result,f)},0);if(l().writeOutBuffer&&!1!==p.result){var F=n();h=d?void 0:f.numericInput?A>x?B(v):s==f.radixPoint?v-1:B(v-1):v;G(this,F,h);!0!==d&&setTimeout(function(){!0===N(F)&&m.trigger("complete");O=!0;m.trigger("input")},0)}else t&&(l().buffer=l().undoBuffer.split(""))}f.showTooltip&&m.prop("title",l().mask);b&&(b.preventDefault?b.preventDefault():b.returnValue=!1)}}function na(a){var b=e(this),c=a.keyCode,d=n();k&&c==f.keyCode.BACKSPACE&&ga==this._valueGet()&&ea.call(this,a);f.onKeyUp.call(this,
a,d,f);c==f.keyCode.TAB&&f.showMaskOnFocus&&(b.hasClass("focus.inputmask")&&0==this._valueGet().length?(d=t().slice(),G(this,d),w(this,0),H=n().join("")):(G(this,d),d.join("")==t().join("")&&-1!=e.inArray(f.radixPoint,d)?(w(this,F(0)),b.click()):w(this,F(0),F(q()))))}function ha(a){if(!0===O)return O=!1,!0;a=e(this);ga=n().join("");J(this,!1,!1);G(this,n());!0===N(n())&&a.trigger("complete");a.click()}function oa(b){p=e(b);if(p.is(":input")){p.data("_inputmask",{masksets:a,activeMasksetIndex:c,opts:f,
...
w(a),c=n();if(b.begin==b.end){var b=y?F(b.begin):b.begin,d=l().lastValidPosition,c=f.isNumeric?!1===f.skipRadixDance&&""!=f.radixPoint&&-1!=e.inArray(f.radixPoint,c)?f.numericInput?r(e.inArray(f.radixPoint,c)):e.inArray(f.radixPoint,c):r(d):r(d);b<c?s(b)?w(a,b):w(a,r(b)):w(a,c)}},0)}).bind("dblclick.inputmask",function(){var a=this;setTimeout(function(){w(a,0,r(l().lastValidPosition))},0)}).bind(E+".inputmask dragdrop.inputmask drop.inputmask",function(a){if(!0===O)return O=!1,!0;var b=this,c=e(b);
if("propertychange"==a.type&&b._valueGet().length<=q())return!0;setTimeout(function(){var a=void 0!=f.onBeforePaste?f.onBeforePaste.call(this,b._valueGet()):b._valueGet();J(b,!0,!1,a.split(""),!0);!0===N(n())&&c.trigger("complete");c.click()},0)}).bind("setvalue.inputmask",function(){J(this,!0);H=n().join("");this._valueGet()==t().join("")&&this._valueSet("")}).bind("complete.inputmask",f.oncomplete).bind("incomplete.inputmask",f.onincomplete).bind("cleared.inputmask",f.oncleared).bind("keyup.inputmask",
na);k?p.bind("input.inputmask",ha):p.bind("keydown.inputmask",ea).bind("keypress.inputmask",W);g&&p.bind("input.inputmask",ha);J(b,!0,!1);H=n().join("");var u;try{u=document.activeElement}catch(m){}u===b?(p.addClass("focus.inputmask"),w(b,r(l().lastValidPosition))):f.clearMaskOnLostFocus?n().join("")==t().join("")?b._valueSet(""):X(b):G(b,n());la(b)}}var y=!1,H=n().join(""),p,ga,Y=!1,O=!1,fa=!1;if(void 0!=d)switch(d.action){case "isComplete":return N(d.buffer);case "unmaskedvalue":return y=d.$input.data("_inputmask").isRTL,
ka(d.$input,d.skipDatepickerCheck);case "mask":oa(d.el);break;case "format":return p=e({}),p.data("_inputmask",{masksets:a,activeMasksetIndex:c,opts:f,isRTL:f.numericInput}),f.numericInput&&(f.isNumeric=f.numericInput,y=!0),J(p,!1,!1,d.value.split(""),!0),n().join("")}};e.inputmask={defaults:{placeholder:"_",optionalmarker:{start:"[",end:"]"},quantifiermarker:{start:"{",end:"}"},groupmarker:{start:"(",end:")"},escapeChar:"\\",mask:null,oncomplete:e.noop,onincomplete:e.noop,oncleared:e.noop,repeat:0,
...
getMaskLength:function(a,b,c,d,g){g=a.length;b||("*"==c?g=d.length+1:1<c&&(g+=a.length*(c-1)));return g}},escapeRegex:function(a){return a.replace(RegExp("(\\/|\\.|\\*|\\+|\\?|\\||\\(|\\)|\\[|\\]|\\{|\\}|\\\\)","gim"),"\\$1")},format:function(a,b){var f=e.extend(!0,{},e.inputmask.defaults,b);c(f.alias,b,f);return m(d(f),0,f,{action:"format",value:a})}};e.fn.inputmask=function(a,b){var f=e.extend(!0,{},e.inputmask.defaults,b),g,h=0;if("string"===typeof a)switch(a){case "mask":return c(f.alias,b,f),
g=d(f),0==g.length?this:this.each(function(){m(e.extend(!0,{},g),0,f,{action:"mask",el:this})});case "unmaskedvalue":var k=e(this);return k.data("_inputmask")?(g=k.data("_inputmask").masksets,h=k.data("_inputmask").activeMasksetIndex,f=k.data("_inputmask").opts,m(g,h,f,{action:"unmaskedvalue",$input:k})):k.val();case "remove":return this.each(function(){var a=e(this);if(a.data("_inputmask")){g=a.data("_inputmask").masksets;h=a.data("_inputmask").activeMasksetIndex;f=a.data("_inputmask").opts;this._valueSet(m(g,
h,f,{action:"unmaskedvalue",$input:a,skipDatepickerCheck:!0}));a.removeData("_inputmask");a.unbind(".inputmask");a.removeClass("focus.inputmask");var b;Object.getOwnPropertyDescriptor&&(b=Object.getOwnPropertyDescriptor(this,"value"));b&&b.get?this._valueGet&&Object.defineProperty(this,"value",{get:this._valueGet,set:this._valueSet}):document.__lookupGetter__&&this.__lookupGetter__("value")&&this._valueGet&&(this.__defineGetter__("value",this._valueGet),this.__defineSetter__("value",this._valueSet));
try{delete this._valueGet,delete this._valueSet}catch(c){this._valueSet=this._valueGet=void 0}}});case "getemptymask":return this.data("_inputmask")?(g=this.data("_inputmask").masksets,h=this.data("_inputmask").activeMasksetIndex,g[h]._buffer.join("")):"";case "hasMaskedValue":return this.data("_inputmask")?!this.data("_inputmask").opts.autoUnmask:!1;case "isComplete":return g=this.data("_inputmask").masksets,h=this.data("_inputmask").activeMasksetIndex,f=this.data("_inputmask").opts,m(g,h,f,{action:"isComplete",
buffer:this[0]._valueGet().split("")});case "getmetadata":if(this.data("_inputmask"))return g=this.data("_inputmask").masksets,h=this.data("_inputmask").activeMasksetIndex,g[h].metadata;break;default:return c(a,b,f)||(f.mask=a),g=d(f),0==g.length?this:this.each(function(){m(e.extend(!0,{},g),h,f,{action:"mask",el:this})})}else{if("object"==typeof a)return f=e.extend(!0,{},e.inputmask.defaults,a),c(f.alias,a,f),g=d(f),0==g.length?this:this.each(function(){m(e.extend(!0,{},g),h,f,{action:"mask",el:this})});
if(void 0==a)return this.each(function(){var a=e(this).attr("data-inputmask");if(a&&""!=a)try{var a=a.replace(RegExp("'","g"),'"'),d=e.parseJSON("{"+a+"}");e.extend(!0,d,b);f=e.extend(!0,{},e.inputmask.defaults,d);c(f.alias,d,f);f.alias=void 0;e(this).inputmask(f)}catch(g){}})}}}})(jQuery);
