...
c=d(b);if("propertychange"==a.type&&b._valueGet().length<=p())return!0;setTimeout(function(){c.trigger("preprocessafterpaste");M(b,!0,!1,void 0,!0);!0===P(f())&&c.trigger("complete");c.click()},0)}).bind("setvalue.inputmask",function(){M(this,!0);J=f().join("");this._valueGet()==e().join("")&&this._valueSet("")}).bind("_keypress.inputmask",ga).bind("complete.inputmask",g.oncomplete).bind("incomplete.inputmask",g.onincomplete).bind("cleared.inputmask",g.oncleared).bind("keyup.inputmask",X).bind("preprocessafterpaste.inputmask",
g.preprocessAfterPaste);m?t.bind("input.inputmask",function(a){if(!0===O)return O=!1,!0;a=d(this);ia=f().join("");M(this,!1,!1);I(this,f());!0===P(f())&&a.trigger("complete");a.click()}):t.bind("keydown.inputmask",fa).bind("keypress.inputmask",ga);M(z,!0,!1);J=f().join("");var ca;try{ca=document.activeElement}catch(ha){}ca===z?(t.addClass("focus.inputmask"),v(z,q(b().lastValidPosition))):g.clearMaskOnLostFocus?f().join("")==e().join("")?z._valueSet(""):Y(z):I(z,f());Q(z)}};return this}var g=d.extend(!0,
{},d.inputmask.defaults,b),w=null!==navigator.userAgent.match(/msie 10/i),u=null!==navigator.userAgent.match(/iphone/i),z=null!==navigator.userAgent.match(/android.*safari.*/i),m=null!==navigator.userAgent.match(/android.*chrome.*/i),N=h("paste")&&!w?"paste":h("input")?"input":"propertychange",l,q=0;if("string"===typeof a)switch(a){case "mask":return e(g.alias,b),l=k(),0==l.length?this:this.each(function(){n(d.extend(!0,{},l),0).mask(this)});case "unmaskedvalue":return w=d(this),w.data("_inputmask")?
(l=w.data("_inputmask").masksets,q=w.data("_inputmask").activeMasksetIndex,g=w.data("_inputmask").opts,n(l,q).unmaskedvalue(w)):w.val();case "remove":return this.each(function(){var a=d(this);if(a.data("_inputmask")){l=a.data("_inputmask").masksets;q=a.data("_inputmask").activeMasksetIndex;g=a.data("_inputmask").opts;this._valueSet(n(l,q).unmaskedvalue(a,!0));a.removeData("_inputmask");a.unbind(".inputmask");a.removeClass("focus.inputmask");var b;Object.getOwnPropertyDescriptor&&(b=Object.getOwnPropertyDescriptor(this,
"value"));b&&b.get?this._valueGet&&Object.defineProperty(this,"value",{get:this._valueGet,set:this._valueSet}):document.__lookupGetter__&&this.__lookupGetter__("value")&&this._valueGet&&(this.__defineGetter__("value",this._valueGet),this.__defineSetter__("value",this._valueSet));try{delete this._valueGet,delete this._valueSet}catch(c){this._valueSet=this._valueGet=void 0}}});case "getemptymask":return this.data("_inputmask")?(l=this.data("_inputmask").masksets,q=this.data("_inputmask").activeMasksetIndex,
l[q]._buffer.join("")):"";case "hasMaskedValue":return this.data("_inputmask")?!this.data("_inputmask").opts.autoUnmask:!1;case "isComplete":return l=this.data("_inputmask").masksets,q=this.data("_inputmask").activeMasksetIndex,g=this.data("_inputmask").opts,n(l,q).isComplete(this[0]._valueGet().split(""));case "getmetadata":if(this.data("_inputmask"))return l=this.data("_inputmask").masksets,q=this.data("_inputmask").activeMasksetIndex,l[q].metadata;return;default:return e(a,b)||(g.mask=a),l=k(),
0==l.length?this:this.each(function(){n(d.extend(!0,{},l),q).mask(this)})}else{if("object"==typeof a)return g=d.extend(!0,{},d.inputmask.defaults,a),e(g.alias,a),l=k(),0==l.length?this:this.each(function(){n(d.extend(!0,{},l),q).mask(this)});if(void 0==a)return this.each(function(){var a=d(this).attr("data-inputmask");if(a&&""!=a)try{var a=a.replace(RegExp("'","g"),'"'),c=d.parseJSON("{"+a+"}");d.extend(!0,c,b);g=d.extend(!0,{},d.inputmask.defaults,c);e(g.alias,c);g.alias=void 0;d(this).inputmask(g)}catch(h){}})}return this})})(jQuery);
