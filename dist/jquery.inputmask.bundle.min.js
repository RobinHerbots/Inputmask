...
function(a,c){b("",c.toString())}):b("",g.mask.toString());return c}function h(){return y[p]}function C(){return h().tests}function q(){return h()._buffer}function r(){return h().buffer}function G(a,b,c,d){function f(a,d){for(var e=x(a),v=b?1:0,j="",h=d.buffer,l=d.tests[e].cardinality;l>v;l--)j+=F(h,e-(l-1));b&&(j+=b);return null!=d.tests[e].fn?d.tests[e].fn.test(j,h,a,c,g):!1}if(c){var j=f(a,h());!0===j&&(j={pos:a});return j}var k=[],j=!1,t=p;e.each(y,function(c){p=c;if(t!=p&&!A(a)){if(b==this._buffer[a]||
...
e}else this.lastValidPosition=d?a==l()?void 0:u(a):0==a?void 0:B(a);k.push({activeMasksetIndex:c,result:j})}});p=t;return k}function S(a){var b=p,c={activeMasksetIndex:0,lastValidPosition:a?l()+1:-1};e.each(y,function(b){if(void 0!=this.lastValidPosition&&(a||g.numericInput?this.lastValidPosition<c.lastValidPosition:this.lastValidPosition>c.lastValidPosition))c.activeMasksetIndex=b,c.lastValidPosition=this.lastValidPosition});p=c.activeMasksetIndex;b!=p&&(h().writeOutBuffer=!0)}function A(a){a=x(a);
...
d=j.selectionEnd):document.selection&&document.selection.createRange&&(a=document.selection.createRange(),b=0-a.duplicate().moveStart("character",-1E5),d=b+a.text.length);return{begin:b,end:d}}}function N(a){var b=!1,c=0,d=p;e.each(y,function(d,e){p=d;var f=B(l());if(void 0!=e.lastValidPosition&&e.lastValidPosition>=c&&e.lastValidPosition==f){for(var j=!0,g=0;g<=f;g++){var h=A(g),k=x(g);if(h&&(void 0==a[g]||a[g]==E(g))||!h&&a[g]!=q()[k]){j=!1;break}}if(b=b||j)return!1}c=e.lastValidPosition});p=d;
...
function k(a,b,c){for(var d=r();!A(a)&&0<=a-1;)a--;for(var e=a;e<b&&e<l();e++)if(A(e)){P(d,e);var f=u(e),j=F(d,f);if(j!=E(f))if(f<l()&&!1!==G(e,j,!0,m)&&C()[x(e)].def==C()[x(f)].def)I(d,e,F(d,f),!0,m),f<b&&P(d,f);else if(A(e))break}else P(d,e);void 0!=c&&I(d,m?b:B(b),c);if(!1==h().greedy){b=V(d.join(""),m).split("");d.length=b.length;e=0;for(c=d.length;e<c;e++)d[e]=b[e];0==d.length&&(h().buffer=q().slice())}return a}function z(a,b,c,d){for(var e=r();a<=b&&a<l();a++)if(A(a)){var f=F(e,a);I(e,a,c,!0,
m);if(f!=E(a))if(c=u(a),c<l())if(!1!==G(c,f,!0,m)&&C()[x(a)].def==C()[x(c)].def)c=f;else if(A(c))break;else c=f;else break;else if(c=f,!0!==d)break}else P(e,a);d=e.length;if(!1==h().greedy){c=V(e.join(""),m).split("");e.length=c.length;a=0;for(f=e.length;a<f;a++)e[a]=c[a];0==e.length&&(h().buffer=q().slice())}return b-(d-e.length)}function O(a){R=!1;var b=this,c=a.keyCode,d=w(b);j(b,d);if(c==g.keyCode.BACKSPACE||c==g.keyCode.DELETE||Z&&127==c||a.ctrlKey&&88==c){a.preventDefault();var f=d.begin;if(0==
d.begin&&d.end==l())U(r(),d.begin,d.end),e.each(y,function(a,b){b.buffer=b._buffer.slice();b.lastValidPosition=void 0;b.p=m?l():0});else if(1<d.end-d.begin||1==d.end-d.begin&&g.insertMode){U(r(),d.begin,d.end);var v=l();if(!1==g.greedy)m?z(0,d.end-1,E(d.end),!0):k(d.begin,v);else for(var o=d.begin;o<d.end;o++)A(o)&&(m?z(0,d.end-1,E(d.end),!0):k(d.begin,v));K(b,!1,!0,r())}else e.each(y,function(a){p=a;f=X?d.end:d.begin;var a=r(),b=m?B(l()+1):u(-1),e=l();if(c==g.keyCode.DELETE){if(m?f>b:f<b)f=b;if(f<
e&&(g.numericInput&&""!=g.radixPoint&&a[f]==g.radixPoint?(f=a.length-1==f?f:u(f),f=k(f,e)):m?(f=z(0,f,E(f),!0),f=u(f)):f=k(f,e),void 0!=h().lastValidPosition))-1!=h().lastValidPosition&&r()[h().lastValidPosition]==q()[h().lastValidPosition]&&(h().lastValidPosition=m?u(h().lastValidPosition):0==h().lastValidPosition?-1:B(h().lastValidPosition)),(m?h().lastValidPosition>b:h().lastValidPosition<b)?(h().lastValidPosition=void 0,h().p=b):(h().writeOutBuffer=!0,h().p=f)}else if(c==g.keyCode.BACKSPACE)if(m?
...
!0,h().p=f)}else 0<p&&(h().lastValidPosition=void 0,h().writeOutBuffer=!0,h().p=b,p=0,h().buffer=q().slice(),h().p=m?B(l()+1):u(-1),h().lastValidPosition=void 0)});S(m);J(b,r(),h().p);b._valueGet()==q().join("")&&e(b).trigger("cleared");g.showTooltip&&n.prop("title",h().mask)}else c==g.keyCode.END||c==g.keyCode.PAGE_DOWN?setTimeout(function(){var c=m?h().lastValidPosition:u(h().lastValidPosition);!g.insertMode&&(c==l()&&!a.shiftKey)&&c--;w(b,a.shiftKey?d.begin:c,c)},0):c==g.keyCode.HOME&&!a.shiftKey||
c==g.keyCode.PAGE_UP?w(b,0,a.shiftKey?d.begin:0):c==g.keyCode.ESCAPE?(b._valueSet(h().undoBuffer),K(b,!0,!0)):c==g.keyCode.INSERT?(g.insertMode=!g.insertMode,w(b,!g.insertMode&&d.begin==l()?d.begin-1:d.begin)):!1==g.insertMode&&!a.shiftKey&&(c==g.keyCode.RIGHT?setTimeout(function(){var a=w(b);w(b,a.begin)},0):c==g.keyCode.LEFT&&setTimeout(function(){var a=w(b);w(b,a.begin-1)},0));g.onKeyDown.call(this,a,r(),g);L=-1!=e.inArray(c,g.ignorables)}function t(a,b,d,j,v,q){if(void 0==d&&R)return!1;R=!0;var o=
e(this),a=a||window.event,d=d||a.which||a.charCode||a.keyCode,n=String.fromCharCode(d);if(g.numericInput&&n==g.radixPoint){var t=this._valueGet().indexOf(g.radixPoint);w(this,u(-1!=t?t:l()))}if((a.ctrlKey||a.metaKey||L)&&!0!==b)return!0;if(d){var D,x;b?(b=v?q:h().p,D={begin:b,end:b}):D=w(this);b=p;e.each(y,function(a){p=a;h().undoBuffer=r().join("");if(D.end-D.begin>1||D.end-D.begin==1&&g.insertMode){a=D.end<l()?D.end:l();U(r(),D.begin,a);var b=l();if(g.greedy==false)m?z(0,a-1,E(a),true):k(D.begin,
b);else for(var c=D.begin;c<a;c++)A(c)&&(m?z(0,a-1,E(a),true):k(D.begin,b))}});p=b;if(m){var s=B(D.end),b=G(s==l()||F(r(),s)==g.radixPoint?B(s):s,n,v,m);!0===v&&(b=[{activeMasksetIndex:p,result:b}]);e.each(b,function(a,b){p=b.activeMasksetIndex;h().writeOutBuffer=true;var c=b.result;if(c!==false){var d=false,f=r();if(c!==true){d=c.refresh;s=c.pos!=void 0?c.pos:s;n=c.c!=void 0?c.c:n}if(d!==true){var d=l(),e=u(-1),c=e;if(g.insertMode==true){if(h().greedy==true)for(var j=f.slice();F(j,c,true)!=E(c)&&
c<=s;)c=c==d?d+1:u(c);if(c<=s&&(h().greedy||f.length<d||F(f,s)==E(s))){if(f[e]!=E(e)&&f.length<d){f=T(f,-1,m);D.end!=0&&(s=s+f)}k(c,s,n)}else h().writeOutBuffer=false}else I(f,s,n,true,m)}h().p=s}});!0!==v&&S(m);if(!1!==j&&(e.each(b,function(a,b){if(b.activeMasksetIndex==p){x=b;return false}}),void 0!=x))if(setTimeout(function(){g.onKeyValidation.call(this,x.result,g)},0),h().writeOutBuffer&&!1!==x.result){var C=r();J(this,C,g.numericInput?u(h().p):h().p);setTimeout(function(){N(C)&&o.trigger("complete")},
...
j&&(e.each(b,function(a,b){if(b.activeMasksetIndex==p){x=b;return false}}),void 0!=x&&(setTimeout(function(){g.onKeyValidation.call(this,x.result,g)},0),h().writeOutBuffer&&!1!==x.result?(s=h().p,C=r(),J(this,C,s),setTimeout(function(){N(C)&&o.trigger("complete")},0)):h().buffer=h().undoBuffer.split("")));Q&&w(this,c,f);g.showTooltip&&o.prop("title",h().mask);a.preventDefault()}}function o(a){var b=e(this),c=a.keyCode,d=r();g.onKeyUp.call(this,a,d,g);c==g.keyCode.TAB&&(b.hasClass("focus.inputmask")&&
...
a?(n.addClass("focus.inputmask"),w(a,h().lastValidPosition)):g.clearMaskOnLostFocus&&(r().join("")==q().join("")?a._valueSet(""):W(a));b(a)}}var g=e.extend(!0,{},e.inputmask.defaults,d),$=function(a){var b=document.createElement("input"),a="on"+a,c=a in b;c||(b.setAttribute(a,"return;"),c="function"==typeof b[a]);return c}("paste")?"paste":"input",Z=null!=navigator.userAgent.match(/iphone/i),Q=null!=navigator.userAgent.match(/android.*safari.*/i),X;if(Q){var Y=navigator.userAgent.match(/safari.*/i);
X=533>=parseInt(RegExp(/[0-9]+/).exec(Y))}var y,p=0;if("string"==typeof a)switch(a){case "mask":return b(g.alias,d),y=z(),this.each(function(){O(this)});case "unmaskedvalue":return y=this.data("inputmask").masksets,p=this.data("inputmask").activeMasksetIndex,g=this.data("inputmask").opts,M(this);case "remove":return this.each(function(){var a=e(this),b=this;setTimeout(function(){if(a.data("inputmask")){y=a.data("inputmask").masksets;p=a.data("inputmask").activeMasksetIndex;g=a.data("inputmask").opts;
...
(y=this.data("inputmask").masksets,p=this.data("inputmask").activeMasksetIndex,y[p]._buffer.join("")):"";case "hasMaskedValue":return this.data("inputmask")?!this.data("inputmask").opts.autoUnmask:!1;case "isComplete":return y=this.data("inputmask").masksets,p=this.data("inputmask").activeMasksetIndex,g=this.data("inputmask").opts,N(this[0]._valueGet().split(""));default:return b(a,d)||(g.mask=a),y=z(),this.each(function(){O(this)})}else{if("object"==typeof a)return g=e.extend(!0,{},e.inputmask.defaults,
...
urlpre8:/(ftp:\/\/|ftps:\/\/|http:\/\/|https:\/\/)/},definitions:{i:{validator:function(){return!0},cardinality:8,prevalidator:function(){for(var a=[],d=0;8>d;d++)a[d]=function(){var a=d;return{validator:function(d,b,e,k,z){if(z.regex["urlpre"+(a+1)]){var h=d;0<a+1-d.length&&(h=b.join("").substring(0,a+1-d.length)+""+h);d=z.regex["urlpre"+(a+1)].test(h);if(!k&&!d){e-=a;for(k=0;k<z.defaultPrefix.length;k++)b[e]=z.defaultPrefix[k],e++;for(k=0;k<h.length-1;k++)b[e]=h[k],e++;return{pos:e}}return d}return!1},
