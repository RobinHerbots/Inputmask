...
(function webpackUniversalModuleDefinition(e, t) {
    if (typeof exports === "object" && typeof module === "object") module.exports = t(require("jQuery")); else if (typeof define === "function" && define.amd) define([ "jQuery" ], t); else {
        var a = typeof exports === "object" ? t(require("jQuery")) : t(e["jQuery"]);
    ...
    return function(a) {
                ...
                n.fn.inputmask = function(e, t) {
                    ...
                    if (typeof e === "string") {
                        switch (e) {
                          ...
                          case "hasMaskedValue":
                            return i && i.inputmask ? i.inputmask.hasMaskedValue() : false;

                          case "isComplete":
                            return i && i.inputmask ? i.inputmask.isComplete() : true;

                          case "getmetadata":
                            return i && i.inputmask ? i.inputmask.getmetadata() : undefined;
        ...
        (function(e) {
            if (true) {
                !(r = [ i(3), i(4) ], n = e, s = typeof n === "function" ? n.apply(a, r) : n, s !== undefined && (t.exports = s));
            } else {}
        })(function(L, S, V) {
            var _ = S.document, e = navigator.userAgent, P = e.indexOf("MSIE ") > 0 || e.indexOf("Trident/") > 0, E = isInputEventSupported("touchstart"), T = /iemobile/i.test(e), x = /iphone/i.test(e) && !T;
            function Inputmask(e, t, a) {
                ...
                if (a !== true) {
                    ...
                    this.opts = L.extend(true, {}, this.defaults, t);
            ...
            Inputmask.prototype = {
                ...
                mask: function mask(e) {
                    ...
                    L.each(e, function(e, t) {
                        var a = L.extend(true, {}, n.opts);
                        if (importAttributeOptions(t, a, L.extend(true, {}, n.userOptions), n.dataAttribute)) {
                            ...
                            if (i !== V) {
                                ...
                                t.inputmask.userOptions = L.extend(true, {}, n.userOptions);
                                t.inputmask.isRTL = a.isRTL || a.numericInput;
                                t.inputmask.el = t;
                                t.inputmask.maskset = i;
                                L.data(t, "_inputmask_opts", a);
                ...
                setValue: function setValue(e) {
                    if (this.el) {
                        L(this.el).trigger("setvalue", [ e ]);
                    }
                },
                analyseMask: function analyseMask(e, r, s) {
                    var t = /(?:[?*+]|\{[0-9\+\*]+(?:,[0-9\+\*]*)?(?:\|[0-9\+\*]*)?\})|[^.?*+^${[]()|\\]+|./g, a = /\[\^?]?(?:[^\\\]]+|\\[\S\s]?)*]?|\\(?:0(?:[0-3][0-7]{0,2}|[4-7][0-7]?)?|[1-9][0-9]*|x[0-9A-Fa-f]{2}|u[0-9A-Fa-f]{4}|c[A-Za-z]|[\S\s]?)|\((?:\?[:=!]?)?|(?:[?*+]|\{[0-9]+(?:,[0-9]*)?\})\??|[^.?*+^${[()|\\]+|./g, o = false, i = new MaskToken(), n, l, u = [], f = [], c, p, k, m, g;
                          ...
                          case s.groupmarker[1]:
                            ...
                            if (c !== V) {
                                if (u.length > 0) {
                                    ...
                                    if (p.isAlternator) {
                                        k = u.pop();
                                        for (var d = 0; d < k.matches.length; d++) {
                                            k.matches[d].isGroup = false;
                                            k.matches[d].alternatorGroup = false;
                                        }
                                        if (u.length > 0) {
                                            p = u[u.length - 1];
                                            p.matches.push(k);
            ...
            Inputmask.extendDefaults = function(e) {
                L.extend(true, Inputmask.prototype.defaults, e);
            };
            Inputmask.extendDefinitions = function(e) {
                L.extend(true, Inputmask.prototype.definitions, e);
            };
            Inputmask.extendAliases = function(e) {
                L.extend(true, Inputmask.prototype.aliases, e);
            };
            ...
            Inputmask.setValue = function(e, a) {
                ...
                e = e.nodeName ? [ e ] : e;
                L.each(e, function(e, t) {
                    if (t.inputmask) t.inputmask.setValue(a); else L(t).trigger("setvalue", [ a ]);
                });
            };
            ...
            function generateMaskSet(a, o) {
                function generateMask(e, t, a) {
                    ...
                    if (Inputmask.prototype.masksCache[s] === V || o === true) {
                        ...
                        if (o !== true) {
                            ...
                            r = L.extend(true, {}, Inputmask.prototype.masksCache[s]);
                        }
                    } else r = L.extend(true, {}, Inputmask.prototype.masksCache[s]);
                    return r;
                }
                var e;
                if (L.isFunction(a.mask)) {
                    a.mask = a.mask(a);
                }
                if (L.isArray(a.mask)) {
                    if (a.mask.length > 1) {
                        ...
                        L.each(a.isRTL ? a.mask.reverse() : a.mask, function(e, t) {
                            if (i.length > 1) {
                                i += a.groupmarker[1] + a.alternatormarker + a.groupmarker[0];
                            }
                            if (t.mask !== V && !L.isFunction(t.mask)) {
                                i += t.mask;
                            } else {
                                i += t;
                            }
                ...
                if (a.mask && a.mask.mask !== V && !L.isFunction(a.mask.mask)) {
            ...
            function maskScope(e, t, D) {
                t = t || this.maskset;
                D = D || this.opts;
                var f = this, l = this.el, m = this.isRTL, g, n, s = false, u = false, d = false, h, i = false, p, r;
                function getMaskTemplate(e, t, a, i, n) {
                    ...
                    do {
                        if (e === true && getMaskSet().validPositions[l]) {
                            f = n && getMaskSet().validPositions[l].match.optionality === true && getMaskSet().validPositions[l + 1] === V && (getMaskSet().validPositions[l].generatedInput === true || getMaskSet().validPositions[l].input == D.skipOptionalPartCharacter && l > 0) ? determineTestTemplate(l, getTests(l, o, l - 1)) : getMaskSet().validPositions[l];
                            u = f.match;
                            o = f.locator.slice();
                ...
                function getTests(w, e, t) {
                    var a = getMaskSet().maskToken, B = e ? t : 0, i = e ? e.slice() : [ 0 ], A = [], O = false, I, j = e ? e.join("") : "";
                    function resolveTestFromToken(x, C, e, t) {
                        function handleMatch(e, t, a) {
                            function isFirstMatch(a, i) {
                                var n = L.inArray(a, i.matches) === 0;
                                if (!n) {
                                    L.each(i.matches, function(e, t) {
                            ...
                            function resolveNdxInitializer(e, n, r) {
                                ...
                                if (getMaskSet().tests[e] || getMaskSet().validPositions[e]) {
                                    L.each(getMaskSet().tests[e] || [ getMaskSet().validPositions[e] ], function(e, t) {
                                        if (t.mloc[n]) {
                                            s = t;
                                            return false;
                                        }
                            ...
                            function isSubsetOf(e, t) {
                                ...
                                if (D.regex && e.match.fn !== null && t.match.fn !== null) {
                            ...
                            function staticCanMatchDefinition(e, t) {
                                ...
                                n = n && e.match.fn === null && t.match.fn !== null ? t.match.fn.test(e.match.def, getMaskSet(), w, false, D, false) : false;
                                return n;
                            }
                            ...
                            if (B === w && e.matches === V) {
                                ...
                                if (e.isGroup && a !== e) {
                                    e = handleMatch(x.matches[L.inArray(e, x.matches) + 1], t, a);
                                    if (e) return true;
                                    ...
                                    if (e) {
                                        ...
                                        I = A[A.length - 1].match;
                                        if (a === V && isFirstMatch(I, i)) {
                                            O = true;
                                            B = w;
                                        } else return true;
                                    }
                                    ...
                                    if (u === -1 || typeof u === "string") {
                                        ...
                                        if (getMaskSet().excludes[w]) {
                                            var m = p.slice();
                                            for (var g = 0, d = getMaskSet().excludes[w].length; g < d; g++) {
                                                p.splice(p.indexOf(getMaskSet().excludes[w][g].toString()), 1);
                                            }
                                            if (p.length === 0) {
                                        ...
                                        if (D.keepStatic === true || isFinite(parseInt(D.keepStatic)) && f >= D.keepStatic) p = p.slice(0, 1);
                                        var h = false;
                                        for (var v = 0; v < p.length; v++) {
                                            ...
                                            for (var b = 0; b < s.length; b++) {
                                                ...
                                                for (var S = 0; S < r.length; S++) {
                                                    var _ = r[S];
                                                    if (typeof u !== "string" || y.alternation !== V && L.inArray(y.locator[y.alternation].toString(), p) !== -1) {
                                        ...
                                        e = r.length > 0;
                                        C = c.slice();
                                    } else e = handleMatch(n.matches[u] || x.matches[u], [ u ].concat(t), a);
                                    if (e) return true;
                                } else if (e.isQuantifier && a !== x.matches[L.inArray(e, x.matches) - 1]) {
                                    var P = e;
                                    for (var E = C.length > 0 ? C.shift() : 0; E < (isNaN(P.quantifier.max) ? E + 1 : P.quantifier.max) && B <= w; E++) {
                                        var T = x.matches[L.inArray(P, x.matches) - 1];
                                        e = handleMatch(T, [ E ].concat(t), T);
                                        if (e) {
                                            I = A[A.length - 1].match;
                                            I.optionalQuantifier = E > P.quantifier.min - 1;
                                            I.jit = (E || 1) * T.matches.indexOf(I) >= P.quantifier.jit;
                                            if (I.optionalQuantifier && isFirstMatch(I, T)) {
                                                O = true;
                                                B = w;
                                                break;
                                            }
                                            if (I.jit && !I.optionalQuantifier) {
                                                I.jitOffset = T.matches.indexOf(I);
                                            }
                                            return true;
                                        }
                                    }
                        ...
                        for (var a = C.length > 0 ? C.shift() : 0; a < x.matches.length; a++) {
                            if (x.matches[a].isQuantifier !== true) {
                                var i = handleMatch(x.matches[a], [ a ].concat(e), t);
                                if (i && B === w) {
                                    return i;
                                } else if (B > w) {
                                    break;
                    ...
                    if (w > -1) {
                        ...
                        if (getMaskSet().tests[w] && getMaskSet().tests[w][0].cd === j) {
                    ...
                    if (e !== V && getMaskSet().tests[w]) {
                        return L.extend(true, [], A);
                    }
                    getMaskSet().tests[w] = L.extend(true, [], A);
                ...
                function refreshFromBuffer(e, t, a) {
                    ...
                    for (i = e; i < t; i++) {
                        resetMaskSet(true);
                        if (a[i] !== D.skipOptionalPartCharacter) {
                ...
                function casing(e, t, a) {
                    switch (D.casing || t.casing) {
                      ...
                      default:
                        if (L.isFunction(D.casing)) {
                            var n = Array.prototype.slice.call(arguments);
                            n.push(getMaskSet().validPositions);
                            e = D.casing.apply(this, n);
                        }
                    }
                    return e;
                }
                function checkAlternationMatch(e, t, a) {
                    var i = D.greedy ? t : t.slice(0, 1), n = false, r = a !== V ? a.split(",") : [], s;
                ...
                function alternate(e, t, a, i, n) {
                    var r = L.extend(true, {}, getMaskSet().validPositions), s, o, l = false, u, f, c, p, k, m = n !== V ? n : getLastValidPosition();
                    if (m === -1 && n === V) {
                        s = 0;
                        f = getTest(s);
                        o = f.alternation;
                    ...
                    if (o !== V) {
                        ...
                        while (getMaskSet().excludes[k] && getMaskSet().excludes[k].length < 10) {
                            ...
                            if (!l) {
                                resetMaskSet();
                                f = getTest(k);
                                getMaskSet().validPositions = L.extend(true, {}, r);
                ...
                function isValid(u, e, t, f, a, i) {
                    ...
                    function _isValid(r, s, o) {
                        var l = false;
                        L.each(getTests(r), function(e, t) {
                            var a = t.match;
                            getBuffer(true);
                            l = a.fn != null ? a.fn.test(s, getMaskSet(), r, o, D, isSelection(u)) : (s === a.def || s === D.skipOptionalPartCharacter) && a.def !== "" ? {
                                c: getPlaceholder(r, a, true) || a.def,
                                pos: r
                            } : false;
                            if (l !== false) {
                                var i = l.c !== V ? l.c : s, n = r;
                                i = i === D.skipOptionalPartCharacter && a.fn === null ? getPlaceholder(r, a, true) || a.def : i;
                                if (l.remove !== V) {
                                    if (!L.isArray(l.remove)) l.remove = [ l.remove ];
                                    L.each(l.remove.sort(function(e, t) {
                                        return t - e;
                                    }), function(e, t) {
                                        revalidateMask({
                                            begin: t,
                                ...
                                if (l.insert !== V) {
                                    if (!L.isArray(l.insert)) l.insert = [ l.insert ];
                                    L.each(l.insert.sort(function(e, t) {
                                        return e - t;
                                    }), function(e, t) {
                                ...
                                if (!revalidateMask(u, L.extend({}, t, {
                                    input: casing(i, a, n)
                                }), f, n)) {
                                    l = false;
                                }
                    ...
                    var r = true, s = L.extend(true, {}, getMaskSet().validPositions);
                    if (L.isFunction(D.preValidation) && !t && f !== true && i !== true) {
                        r = D.preValidation(getBuffer(), n, e, isSelection(u), D, getMaskSet());
                    }
                    if (r === true) {
                        ...
                        if (h === V || n < h) {
                            ...
                            if ((!t || f === true) && r === false && i !== true) {
                                ...
                                if (o && o.match.fn === null && (o.match.def === e || e === D.skipOptionalPartCharacter)) {
                                    r = {
                                        caret: seekNext(n)
                                    };
                                } else if ((D.insertMode || getMaskSet().validPositions[seekNext(n)] === V) && !isMask(n, true)) {
                        ...
                        if (r === false && D.keepStatic !== false && (D.regex == null || isComplete(getBuffer())) && !t && a !== true) {
                            r = alternate(n, e, t, f);
                        }
                        if (r === true) {
                            r = {
                    ...
                    if (L.isFunction(D.postValidation) && r !== false && !t && f !== true && i !== true) {
                        var p = D.postValidation(getBuffer(true), u.begin !== V ? m ? u.end : u.begin : u, r, D);
                        if (p !== V) {
                    ...
                    if (r === false || i === true) {
                        resetMaskSet(true);
                        getMaskSet().validPositions = L.extend(true, {}, s);
                    }
                    return r;
                }
                ...
                function revalidateMask(e, t, a, i) {
                    function IsEnclosedStatic(e, t, a) {
                        var i = t[e];
                        if (i !== V && (i.match.fn === null && i.match.optionality !== true || i.input === D.radixPoint)) {
                    ...
                    i = i !== V ? i : n;
                    if (n !== r || D.insertMode && getMaskSet().validPositions[i] !== V && a === V) {
                        var s = L.extend(true, {}, getMaskSet().validPositions), o = getLastValidPosition(V, true), l;
                        getMaskSet().p = n;
                        for (l = o; l >= n; l--) {
                        ...
                        if (t) {
                            getMaskSet().validPositions[i] = L.extend(true, {}, t);
                            k++;
                            f++;
                            if (n < r) l++;
                        }
                        for (;l <= o; l++) {
                            var m = s[l];
                            if (m !== V && (l >= r || l >= n && m.generatedInput !== true && IsEnclosedStatic(l, s, {
                                begin: n,
                                end: r
                            }))) {
                                while (getTest(k).match.def !== "") {
                                    if (p === false && s[k] && s[k].match.nativeDef === m.match.nativeDef) {
                                        getMaskSet().validPositions[k] = L.extend(true, {}, s[k]);
                                        getMaskSet().validPositions[k].input = m.input;
                                        trackbackPositions(V, k, true);
                                        f = k + 1;
                                        u = true;
                                    } else if (D.shiftPositions && positionCanMatchDefinition(k, m.match.def)) {
                                        var g = isValid(k, m.input, true, true);
                                        u = g !== false;
                                        f = g.caret || g.insert ? getLastValidPosition() : k + 1;
                                        p = true;
                                    } else {
                                        u = m.generatedInput === true || m.input === D.radixPoint && D.numericInput === true;
                                    }
                                    if (u) break;
                                    if (!u && k > r && isMask(k, true) && (m.match.fn !== null || k > getMaskSet().maskLength)) {
                                        break;
                                    }
                                    k++;
                                }
                ...
                function writeBuffer(e, t, a, i, n) {
                    if (i && L.isFunction(D.onBeforeWrite)) {
                        var r = D.onBeforeWrite.call(f, i, t, a, D);
                        if (r) {
                ...
                function getPlaceholder(e, t, a) {
                    ...
                    if (t.placeholder !== V || a === true) {
                        return L.isFunction(t.placeholder) ? t.placeholder(D) : t.placeholder;
                    } else if (t.fn === null) {
                        if (e > -1 && getMaskSet().validPositions[e] === V) {
                            var i = getTests(e), n = [], r;
                            if (i.length > 1 + (i[i.length - 1].match.def === "" ? 1 : 0)) {
                                for (var s = 0; s < i.length; s++) {
                                    if (i[s].match.optionality !== true && i[s].match.optionalQuantifier !== true && (i[s].match.fn === null || r === V || i[s].match.fn.test(r.match.def, getMaskSet(), e, true, D) !== false)) {
                                        n.push(i[s]);
                ...
                var o = {
                    on: function on(e, t, r) {
                        var a = function ev(e) {
                            ...
                            } else if (e.type !== "setvalue" && this.nodeName !== "FORM" && (t.disabled || t.readOnly && !(e.type === "keydown" && e.ctrlKey && e.keyCode === 67 || D.tabThrough === false && e.keyCode === Inputmask.keyCode.TAB))) {
                                e.preventDefault();
                            } else {
                                switch (e.type) {
                                  case "input":
                        ...
                        if (L.inArray(t, [ "submit", "reset" ]) !== -1) {
                            if (e.form !== null) L(e.form).on(t, a);
                        } else {
                            L(e).on(t, a);
                        }
                    },
                    off: function off(i, e) {
                        if (i.inputmask && i.inputmask.events) {
                            ...
                            L.each(t, function(e, t) {
                                while (t.length > 0) {
                                    var a = t.pop();
                                    if (L.inArray(e, [ "submit", "reset" ]) !== -1) {
                                        if (i.form !== null) L(i.form).off(e, a);
                                    } else {
                                        L(i).off(e, a);
                                    }
                                }
                ...
                var v = {
                    keydownEvent: function keydownEvent(e) {
                        ...
                        if (i === Inputmask.keyCode.BACKSPACE || i === Inputmask.keyCode.DELETE || x && i === Inputmask.keyCode.BACKSPACE_SAFARI || e.ctrlKey && i === Inputmask.keyCode.X && !isInputEventSupported("cut")) {
                            e.preventDefault();
                            handleRemove(t, i, n);
                        ...
                        } else if ((D.undoOnEscape && i === Inputmask.keyCode.ESCAPE || i === 90 && e.ctrlKey) && e.altKey !== true) {
                            checkVal(t, true, false, g.split(""));
                            a.trigger("click");
                        } else if (i === Inputmask.keyCode.INSERT && !(e.shiftKey || e.ctrlKey)) {
                            D.insertMode = !D.insertMode;
                            t.setAttribute("im-insert", D.insertMode);
                        } else if (D.tabThrough === true && i === Inputmask.keyCode.TAB) {
                            if (e.shiftKey === true) {
                        ...
                        D.onKeyDown.call(this, e, getBuffer(), caret(t).begin, D);
                        d = L.inArray(i, D.ignorables) !== -1;
                    },
                    keypressEvent: function keypressEvent(e, t, a, i, n) {
                        var r = this, s = L(r), o = e.which || e.charCode || e.keyCode;
                        if (t !== true && !(e.ctrlKey && e.altKey) && (e.ctrlKey || e.metaKey || d)) {
                            ...
                            if (o) {
                                if (o === 46 && e.shiftKey === false && D.radixPoint !== "") o = D.radixPoint.charCodeAt(0);
                                var l = t ? {
                                    begin: n,
                                    end: n
                                } : caret(r), u, f = String.fromCharCode(o), c = 0;
                                if (D._radixDance && D.numericInput) {
                                    var p = getBuffer().indexOf(D.radixPoint.charAt(0)) + 1;
                                    if (l.begin <= p) {
                                        if (o === D.radixPoint.charCodeAt(0)) c = 1;
                                        l.begin -= 1;
                                        l.end -= 1;
                                    }
                                }
                                ...
                                u = (D.numericInput && k.caret === V ? seekPrevious(u) : u) + c;
                                if (a !== false) {
                                    setTimeout(function() {
                                        D.onKeyValidation.call(r, o, k, D);
                                    }, 0);
                    ...
                    pasteEvent: function pasteEvent(e) {
                        var t = this, a = e.originalEvent || e, i = L(t), n = t.inputmask._valueGet(true), r = caret(t), s;
                        if (m) {
                            s = r.end;
                            r.end = r.begin;
                            r.begin = s;
                        ...
                        var u = n;
                        if (L.isFunction(D.onBeforePaste)) {
                            u = D.onBeforePaste.call(f, n, D);
                            if (u === false) {
                                return e.preventDefault();
                            }
                            if (!u) {
                    ...
                    inputFallBackEvent: function inputFallBackEvent(e) {
                        function radixPointHandler(e, t, a) {
                            if (t.charAt(a.begin - 1) === "." && D.radixPoint !== "") {
                                t = t.split("");
                                t[a.begin - 1] = D.radixPoint.charAt(0);
                                t = t.join("");
                            }
                            return t;
                        }
                        ...
                        if (getBuffer().join("") !== t) {
                            ...
                            if (getBuffer().join("") !== t) {
                                var n = getBuffer().join(""), r = !D.numericInput && t.length > n.length ? -1 : 0, s = t.substr(0, a.begin), o = t.substr(a.begin), l = n.substr(0, a.begin + r), u = n.substr(a.begin + r);
                                var f = a, c = "", p = false;
                                if (s !== l) {
                                    var k = (p = s.length >= l.length) ? s.length : l.length, m;
                                    for (m = 0; s.charAt(m) === l.charAt(m) && m < k; m++) {}
                                    if (p) {
                                        f.begin = m - r;
                                        c += s.slice(m, f.end);
                                    }
                                ...
                                if (o !== u) {
                                    if (o.length > u.length) {
                                        ...
                                        if (o.length < u.length) {
                                            ...
                                            if (!p && D.radixPoint !== "" && o === "" && s.charAt(f.begin + r - 1) === D.radixPoint) {
                                                f.begin--;
                                                c = D.radixPoint;
                                            }
                                        }
                                ...
                                if (c.length > 0) {
                                    ...
                                    var g = new L.Event("keydown");
                                    g.keyCode = D.numericInput ? Inputmask.keyCode.BACKSPACE : Inputmask.keyCode.DELETE;
                                    v.keydownEvent.call(i, g);
                                }
                                e.preventDefault();
                            }
                        }
                    ...
                    beforeInputEvent: function beforeInputEvent(e) {
                        if (e.cancelable) {
                            ...
                            switch (e.inputType) {
                              case "insertText":
                                L.each(e.data.split(""), function(e, t) {
                                    var a = new L.Event("keypress");
                                    a.which = t.charCodeAt(0);
                                    d = false;
                                    v.keypressEvent.call(i, a);
                    ...
                    setValueEvent: function setValueEvent(e) {
                        ...
                        if (L.isFunction(D.onBeforeMask)) a = D.onBeforeMask.call(f, a, D) || a;
                        a = a.split("");
                        checkVal(t, true, false, a);
                        g = getBuffer().join("");
                        if ((D.clearMaskOnLostFocus || D.clearIncomplete) && t.inputmask._valueGet() === getBufferTemplate().join("")) {
                            t.inputmask._valueSet("");
                        }
                    },
                    focusEvent: function focusEvent(e) {
                        var t = this, a = t.inputmask._valueGet();
                        if (D.showMaskOnFocus && (!D.showMaskOnHover || D.showMaskOnHover && a === "")) {
                        ...
                        if (D.positionCaretOnTab === true && i === false) {
                    ...
                    mouseleaveEvent: function mouseleaveEvent(e) {
                        var t = this;
                        i = false;
                        if (D.clearMaskOnLostFocus && _.activeElement !== t) {
                        ...
                        function doRadixFocus(e) {
                            if (D.radixPoint !== "") {
                                ...
                                if (t[e] === V || t[e].input === getPlaceholder(e)) {
                                    ...
                                    var a = L.inArray(D.radixPoint, getBuffer());
                                    if (a !== -1) {
                                        for (var i in t) {
                                    ...
                                    switch (D.positionCaretOnClick) {
                                      ...
                                      case "radixFocus":
                                        if (doRadixFocus(e.begin)) {
                                            var t = getBuffer().join("").indexOf(D.radixPoint);
                                            caret(f, D.numericInput ? seekNext(t) : t);
                                            break;
                                        }
                                      ...
                                      default:
                                        ...
                                        if (a < n) {
                                            ...
                                            if (o !== "" && getBuffer()[n] !== o && s.match.optionalQuantifier !== true && s.match.newBlockMarker !== true || !isMask(n, D.keepStatic) && s.match.def === o) {
                                                var l = seekNext(n);
                                                if (a >= l || a === n) {
                                                    n = l;
                                                }
                    ...
                    cutEvent: function cutEvent(e) {
                        var t = this, a = L(t), i = caret(t), n = e.originalEvent || e;
                        var r = S.clipboardData || n.clipboardData, s = m ? getBuffer().slice(i.end, i.begin) : getBuffer().slice(i.begin, i.end);
                    ...
                    mouseenterEvent: function mouseenterEvent(e) {
                        var t = this;
                        i = true;
                        if (_.activeElement !== t && D.showMaskOnHover) {
                    ...
                    submitEvent: function submitEvent(e) {
                        ...
                        if (D.clearMaskOnLostFocus && getLastValidPosition() === -1 && l.inputmask._valueGet && l.inputmask._valueGet() === getBufferTemplate().join("")) {
                            l.inputmask._valueSet("");
                        }
                        if (D.clearIncomplete && isComplete(getBuffer()) === false) {
                            l.inputmask._valueSet("");
                        }
                        if (D.removeMaskOnSubmit) {
                ...
                function checkVal(n, e, r, t, a) {
                    ...
                    if (e) writeBuffer(n, getBuffer(), f ? f.forwardPosition : V, a || new L.Event("checkval"), a && a.type === "input");
                }
                function unmaskedvalue(e) {
                    ...
                    if (L.isFunction(D.onUnMask)) {
                        var r = (m ? getBuffer().slice().reverse() : getBuffer()).join("");
                        n = D.onUnMask.call(f, r, n, D);
                    }
                    return n;
                }
                function caret(e, t, a, i) {
                    function translatePosition(e) {
                        if (m && typeof e === "number" && (!D.greedy || D.placeholder !== "") && l) {
                ...
                function isComplete(e) {
                    if (L.isFunction(D.isComplete)) return D.isComplete(e, D);
                    if (D.repeat === "*") return V;
                ...
                function handleRemove(e, t, a, i, n) {
                    ...
                    if (t === Inputmask.keyCode.BACKSPACE && a.end - a.begin < 1) {
                        ...
                        if (getMaskSet().validPositions[a.begin] !== V && getMaskSet().validPositions[a.begin].input === D.groupSeparator) {
                            a.begin--;
                        }
                    } else if (t === Inputmask.keyCode.DELETE && a.begin === a.end) {
                        a.end = isMask(a.end, true) && getMaskSet().validPositions[a.end] && getMaskSet().validPositions[a.end].input !== D.radixPoint ? a.end + 1 : seekNext(a.end) + 1;
                        if (getMaskSet().validPositions[a.begin] !== V && getMaskSet().validPositions[a.begin].input === D.groupSeparator) {
                            a.end++;
                        }
                    }
                    revalidateMask(a);
                    if (i !== true && D.keepStatic !== false || D.regex !== null) {
                ...
                function initializeColorMask(u) {
                    ...
                    L(p).on("mouseleave", function(e) {
                        return v.mouseleaveEvent.call(u, [ e ]);
                    });
                    L(p).on("mouseenter", function(e) {
                        return v.mouseenterEvent.call(u, [ e ]);
                    });
                    L(p).on("click", function(e) {
                        ...
                        if (a !== true) {
                            ...
                            do {
                                if (getMaskSet().validPositions[l]) {
                                    ...
                                    r = s.match;
                                    o = s.locator.slice();
                                    if (D.jitMasking === false || l < f || typeof D.jitMasking === "number" && isFinite(D.jitMasking) && D.jitMasking > l) {
                ...
                function mask(e) {
                    function isElementTypeSupported(e, r) {
                        function patchValueProperty(e) {
                            ...
                            function patchValhook(e) {
                                if (L.valHooks && (L.valHooks[e] === V || L.valHooks[e].inputmaskpatch !== true)) {
                                    var a = L.valHooks[e] && L.valHooks[e].get ? L.valHooks[e].get : function(e) {
                                        return e.value;
                                    };
                                    var n = L.valHooks[e] && L.valHooks[e].set ? L.valHooks[e].set : function(e, t) {
                                        e.value = t;
                                        return e;
                                    };
                                    L.valHooks[e] = {
                            ...
                            function getter() {
                                if (this.inputmask) {
                                    return this.inputmask.opts.autoUnmask ? this.inputmask.unmaskedvalue() : getLastValidPosition() !== -1 || r.nullable !== true ? _.activeElement === this && r.clearMaskOnLostFocus ? (m ? clearOptionalTail(getBuffer().slice()).reverse() : clearOptionalTail(getBuffer().slice())).join("") : t.call(this) : "";
                                } else return t.call(this);
                            }
                            function setter(e) {
                                a.call(this, e);
                                if (this.inputmask) {
                                    L(this).trigger("setvalue", [ e ]);
                                }
                            }
                            function installNativeValueSetFallback(e) {
                                o.on(e, "mouseenter", function(e) {
                                    var t = L(this), a = this, i = a.inputmask._valueGet();
                                    if (i !== getBuffer().join("")) {
                                        t.trigger("setvalue");
                                    }
                                });
                            ...
                            if (!e.inputmask.__valueGet) {
                                ...
                                e.inputmask._valueSet = function(e, t) {
                                    a.call(this.el, e === null || e === V ? "" : t !== true && m ? e.split("").reverse().join("") : e);
                                };
                                if (t === V) {
                                    t = function valueGet() {
                                        return this.value;
                        ...
                        var a = e.tagName === "INPUT" && L.inArray(t, r.supportsInputType) !== -1 || e.isContentEditable || e.tagName === "TEXTAREA";
                        if (!a) {
                            if (e.tagName === "INPUT") {
                    ...
                    o.off(e);
                    var t = isElementTypeSupported(e, D);
                    if (t !== false) {
                        l = e;
                        n = L(l);
                        r = l.placeholder;
                        ...
                        if (E) {
                            if ("inputmode" in l) {
                                l.inputmode = D.inputmode;
                                l.setAttribute("inputmode", D.inputmode);
                            }
                            if (D.disablePredictiveText === true) {
                                if ("autocorrect" in l) {
                                    l.autocorrect = false;
                                } else {
                                    if (D.colorMask !== true) {
                        ...
                        if (t === true) {
                            l.setAttribute("im-insert", D.insertMode);
                            ...
                            o.on(l, "complete", D.oncomplete);
                            o.on(l, "incomplete", D.onincomplete);
                            o.on(l, "cleared", D.oncleared);
                            if (!E && D.inputEventOnly !== true) {
                        ...
                        if (l.inputmask._valueGet(true) !== "" || D.clearMaskOnLostFocus === false || _.activeElement === l) {
                            var a = L.isFunction(D.onBeforeMask) ? D.onBeforeMask.call(f, l.inputmask._valueGet(true), D) || l.inputmask._valueGet(true) : l.inputmask._valueGet(true);
                            ...
                            if (D.clearMaskOnLostFocus && _.activeElement !== l) {
                            ...
                            if (D.clearMaskOnLostFocus === false || D.showMaskOnFocus && _.activeElement === l || l.inputmask._valueGet(true) !== "") writeBuffer(l, i);
                ...
                if (e !== V) {
                    switch (e.action) {
                      ...
                      case "unmaskedvalue":
                        if (l === V || e.value !== V) {
                            a = e.value;
                            a = (L.isFunction(D.onBeforeMask) ? D.onBeforeMask.call(f, a, D) || a : a).split("");
                            checkVal.call(this, V, false, false, a);
                            if (L.isFunction(D.onBeforeWrite)) D.onBeforeWrite.call(f, V, getBuffer(), 0, D);
                        }
                      ...
                      case "format":
                        a = (L.isFunction(D.onBeforeMask) ? D.onBeforeMask.call(f, e.value, D) || e.value : e.value).split("");
                      ...
                      case "remove":
                        if (l && l.inputmask) {
                            L.data(l, "_inputmask_opts", null);
                            n = L(l);
                            l.inputmask._valueSet(D.autoUnmask ? unmaskedvalue(l) : l.inputmask._valueGet(true));
                            o.off(l);
                      ...
                      case "getmetadata":
                        if (L.isArray(t.metadata)) {
                            ...
                            L.each(t.metadata, function(e, t) {
                                if (t.mask === M) {
                                    M = t;
                                    return false;
                                }
        ...
        (function(e) {
            if (true) {
                !(r = [ i(1) ], n = e, s = typeof n === "function" ? n.apply(a, r) : n, s !== undefined && (t.exports = s));
            } else {}
        })(function(e) {
            return e;
        });
