    ...
    return function(a) {
        ...
        i = [ a(0) ], void 0 === (r = "function" == typeof (n = function(s) {
            ...
            function parse(e, t, a, n) {
                for (var i, r = ""; i = getTokenizer(a).exec(e); ) if (void 0 === t) if (u[i[0]]) r += "(" + u[i[0]][0] + ")"; else switch (i[0]) {
                  case "[":
                    r += "(";
                    break;
                  ...
                  default:
                    r += s.escapeRegex(i[0]);
                } else if (u[i[0]]) if (!0 !== n && u[i[0]][3]) {
                    var o = u[i[0]][3];
                    r += o.call(t.date);
                } else u[i[0]][2] ? r += t["raw" + u[i[0]][2]] : r += i[0]; else r += i[0];
                return r;
            }
            function pad(e, t) {
            ...
            function analyseMask(e, t, r) {
                ...
                if ("string" == typeof s) {
                    for (;a = getTokenizer(r).exec(t); ) {
                        ...
                        u.hasOwnProperty(a[0]) && (u[a[0]][0], o = u[a[0]][2], n = u[a[0]][1], setValue(i, l)), 
                        s = s.slice(l.length);
                    }
                    return i;
                }
                ...
                datetime: {
                    ...
                    postValidation: function postValidation(e, t, a, n) {
                        ...
                        return i && r.date.getTime() == r.date.getTime() && (i = (i = function isValidDate(e, t) {
                            ...
                            if (t.min) {
                                if (e.rawyear) {
                                    var n = e.rawyear.replace(/[^0-9]/g, ""), i = t.min.year.substr(0, n.length);
                                    a = i <= n;
                                }
