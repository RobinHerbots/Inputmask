...
You can find/modify/extend these aliases in lib/extensions/ (extensions.js aggregates the individual ip, email, url, cssunit, mac, vin, ssn and definitions modules).
