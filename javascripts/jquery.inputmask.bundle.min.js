...
a!=g.optionalmarker.end||b){var f=g.definitions[a];if(f&&!b)for(var h=0;h<f.cardinality;h++)c.push(z(d+h));else c.push(a),b=!1;d+=c.length;return c}});for(var h=a.slice(),s=1;s<f&&c;s++)h=h.concat(a.slice());return{mask:h,repeat:f,greedy:c}}function h(a){g.numericInput&&(a=a.split("").reverse().join(""));var b=!1,d=!1,c=!1;return e.map(a.split(""),function(a,e){var f=[];if(a==g.escapeChar)d=!0;else{if(a!=g.optionalmarker.start||d){if(a!=g.optionalmarker.end||d){var h=g.definitions[a];if(h&&!d){for(var R=
h.prevalidator,k=R?R.length:0,p=1;p<h.cardinality;p++){var l=k>=p?R[p-1]:[],m=l.validator,l=l.cardinality;f.push({fn:m?"string"==typeof m?RegExp(m):new function(){this.test=m}:/./,cardinality:l?l:1,optionality:b,newBlockMarker:!0==b?c:!1,offset:0,casing:h.casing,def:h.definitionSymbol||a});!0==b&&(c=!1)}f.push({fn:h.validator?"string"==typeof h.validator?RegExp(h.validator):new function(){this.test=h.validator}:/./,cardinality:h.cardinality,optionality:b,newBlockMarker:c,offset:0,casing:h.casing,
...
function n(a,b){function c(){return a[b]}function d(){return c().tests}function f(){return c()._buffer}function h(){return c().buffer}function k(d,f,E){function l(a,c,b,f){for(var d=q(a),h=b?1:0,e="",G=c.buffer,T=c.tests[d].cardinality;T>h;T--)e+=H(G,d-(T-1));b&&(e+=b);return null!=c.tests[d].fn?c.tests[d].fn.test(e,G,a,f,g):b==H(c._buffer,a,!0)||b==g.skipOptionalPartCharacter?{refresh:!0,c:H(c._buffer,a,!0),pos:a}:!1}if(E=!0===E){var C=l(d,c(),f,E);!0===C&&(C={pos:d});return C}var m=[],C=!1,s=b,
v=h().slice(),t=c().lastValidPosition;w(d);var u=[];e.each(a,function(a,e){if("object"==typeof e){b=a;var g=d,k=c().lastValidPosition,q;if(k==t){if(1<g-t)for(k=-1==k?0:k;k<g&&(q=l(k,c(),v[k],!0),!1!==q);k++)I(h(),k,v[k],!0),!0===q&&(q={pos:k}),q=q.pos||k,c().lastValidPosition<q&&(c().lastValidPosition=q);if(!r(g)&&!l(g,c(),f,E)){k=n(g)-g;for(q=0;q<k&&!1===l(++g,c(),f,E);q++);u.push(b)}}(c().lastValidPosition>=t||b==s)&&0<=g&&g<p()&&(C=l(g,c(),f,E),!1!==C&&(!0===C&&(C={pos:g}),q=C.pos||g,c().lastValidPosition<
q&&(c().lastValidPosition=q)),m.push({activeMasksetIndex:a,result:C}))}});b=s;return function(c,b){var g=!1;e.each(b,function(a,b){if(g=-1==e.inArray(b.activeMasksetIndex,c)&&!1!==b.result)return!1});if(g)b=e.map(b,function(b,h){if(-1==e.inArray(b.activeMasksetIndex,c))return b;a[b.activeMasksetIndex].lastValidPosition=t});else{var h=-1,k=-1;e.each(b,function(a,b){-1!=e.inArray(b.activeMasksetIndex,c)&&!1!==b.result&(-1==h||h>b.result.pos)&&(h=b.result.pos,k=b.activeMasksetIndex)});b=e.map(b,function(b,
g){if(-1!=e.inArray(b.activeMasksetIndex,c)){if(b.result.pos==h)return b;if(!1!==b.result){for(var G=d;G<h;G++)if(rsltValid=l(G,a[b.activeMasksetIndex],a[k].buffer[G],!0),!1===rsltValid){a[b.activeMasksetIndex].lastValidPosition=h-1;break}else I(a[b.activeMasksetIndex].buffer,G,a[k].buffer[G],!0),a[b.activeMasksetIndex].lastValidPosition=G;rsltValid=l(h,a[b.activeMasksetIndex],f,!0);!1!==rsltValid&&(I(a[b.activeMasksetIndex].buffer,h,f,!0),a[b.activeMasksetIndex].lastValidPosition=h);return b}}})}return b}(u,
m)}function l(){var d=b,f={activeMasksetIndex:0,lastValidPosition:-1,next:-1};e.each(a,function(a,d){"object"==typeof d&&(b=a,c().lastValidPosition>f.lastValidPosition?(f.activeMasksetIndex=a,f.lastValidPosition=c().lastValidPosition,f.next=n(c().lastValidPosition)):c().lastValidPosition==f.lastValidPosition&&(-1==f.next||f.next>n(c().lastValidPosition))&&(f.activeMasksetIndex=a,f.lastValidPosition=c().lastValidPosition,f.next=n(c().lastValidPosition)))});b=-1!=f.lastValidPosition&&a[d].lastValidPosition==
f.lastValidPosition?d:f.activeMasksetIndex;d!=b&&(V(h(),n(f.lastValidPosition),p()),c().writeOutBuffer=!0);t.data("_inputmask").activeMasksetIndex=b}function r(a){a=q(a);a=d()[a];return void 0!=a?a.fn:!1}function q(a){return a%d().length}function p(){return g.getMaskLength(f(),c().greedy,c().repeat,h(),g)}function n(a){var b=p();if(a>=b)return b;for(;++a<b&&!r(a););return a}function w(a){if(0>=a)return 0;for(;0<--a&&!r(a););return a}function I(a,b,c,f){f&&(b=O(a,b));f=d()[q(b)];var h=c;if(void 0!=
h&&void 0!=f)switch(f.casing){case "upper":h=c.toUpperCase();break;case "lower":h=c.toLowerCase()}a[b]=h}function H(a,b,c){c&&(b=O(a,b));return a[b]}function O(a,b){for(var c;void 0==a[b]&&a.length<p();)for(c=0;void 0!==f()[c];)a.push(f()[c++]);return b}function K(a,b,c){a._valueSet(b.join(""));void 0!=c&&v(a,c)}function V(a,b,c,h){for(var d=p();b<c&&b<d;b++)!0===h?r(b)||I(a,b,""):I(a,b,H(f().slice(),b,!0))}function P(a,b){var c=q(b);I(a,b,H(f(),c))}function L(h,d,k,l){l=void 0!=l?l.slice():W(h._valueGet()).split("");
e.each(a,function(a,b){"object"==typeof b&&(b.buffer=b._buffer.slice(),b.lastValidPosition=-1,b.p=-1)});!0!==k&&(b=0);d&&h._valueSet("");p();e.each(l,function(a,b){var l=c().lastValidPosition,q=-1==l?a:n(l);(e.isArray(g.mask)||-1==e.inArray(b,f().slice(l+1,q)))&&e(h).trigger("_keypress",[!0,b.charCodeAt(0),d,k,a])});!0===k&&-1!=c().p&&(c().lastValidPosition=w(c().p))}function X(a){return e.inputmask.escapeRegex.call(this,a)}function W(a){return a.replace(RegExp("("+X(f().join(""))+")*$"),"")}function Y(a){var b=
h(),c=b.slice(),f,g;for(g=c.length-1;0<=g;g--)if(f=q(g),d()[f].optionality)if(r(g)&&k(g,b[g],!0))break;else c.pop();else break;K(a,c)}function Z(a,b){if(!d()||!0!==b&&a.hasClass("hasDatepicker"))return a[0]._valueGet();var c=e.map(h(),function(a,b){return r(b)&&k(b,a,!0)?a:null});return(A?c.reverse():c).join("")}function N(a){!A||"number"!=typeof a||g.greedy&&""==g.placeholder||(a=h().length-a);return a}function v(a,b,c){var f=a.jquery&&0<a.length?a[0]:a;if("number"==typeof b)b=N(b),c=N(c),e(a).is(":visible")&&
(c="number"==typeof c?c:b,f.scrollLeft=f.scrollWidth,!1==g.insertMode&&b==c&&c++,f.setSelectionRange?(f.selectionStart=b,f.selectionEnd=u?b:c):f.createTextRange&&(a=f.createTextRange(),a.collapse(!0),a.moveEnd("character",c),a.moveStart("character",b),a.select()));else{if(!e(a).is(":visible"))return{begin:0,end:0};f.setSelectionRange?(b=f.selectionStart,c=f.selectionEnd):document.selection&&document.selection.createRange&&(a=document.selection.createRange(),b=0-a.duplicate().moveStart("character",
-1E5),c=b+a.text.length);b=N(b);c=N(c);return{begin:b,end:c}}}function Q(c){var h=!1,d=0,g=b;e.each(a,function(a,g){if("object"==typeof g){b=a;var e=w(p());if(g.lastValidPosition>=d&&g.lastValidPosition==e){for(var k=!0,l=0;l<=e;l++){var n=r(l),m=q(l);if(n&&(void 0==c[l]||c[l]==z(l))||!n&&c[l]!=f()[m]){k=!1;break}}if(h=h||k)return!1}d=g.lastValidPosition}});b=g;return h}var A=!1,D=h().join(""),t;this.unmaskedvalue=function(a,b){A=a.data("_inputmask").isRTL;return Z(a,b)};this.isComplete=function(a){return Q(a)};
this.mask=function(u){function O(a){a=e._data(a).events;e.each(a,function(a,b){e.each(b,function(a,b){if("inputmask"==b.namespace&&"setvalue"!=b.type&&"_keypress"!=b.type){var c=b.handler;b.handler=function(a){if(this.readOnly||this.disabled)a.preventDefault;else return c.apply(this,arguments)}}})})}function E(a){var b;Object.getOwnPropertyDescriptor&&(b=Object.getOwnPropertyDescriptor(a,"value"));if(b&&b.get){if(!a._valueGet){var c=b.get,f=b.set;a._valueGet=function(){return A?c.call(this).split("").reverse().join(""):
c.call(this)};a._valueSet=function(a){f.call(this,A?a.split("").reverse().join(""):a)};Object.defineProperty(a,"value",{get:function(){var a=e(this),b=e(this).data("_inputmask"),f=b.masksets,h=b.activeMasksetIndex;return b&&b.opts.autoUnmask?a.inputmask("unmaskedvalue"):c.call(this)!=f[h]._buffer.join("")?c.call(this):""},set:function(a){f.call(this,a);e(this).triggerHandler("setvalue.inputmask")}})}}else if(document.__lookupGetter__&&a.__lookupGetter__("value"))a._valueGet||(c=a.__lookupGetter__("value"),
f=a.__lookupSetter__("value"),a._valueGet=function(){return A?c.call(this).split("").reverse().join(""):c.call(this)},a._valueSet=function(a){f.call(this,A?a.split("").reverse().join(""):a)},a.__defineGetter__("value",function(){var a=e(this),b=e(this).data("_inputmask"),f=b.masksets,h=b.activeMasksetIndex;return b&&b.opts.autoUnmask?a.inputmask("unmaskedvalue"):c.call(this)!=f[h]._buffer.join("")?c.call(this):""}),a.__defineSetter__("value",function(a){f.call(this,a);e(this).triggerHandler("setvalue.inputmask")}));
else if(a._valueGet||(a._valueGet=function(){return A?this.value.split("").reverse().join(""):this.value},a._valueSet=function(a){this.value=A?a.split("").reverse().join(""):a}),void 0==e.valHooks.text||!0!=e.valHooks.text.inputmaskpatch)c=e.valHooks.text&&e.valHooks.text.get?e.valHooks.text.get:function(a){return a.value},f=e.valHooks.text&&e.valHooks.text.set?e.valHooks.text.set:function(a,b){a.value=b;return a},jQuery.extend(e.valHooks,{text:{get:function(a){var b=e(a);if(b.data("_inputmask")){if(b.data("_inputmask").opts.autoUnmask)return b.inputmask("unmaskedvalue");
a=c(a);b=b.data("_inputmask");return a!=b.masksets[b.activeMasksetIndex]._buffer.join("")?a:""}return c(a)},set:function(a,b){var c=e(a),h=f(a,b);c.data("_inputmask")&&c.triggerHandler("setvalue.inputmask");return h},inputmaskpatch:!0}})}function $(a,b,g,e){var l=h();if(!1!==e)for(;!r(a)&&0<=a-1;)a--;for(e=a;e<b&&e<p();e++)if(r(e)){P(l,e);var m=n(e),u=H(l,m);if(u!=z(m))if(m<p()&&!1!==k(e,u,!0)&&d()[q(e)].def==d()[q(m)].def)I(l,e,H(l,m),!0),m<b&&P(l,m);else if(r(e))break}else P(l,e);void 0!=g&&I(l,
w(b),g);if(!1==c().greedy){b=W(l.join("")).split("");l.length=b.length;e=0;for(g=l.length;e<g;e++)l[e]=b[e];0==l.length&&(c().buffer=f().slice())}return a}function C(a,b,g,e){for(var l=h();a<=b&&a<p();a++)if(r(a)){var m=H(l,a,!0);I(l,a,g,!0);if(m!=z(a))if(g=n(a),g<p())if(!1!==k(g,m,!0)&&d()[q(a)].def==d()[q(g)].def)g=m;else if(r(g))break;else g=m;else break;else if(g=m,!0!==e)break}else P(l,a);e=l.length;if(!1==c().greedy){g=W(l.join("")).split("");l.length=g.length;a=0;for(m=l.length;a<m;a++)l[a]=
g[a];0==l.length&&(c().buffer=f().slice())}return b-(e-l.length)}function da(b,f,d){if(g.numericInput||A){switch(f){case g.keyCode.BACKSPACE:f=g.keyCode.DELETE;break;case g.keyCode.DELETE:f=g.keyCode.BACKSPACE}if(A){var e=d.end;d.end=d.begin;d.begin=e}}e=!0;d.begin==d.end?(e=f==g.keyCode.BACKSPACE?d.begin-1:d.begin,g.isNumeric&&""!=g.radixPoint&&h()[e]==g.radixPoint&&(d.begin=h().length-1==e?d.begin:f==g.keyCode.BACKSPACE?e:n(e),d.end=d.begin),e=!1,f==g.keyCode.BACKSPACE?d.begin--:f==g.keyCode.DELETE&&
d.end++):1!=d.end-d.begin||g.insertMode||(e=!1,f==g.keyCode.BACKSPACE&&d.begin--);V(h(),d.begin,d.end);var l=p();if(!1==g.greedy)$(d.begin,l,void 0,!A&&f==g.keyCode.BACKSPACE&&!e);else{for(var k=d.begin,m=d.begin;m<d.end;m++)if(r(m)||!e)k=$(d.begin,l,void 0,!A&&f==g.keyCode.BACKSPACE&&!e);e||(d.begin=k)}f=n(-1);V(h(),d.begin,d.end,!0);L(b,!1,void 0==a[1]||f>=d.end,h());c().lastValidPosition<f?(c().lastValidPosition=-1,c().p=f):c().p=d.begin}function X(a){U=!1;var b=this,d=e(b),k=a.keyCode,m=v(b);
k==g.keyCode.BACKSPACE||k==g.keyCode.DELETE||M&&127==k||a.ctrlKey&&88==k?(a.preventDefault(),88==k&&(D=h().join("")),da(b,k,m),l(),K(b,h(),c().p),b._valueGet()==f().join("")&&d.trigger("cleared"),g.showTooltip&&d.prop("title",c().mask)):k==g.keyCode.END||k==g.keyCode.PAGE_DOWN?setTimeout(function(){var f=n(c().lastValidPosition);g.insertMode||f!=p()||a.shiftKey||f--;v(b,a.shiftKey?m.begin:f,f)},0):k==g.keyCode.HOME&&!a.shiftKey||k==g.keyCode.PAGE_UP?v(b,0,a.shiftKey?m.begin:0):k==g.keyCode.ESCAPE||
90==k&&a.ctrlKey?(L(b,!0,!1,D.split("")),d.click()):k!=g.keyCode.INSERT||a.shiftKey||a.ctrlKey?!1!=g.insertMode||a.shiftKey||(k==g.keyCode.RIGHT?setTimeout(function(){var a=v(b);v(b,a.begin)},0):k==g.keyCode.LEFT&&setTimeout(function(){var a=v(b);v(b,a.begin-1)},0)):(g.insertMode=!g.insertMode,v(b,g.insertMode||m.begin!=p()?m.begin:m.begin-1));d=v(b);!0===g.onKeyDown.call(this,a,h(),g)&&v(b,d.begin,d.end);aa=-1!=e.inArray(k,g.ignorables)}function ea(f,d,m,q,u,r){if(void 0==m&&U)return!1;U=!0;var t=
e(this);f=f||window.event;m=m||f.which||f.charCode||f.keyCode;if((!f.ctrlKey||!f.altKey)&&(f.ctrlKey||f.metaKey||aa)&&!0!==d)return!0;if(m){!0!==d&&46==m&&!1==f.shiftKey&&","==g.radixPoint&&(m=44);var x,M,y=String.fromCharCode(m);d?(m=u?r:c().lastValidPosition+1,x={begin:m,end:m}):x=v(this);r=A?1<x.begin-x.end||1==x.begin-x.end&&g.insertMode:1<x.end-x.begin||1==x.end-x.begin&&g.insertMode;var E=b;r&&(b=E,e.each(a,function(a,f){"object"==typeof f&&(b=a,c().undoBuffer=h().join(""))}),da(this,g.keyCode.DELETE,
x),g.insertMode||e.each(a,function(a,f){"object"==typeof f&&(b=a,C(x.begin,p(),z(x.begin),!0),c().lastValidPosition=n(c().lastValidPosition))}),b=E);var D=h().join("").indexOf(g.radixPoint);g.isNumeric&&!0!==d&&-1!=D&&(g.greedy&&x.begin<=D?(x.begin=w(x.begin),x.end=x.begin):y==g.radixPoint&&(x.begin=D,x.end=x.begin));var B=x.begin;m=k(B,y,u);!0===u&&(m=[{activeMasksetIndex:b,result:m}]);var F=-1;e.each(m,function(a,f){b=f.activeMasksetIndex;c().writeOutBuffer=!0;var d=f.result;if(!1!==d){var e=!1,
k=h();!0!==d&&(e=d.refresh,B=void 0!=d.pos?d.pos:B,y=void 0!=d.c?d.c:y);if(!0!==e){if(!0==g.insertMode){d=p();for(e=k.slice();H(e,d,!0)!=z(d)&&d>=B;)d=0==d?-1:w(d);d>=B?(C(B,k.length,y),k=c().lastValidPosition,d=n(k),d!=p()&&k>=B&&H(h(),d,!0)!=z(d)&&(c().lastValidPosition=d)):c().writeOutBuffer=!1}else I(k,B,y,!0);if(-1==F||F>n(B))F=n(B)}else!u&&(k=B<p()?B+1:B,-1==F||F>k)&&(F=k);F>c().p&&(c().p=F)}});!0!==u&&(b=E,l());if(!1!==q&&(e.each(m,function(a,c){if(c.activeMasksetIndex==b)return M=c,!1}),void 0!=
M)){var J=this;setTimeout(function(){g.onKeyValidation.call(J,M.result,g)},0);if(c().writeOutBuffer&&!1!==M.result){var L=h();q=d?void 0:g.numericInput?B>D?w(F):y==g.radixPoint?F-1:w(F-1):F;K(this,L,q);!0!==d&&setTimeout(function(){Q(L)&&t.trigger("complete")},0)}else r&&(c().buffer=c().undoBuffer.split(""))}g.showTooltip&&t.prop("title",c().mask);f.preventDefault()}}function Z(a){var b=e(this),c=a.keyCode,d=h();g.onKeyUp.call(this,a,d,g);c==g.keyCode.TAB&&g.showMaskOnFocus&&(b.hasClass("focus.inputmask")&&
0==this._valueGet().length?(d=f().slice(),K(this,d),v(this,0),D=h().join("")):(K(this,d),v(this,0,p())))}t=e(u);if(t.is(":input")){t.data("_inputmask",{masksets:a,activeMasksetIndex:b,opts:g,isRTL:!1});g.showTooltip&&t.prop("title",c().mask);c().greedy=c().greedy?c().greedy:0==c().repeat;if(null!=t.attr("maxLength")){var J=t.prop("maxLength");-1<J&&e.each(a,function(a,b){"object"==typeof b&&"*"==b.repeat&&(b.repeat=J)});p()>J&&-1<J&&(J<f().length&&(f().length=J),!1==c().greedy&&(c().repeat=Math.round(J/
f().length)),t.prop("maxLength",2*p()))}E(u);var U=!1,aa=!1;g.numericInput&&(g.isNumeric=g.numericInput);("rtl"==u.dir||g.numericInput&&g.rightAlignNumerics||g.isNumeric&&g.rightAlignNumerics)&&t.css("text-align","right");if("rtl"==u.dir||g.numericInput){u.dir="ltr";t.removeAttr("dir");var ba=t.data("_inputmask");ba.isRTL=!0;t.data("_inputmask",ba);A=!0}t.unbind(".inputmask");t.removeClass("focus.inputmask");t.closest("form").bind("submit",function(){D!=h().join("")&&t.change()}).bind("reset",function(){setTimeout(function(){t.trigger("setvalue")},
0)});t.bind("mouseenter.inputmask",function(){!e(this).hasClass("focus.inputmask")&&g.showMaskOnHover&&this._valueGet()!=h().join("")&&K(this,h())}).bind("blur.inputmask",function(){var c=e(this),d=this._valueGet(),k=h();c.removeClass("focus.inputmask");D!=h().join("")&&c.change();g.clearMaskOnLostFocus&&""!=d&&(d==f().join("")?this._valueSet(""):Y(this));Q(k)||(c.trigger("incomplete"),g.clearIncomplete&&(e.each(a,function(a,b){"object"==typeof b&&(b.buffer=b._buffer.slice(),b.lastValidPosition=-1)}),
b=0,g.clearMaskOnLostFocus?this._valueSet(""):(k=f().slice(),K(this,k))))}).bind("focus.inputmask",function(){var a=e(this),b=this._valueGet();g.showMaskOnFocus&&!a.hasClass("focus.inputmask")&&(!g.showMaskOnHover||g.showMaskOnHover&&""==b)&&this._valueGet()!=h().join("")&&K(this,h(),n(c().lastValidPosition));a.addClass("focus.inputmask");D=h().join("")}).bind("mouseleave.inputmask",function(){var a=e(this);g.clearMaskOnLostFocus&&(a.hasClass("focus.inputmask")||this._valueGet()==a.attr("placeholder")||
(this._valueGet()==f().join("")||""==this._valueGet()?this._valueSet(""):Y(this)))}).bind("click.inputmask",function(){var a=this;setTimeout(function(){var b=v(a),d=h();if(b.begin==b.end){var b=g.isRTL?N(b.begin):b.begin,f=c().lastValidPosition,d=g.isNumeric?!1===g.skipRadixDance&&""!=g.radixPoint&&-1!=e.inArray(g.radixPoint,d)?g.numericInput?n(e.inArray(g.radixPoint,d)):e.inArray(g.radixPoint,d):n(f):n(f);b<d?r(b)?v(a,b):v(a,n(b)):v(a,d)}},0)}).bind("dblclick.inputmask",function(){var a=this;setTimeout(function(){v(a,
0,n(c().lastValidPosition))},0)}).bind("keydown.inputmask",X).bind("keypress.inputmask",ea).bind("keyup.inputmask",Z).bind(m+".inputmask dragdrop.inputmask drop.inputmask",function(a){var b=this,c=e(b);if("propertychange"==a.type&&b._valueGet().length<=p())return!0;setTimeout(function(){L(b,!0,!1);Q(h())&&c.trigger("complete");c.click()},0)}).bind("setvalue.inputmask",function(){L(this,!0);D=h().join("");this._valueGet()==f().join("")&&this._valueSet("")}).bind("_keypress.inputmask",ea).bind("complete.inputmask",
g.oncomplete).bind("incomplete.inputmask",g.onincomplete).bind("cleared.inputmask",g.oncleared);L(u,!0,!1);D=h().join("");var ca;try{ca=document.activeElement}catch(fa){}ca===u?(t.addClass("focus.inputmask"),v(u,n(c().lastValidPosition))):g.clearMaskOnLostFocus?h().join("")==f().join("")?u._valueSet(""):Y(u):K(u,h());O(u)}};return this}var g=e.extend(!0,{},e.inputmask.defaults,c),w=null!==navigator.userAgent.match(/msie 10/i),M=null!==navigator.userAgent.match(/iphone/i),u=null!==navigator.userAgent.match(/android.*safari.*/i),
m=d("paste")&&!w?"paste":d("input")?"input":"propertychange",l,q=0;u&&(w=navigator.userAgent.match(/safari.*/i),parseInt(RegExp(/[0-9]+/).exec(w)));if("string"===typeof a)switch(a){case "mask":return f(g.alias,c),l=k(),0==l.length?this:this.each(function(){n(e.extend(!0,{},l),0).mask(this)});case "unmaskedvalue":return w=e(this),w.data("_inputmask")?(l=w.data("_inputmask").masksets,q=w.data("_inputmask").activeMasksetIndex,g=w.data("_inputmask").opts,n(l,q).unmaskedvalue(w)):w.val();case "remove":return this.each(function(){var a=
e(this);if(a.data("_inputmask")){l=a.data("_inputmask").masksets;q=a.data("_inputmask").activeMasksetIndex;g=a.data("_inputmask").opts;this._valueSet(n(l,q).unmaskedvalue(a,!0));a.removeData("_inputmask");a.unbind(".inputmask");a.removeClass("focus.inputmask");var b;Object.getOwnPropertyDescriptor&&(b=Object.getOwnPropertyDescriptor(this,"value"));b&&b.get?this._valueGet&&Object.defineProperty(this,"value",{get:this._valueGet,set:this._valueSet}):document.__lookupGetter__&&this.__lookupGetter__("value")&&
...
q=this.data("_inputmask").activeMasksetIndex,g=this.data("_inputmask").opts,n(l,q).isComplete(this[0]._valueGet().split(""));case "getmetadata":if(this.data("_inputmask"))return l=this.data("_inputmask").masksets,q=this.data("_inputmask").activeMasksetIndex,l[q].metadata;return;default:return f(a,c)||(g.mask=a),l=k(),0==l.length?this:this.each(function(){n(e.extend(!0,{},l),q).mask(this)})}else{if("object"==typeof a)return g=e.extend(!0,{},e.inputmask.defaults,a),f(g.alias,a),l=k(),0==l.length?this:
this.each(function(){n(e.extend(!0,{},l),q).mask(this)});if(void 0==a)return this.each(function(){var a=e(this).attr("data-inputmask");if(a&&""!=a)try{var a=a.replace(RegExp("'","g"),'"'),b=e.parseJSON("{"+a+"}");e.extend(!0,b,c);g=e.extend(!0,{},e.inputmask.defaults,b);f(g.alias,b);g.alias=void 0;e(this).inputmask(g)}catch(d){}})}return this})})(jQuery);
(function(e){e.extend(e.inputmask.defaults.definitions,{A:{validator:"[A-Za-z]",cardinality:1,casing:"upper"},"#":{validator:"[A-Za-z\u0410-\u044f\u0401\u04510-9]",cardinality:1,casing:"upper"}});e.extend(e.inputmask.defaults.aliases,{url:{mask:"ir",placeholder:"",separator:"",defaultPrefix:"http://",regex:{urlpre1:/[fh]/,urlpre2:/(ft|ht)/,urlpre3:/(ftp|htt)/,urlpre4:/(ftp:|http|ftps)/,urlpre5:/(ftp:\/|ftps:|http:|https)/,urlpre6:/(ftp:\/\/|ftps:\/|http:\/|https:)/,urlpre7:/(ftp:\/\/|ftps:\/\/|http:\/\/|https:\/)/,
urlpre8:/(ftp:\/\/|ftps:\/\/|http:\/\/|https:\/\/)/},definitions:{i:{validator:function(a,c,d,f,b){return!0},cardinality:8,prevalidator:function(){for(var a=[],c=0;8>c;c++)a[c]=function(){var a=c;return{validator:function(c,b,e,k,z){if(z.regex["urlpre"+(a+1)]){var n=c;0<a+1-c.length&&(n=b.join("").substring(0,a+1-c.length)+""+n);c=z.regex["urlpre"+(a+1)].test(n);if(!k&&!c){e-=a;for(k=0;k<z.defaultPrefix.length;k++)b[e]=z.defaultPrefix[k],e++;for(k=0;k<n.length-1;k++)b[e]=n[k],e++;return{pos:e}}return c}return!1},
...
(function(e){e.extend(e.inputmask.defaults.aliases,{Regex:{mask:"r",greedy:!1,repeat:"*",regex:null,regexTokens:null,tokenizer:/\[\^?]?(?:[^\\\]]+|\\[\S\s]?)*]?|\\(?:0(?:[0-3][0-7]{0,2}|[4-7][0-7]?)?|[1-9][0-9]*|x[0-9A-Fa-f]{2}|u[0-9A-Fa-f]{4}|c[A-Za-z]|[\S\s]?)|\((?:\?[:=!]?)?|(?:[?*+]|\{[0-9]+(?:,[0-9]*)?\})\??|[^.?*+^${[()|\\]+|./g,quantifierFilter:/[0-9]+[^,]/,definitions:{r:{validator:function(a,c,d,f,b){function e(){this.matches=[];this.isLiteral=this.isQuantifier=this.isGroup=!1}function k(){var a=
new e,c,d=[];for(b.regexTokens=[];c=b.tokenizer.exec(b.regex);)switch(c=c[0],c.charAt(0)){case "[":case "\\":0<d.length?d[d.length-1].matches.push(c):a.matches.push(c);break;case "(":!a.isGroup&&0<a.matches.length&&b.regexTokens.push(a);a=new e;a.isGroup=!0;d.push(a);break;case ")":c=d.pop();0<d.length?d[d.length-1].matches.push(c):(b.regexTokens.push(c),a=new e);break;case "{":var f=new e;f.isQuantifier=!0;f.matches.push(c);0<d.length?d[d.length-1].matches.push(f):a.matches.push(f);break;default:f=
new e,f.isLiteral=!0,f.matches.push(c),0<d.length?d[d.length-1].matches.push(f):a.matches.push(f)}0<a.matches.length&&b.regexTokens.push(a)}function z(a,c){var d=!1;c&&(n+="(",g++);for(var f=0;f<a.matches.length;f++){var e=a.matches[f];if(!0==e.isGroup)d=z(e,!0);else if(!0==e.isQuantifier){for(var e=e.matches[0],h=b.quantifierFilter.exec(e)[0].replace("}",""),h=n+"{1,"+h+"}",k=0;k<g;k++)h+=")";d=RegExp("^("+h+")$");d=d.test(w);n+=e}else if(!0==e.isLiteral){for(var e=e.matches[0],h=n,S="",k=0;k<g;k++)S+=
")";for(k=0;k<e.length&&!(h=(h+e[k]).replace(/\|$/,""),d=RegExp("^("+h+S+")$"),d=d.test(w));k++);n+=e}else{n+=e;h=n.replace(/\|$/,"");for(k=0;k<g;k++)h+=")";d=RegExp("^("+h+")$");d=d.test(w)}if(d)break}c&&(n+=")",g--);return d}null==b.regexTokens&&k();f=c.slice();var n="";c=!1;var g=0;f.splice(d,0,a);var w=f.join("");for(a=0;a<b.regexTokens.length&&!(e=b.regexTokens[a],c=z(e,e.isGroup));a++);return c},cardinality:1}}}})})(jQuery);
