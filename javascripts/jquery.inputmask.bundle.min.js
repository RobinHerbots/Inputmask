...
u=h().slice(),t=c().lastValidPosition;w(d);var L=[];e.each(a,function(a,g){if("object"==typeof g){b=a;var e=d,k=c().lastValidPosition,m;if(k==t){if(1<e-t)for(k=-1==k?0:k;k<e&&(m=l(k,c(),u[k],!0),!1!==m);k++)I(h(),k,u[k],!0),!0===m&&(m={pos:k}),m=m.pos||k,c().lastValidPosition<m&&(c().lastValidPosition=m);if(!r(e)&&!l(e,c(),f,C)){k=q(e)-e;for(m=0;m<k&&!1===l(++e,c(),f,C);m++);L.push(b)}}(c().lastValidPosition>=t||b==s)&&0<=e&&e<p()&&(D=l(e,c(),f,C),!1!==D&&(!0===D&&(D={pos:e}),m=D.pos||e,c().lastValidPosition<
...
d.begin,d.end);ba=-1!=e.inArray(k,g.ignorables)}function fa(d,f,n,m,r,x){if(void 0==n&&V)return!1;V=!0;var t=e(this);d=d||window.event;n=n||d.which||d.charCode||d.keyCode;if((!d.ctrlKey||!d.altKey)&&(d.ctrlKey||d.metaKey||ba)&&!0!==f)return!0;if(n){!0!==f&&46==n&&!1==d.shiftKey&&","==g.radixPoint&&(n=44);var v,L,M=String.fromCharCode(n);f?(n=r?x:c().lastValidPosition+1,v={begin:n,end:n}):v=u(this);x=A?1<v.begin-v.end||1==v.begin-v.end&&g.insertMode:1<v.end-v.begin||1==v.end-v.begin&&g.insertMode;
var y=b;x&&(b=y,e.each(a,function(a,d){"object"==typeof d&&(b=a,c().undoBuffer=h().join(""))}),ea(this,g.keyCode.DELETE,v),g.insertMode||e.each(a,function(a,d){"object"==typeof d&&(b=a,D(v.begin,p(),z(v.begin),!0),c().lastValidPosition=q(c().lastValidPosition))}),b=y);var C=h().join("").indexOf(g.radixPoint);g.isNumeric&&!0!==f&&-1!=C&&(g.greedy&&v.begin<=C?(v.begin=w(v.begin),v.end=v.begin):M==g.radixPoint&&(v.begin=C,v.end=v.begin));var B=v.begin;n=k(B,M,r);!0===r&&(n=[{activeMasksetIndex:b,result:n}]);
...
(c().p=E)}});!0!==r&&(b=y,l());if(!1!==m&&(e.each(n,function(a,c){if(c.activeMasksetIndex==b)return L=c,!1}),void 0!=L)){var J=this;setTimeout(function(){g.onKeyValidation.call(J,L.result,g)},0);if(c().writeOutBuffer&&!1!==L.result){var H=h();m=f?void 0:g.numericInput?B>C?w(E):M==g.radixPoint?E-1:w(E-1):E;K(this,H,m);!0!==f&&setTimeout(function(){!0===S(H)&&t.trigger("complete")},0)}else x&&(c().buffer=c().undoBuffer.split(""))}g.showTooltip&&t.prop("title",c().mask);d.preventDefault()}}function $(a){var b=
...
q(e.inArray(g.radixPoint,d)):e.inArray(g.radixPoint,d):q(f):q(f);b<d?r(b)?u(a,b):u(a,q(b)):u(a,d)}},0)}).bind("dblclick.inputmask",function(){var a=this;setTimeout(function(){u(a,0,q(c().lastValidPosition))},0)}).bind("keydown.inputmask",Y).bind(n?"input.inputmask":"keypress.inputmask",fa).bind("keyup.inputmask",$).bind(M+".inputmask dragdrop.inputmask drop.inputmask",function(a){var b=this,c=e(b);if("propertychange"==a.type&&b._valueGet().length<=p())return!0;setTimeout(function(){O(b,!0,!1);!0===
S(h())&&c.trigger("complete");c.click()},0)}).bind("setvalue.inputmask",function(){O(this,!0);J=h().join("");this._valueGet()==f().join("")&&this._valueSet("")}).bind("_keypress.inputmask",fa).bind("complete.inputmask",g.oncomplete).bind("incomplete.inputmask",g.onincomplete).bind("cleared.inputmask",g.oncleared);O(x,!0,!1);J=h().join("");var da;try{da=document.activeElement}catch(ga){}da===x?(t.addClass("focus.inputmask"),u(x,q(c().lastValidPosition))):g.clearMaskOnLostFocus?h().join("")==f().join("")?
x._valueSet(""):Z(x):K(x,h());Q(x)}};return this}var g=e.extend(!0,{},e.inputmask.defaults,c),w=null!==navigator.userAgent.match(/msie 10/i),L=null!==navigator.userAgent.match(/iphone/i),x=null!==navigator.userAgent.match(/android.*safari.*/i),n=null!==navigator.userAgent.match(/android.*chrome.*/i),M=d("paste")&&!w?"paste":d("input")?"input":"propertychange",l,q=0;if("string"===typeof a)switch(a){case "mask":return f(g.alias,c),l=k(),0==l.length?this:this.each(function(){m(e.extend(!0,{},l),0).mask(this)});
case "unmaskedvalue":return w=e(this),w.data("_inputmask")?(l=w.data("_inputmask").masksets,q=w.data("_inputmask").activeMasksetIndex,g=w.data("_inputmask").opts,m(l,q).unmaskedvalue(w)):w.val();case "remove":return this.each(function(){var a=e(this);if(a.data("_inputmask")){l=a.data("_inputmask").masksets;q=a.data("_inputmask").activeMasksetIndex;g=a.data("_inputmask").opts;this._valueSet(m(l,q).unmaskedvalue(a,!0));a.removeData("_inputmask");a.unbind(".inputmask");a.removeClass("focus.inputmask");
var b;Object.getOwnPropertyDescriptor&&(b=Object.getOwnPropertyDescriptor(this,"value"));b&&b.get?this._valueGet&&Object.defineProperty(this,"value",{get:this._valueGet,set:this._valueSet}):document.__lookupGetter__&&this.__lookupGetter__("value")&&this._valueGet&&(this.__defineGetter__("value",this._valueGet),this.__defineSetter__("value",this._valueSet));try{delete this._valueGet,delete this._valueSet}catch(c){this._valueSet=this._valueGet=void 0}}});case "getemptymask":return this.data("_inputmask")?
(l=this.data("_inputmask").masksets,q=this.data("_inputmask").activeMasksetIndex,l[q]._buffer.join("")):"";case "hasMaskedValue":return this.data("_inputmask")?!this.data("_inputmask").opts.autoUnmask:!1;case "isComplete":return l=this.data("_inputmask").masksets,q=this.data("_inputmask").activeMasksetIndex,g=this.data("_inputmask").opts,m(l,q).isComplete(this[0]._valueGet().split(""));case "getmetadata":if(this.data("_inputmask"))return l=this.data("_inputmask").masksets,q=this.data("_inputmask").activeMasksetIndex,
l[q].metadata;return;default:return f(a,c)||(g.mask=a),l=k(),0==l.length?this:this.each(function(){m(e.extend(!0,{},l),q).mask(this)})}else{if("object"==typeof a)return g=e.extend(!0,{},e.inputmask.defaults,a),f(g.alias,a),l=k(),0==l.length?this:this.each(function(){m(e.extend(!0,{},l),q).mask(this)});if(void 0==a)return this.each(function(){var a=e(this).attr("data-inputmask");if(a&&""!=a)try{var a=a.replace(RegExp("'","g"),'"'),b=e.parseJSON("{"+a+"}");e.extend(!0,b,c);g=e.extend(!0,{},e.inputmask.defaults,
b);f(g.alias,b);g.alias=void 0;e(this).inputmask(g)}catch(d){}})}return this})})(jQuery);
