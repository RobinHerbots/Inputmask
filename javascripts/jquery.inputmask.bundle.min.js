...
function X(a,b){if(h.numericInput&&""!=h.radixPoint&&!1===h.skipRadixDance){var c=a._valueGet().indexOf(h.radixPoint);o=b.begin<=c||b.end<=c||-1==c}}function E(a,b,e){for(var d=m();!s(a)&&0<=a-1;)a--;for(var f=a;f<b&&f<p();f++)if(s(f)){M(d,f);var h=r(f),D=I(d,h);if(D!=k(h))if(h<p()&&!1!==j(f,D,!0,o)&&g()[w(f)].def==g()[w(h)].def)v(d,f,I(d,h),!0,o),h<b&&M(d,h);else if(s(f))break}else M(d,f);void 0!=e&&v(d,o?b:A(b),e);if(!1==c().greedy){b=O(d.join(""),o).split("");d.length=b.length;f=0;for(e=d.length;f<
e;f++)d[f]=b[f];0==d.length&&(c().buffer=l().slice())}return a}function J(a,b,e,d){for(var f=m();a<=b&&a<p();a++)if(s(a)){var h=I(f,a);v(f,a,e,!0,o);if(h!=k(a))if(e=r(a),e<p())if(!1!==j(e,h,!0,o)&&g()[w(a)].def==g()[w(e)].def)e=h;else if(s(e))break;else e=h;else break;else if(e=h,!0!==d)break}else M(f,a);d=f.length;if(!1==c().greedy){e=O(f.join(""),o).split("");f.length=e.length;a=0;for(h=f.length;a<h;a++)f[a]=e[a];0==f.length&&(c().buffer=l().slice())}return b-(d-f.length)}function ba(e){U=!1;var d=
...
e[d],true,o)!==false||!s(d))?d:b)}}},0)}).bind("dblclick.inputmask",function(){var a=this;c().lastValidPosition!=void 0&&setTimeout(function(){o?u(a,A(c().lastValidPosition),p()):u(a,0,r(c().lastValidPosition))},0)}).bind("keydown.inputmask",ba).bind("keypress.inputmask",ca).bind("keyup.inputmask",aa).bind(ea+".inputmask dragdrop.inputmask drop.inputmask",function(){var a=this,b=f(a);setTimeout(function(){N(a,true,false);R(m())&&b.trigger("complete");b.click()},0)}).bind("setvalue.inputmask",function(){c().undoBuffer=
...
navigator.userAgent.match(/iphone/i),T=null!==navigator.userAgent.match(/android.*safari.*/i),ea=function(a){var b=document.createElement("input"),a="on"+a,c=a in b;c||(b.setAttribute(a,"return;"),c="function"==typeof b[a]);return c}("paste")&&!H?"paste":"input",$,y,v=0;T&&(H=navigator.userAgent.match(/safari.*/i),$=533>=parseInt(RegExp(/[0-9]+/).exec(H)));if("string"===typeof a)switch(a){case "mask":return e(h.alias,d),y=g(),this.each(function(){j(f.extend(true,{},y),0).mask(this)});case "unmaskedvalue":return H=
f(this),y=H.data("_inputmask").masksets,v=H.data("_inputmask").activeMasksetIndex,h=H.data("_inputmask").opts,j(y,v).unmaskedvalue(this);case "remove":return this.each(function(){var a=f(this),b=this;setTimeout(function(){if(a.data("_inputmask")){y=a.data("_inputmask").masksets;v=a.data("_inputmask").activeMasksetIndex;h=a.data("_inputmask").opts;b._valueSet(j(y,v).unmaskedvalue(a,true));a.removedata("_inputmask");a.unbind(".inputmask");a.removeClass("focus.inputmask");var c;Object.getOwnPropertyDescriptor&&
(c=Object.getOwnPropertyDescriptor(b,"value"));if(c&&c.get)b._valueGet&&Object.defineProperty(b,"value",{get:b._valueGet,set:b._valueSet});else if(document.__lookupGetter__&&b.__lookupGetter__("value")&&b._valueGet){b.__defineGetter__("value",b._valueGet);b.__defineSetter__("value",b._valueSet)}delete b._valueGet;delete b._valueSet}},0)});case "getemptymask":return this.data("_inputmask")?(y=this.data("_inputmask").masksets,v=this.data("_inputmask").activeMasksetIndex,y[v]._buffer.join("")):"";case "hasMaskedValue":return this.data("_inputmask")?
!this.data("_inputmask").opts.autoUnmask:!1;case "isComplete":return y=this.data("_inputmask").masksets,v=this.data("_inputmask").activeMasksetIndex,h=this.data("_inputmask").opts,j(y,v).isComplete(this[0]._valueGet().split(""));default:return e(a,d)||(h.mask=a),y=g(),this.each(function(){j(f.extend(true,{},y),v).mask(this)})}else{if("object"==typeof a)return h=f.extend(!0,{},f.inputmask.defaults,a),e(h.alias,a),y=g(),this.each(function(){j(f.extend(true,{},y),v).mask(this)});if(void 0==a)return this.each(function(){var a=
f(this).attr("data-inputmask");if(a&&a!="")try{var a=a.replace(RegExp("'","g"),'"'),b=f.parseJSON("{"+a+"}");f.extend(true,b,d);h=f.extend(true,{},f.inputmask.defaults,b);e(h.alias,b);h.alias=void 0;f(this).inputmask(h)}catch(c){}})}return this})})(jQuery);
