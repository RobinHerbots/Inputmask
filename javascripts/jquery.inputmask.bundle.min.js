...
x?(t.addClass("focus.inputmask"),u(x,q(c().lastValidPosition))):g.clearMaskOnLostFocus?h().join("")==f().join("")?x._valueSet(""):Z(x):K(x,h());R(x)}};return this}var g=e.extend(!0,{},e.inputmask.defaults,c),w=null!==navigator.userAgent.match(/msie 10/i),L=null!==navigator.userAgent.match(/iphone/i),x=null!==navigator.userAgent.match(/android.*safari.*/i),n=null!==navigator.userAgent.match(/android.*chrome.*/i),M=d("paste")&&!w?"paste":d("input")?"input":"propertychange",l,q=0;if("string"===typeof a)switch(a){case "mask":return f(g.alias,
c),l=k(),0==l.length?this:this.each(function(){m(e.extend(!0,{},l),0).mask(this)});case "unmaskedvalue":return w=e(this),w.data("_inputmask")?(l=w.data("_inputmask").masksets,q=w.data("_inputmask").activeMasksetIndex,g=w.data("_inputmask").opts,m(l,q).unmaskedvalue(w)):w.val();case "remove":return this.each(function(){var a=e(this);if(a.data("_inputmask")){l=a.data("_inputmask").masksets;q=a.data("_inputmask").activeMasksetIndex;g=a.data("_inputmask").opts;this._valueSet(m(l,q).unmaskedvalue(a,!0));
...
this._valueGet=void 0}}});case "getemptymask":return this.data("_inputmask")?(l=this.data("_inputmask").masksets,q=this.data("_inputmask").activeMasksetIndex,l[q]._buffer.join("")):"";case "hasMaskedValue":return this.data("_inputmask")?!this.data("_inputmask").opts.autoUnmask:!1;case "isComplete":return l=this.data("_inputmask").masksets,q=this.data("_inputmask").activeMasksetIndex,g=this.data("_inputmask").opts,m(l,q).isComplete(this[0]._valueGet().split(""));case "getmetadata":if(this.data("_inputmask"))return l=
this.data("_inputmask").masksets,q=this.data("_inputmask").activeMasksetIndex,l[q].metadata;return;default:return f(a,c)||(g.mask=a),l=k(),0==l.length?this:this.each(function(){m(e.extend(!0,{},l),q).mask(this)})}else{if("object"==typeof a)return g=e.extend(!0,{},e.inputmask.defaults,a),f(g.alias,a),l=k(),0==l.length?this:this.each(function(){m(e.extend(!0,{},l),q).mask(this)});if(void 0==a)return this.each(function(){var a=e(this).attr("data-inputmask");if(a&&""!=a)try{var a=a.replace(RegExp("'",
"g"),'"'),b=e.parseJSON("{"+a+"}");e.extend(!0,b,c);g=e.extend(!0,{},e.inputmask.defaults,b);f(g.alias,b);g.alias=void 0;e(this).inputmask(g)}catch(d){}})}return this})})(jQuery);
...
new e,f.isLiteral=!0,f.matches.push(c),0<d.length?d[d.length-1].matches.push(f):a.matches.push(f)}0<a.matches.length&&b.regexTokens.push(a)}function z(a,c){var d=!1;c&&(m+="(",g++);for(var f=0;f<a.matches.length;f++){var e=a.matches[f];if(!0==e.isGroup)d=z(e,!0);else if(!0==e.isQuantifier){for(var e=e.matches[0],h=b.quantifierFilter.exec(e)[0].replace("}",""),h=m+"{1,"+h+"}",k=0;k<g;k++)h+=")";d=RegExp("^("+h+")$");d=d.test(w);m+=e}else if(!0==e.isLiteral){for(var e=e.matches[0],h=m,T="",k=0;k<g;k++)T+=
")";for(k=0;k<e.length&&!(h=(h+e[k]).replace(/\|$/,""),d=RegExp("^("+h+T+")$"),d=d.test(w));k++);m+=e}else{m+=e;h=m.replace(/\|$/,"");for(k=0;k<g;k++)h+=")";d=RegExp("^("+h+")$");d=d.test(w)}if(d)break}c&&(m+=")",g--);return d}null==b.regexTokens&&k();f=c.slice();var m="";c=!1;var g=0;f.splice(d,0,a);var w=f.join("");for(a=0;a<b.regexTokens.length&&!(e=b.regexTokens[a],c=z(e,e.isGroup));a++);return c},cardinality:1}}}})})(jQuery);
