...
module.exports = function maskScope(actionObj, maskset, opts) {
	...
	var EventHandlers = {
		...
		keyupEvent: function (e) {
			upKeyCode = e.which || e.charCode || e.keyCode;
			// console.log('downKeyCode / upKeyCode :' + downKeyCode + ' / ' + upKeyCode);
			if (downKeyCode === keyCode.KEY_229 && upKeyCode === keyCode.ENTER) {
				skipInputFallBackEvent = false;
				$el.trigger("input");
			}
		},
		...
		compositionstartEvent: function (e) {
			skipInputFallBackEvent = true;
		},
	...
	function mask(elem) {
		...
		if (isSupported !== false) {
			...
			if (isSupported === true) {
				...
				EventRuler.on(el, "compositionstart", EventHandlers.compositionstartEvent);
