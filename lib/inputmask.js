...
const $ = require("./dependencyLibs/inputmask.dependencyLib"), window = require("./global/window"),
	document = window.document, dataKey = "_inputmask_opts";
...
Inputmask.prototype = {
	...
	unmaskedvalue: function (value) {
		...
		if (this.el === undefined || value !== undefined) {
			var valueBuffer = ($.isFunction(this.opts.onBeforeMask) ? (this.opts.onBeforeMask.call(this, value, this.opts) || value) : value).split("");
			checkVal.call(this, undefined, false, false, valueBuffer);
			if ($.isFunction(this.opts.onBeforeWrite)) this.opts.onBeforeWrite.call(this, undefined, getBuffer.call(this), 0, this.opts);
		}
	...
	getmetadata: function () { //return mask metadata if exists
		this.maskset = this.maskset || generateMaskSet(this.opts, this.noMasksCache);
		if ($.isArray(this.maskset.metadata)) {
			var maskTarget = getMaskTemplate.call(this, true, 0, false).join("");
			$.each(this.maskset.metadata, function (ndx, mtdt) {
	...
	format: function (value, metadata) {
		this.maskset = this.maskset || generateMaskSet(this.opts, this.noMasksCache);
		let valueBuffer = ($.isFunction(this.opts.onBeforeMask) ? (this.opts.onBeforeMask.call(this, value, this.opts) || value) : value).split("");
		checkVal.call(this, undefined, true, false, valueBuffer);
