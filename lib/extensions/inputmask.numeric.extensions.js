...
Inputmask.extendAliases({
    "numeric": {
        mask: function (opts) {
            ...
            if (opts.digits !== undefined) {
                ...
                if (isFinite(dq[0]) && dq[1] && isFinite(dq[1])) {
                    mask += opts.radixPoint + "9{" + opts.digits + "}";
                } else if (isNaN(opts.digits) || parseInt(opts.digits) > 0) {
                    if (opts.digitsOptional) {
                        mask += "[" + opts.radixPoint + "9{1," + opts.digits + "}]";
                    } else mask += opts.radixPoint + "9{" + opts.digits + "}";
                }
            }
        ...
        preValidation: function (buffer, pos, c, isSelection, opts, maskset) {
            ...
            //     if (radixPos !== pos)
            //         return {
            //             "caret": opts._radixDance && pos > radixPos ? radixPos + 1 : radixPos - 1
            //         };
            // }
            //
            return true;
