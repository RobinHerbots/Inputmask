      ...
      switch (targetProp) {
        ...
        case "month":
          if (fcode === "MMM" || fcode === "MMMM") {
            ...
            dateObj["partial" + targetProp] =
              dateObj[targetProp] === "" || dateObj[targetProp] === undefined;
            break;
          }
...
function parse(format, dateObjValue, opts, partial) {
      ...
      if (dateObjValue === undefined) {
        ...
        if (!escaped && (fcode = formatcode(match[0]))) {
          if (fcode[3]) {
            const getFn = fcode[3];
            mask +=
              partial && dateObjValue["partial" + fcode[2]]
                ? match[0]
