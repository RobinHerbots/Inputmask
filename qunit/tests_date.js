export default function (qunit, $, Inputmask) {
    ...
    qunit.test("datetime inputformat dd/mm/yyyy - input 2331973", function (assert) {
    ...
    qunit.test("datetime inputformat mm/dd/yyyy - input 3231973", function (assert) {
        var $fixture = $("#qunit-fixture");
        $fixture.append('<input type="text" id="testmask" />');
        var testmask = document.getElementById("testmask");
        Inputmask("datetime", {
    ...
    qunit.test("datetime inputformat dd/mm/yyyy - input 29022012", function (assert) {
        var $fixture = $("#qunit-fixture");
        $fixture.append('<input type="text" id="testmask" />');
        var testmask = document.getElementById("testmask");
        Inputmask("datetime", {
        ...
        testmask.focus();
        $("#testmask").Type("29022012");
        assert.equal(testmask.value, "29/02/201_", "Result " + testmask.value);
    });

    qunit.test("datetime inputformat dd/mm/yyyy - input 29022013", function (assert) {
        var $fixture = $("#qunit-fixture");
        $fixture.append('<input type="text" id="testmask" />');
        var testmask = document.getElementById("testmask");
        Inputmask("datetime", {
        ...
        assert.equal(testmask.value, "29/02/2013", "Result " + testmask.value);


    });

    qunit.test("datetime inputformat mm/dd/yyyy - input 02292012", function (assert) {
        var $fixture = $("#qunit-fixture");
        $fixture.append('<input type="text" id="testmask" />');
        var testmask = document.getElementById("testmask");
        Inputmask("datetime", {inputFormat: "mm/dd/yyyy"}).mask(testmask);
        ...
        assert.equal(testmask.value, "02/29/201_", "Result " + testmask.value);


    });

    qunit.test("datetime inputformat mm/dd/yyyy - input 02292013", function (assert) {
        var $fixture = $("#qunit-fixture");
        $fixture.append('<input type="text" id="testmask" />');
        var testmask = document.getElementById("testmask");
        Inputmask("datetime", {inputFormat: "mm/dd/yyyy"}).mask(testmask);
        ...
        assert.equal(testmask.value, "02/29/2013", "Result " + testmask.value);


    });

    qunit.test("datetime inputformat dd/mm/yyyy - input CTRL RIGHT", function (assert) {
        var $fixture = $("#qunit-fixture");
        $fixture.append('<input type="text" id="testmask" />');
        var testmask = document.getElementById("testmask");
        Inputmask("datetime", {inputFormat: "mm/dd/yyyy"}).mask(testmask);
    ...
    qunit.test("datetime inputformat dd/mm/yyyy - input 2331973 BACKSPACE x4 2013", function (assert) {
        var $fixture = $("#qunit-fixture");
        $fixture.append('<input type="text" id="testmask" />');
        var testmask = document.getElementById("testmask");
        Inputmask("datetime", {inputFormat: "mm/dd/yyyy"}).mask(testmask);
    ...
    qunit.test("datetime inputformat dd/mm/yyyy - input 23373 ", function (assert) {
        var $fixture = $("#qunit-fixture");
        $fixture.append('<input type="text" id="testmask" />');
        var testmask = document.getElementById("testmask");
        Inputmask("datetime", {inputFormat: "mm/dd/yyyy"}).mask(testmask);
    ...
    qunit.test("datetime inputformat dd/mm/yyyy - input 23318 - jimithing277", function (assert) {
        var $fixture = $("#qunit-fixture");
        $fixture.append('<input type="text" id="testmask" />');
        var testmask = document.getElementById("testmask");
        Inputmask("datetime", {inputFormat: "mm/dd/yyyy"}).mask(testmask);
    ...
    qunit.test("datetime inputformat mm/dd/yyyy min 1900/1/1 max 2000/1/1 - input 32373 ", function (assert) {
        var $fixture = $("#qunit-fixture");
        $fixture.append('<input type="text" id="testmask" />');
        var testmask = document.getElementById("testmask");
        Inputmask("datetime", {
    ...
    qunit.test("datetime inputformat hh:MM - add remove add", function (assert) {
        var $fixture = $("#qunit-fixture");
        $fixture.append('<input type="text" id="testmask" />');
        var testmask = document.getElementById("testmask");
        Inputmask('datetime', {
    ...
    qunit.test("datetime inputformat mm/yyyy - input 31973", function (assert) {
        var $fixture = $("#qunit-fixture");
        $fixture.append('<input type="text" id="testmask" />');
        var testmask = document.getElementById("testmask");
        Inputmask('datetime', {
